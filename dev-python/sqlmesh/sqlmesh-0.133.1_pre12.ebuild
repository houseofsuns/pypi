...
IUSE="athena bigquery cicdtest clickhouse databricks dbt dev dlt gcppostgres github llm mssql mwaa mysql postgres redshift slack snowflake trino web"
DEPENDENCIES="dev-python/astor[${PYTHON_USEDEP}]
	...
	~dev-python/sqlglot-25.31.4[${PYTHON_USEDEP}]
