...
IUSE="all ansible docs export-polarion link-jira prepare-artifact provision-beaker provision-bootc provision-virtual report-junit report-polarion test-convert"
DEPENDENCIES=">=dev-python/click-8.0.3[${PYTHON_USEDEP}]
	...
	all? ( dev-python/copr[${PYTHON_USEDEP}] )
	...
	prepare-artifact? ( dev-python/copr[${PYTHON_USEDEP}] )
	prepare-artifact? ( dev-python/koji[${PYTHON_USEDEP}] )
	provision-beaker? ( dev-python/mrack[${PYTHON_USEDEP}] )
	provision-bootc? ( dev-python/testcloud[${PYTHON_USEDEP}] )
