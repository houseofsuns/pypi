...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/ec/2a/bf5617553a7a8af97e374320ee22656132b579a45b1a626e73e198398d0c/${REALNAME}-${REALVERSION}.tar.gz"
...
DEPENDENCIES="dev-python/fast-depends[${PYTHON_USEDEP}]
	...
	cli? ( <=dev-python/typer-0.20.0[${PYTHON_USEDEP}] )
	...
	redis? ( <dev-python/redis-8.0.0[${PYTHON_USEDEP}] )"
