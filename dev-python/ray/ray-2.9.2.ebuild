...
DEPENDENCIES=">=dev-python/click-7.0[${PYTHON_USEDEP}]
	...
	air? ( dev-python/aiorwlock[${PYTHON_USEDEP}] )
	...
	air? ( dev-python/gpustat[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/ray-cpp[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/gpustat[${PYTHON_USEDEP}] )
	...
	default? ( dev-python/gpustat[${PYTHON_USEDEP}] )
	...
	serve? ( dev-python/aiorwlock[${PYTHON_USEDEP}] )
	...
	serve? ( dev-python/gpustat[${PYTHON_USEDEP}] )
	...
	serve-grpc? ( dev-python/aiorwlock[${PYTHON_USEDEP}] )
	...
	serve-grpc? ( dev-python/gpustat[${PYTHON_USEDEP}] )
