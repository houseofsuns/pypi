...
IUSE="docs export-mpl import-gmsh matrix-mkl matrix-scipy"
DEPENDENCIES="<dev-python/appdirs-2.0[${PYTHON_USEDEP}]
	...
	export-mpl? ( <dev-python/matplotlib-4.0[${PYTHON_USEDEP}] )
	import-gmsh? ( <dev-python/meshio-6.0[${PYTHON_USEDEP}] )
	matrix-mkl? ( dev-python/mkl[${PYTHON_USEDEP}] )
	matrix-scipy? ( <dev-python/scipy-2.0[${PYTHON_USEDEP}] )"
