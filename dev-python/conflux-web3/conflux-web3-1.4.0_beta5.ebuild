...
DEPENDENCIES="dev-python/web3[${PYTHON_USEDEP}]
	...
	dev? ( <dev-python/docker-8.0[${PYTHON_USEDEP}] )
	...
	linter? ( <dev-python/black-23.0[${PYTHON_USEDEP}] )
	tester? ( <dev-python/docker-8.0[${PYTHON_USEDEP}] )
	tester? ( <dev-python/pytest-9.0[${PYTHON_USEDEP}] )
	tester? ( <dev-python/pytest-xdist-4.0[${PYTHON_USEDEP}] )
	...
	tester? ( dev-python/setuptools[${PYTHON_USEDEP}] )
	tester? ( <dev-python/pydantic-3.0[${PYTHON_USEDEP}] )
	tester? ( dev-python/cfx-address[${PYTHON_USEDEP}] )
	tester? ( dev-python/pytest-xdist[${PYTHON_USEDEP}] )
	tester? ( dev-python/pytest-order[${PYTHON_USEDEP}] )"
