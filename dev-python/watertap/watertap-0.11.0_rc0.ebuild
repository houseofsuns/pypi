...
DESCRIPTION="WaterTAP modeling library [newver 0.11.0rc1]"
...
IUSE="dev notebooks oli_api testing"
DEPENDENCIES="dev-python/idaes-pse[${PYTHON_USEDEP}]
	...
	oli_api? ( dev-python/requests[${PYTHON_USEDEP}] )
	oli_api? ( dev-python/cryptography[${PYTHON_USEDEP}] )
