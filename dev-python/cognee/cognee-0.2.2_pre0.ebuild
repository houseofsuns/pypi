...
IUSE="anthropic api aws chromadb codegraph debug deepeval dev distributed docs evals falkordb gemini graphiti groq gui huggingface langchain llama-index mistral neo4j notebook ollama postgres postgres-binary posthog qdrant"
