...
DEPENDENCIES="~dev-python/django-5.1.5[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/sphinxcontrib-mermaid-0.9.2[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/sphinxcontrib-mermaid-0.9.2[${PYTHON_USEDEP}] )
	...
	pil? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] )
