...
IUSE="all bioformats colormaps common converter deepzoom dicom dummy gdal mapnik memcached multi nd2 ometiff openjpeg openslide performance pil rasterio sources test tiff tifffile tiledoutput vips zarr"
DEPENDENCIES="dev-python/cachetools[${PYTHON_USEDEP}]
	...
	common? ( dev-python/psutil[${PYTHON_USEDEP}] )
	common? ( dev-python/pylibmc[${PYTHON_USEDEP}] )
	...
	performance? ( dev-python/psutil[${PYTHON_USEDEP}] )
