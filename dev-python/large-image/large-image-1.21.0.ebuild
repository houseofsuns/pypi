...
IUSE="all bioformats colormaps converter deepzoom dicom dummy gdal mapnik memcached multi nd2 ometiff openjpeg openslide performance pil sources test tiff tifffile tiledoutput vips"
