...
DEPENDENCIES=">=dev-python/absl-py-2.2.2[${PYTHON_USEDEP}]
	...
	dev-python/daytona-sdk[${PYTHON_USEDEP}]
	...
	dev-python/opentelemetry-exporter-gcp-logging[${PYTHON_USEDEP}]
	dev-python/opentelemetry-exporter-gcp-monitoring[${PYTHON_USEDEP}]
	...
	dev-python/smsactivate[${PYTHON_USEDEP}]
