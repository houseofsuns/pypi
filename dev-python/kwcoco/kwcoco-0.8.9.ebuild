...
DEPENDENCIES="dev-python/delayed-image[${PYTHON_USEDEP}]
	...
	docs? ( >=dev-python/networkx-3.0.0[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/networkx-2.8.0[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/networkx-3.0.0[${PYTHON_USEDEP}] )
	runtime? ( >=dev-python/networkx-2.8.0[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/networkx-3.0.0[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/networkx-2.8.0[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/networkx-3.0.0[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/networkx-2.8.0[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/networkx-3.0.0[${PYTHON_USEDEP}] )
	runtime-strict? ( ~dev-python/networkx-2.8.0[${PYTHON_USEDEP}] )
