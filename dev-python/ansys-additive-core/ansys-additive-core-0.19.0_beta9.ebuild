...
DEPENDENCIES="dev-python/ansys-api-additive[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/ipywidgets-8.1.3[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/imageio-2.34.2[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/sphinx-notfound-page-1.0.2[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/google-api-python-client-2.136.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/googleapis-common-protos-1.63.2[${PYTHON_USEDEP}] )
	tests? ( dev-python/grpcio[${PYTHON_USEDEP}] )
	tests? ( dev-python/grpcio-health-checking[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/numpy-2.0.1[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/pandas-2.2.2[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/platformdirs-4.2.2[${PYTHON_USEDEP}] )
