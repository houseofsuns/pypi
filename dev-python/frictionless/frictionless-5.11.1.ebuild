...
IUSE="application aws bigquery ckan datasette dev excel github gsheets html json markdown mysql ods pandas parquet postgresql server spss sql visidata wkt zenodo"
