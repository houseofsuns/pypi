...
DEPENDENCIES=">=dev-python/scipy-1.14.1[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/scikit-image-0.25.1[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/scikit-image-0.25.1[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/scikit-image-0.25.1[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/scikit-image-0.25.1[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/scikit-image-0.25.1[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/scikit-image-0.25.1[${PYTHON_USEDEP}] )
