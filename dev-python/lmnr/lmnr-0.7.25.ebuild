...
IUSE="alephalpha all bedrock chromadb claude-agent-sdk cohere crewai haystack lancedb langchain llamaindex marqo mcp milvus mistralai ollama pinecone qdrant replicate sagemaker together transformers vertexai watsonx weaviate"
DEPENDENCIES="<dev-python/pydantic-3.0.0[${PYTHON_USEDEP}]
	...
	all? ( dev-python/lmnr-claude-code-proxy[${PYTHON_USEDEP}] )
	...
	claude-agent-sdk? ( dev-python/lmnr-claude-code-proxy[${PYTHON_USEDEP}] )
