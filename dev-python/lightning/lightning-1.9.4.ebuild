...
IUSE="all app-cloud app-components app-test app-ui cloud components dev examples extra fabric-examples fabric-strategies fabric-test pytorch-examples pytorch-extra pytorch-strategies pytorch-test strategies test ui"
DEPENDENCIES="dev-python/Jinja2[${PYTHON_USEDEP}]
	...
	app-test? ( dev-python/codecov[${PYTHON_USEDEP}] )
	...
	app-test? ( dev-python/sqlmodel[${PYTHON_USEDEP}] )
	...
	fabric-test? ( dev-python/codecov[${PYTHON_USEDEP}] )
	fabric-test? ( dev-python/coverage[${PYTHON_USEDEP}] )
	fabric-test? ( dev-python/pre-commit[${PYTHON_USEDEP}] )
	...
	pytorch-strategies? ( dev-python/colossalai[${PYTHON_USEDEP}] )
	pytorch-strategies? ( dev-python/deepspeed[${PYTHON_USEDEP}] )
	pytorch-strategies? ( dev-python/fairscale[${PYTHON_USEDEP}] )
	pytorch-strategies? ( dev-python/horovod[${PYTHON_USEDEP}] )
	pytorch-strategies? ( dev-python/hivemind[${PYTHON_USEDEP}] )
	pytorch-test? ( dev-python/cloudpickle[${PYTHON_USEDEP}] )
	pytorch-test? ( dev-python/codecov[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( dev-python/pre-commit[${PYTHON_USEDEP}] )
