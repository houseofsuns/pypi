...
IUSE="all all-vectorizers dev encryption ollama openai parsing sentence-transformers tfidf"
DEPENDENCIES="dev-python/ascii-colors[${PYTHON_USEDEP}]
	...
	all-vectorizers? ( dev-python/ollama[${PYTHON_USEDEP}] )
	all-vectorizers? ( dev-python/openai[${PYTHON_USEDEP}] )
