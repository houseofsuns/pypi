...
HOMEPAGE="https://github.com/amplify-education/terrawrap"
LICENSE="MIT"
...
IUSE=""
DEPENDENCIES="dev-python/amplify-aws-utils[${PYTHON_USEDEP}]
	dev-python/aws-requests-auth[${PYTHON_USEDEP}]
	~dev-python/docopt-0.6.2[${PYTHON_USEDEP}]
	<dev-python/filelock-4.0[${PYTHON_USEDEP}]
	>=dev-python/gitpython-2.1.10[${PYTHON_USEDEP}]
	<dev-python/pyyaml-7.0[${PYTHON_USEDEP}]
	dev-python/ssm-cache[${PYTHON_USEDEP}]
	...
	<dev-python/pytz-2023.1[${PYTHON_USEDEP}]
