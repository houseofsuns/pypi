...
IUSE="all altair catboost keras lightgbm llm mlflow prophet streamlit tensorflow torch transformers"
DEPENDENCIES="<dev-python/anyio-5.0[${PYTHON_USEDEP}]
	...
	llm? ( dev-python/mlflow[${PYTHON_USEDEP}] )
	...
	llm? ( dev-python/torchdata[${PYTHON_USEDEP}] )
