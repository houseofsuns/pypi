...
DEPENDENCIES="dev-python/bokeh[${PYTHON_USEDEP}]
	...
	examples? ( dev-python/selenium[${PYTHON_USEDEP}] )
	examples? ( dev-python/scikit-image[${PYTHON_USEDEP}] )
	examples? ( dev-python/python-snappy[${PYTHON_USEDEP}] )
	...
	examples_tests? ( dev-python/selenium[${PYTHON_USEDEP}] )
	examples_tests? ( dev-python/scikit-image[${PYTHON_USEDEP}] )
	examples_tests? ( dev-python/python-snappy[${PYTHON_USEDEP}] )
