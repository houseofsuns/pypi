...
DESCRIPTION="File Storage and Management Infrastructure for Tendril"

HOMEPAGE="https://github.com/tendril-framework/tendril-filestore"
LICENSE=""
...
DEPENDENCIES="dev-python/fs[${PYTHON_USEDEP}]
	dev-python/tendril-artefacts[${PYTHON_USEDEP}]
	dev-python/tendril-auth[${PYTHON_USEDEP}]
	dev-python/tendril-config[${PYTHON_USEDEP}]
	dev-python/tendril-utils-fsutils[${PYTHON_USEDEP}]
	dev-python/tendril-utils-db[${PYTHON_USEDEP}]
	dev-python/tendril-utils-www[${PYTHON_USEDEP}]
