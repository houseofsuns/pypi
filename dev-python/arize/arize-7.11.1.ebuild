...
IUSE="autoembeddings llm_evaluation mimicexplainer nlp_metrics tracing"
DEPENDENCIES="~dev-python/requests-futures-1.0.0[${PYTHON_USEDEP}]
	...
	nlp_metrics? ( dev-python/nltk[${PYTHON_USEDEP}] )
	nlp_metrics? ( dev-python/sacrebleu[${PYTHON_USEDEP}] )
	nlp_metrics? ( dev-python/rouge-score[${PYTHON_USEDEP}] )
	nlp_metrics? ( dev-python/evaluate[${PYTHON_USEDEP}] )
	nlp_metrics? ( dev-python/datasets[${PYTHON_USEDEP}] )
	tracing? ( dev-python/opentelemetry-semantic-conventions[${PYTHON_USEDEP}] )
