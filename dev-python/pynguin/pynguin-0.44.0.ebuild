...
IUSE="fandango-faker numpy openai typing"
DEPENDENCIES="<dev-python/jinja2-4.0.0[${PYTHON_USEDEP}]
	...
	<dev-python/astroid-5.0.0[${PYTHON_USEDEP}]
	<dev-python/black-26.0.0[${PYTHON_USEDEP}]
	dev-python/bytecode[${PYTHON_USEDEP}]
	<dev-python/dill-0.5.0[${PYTHON_USEDEP}]
	fandango-faker? ( <dev-python/faker-38.0.0[${PYTHON_USEDEP}] )
	fandango-faker? ( dev-python/fandango-fuzzer[${PYTHON_USEDEP}] )
	...
	typing? ( <dev-python/typing-extensions-5.0.0[${PYTHON_USEDEP}] )
	dev-python/typing-inspect[${PYTHON_USEDEP}]
	fandango-faker? ( <dev-python/xmltodict-0.15.0[${PYTHON_USEDEP}] )"
