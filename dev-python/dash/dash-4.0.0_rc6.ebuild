...
DEPENDENCIES="<dev-python/flask-3.2[${PYTHON_USEDEP}]
	...
	ci? ( >=dev-python/pyzmq-26.0.0[${PYTHON_USEDEP}] )
	...
	celery? ( <=dev-python/redis-5.0.4[${PYTHON_USEDEP}] )
