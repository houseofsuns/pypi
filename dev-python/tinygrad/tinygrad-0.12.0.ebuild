...
IUSE="arm docs linting testing testing-minimal testing-unit triton"
DEPENDENCIES="arm? ( dev-python/unicorn[${PYTHON_USEDEP}] )
	...
	linting? ( ~dev-python/mypy-1.19.1[${PYTHON_USEDEP}] )
	...
	linting? ( dev-python/typeguard[${PYTHON_USEDEP}] )
	...
	testing-minimal? ( dev-python/pytest-timeout[${PYTHON_USEDEP}] )
	testing-minimal? ( dev-python/pytest-split[${PYTHON_USEDEP}] )
	testing-minimal? ( >=dev-python/hypothesis-6.148.9[${PYTHON_USEDEP}] )
	testing-minimal? ( dev-python/z3-solver[${PYTHON_USEDEP}] )
	testing-unit? ( dev-python/tinygrad[${PYTHON_USEDEP}] )
	...
	testing-unit? ( dev-python/openai[${PYTHON_USEDEP}] )
	testing-unit? ( dev-python/ggml-python[${PYTHON_USEDEP}] )
	testing? ( dev-python/tinygrad[${PYTHON_USEDEP}] )
	...
	testing? ( dev-python/influxdb3-python[${PYTHON_USEDEP}] )
