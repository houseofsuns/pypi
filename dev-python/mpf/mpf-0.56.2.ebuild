...
DEPENDENCIES="~dev-python/ruamel-yaml-0.15.42[${PYTHON_USEDEP}]
	...
	cli? ( ~dev-python/prompt-toolkit-3.0.33[${PYTHON_USEDEP}] )
	cli? ( dev-python/asciimatics[${PYTHON_USEDEP}] )
	cli? ( ~dev-python/terminaltables-3.1.0[${PYTHON_USEDEP}] )
