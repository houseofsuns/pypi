...
HOMEPAGE="https://github.com/wiremind/remoulade"
LICENSE=""
...
IUSE="dev postgres pydantic rabbitmq redis server"
DEPENDENCIES=">=dev-python/prometheus-client-0.2[${PYTHON_USEDEP}]
	...
	pydantic? ( >=dev-python/pydantic-2.12[${PYTHON_USEDEP}] )
