...
IUSE="crypto desktop lxml mobile ruamel-yaml tui ujson webui zstd"
DEPENDENCIES="dev-python/bidict[${PYTHON_USEDEP}]
	...
	<dev-python/rich-14.2.1[${PYTHON_USEDEP}]
	...
	ruamel-yaml? ( >=dev-python/ruamel-yaml-0.18.16[${PYTHON_USEDEP}] )
