...
IUSE="all bigquery boto3 cassandra clickhouse couchdb dataframe default elasticsearch hazelcast influxdb jdbc mariadb memcache mongodb msqlserver mysql odbc oracle postgres postgresql pyspark redis redpanda rethinkdb scylla sqlalchemy sqlite"
DEPENDENCIES="~dev-python/cryptography-42.0.4[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/elasticsearch-8.13.2[${PYTHON_USEDEP}] )
	...
	elasticsearch? ( ~dev-python/elasticsearch-8.13.2[${PYTHON_USEDEP}] )
