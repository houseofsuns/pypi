...
IUSE="auth buildtools geo manifest notifications platform queues storage tasks test web"
DEPENDENCIES="dev-python/arrow[${PYTHON_USEDEP}]
	...
	geo? ( dev-python/googlemaps[${PYTHON_USEDEP}] )
	manifest? ( dev-python/boto3[${PYTHON_USEDEP}] )
	manifest? ( dev-python/opencv-python-headless[${PYTHON_USEDEP}] )
	notifications? ( dev-python/google-cloud-pubsub[${PYTHON_USEDEP}] )
	platform? ( dev-python/google-cloud-firestore[${PYTHON_USEDEP}] )
	platform? ( dev-python/boto3[${PYTHON_USEDEP}] )
	platform? ( dev-python/opencv-python-headless[${PYTHON_USEDEP}] )
	platform? ( dev-python/googlemaps[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/googlemaps[${PYTHON_USEDEP}] )
