...
IUSE="athena azuresql bigframes bigquery cicdtest clickhouse databricks dbt dev dlt gcppostgres github llm mssql mwaa mysql postgres redshift slack snowflake trino web"
DEPENDENCIES="dev-python/astor[${PYTHON_USEDEP}]
	...
	~dev-python/sqlglot-26.2.1[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/custom-materializations[${PYTHON_USEDEP}] )
	...
	cicdtest? ( dev-python/dbt-athena-community[${PYTHON_USEDEP}] )
	cicdtest? ( dev-python/dbt-clickhouse[${PYTHON_USEDEP}] )
	...
	snowflake? ( ~dev-python/cryptography-42.0.4[${PYTHON_USEDEP}] )
