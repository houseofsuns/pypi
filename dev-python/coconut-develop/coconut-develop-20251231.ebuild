...
DESCRIPTION="Simple, elegant, Pythonic functional programming. [badver 3.2.0.post0.dev1]"
...
DEPENDENCIES=">=dev-python/setuptools-44.0[${PYTHON_USEDEP}]
	...
	kernel? ( >=dev-python/ipykernel-7.0[${PYTHON_USEDEP}] )
	...
	mypy? ( >=dev-python/mypy-1.19[${PYTHON_USEDEP}] )
	...
	jupyterlab? ( >=dev-python/ipykernel-7.0[${PYTHON_USEDEP}] )
	...
	jupytext? ( >=dev-python/ipykernel-7.0[${PYTHON_USEDEP}] )
	...
	ipython? ( >=dev-python/ipykernel-7.0[${PYTHON_USEDEP}] )
