...
HOMEPAGE="https://github.com/vstconsulting/vstutils"
LICENSE="Apache-2.0"
...
IUSE="all boto3 doc ldap librabbitmq pil prod rpc sqs stubs test"
DEPENDENCIES="dev-python/django[${PYTHON_USEDEP}]
	...
	all? ( dev-python/dj-inmemorystorage[${PYTHON_USEDEP}] )
	...
	librabbitmq? ( dev-python/celery[${PYTHON_USEDEP}] )
	librabbitmq? ( dev-python/django-celery-beat[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/dj-inmemorystorage[${PYTHON_USEDEP}] )
