...
DEPENDENCIES="dev-python/deepdiff[${PYTHON_USEDEP}]
	...
	core? ( dev-python/pytz[${PYTHON_USEDEP}] )
	...
	dash? ( dev-python/pytz[${PYTHON_USEDEP}] )
	...
	streamlit? ( dev-python/pytz[${PYTHON_USEDEP}] )
	streamlit? ( dev-python/pandas[${PYTHON_USEDEP}] )
	...
	jupyter? ( dev-python/pytz[${PYTHON_USEDEP}] )
	...
	jupyter? ( dev-python/beautifulsoup4[${PYTHON_USEDEP}] )
