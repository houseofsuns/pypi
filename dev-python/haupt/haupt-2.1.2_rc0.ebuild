...
DEPENDENCIES="~dev-python/croniter-2.0.1[${PYTHON_USEDEP}]
	...
	fs? ( ~dev-python/fsspec-2024.2.0[${PYTHON_USEDEP}] )
	...
	sandbox? ( ~dev-python/fsspec-2024.2.0[${PYTHON_USEDEP}] )
	...
	streams? ( ~dev-python/fsspec-2024.2.0[${PYTHON_USEDEP}] )
