...
DEPENDENCIES="~dev-python/django-5.0.6[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/redis-5.0.5[${PYTHON_USEDEP}] )
	...
	prod? ( ~dev-python/redis-5.0.5[${PYTHON_USEDEP}] )
	...
	stubs? ( ~dev-python/typing-extensions-4.11.0[${PYTHON_USEDEP}] )
