...
IUSE="arangodb azurite clickhouse google k3s kafka keycloak localstack minio mongodb mssql mysql neo4j opensearch oracle postgres rabbitmq redis selenium"
DEPENDENCIES="azurite? ( dev-python/azure-storage-blob[${PYTHON_USEDEP}] )
