...
DEPENDENCIES="ray-testing? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	...
	langchain-testing? ( <dev-python/pydantic-2.10[${PYTHON_USEDEP}] )
	...
	reasoningengine? ( <dev-python/pydantic-2.10[${PYTHON_USEDEP}] )
