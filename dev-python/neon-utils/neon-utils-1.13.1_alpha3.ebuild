...
IUSE="audio configuration network sentry signal skills test"
DEPENDENCIES="dev-python/ovos-bus-client[${PYTHON_USEDEP}]
	...
	skills? ( dev-python/mock[${PYTHON_USEDEP}] )
	skills? ( dev-python/toml[${PYTHON_USEDEP}] )
