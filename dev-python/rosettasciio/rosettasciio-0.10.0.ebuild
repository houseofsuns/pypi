...
IUSE="all arina blockfile dev doc eds-stream hdf5 image mrcz scalebar-export speed tests tiff usid zspy"
DEPENDENCIES="dev-python/dask[${PYTHON_USEDEP}]
	...
	arina? ( >=dev-python/h5py-2.3[${PYTHON_USEDEP}] )
	arina? ( dev-python/hdf5plugin[${PYTHON_USEDEP}] )
