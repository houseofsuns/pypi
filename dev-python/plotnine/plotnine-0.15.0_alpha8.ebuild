...
DEPENDENCIES=">=dev-python/matplotlib-3.8.0[${PYTHON_USEDEP}]
	...
	extra? ( dev-python/geodatasets[${PYTHON_USEDEP}] )
	extra? ( >=dev-python/scikit-learn-1.3.0[${PYTHON_USEDEP}] )
	extra? ( dev-python/scikit-misc[${PYTHON_USEDEP}] )
	extra? ( dev-python/polars[${PYTHON_USEDEP}] )
	extra? ( >=dev-python/pyarrow-19.0.1[${PYTHON_USEDEP}] )
