...
DEPENDENCIES="<dev-python/django-5.3[${PYTHON_USEDEP}]
	...
	~dev-python/selenium-4.30[${PYTHON_USEDEP}]
	>=dev-python/cryptography-44.0[${PYTHON_USEDEP}]
	~dev-python/boto3-1.37[${PYTHON_USEDEP}]
	...
	testing? ( ~dev-python/flake8-7.2[${PYTHON_USEDEP}] )
	...
	testing? ( ~dev-python/twine-6.1[${PYTHON_USEDEP}] )
