...
DEPENDENCIES="dev-python/jinja2[${PYTHON_USEDEP}]
	...
	all? ( dev-python/altair-alx-alpha[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/altair-alx-alpha[${PYTHON_USEDEP}] )
	dev? ( dev-python/geopandas[${PYTHON_USEDEP}] )
	dev? ( dev-python/hatch[${PYTHON_USEDEP}] )
	dev? ( dev-python/ipython[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/jupyterlab-4.1.5[${PYTHON_USEDEP}] )
	...
	doc? ( dev-python/altair-alx-alpha[${PYTHON_USEDEP}] )
