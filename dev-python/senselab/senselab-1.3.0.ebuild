...
IUSE="articulatory senselab-ai text video"
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	senselab-ai? ( <dev-python/ipykernel-8.0[${PYTHON_USEDEP}] )
	senselab-ai? ( <dev-python/nbformat-6.0[${PYTHON_USEDEP}] )
	senselab-ai? ( dev-python/nbss-upload[${PYTHON_USEDEP}] )
	senselab-ai? ( <dev-python/jupyterlab-5.0[${PYTHON_USEDEP}] )
	dev-python/ppgs[${PYTHON_USEDEP}]
