...
IUSE="ai all dev lightgbm pyspark tensorflow-decision-forests xgboost"
DEPENDENCIES=">=dev-python/graphviz-0.9[${PYTHON_USEDEP}]
	...
	tensorflow-decision-forests? ( dev-python/tensorflow-decision-forests[${PYTHON_USEDEP}] )
	ai? ( dev-python/langchain-openai[${PYTHON_USEDEP}] )
