...
DEPENDENCIES="~dev-python/black-24.2.0[${PYTHON_USEDEP}]
	...
	~dev-python/pyupgrade-3.15.1[${PYTHON_USEDEP}]
	...
	core? ( ~dev-python/psycopg-3.1.18[${PYTHON_USEDEP}] )
	...
	extension? ( ~dev-python/psycopg-3.1.18[${PYTHON_USEDEP}] )
	extension? ( <dev-python/tornado-7.0[${PYTHON_USEDEP}] )
	async? ( ~dev-python/pytest-asyncio-0.23.5_p1[${PYTHON_USEDEP}] )
