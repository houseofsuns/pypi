...
DESCRIPTION="Precompiled binary for surelog. [wheel]"

HOMEPAGE="https://github.com/siliconcompiler/sc-surelog"
LICENSE="Apache-2.0"
...
IUSE="test"
DEPENDENCIES="test? ( ~dev-python/pytest-7.1.0[${PYTHON_USEDEP}] )
