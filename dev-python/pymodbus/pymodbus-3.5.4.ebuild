...
DEPENDENCIES="all? ( dev-python/pyserial[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/types-pyserial[${PYTHON_USEDEP}] )
	...
	development? ( dev-python/pyflakes[${PYTHON_USEDEP}] )
	development? ( dev-python/pydocstyle[${PYTHON_USEDEP}] )
	development? ( dev-python/pycodestyle[${PYTHON_USEDEP}] )
