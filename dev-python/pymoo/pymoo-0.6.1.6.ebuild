...
IUSE="dev full others parallelization"
DEPENDENCIES=">=dev-python/numpy-1.19.3[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/pyrecorder[${PYTHON_USEDEP}] )
	dev? ( dev-python/optproblems[${PYTHON_USEDEP}] )
	dev? ( dev-python/pandas[${PYTHON_USEDEP}] )
	dev? ( dev-python/ipython[${PYTHON_USEDEP}] )
	dev? ( dev-python/ipykernel[${PYTHON_USEDEP}] )
	parallelization? ( dev-python/joblib[${PYTHON_USEDEP}] )
	parallelization? ( dev-python/dask[${PYTHON_USEDEP}] )
	parallelization? ( dev-python/ray[${PYTHON_USEDEP}] )
	others? ( dev-python/optuna[${PYTHON_USEDEP}] )
