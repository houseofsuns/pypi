...
IUSE="benchmark bloom cassandra experimental-aio redis test"
DEPENDENCIES=">=dev-python/numpy-1.11[${PYTHON_USEDEP}]
	...
	bloom? ( dev-python/pybloomfilter3[${PYTHON_USEDEP}] )
	cassandra? ( dev-python/cassandra-driver[${PYTHON_USEDEP}] )
	experimental-aio? ( dev-python/aiounittest[${PYTHON_USEDEP}] )
	experimental-aio? ( dev-python/motor[${PYTHON_USEDEP}] )
