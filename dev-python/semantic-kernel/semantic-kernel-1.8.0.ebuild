...
IUSE="all anthropic azure chromadb google hugging-face milvus mistralai mongo notebooks ollama pinecone postgres qdrant redis usearch weaviate"
DEPENDENCIES="<dev-python/aiohttp-4.0[${PYTHON_USEDEP}]
	...
	usearch? ( <dev-python/pyarrow-18.0.0[${PYTHON_USEDEP}] )
