...
IUSE="+bin-wheel all argoverse camera_obs dev diagnostic doc envision extras gym opendrive ray remote_agent rllib ros sumo test test_notebook torch train visdom waymo"
DEPENDENCIES=">=dev-python/setuptools-41.0.0[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/grpcio-tools-1.32.0[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/grpcio-1.32.0[${PYTHON_USEDEP}] )
	...
	camera_obs? ( dev-python/Panda3D[${PYTHON_USEDEP}] )
	camera_obs? ( dev-python/panda3d-gltf[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/black-22.6.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/ipython-8.13.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/grpcio-tools-1.32.0[${PYTHON_USEDEP}] )
	...
	diagnostic? ( dev-python/gym[${PYTHON_USEDEP}] )
	...
	remote_agent? ( ~dev-python/grpcio-1.32.0[${PYTHON_USEDEP}] )
	...
	test_notebook? ( >=dev-python/ipykernel-4.10.1[${PYTHON_USEDEP}] )
	test_notebook? ( >=dev-python/jupyter-client-7.1.2[${PYTHON_USEDEP}] )
	test_notebook? ( dev-python/pytest_notebook[${PYTHON_USEDEP}] )
