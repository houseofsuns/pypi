...
IUSE="abinit ase ci docs electronic-structure mlp numba numpy-v1 optional tblite vis"
DEPENDENCIES=">=dev-python/joblib-1.0[${PYTHON_USEDEP}]
	...
	abinit? ( >=dev-python/netcdf4-1.7.1[${PYTHON_USEDEP}] )
	...
	optional? ( >=dev-python/netcdf4-1.6.5[${PYTHON_USEDEP}] )
	...
	optional? ( dev-python/openbabel-wheel[${PYTHON_USEDEP}] )
