...
DEPENDENCIES="<dev-python/numpy-3.0[${PYTHON_USEDEP}]
	dev-python/nvmath-python[${PYTHON_USEDEP}]
	...
	dev-python/cupauliprop-cu12[${PYTHON_USEDEP}]
	dev-python/custabilizer-cu12[${PYTHON_USEDEP}]
	...
	test? ( dev-python/stim[${PYTHON_USEDEP}] )
	jax? ( dev-python/cuquantum-python-jax[${PYTHON_USEDEP}] )
