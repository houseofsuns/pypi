...
DESCRIPTION="The Python Risk Identification Tool for LLMs (PyRIT) is a library used to assess the robustness of LLMs [wheel]"
...
IUSE="all dev gcg gradio huggingface opencv playwright speech"
DEPENDENCIES="dev-python/aioconsole[${PYTHON_USEDEP}]
	...
	dev? ( >=dev-python/ipykernel-6.29.4[${PYTHON_USEDEP}] )
	...
	speech? ( dev-python/azure-cognitiveservices-speech[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/ipykernel-6.29.4[${PYTHON_USEDEP}] )
