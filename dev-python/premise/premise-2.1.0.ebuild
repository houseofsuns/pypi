...
DESCRIPTION="Coupling IAM output to ecoinvent LCA database ecoinvent for prospective LCA [prod-max (True, <g_sorcery.g_collections.Version object at 0x7fe5679a2570>)]"
