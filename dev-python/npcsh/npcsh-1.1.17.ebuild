...
DEPENDENCIES="dev-python/npcpy[${PYTHON_USEDEP}]
	...
	dev-python/chroptiks[${PYTHON_USEDEP}]
	...
	local? ( dev-python/darts[${PYTHON_USEDEP}] )
	...
	bench? ( dev-python/harbor[${PYTHON_USEDEP}] )
	bench? ( dev-python/terminal-bench[${PYTHON_USEDEP}] )
