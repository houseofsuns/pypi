...
DEPENDENCIES="dev-python/lamindb[${PYTHON_USEDEP}]
	...
	flash? ( dev-python/torch[${PYTHON_USEDEP}] )
	flash? ( dev-python/torchvision[${PYTHON_USEDEP}] )
	flash? ( dev-python/torchaudio[${PYTHON_USEDEP}] )
	flash? ( dev-python/torchtext[${PYTHON_USEDEP}] )
