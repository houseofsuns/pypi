...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="4.0.1a4.post250529093958"
DIGEST_SOURCES="yes"
...
DESCRIPTION="Read and write Minecraft NBT and SNBT data. [badver 4.0.1a4.post250529093958, wheel]"

HOMEPAGE="https://www.amuletmc.com"
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/cp313/${REALNAME::1}/${REALNAME}/${REALNAME//-/_}-${REALVERSION}-cp313-cp313-win_amd64.whl"
SOURCEFILE="${REALNAME//-/_}-${REALVERSION}-cp313-cp313-win_amd64.whl"
RESTRICT="test"
