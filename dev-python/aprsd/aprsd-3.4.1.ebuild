...
DEPENDENCIES="dev-python/aprslib[${PYTHON_USEDEP}]
	...
	~dev-python/oslo-config-9.6.0[${PYTHON_USEDEP}]
	~dev-python/oslo-i18n-6.4.0[${PYTHON_USEDEP}]
	...
	~dev-python/python-engineio-4.9.1[${PYTHON_USEDEP}]
	...
	~dev-python/stevedore-5.3.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/filelock-3.16.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/platformdirs-4.3.3[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/virtualenv-20.26.4[${PYTHON_USEDEP}] )
