...
IUSE="alignment all-extras all-extras-pandas2 annotation binder classification clustering compatibility-tests cython-extras dataframe datasets detection dev dl docs forecasting mlflow mlflow-tests networks numpy1 pandas1 param-est regression tests transformations"
