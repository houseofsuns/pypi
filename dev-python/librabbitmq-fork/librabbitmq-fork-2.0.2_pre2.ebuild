...
DESCRIPTION="AMQP Client using the rabbitmq-c library. [wheel]"

HOMEPAGE="http://github.com/henryykt/librabbitmq"
LICENSE="MPL-2.0"
...
IUSE=""
DEPENDENCIES=">=dev-python/amqp-1.4.6[${PYTHON_USEDEP}]
