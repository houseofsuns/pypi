...
DESCRIPTION="Bonobo, a simple, modern and atomic extract-transform-load toolkit for python 3.5+. [newver 0.7.0rc3]"
...
DEPENDENCIES="~dev-python/cached-property-1.4[${PYTHON_USEDEP}]
	...
	~dev-python/python-slugify-1.2.0[${PYTHON_USEDEP}]
	~dev-python/requests-2.0[${PYTHON_USEDEP}]
	~dev-python/stevedore-1.27[${PYTHON_USEDEP}]
