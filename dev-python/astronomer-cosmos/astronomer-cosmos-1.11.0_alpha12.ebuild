...
IUSE="all amazon aws-ecs aws-eks azure-container-instance dbt-all dbt-athena dbt-bigquery dbt-clickhouse dbt-databricks dbt-duckdb dbt-exasol dbt-mysql dbt-oracle dbt-postgres dbt-redshift dbt-snowflake dbt-spark dbt-sqlserver dbt-teradata dbt-vertica docker docs gcp-cloud-run-job google kubernetes microsoft openlineage"
DEPENDENCIES="dev-python/aenum[${PYTHON_USEDEP}]
	...
	all? ( dev-python/dbt-mysql[${PYTHON_USEDEP}] )
	...
	dbt-all? ( dev-python/dbt-mysql[${PYTHON_USEDEP}] )
	...
	dbt-mysql? ( dev-python/dbt-mysql[${PYTHON_USEDEP}] )
