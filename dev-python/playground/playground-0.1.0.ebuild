...
IUSE="all cuda dev learning notebooks test"
DEPENDENCIES="dev-python/absl-py[${PYTHON_USEDEP}]
	...
	all? ( dev-python/rsl-rl-lib[${PYTHON_USEDEP}] )
	...
	learning? ( dev-python/rsl-rl-lib[${PYTHON_USEDEP}] )
	learning? ( dev-python/wandb[${PYTHON_USEDEP}] )
