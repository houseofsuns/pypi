...
HOMEPAGE=""
LICENSE="BSD"
SRC_URI="https://files.pythonhosted.org/packages/56/20/f8489592a9e2b83a7c93db02ac28f7bfb1c12b785b5ab52258610ec1e953/playwrightcapture-${REALVERSION}.tar.gz"
...
DEPENDENCIES="recaptcha? ( dev-python/SpeechRecognition[${PYTHON_USEDEP}] )
	...
	>=dev-python/setuptools-80.0.1[${PYTHON_USEDEP}]
