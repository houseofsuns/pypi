...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/88/d3/c2a3e1233274c93a4978cbac210a81ba05cee09e2e0051049b40f55406f1/${REALNAME}-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/anyio-5.0[${PYTHON_USEDEP}]
	...
	cli? ( <dev-python/watchfiles-0.25.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/mkdocs-macros-plugin-1.3.6[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/watchfiles-0.25.0[${PYTHON_USEDEP}] )
	...
	devdocs? ( ~dev-python/mkdocs-git-revision-date-localized-plugin-1.2.9[${PYTHON_USEDEP}] )
	devdocs? ( dev-python/mkdocs-glightbox[${PYTHON_USEDEP}] )
	devdocs? ( dev-python/mkdocs-literate-nav[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocs-macros-plugin-1.3.6[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocs-material-9.5.42[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocs-minify-plugin-0.8.0[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocs-static-i18n-1.2.3[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocstrings-0.26.2[${PYTHON_USEDEP}] )
	...
	lint? ( <dev-python/redis-6.0.0[${PYTHON_USEDEP}] )
	lint? ( dev-python/ruff[${PYTHON_USEDEP}] )
	lint? ( dev-python/semgrep[${PYTHON_USEDEP}] )
	lint? ( dev-python/typer[${PYTHON_USEDEP}] )
	...
	lint? ( <dev-python/watchfiles-0.25.0[${PYTHON_USEDEP}] )
	...
	optionals? ( <dev-python/redis-6.0.0[${PYTHON_USEDEP}] )
	optionals? ( dev-python/typer[${PYTHON_USEDEP}] )
	optionals? ( <dev-python/watchfiles-0.25.0[${PYTHON_USEDEP}] )
	...
	test-core? ( ~dev-python/coverage-7.6.4[${PYTHON_USEDEP}] )
	test-core? ( ~dev-python/dirty-equals-0.8.0[${PYTHON_USEDEP}] )
	test-core? ( ~dev-python/pytest-asyncio-0.24.0[${PYTHON_USEDEP}] )
	test-core? ( ~dev-python/pytest-8.3.3[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/coverage-7.6.4[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/dirty-equals-0.8.0[${PYTHON_USEDEP}] )
	...
	testing? ( ~dev-python/pytest-asyncio-0.24.0[${PYTHON_USEDEP}] )
	...
	types? ( ~dev-python/mypy-1.12.1[${PYTHON_USEDEP}] )
	...
	types? ( <dev-python/redis-6.0.0[${PYTHON_USEDEP}] )
	types? ( dev-python/typer[${PYTHON_USEDEP}] )
	...
	types? ( <dev-python/watchfiles-0.25.0[${PYTHON_USEDEP}] )"
