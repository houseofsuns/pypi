...
LICENSE="GPL-3"
SRC_URI="https://files.pythonhosted.org/packages/6c/82/6d015aba07ebf5fdb8eeb7ca2cbf971a8a06b2525fa0a84515362371513a/${REALNAME}-0.12.tar.gz"
SOURCEFILE="${REALNAME}-0.12.tar.gz"
RESTRICT="test"
