...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/d5/72/55beb39638a74e902853a3250450dcd74d0b5c60f00e641f5d0db4b693b0/pytooling-${REALVERSION}.tar.gz"
...
DEPENDENCIES="doc? ( dev-python/sphinx_design[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/setuptools-69.5[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/setuptools-69.5[${PYTHON_USEDEP}] )
	all? ( dev-python/sphinx-reports[${PYTHON_USEDEP}] )
	all? ( ~dev-python/typing-extensions-4.11[${PYTHON_USEDEP}] )
