...
DEPENDENCIES=">=dev-python/cachetools-5.5[${PYTHON_USEDEP}]
	...
	testing? ( >=dev-python/build-1.2.2[${PYTHON_USEDEP}] )
	...
	testing? ( >=dev-python/setuptools-74.1.2[${PYTHON_USEDEP}] )
	testing? ( >=dev-python/time-machine-2.15[${PYTHON_USEDEP}] )
	testing? ( >=dev-python/wheel-0.44[${PYTHON_USEDEP}] )"
