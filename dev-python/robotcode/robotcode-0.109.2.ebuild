...
IUSE="all analyze colored debugger languageserver lint repl replserver rest runner tidy yaml"
DEPENDENCIES="all? ( dev-python/robotcode-repl-server[${PYTHON_USEDEP}] )
	...
	dev-python/robotcode-core[${PYTHON_USEDEP}]
