...
IUSE="covalent dask defects dev docs fairchem jobflow mace matgl mp newtonnet orb parsl phonons prefect redun sella sevenn tblite"
DEPENDENCIES="dev-python/ase[${PYTHON_USEDEP}]
	...
	fairchem? ( dev-python/fairchem-data-omat[${PYTHON_USEDEP}] )
	fairchem? ( dev-python/fairchem-data-oc[${PYTHON_USEDEP}] )
	...
	mace? ( dev-python/mace-models[${PYTHON_USEDEP}] )
	...
	sevenn? ( dev-python/sevenn[${PYTHON_USEDEP}] )
