...
DESCRIPTION="Reusable Python and Django common utilities. [wheel]"
...
IUSE="all"
DEPENDENCIES="all? ( dev-python/tabulate[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/django-debug-toolbar[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/django-celery-results[${PYTHON_USEDEP}] )
