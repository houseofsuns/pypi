...
DESCRIPTION="ITK Mesh IO for the MZ3 format, a simple, small, fast triangle mesh file format. [wheel]"

HOMEPAGE="https://github.com/InsightSoftwareConsortium/ITKIOMeshMZ3"
