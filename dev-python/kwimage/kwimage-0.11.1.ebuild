...
IUSE="all all-strict docs docs-strict gdal gdal-strict graphics graphics-strict headless headless-strict optional optional-strict problematic problematic-strict runtime runtime-strict tests tests-strict"
DEPENDENCIES=">=dev-python/ubelt-1.3.3[${PYTHON_USEDEP}]
	...
	docs? ( dev-python/lazy_loader[${PYTHON_USEDEP}] )
	...
	docs-strict? ( dev-python/lazy_loader[${PYTHON_USEDEP}] )
