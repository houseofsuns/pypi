...
DEPENDENCIES=">=dev-python/aiohttp-3.8.4[${PYTHON_USEDEP}]
	...
	dev-python/airbyte-serverless[${PYTHON_USEDEP}]
	...
	tests? ( dev-python/llama-index-readers-pathway[${PYTHON_USEDEP}] )
	tests? ( dev-python/llama-index-retrievers-pathway[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/unstructured[${PYTHON_USEDEP}] )
