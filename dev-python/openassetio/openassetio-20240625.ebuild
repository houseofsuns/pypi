...
DESCRIPTION="An open-source interoperability standard for tools and content management systems used in media production. [badver 1.0.0b2.post2, wheel]"
