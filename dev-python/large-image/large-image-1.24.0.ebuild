...
IUSE="all bioformats colormaps common converter deepzoom dicom dummy gdal mapnik memcached multi nd2 ometiff openjpeg openslide performance pil rasterio sources test tiff tifffile tiledoutput vips"
