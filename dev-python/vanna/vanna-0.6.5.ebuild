...
IUSE="all anthropic bedrock bigquery chromadb clickhouse duckdb gemini google hf marqo milvus mistralai mysql ollama openai opensearch pinecone postgres qdrant qianfan snowflake test vllm weaviate zhipuai"
