...
DEPENDENCIES=">=dev-python/click-7.0[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/alibabacloud-alidns20150109[${PYTHON_USEDEP}] )
	dev? ( dev-python/alibabacloud-tea-openapi[${PYTHON_USEDEP}] )
	dev? ( dev-python/tencentcloud-sdk-python[${PYTHON_USEDEP}] )
