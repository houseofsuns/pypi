...
IUSE="arangodb aws azurite chroma cosmosdb db2 generic google influxdb k3s keycloak localstack mailpit minio mongodb mssql mysql nats neo4j openfga opensearch oracle oracle-free qdrant rabbitmq redis registry scylla selenium sftp test-module-import trino weaviate"
DEPENDENCIES="cosmosdb? ( dev-python/azure-cosmos[${PYTHON_USEDEP}] )
	...
	k3s? ( >=dev-python/pyyaml-6.0.3[${PYTHON_USEDEP}] )
