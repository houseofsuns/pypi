...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/9f/ff/ec99ee0544bed39246a07cfb6eaa9c54b7c1bd9c4a4321af6677d8b2d466/graphinate-${REALVERSION}.tar.gz"
...
IUSE="dbs dev docs plot server test"
DEPENDENCIES="~dev-python/click-8.1.7[${PYTHON_USEDEP}]
	...
	dbs? ( dev-python/neo4j[${PYTHON_USEDEP}] )
	dbs? ( dev-python/pydgraph[${PYTHON_USEDEP}] )
	...
	plot? ( >=dev-python/scipy-1.12.0[${PYTHON_USEDEP}] )
	server? ( dev-python/starlette-prometheus[${PYTHON_USEDEP}] )
	server? ( >=dev-python/uvicorn-0.27.0[${PYTHON_USEDEP}] )
