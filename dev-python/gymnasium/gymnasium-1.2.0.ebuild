...
DEPENDENCIES=">=dev-python/numpy-1.21.0[${PYTHON_USEDEP}]
	...
	jax? ( dev-python/array-api-compat[${PYTHON_USEDEP}] )
	jax? ( >=dev-python/numpy-2.1[${PYTHON_USEDEP}] )
	torch? ( dev-python/torch[${PYTHON_USEDEP}] )
	torch? ( dev-python/array-api-compat[${PYTHON_USEDEP}] )
	torch? ( >=dev-python/numpy-2.1[${PYTHON_USEDEP}] )
	array-api? ( dev-python/array-api-compat[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/array-api-compat[${PYTHON_USEDEP}] )
