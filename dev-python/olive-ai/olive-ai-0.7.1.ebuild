...
IUSE="auto-opt azureml bnb capture-onnx-graph cpu directml docker finetune flash-attn gpu inc lora nvmo openvino optimum ort ort-genai shared-cache tf torch-tensorrt tune-session-params"
DEPENDENCIES="<dev-python/numpy-2.0[${PYTHON_USEDEP}]
	...
	capture-onnx-graph? ( dev-python/onnxruntime-genai[${PYTHON_USEDEP}] )
	...
	finetune? ( dev-python/onnxruntime-genai[${PYTHON_USEDEP}] )
	...
	ort? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	ort-genai? ( dev-python/onnxruntime-genai[${PYTHON_USEDEP}] )
