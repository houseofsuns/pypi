...
DESCRIPTION="QuerySource is a Library for Querying Databases. QuerySource Query parser and generator.Supports SQL, NoSQL, MongoDB, Cassandra, Elasticsearch, etc. [wheel]"
...
DEPENDENCIES="dev-python/LivePopularTimes[${PYTHON_USEDEP}]
	...
	vectors? ( dev-python/gensim[${PYTHON_USEDEP}] )
