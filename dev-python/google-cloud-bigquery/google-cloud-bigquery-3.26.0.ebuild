...
DEPENDENCIES="<dev-python/google-api-core-3.0.0_pre0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/shapely-3.0.0_pre0[${PYTHON_USEDEP}] )
	all? ( dev-python/bigquery-magics[${PYTHON_USEDEP}] )
	all? ( <dev-python/tqdm-5.0.0_pre0[${PYTHON_USEDEP}] )
	all? ( >=dev-python/opentelemetry-api-1.1.0[${PYTHON_USEDEP}] )
	all? ( >=dev-python/opentelemetry-sdk-1.1.0[${PYTHON_USEDEP}] )
	all? ( dev-python/opentelemetry-instrumentation[${PYTHON_USEDEP}] )
	all? ( <dev-python/proto-plus-2.0.0_pre0[${PYTHON_USEDEP}] )
	all? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	all? ( dev-python/grpcio[${PYTHON_USEDEP}] )
	bigquery-v2? ( <dev-python/proto-plus-2.0.0_pre0[${PYTHON_USEDEP}] )
	bigquery-v2? ( dev-python/protobuf[${PYTHON_USEDEP}] )
