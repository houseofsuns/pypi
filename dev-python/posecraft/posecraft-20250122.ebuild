...
DESCRIPTION="Library for manipulating pose keypoints [badver 1.0.1rc93.post1]"
...
DEPENDENCIES="spark? ( dev-python/pyspark[${PYTHON_USEDEP}] )
	test? ( ~dev-python/bandit-1.8.2[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/matplotlib-3.8.3[${PYTHON_USEDEP}] )
