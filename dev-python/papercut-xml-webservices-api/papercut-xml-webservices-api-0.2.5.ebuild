...
DESCRIPTION="PaperCut NG/MF server's API uses XML-RPC. This library utilizes Python's [stable XMLRPC library [wheel]"

HOMEPAGE="https://github.com/safehome_jdev/PaperCutSoftware"
LICENSE="MIT"
