...
DEPENDENCIES="dev-python/circuit-maintenance-parser[${PYTHON_USEDEP}]
	...
	capacity-metrics? ( dev-python/nautobot-capacity-metrics[${PYTHON_USEDEP}] )
	all? ( dev-python/nautobot-capacity-metrics[${PYTHON_USEDEP}] )
