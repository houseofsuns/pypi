...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/01/67/143c27f98fa33036d66fa8b758fb394a999520941ff7605f3089f8048861/${REALNAME}-${REALVERSION}.tar.gz"
...
IUSE="cli confluent dev devdocs kafka lint nats optionals otel rabbit redis test-core testing types"
DEPENDENCIES="<dev-python/anyio-5.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/mkdocs-macros-plugin-1.2.0[${PYTHON_USEDEP}] )
	...
	devdocs? ( ~dev-python/mkdocs-macros-plugin-1.2.0[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocs-material-9.5.39[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocs-minify-plugin-0.8.0[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocs-static-i18n-1.2.3[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocstrings-0.26.1[${PYTHON_USEDEP}] )
