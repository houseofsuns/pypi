...
IUSE="dev docs examples mapping test"
DEPENDENCIES="dev-python/psutil[${PYTHON_USEDEP}]
	...
	mapping? ( dev-python/kiss-icp[${PYTHON_USEDEP}] )
	mapping? ( dev-python/open3d[${PYTHON_USEDEP}] )
	mapping? ( dev-python/laspy[${PYTHON_USEDEP}] )
