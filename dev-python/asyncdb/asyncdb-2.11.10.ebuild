...
IUSE="all bigquery boto3 cassandra clickhouse couchdb dataframe default elasticsearch hazelcast influxdb jdbc mariadb memcache mongodb msqlserver mysql odbc oracle postgres postgresql redis redpanda rethinkdb scylla sqlalchemy sqlite uvloop"
DEPENDENCIES=">=dev-python/cryptography-43.0.1[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/pyarrow-19.0.1[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/pymongo-4.12.0[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/mysqlclient-2.2.7[${PYTHON_USEDEP}] )
