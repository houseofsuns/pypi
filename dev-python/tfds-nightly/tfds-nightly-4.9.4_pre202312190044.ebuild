...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="4.9.4.dev202312190044"
DIGEST_SOURCES="yes"
...
DESCRIPTION="tensorflow/datasets is a library of datasets ready to use with TensorFlow. [newver 4.9.4.dev202401240044]"
...
IUSE="aflw2k3d beir ble_wind_field c4 c4_wsrs cats_vs_dogs colorectal_histology common_voice dev duke_ultrasound eurosat groove gtzan huggingface imagenet2012_corrupted librispeech locomotion lsun matplotlib nsynth ogbg_molpcba pet_finder robonet robosuite_panda_pick_place_can smartwatch_gestures svhn tensorflow tensorflow-data-validation tests-all tf-nightly the300w_lp wider_face wiki_dialog wikipedia wsc273 youtube_vis"
DEPENDENCIES="dev-python/absl-py[${PYTHON_USEDEP}]
	...
	c4_wsrs? ( dev-python/apache-beam[${PYTHON_USEDEP}] )
