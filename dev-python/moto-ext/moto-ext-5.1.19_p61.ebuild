...
DEPENDENCIES=">=dev-python/boto3-1.9.201[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/aws-sam-translator-1.105.0[${PYTHON_USEDEP}] )
	...
	proxy? ( >=dev-python/aws-sam-translator-1.105.0[${PYTHON_USEDEP}] )
	...
	server? ( >=dev-python/aws-sam-translator-1.105.0[${PYTHON_USEDEP}] )
