...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/cp37/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-cp37-none-any.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-cp37-none-any.whl"
RESTRICT="test"
