...
IUSE="dns-srv gssapi telemetry webauthn"
DEPENDENCIES="dns-srv? ( ~dev-python/dnspython-2.6.1[${PYTHON_USEDEP}] )
	gssapi? ( ~dev-python/gssapi-1.8.3[${PYTHON_USEDEP}] )
	telemetry? ( ~dev-python/opentelemetry-api-1.33.1[${PYTHON_USEDEP}] )
	telemetry? ( ~dev-python/opentelemetry-sdk-1.33.1[${PYTHON_USEDEP}] )
	telemetry? ( dev-python/opentelemetry-exporter-otlp-proto-http[${PYTHON_USEDEP}] )
	webauthn? ( ~dev-python/fido2-1.1.2[${PYTHON_USEDEP}] )"
