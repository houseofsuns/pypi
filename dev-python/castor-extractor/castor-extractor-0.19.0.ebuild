...
IUSE="all bigquery databricks looker metabase mysql postgres powerbi qlik redshift snowflake sqlserver tableau"
DEPENDENCIES="snowflake? ( <dev-python/cryptography-43.0.0[${PYTHON_USEDEP}] )
	...
	<dev-python/setuptools-73.0[${PYTHON_USEDEP}]
