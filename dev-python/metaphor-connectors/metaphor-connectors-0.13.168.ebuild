...
IUSE="all bigquery confluence datafactory datahub hive kafka looker metabase monday monte-carlo mssql mysql notion postgresql power-bi redshift s3 snowflake static-web synapse tableau throughtspot trino unity-catalog"
