...
IUSE="dev lsp mcp recommended sql"
DEPENDENCIES="<dev-python/click-9.0[${PYTHON_USEDEP}]
	...
	dev-python/msgspec-m[${PYTHON_USEDEP}]
	...
	dev? ( >=dev-python/sqlglot-26.2.0[${PYTHON_USEDEP}] )
	...
	recommended? ( >=dev-python/sqlglot-26.2.0[${PYTHON_USEDEP}] )
	recommended? ( dev-python/openai[${PYTHON_USEDEP}] )
	recommended? ( dev-python/google-genai[${PYTHON_USEDEP}] )
