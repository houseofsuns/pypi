...
DEPENDENCIES="<dev-python/click-9.0[${PYTHON_USEDEP}]
	...
	test-components? ( dev-python/tomlkit[${PYTHON_USEDEP}] )
	test-components? ( dev-python/jsonschema[${PYTHON_USEDEP}] )
	test-components? ( dev-python/pandas[${PYTHON_USEDEP}] )
	test-components? ( dev-python/duckdb[${PYTHON_USEDEP}] )
