...
DESCRIPTION="Engine for ML/Data tracking, visualization, dashboards, and model UI for Polyaxon. [newver 1.1.0]"
...
DEPENDENCIES="all? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/aiofiles-23.1.1[${PYTHON_USEDEP}] )
