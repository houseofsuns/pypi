...
IUSE="all docs google graphql oxi service"
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	graphql? ( dev-python/jinja[${PYTHON_USEDEP}] )
	...
	service? ( ~dev-python/python-multipart-0.0.9[${PYTHON_USEDEP}] )
	all? ( ~dev-python/python-multipart-0.0.9[${PYTHON_USEDEP}] )
