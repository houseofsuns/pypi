...
IUSE="chainlit chromadb db doc-chat docx embeddings hf-embeddings lancedb litellm meilisearch metaphor mkdocs momento mysql neo4j pdf-parsers postgres scrapy sql transformers unstructured"
DEPENDENCIES="mkdocs? ( <dev-python/mkdocs-2.0.0[${PYTHON_USEDEP}] )
	...
	meilisearch? ( dev-python/meilisearch[${PYTHON_USEDEP}] )
