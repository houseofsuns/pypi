...
DEPENDENCIES=">=dev-python/cachetools-5.2.0[${PYTHON_USEDEP}]
	...
	nlp? ( dev-python/Jinja2[${PYTHON_USEDEP}] )
	...
	nlp? ( >=dev-python/sumtypes-0.1_alpha6[${PYTHON_USEDEP}] )
	...
	rnn? ( dev-python/Jinja2[${PYTHON_USEDEP}] )
	...
	rnn? ( >=dev-python/sumtypes-0.1_alpha6[${PYTHON_USEDEP}] )
