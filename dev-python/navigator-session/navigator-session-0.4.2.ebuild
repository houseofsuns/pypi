...
DESCRIPTION="Navigator Session allows us to store user-specific data into session object. [prod-max (True, <g_sorcery.g_collections.Version object at 0x7fbc78c5ad50>)]"
