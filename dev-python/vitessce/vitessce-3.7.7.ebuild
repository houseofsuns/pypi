...
DESCRIPTION="Jupyter widget facilitating interactive visualization of spatial single-cell data with Vitessce [top-max 3.7.9]"
...
IUSE="all demos docs notebook"
DEPENDENCIES=">=dev-python/black-21.11_beta1[${PYTHON_USEDEP}]
	...
	all? ( dev-python/negspy[${PYTHON_USEDEP}] )
	all? ( dev-python/ome-zarr[${PYTHON_USEDEP}] )
	all? ( dev-python/oxc-py[${PYTHON_USEDEP}] )
	all? ( dev-python/scanpy[${PYTHON_USEDEP}] )
	all? ( >=dev-python/starlette-0.14.0[${PYTHON_USEDEP}] )
	all? ( >=dev-python/tifffile-2020.10.1[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/nbconvert-6.2[${PYTHON_USEDEP}] )
	...
	notebook? ( dev-python/dask[${PYTHON_USEDEP}] )
	notebook? ( dev-python/marimo[${PYTHON_USEDEP}] )
	notebook? ( dev-python/spatialdata[${PYTHON_USEDEP}] )
	notebook? ( >=dev-python/starlette-0.42.0[${PYTHON_USEDEP}] )
	notebook? ( >=dev-python/tqdm-4.1.0[${PYTHON_USEDEP}] )"
