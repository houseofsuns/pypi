...
DEPENDENCIES="~dev-python/alembic-1.13.2[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/pyupgrade-3.17.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/starlette-0.38.4[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/tokenize-rt-6.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/uv-0.4.4[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/werkzeug-3.0.4[${PYTHON_USEDEP}] )
