...
IUSE="audio benchmarks dev docs jax quality s3 tensorflow tensorflow-gpu tests tests-numpy2 tests_numpy2 torch vision"
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	tests-numpy2? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	...
	tests-numpy2? ( dev-python/soundfile[${PYTHON_USEDEP}] )
	...
	tests_numpy2? ( dev-python/soxr[${PYTHON_USEDEP}] )
	tests_numpy2? ( dev-python/jax[${PYTHON_USEDEP}] )
	tests_numpy2? ( dev-python/jaxlib[${PYTHON_USEDEP}] )
