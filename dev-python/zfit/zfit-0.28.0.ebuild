...
IUSE="all alldev bayes dev doc docs emcee hs3 ipyopt plot test tests uproot"
DEPENDENCIES="dev-python/attrs[${PYTHON_USEDEP}]
	...
	alldev? ( dev-python/arviz[${PYTHON_USEDEP}] )
	...
	alldev? ( >=dev-python/emcee-3.0.0[${PYTHON_USEDEP}] )
	...
	alldev? ( dev-python/scikit-image[${PYTHON_USEDEP}] )
	...
	bayes? ( dev-python/arviz[${PYTHON_USEDEP}] )
	bayes? ( >=dev-python/emcee-3.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/emcee-3.0.0[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/emcee-3.0.0[${PYTHON_USEDEP}] )
	...
	emcee? ( >=dev-python/emcee-3.0.0[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/emcee-3.0.0[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/arviz[${PYTHON_USEDEP}] )
	...
	tests? ( >=dev-python/emcee-3.0.0[${PYTHON_USEDEP}] )
