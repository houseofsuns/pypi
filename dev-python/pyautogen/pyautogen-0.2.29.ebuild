...
IUSE="autobuild blendsearch cosmosdb gemini graph jupyter-executor lmm long-context mathchat redis retrievechat retrievechat-pgvector retrievechat-qdrant teachable test types websockets websurfer"
