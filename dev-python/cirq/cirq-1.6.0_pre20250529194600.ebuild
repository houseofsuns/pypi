...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="1.6.0.dev20250529194600"
DIGEST_SOURCES="yes"
...
IUSE="dev-env"
DEPENDENCIES="dev-env? ( ~dev-python/coverage-7.4[${PYTHON_USEDEP}] )
	...
	dev-env? ( ~dev-python/mypy-1.15.0[${PYTHON_USEDEP}] )
	...
	dev-env? ( ~dev-python/black-25.1.0[${PYTHON_USEDEP}] )
	...
	dev-env? ( ~dev-python/ipython-8.10[${PYTHON_USEDEP}] )
