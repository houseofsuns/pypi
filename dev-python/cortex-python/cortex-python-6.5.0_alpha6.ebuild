...
DEPENDENCIES="<dev-python/requests-3.0[${PYTHON_USEDEP}]
	...
	dev-python/cortex-certifai-common[${PYTHON_USEDEP}]
	dev-python/cortex-certifai-engine[${PYTHON_USEDEP}]
	dev-python/cortex-certifai-model-sdk[${PYTHON_USEDEP}]
	dev-python/cortex-certifai-scanner[${PYTHON_USEDEP}]"
