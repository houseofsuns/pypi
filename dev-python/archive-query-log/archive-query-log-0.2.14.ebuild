...
IUSE="documentation examples tests"
DEPENDENCIES="~dev-python/aiohttp-3.8[${PYTHON_USEDEP}]
	...
	<dev-python/certifi-2026.0[${PYTHON_USEDEP}]
	...
	~dev-python/flasgger-0.9.7[${PYTHON_USEDEP}]
	...
	dev-python/warc-cache[${PYTHON_USEDEP}]
	...
	documentation? ( ~dev-python/mkdocs-1.5[${PYTHON_USEDEP}] )
	documentation? ( ~dev-python/mkdocs-material-9.5[${PYTHON_USEDEP}] )"
