...
IUSE="interactive mongo profiler pub-sub qdrant redis storage topk"
DEPENDENCIES="<dev-python/deprecated-2.0.0[${PYTHON_USEDEP}]
	...
	profiler? ( <dev-python/jupyter-2.0.0[${PYTHON_USEDEP}] )
	...
	profiler? ( dev-python/snakeviz[${PYTHON_USEDEP}] )
	...
	profiler? ( dev-python/yelp-gprof2dot[${PYTHON_USEDEP}] )"
