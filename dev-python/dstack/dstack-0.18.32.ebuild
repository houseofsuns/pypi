...
IUSE="all aws azure datacrunch gateway gcp kubernetes lambda oci server"
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	aws? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	aws? ( dev-python/python-json-logger[${PYTHON_USEDEP}] )
	...
	azure? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	azure? ( dev-python/python-json-logger[${PYTHON_USEDEP}] )
	...
	datacrunch? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	datacrunch? ( dev-python/python-json-logger[${PYTHON_USEDEP}] )
	...
	gcp? ( dev-python/python-json-logger[${PYTHON_USEDEP}] )
	...
	kubernetes? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	kubernetes? ( dev-python/python-json-logger[${PYTHON_USEDEP}] )
	...
	lambda? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	lambda? ( dev-python/python-json-logger[${PYTHON_USEDEP}] )
	...
	oci? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	oci? ( dev-python/python-json-logger[${PYTHON_USEDEP}] )
