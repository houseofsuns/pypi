...
HOMEPAGE="https://github.com/thangqd/vgrid"
LICENSE="MIT"
...
IUSE="dev"
DEPENDENCIES="dev-python/dggal[${PYTHON_USEDEP}]
	dev-python/dggrid4py[${PYTHON_USEDEP}]
	dev-python/ease-dggs[${PYTHON_USEDEP}]
	dev-python/fiona[${PYTHON_USEDEP}]
	dev-python/future[${PYTHON_USEDEP}]
	dev-python/gars-field[${PYTHON_USEDEP}]
	dev-python/gdown[${PYTHON_USEDEP}]
	dev-python/geopandas[${PYTHON_USEDEP}]
	dev-python/h3[${PYTHON_USEDEP}]
	dev-python/healpy[${PYTHON_USEDEP}]
	dev-python/matplotlib[${PYTHON_USEDEP}]
	dev-python/pya5[${PYTHON_USEDEP}]
