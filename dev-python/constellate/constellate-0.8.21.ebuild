...
IUSE="all cliargs concurrencypebble debuggerpycharm debuggevscode logging numba numpy pandas sparql sqlalchemy stackframesampler timeinterval zstd"
DEPENDENCIES=">=dev-python/decorator-5.1.0[${PYTHON_USEDEP}]
	...
	debuggerpycharm? ( dev-python/pydevd-pycharm[${PYTHON_USEDEP}] )
	debuggevscode? ( dev-python/debugpy[${PYTHON_USEDEP}] )
