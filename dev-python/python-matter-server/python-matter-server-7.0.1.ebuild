...
DEPENDENCIES="dev-python/aiohttp[${PYTHON_USEDEP}]
	...
	server? ( ~dev-python/aiohttp-3.11.11[${PYTHON_USEDEP}] )
	...
	server? ( ~dev-python/cryptography-44.0.0[${PYTHON_USEDEP}] )
	server? ( ~dev-python/orjson-3.10.13[${PYTHON_USEDEP}] )
	server? ( ~dev-python/zeroconf-0.136.2[${PYTHON_USEDEP}] )
	server? ( dev-python/home-assistant-chip-core[${PYTHON_USEDEP}] )
	test? ( ~dev-python/aioresponses-0.7.7[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/pylint-3.3.3[${PYTHON_USEDEP}] )
