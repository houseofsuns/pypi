...
DEPENDENCIES="dev-python/ansible-core[${PYTHON_USEDEP}]
	...
	lock? ( ~dev-python/ansible-compat-4.1.10[${PYTHON_USEDEP}] )
	lock? ( dev-python/ansible-core[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/attrs-23.1.0[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/black-23.10.1[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/bracex-2.4[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/certifi-2023.7.22[${PYTHON_USEDEP}] )
	...
	lock? ( ~dev-python/cryptography-41.0.5[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/filelock-3.13.1[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/idna-3.4[${PYTHON_USEDEP}] )
	lock? ( dev-python/jinja2[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/jsonschema-4.19.2[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/jsonschema-specifications-2023.7.1[${PYTHON_USEDEP}] )
	...
	lock? ( ~dev-python/platformdirs-3.11.0[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/pycparser-2.21[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/pygments-2.16.1[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/referencing-0.30.2[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/requests-2.31.0[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	lock? ( ~dev-python/rpds-py-0.12.0[${PYTHON_USEDEP}] )
	...
	lock? ( ~dev-python/urllib3-2.0.7[${PYTHON_USEDEP}] )
