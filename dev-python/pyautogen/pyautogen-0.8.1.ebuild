...
DEPENDENCIES="dev-python/asyncer[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/mkdocs-ezlinks-plugin[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/mkdocs-material-9.6.7[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/mkdocs-minify-plugin-0.8.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/mkdocstrings-0.28.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/uv-0.6.4[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/mkdocstrings-0.28.2[${PYTHON_USEDEP}] )
	...
	gemini? ( <dev-python/jsonref-2.0[${PYTHON_USEDEP}] )
	...
	gemini-realtime? ( <dev-python/jsonref-2.0[${PYTHON_USEDEP}] )
