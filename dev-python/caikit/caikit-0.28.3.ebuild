...
IUSE="all all-dev dev-build dev-docs dev-fmt dev-test interfaces-ts interfaces-ts-pyspark interfaces-vision runtime-client runtime-grpc runtime-http runtime-trace"
DEPENDENCIES="dev-python/alchemy-config[${PYTHON_USEDEP}]
	...
	<dev-python/grpcio-3.0[${PYTHON_USEDEP}]
