...
LICENSE="BSD"
SRC_URI="https://files.pythonhosted.org/packages/03/2f/b3ce8e47e76c7a4abbbc0ae4ae5a2d9e8aa8cedb89d2c6e5298f50868a3e/tsinterpret-${REALVERSION}.tar.gz"
...
DEPENDENCIES="~dev-python/scikit-learn-1.3.0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/ipython_genutils-1.0[${PYTHON_USEDEP}] )
	...
	docs? ( <dev-python/ipython_genutils-1.0[${PYTHON_USEDEP}] )
