...
IUSE=""
DEPENDENCIES="~dev-python/Faker-24.3.0[${PYTHON_USEDEP}]
	~dev-python/asgiref-3.8.0[${PYTHON_USEDEP}]
	~dev-python/boto3-1.34.68[${PYTHON_USEDEP}]
	...
	~dev-python/django-5.0.3[${PYTHON_USEDEP}]
	...
	~dev-python/phonenumbers-8.13.32[${PYTHON_USEDEP}]
