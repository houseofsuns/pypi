...
DEPENDENCIES="dev-python/gunicorn[${PYTHON_USEDEP}]
	...
	checks? ( dev-python/basedpyright[${PYTHON_USEDEP}] )
	...
	starlette? ( <dev-python/starlette-0.51.0[${PYTHON_USEDEP}] )
	...
	uvicorn-fast? ( >=dev-python/httptools-0.6.3[${PYTHON_USEDEP}] )
	uvicorn-fast? ( >dev-python/uvloop-0.15.1[${PYTHON_USEDEP}] )
