...
DEPENDENCIES="dev-python/aiocsv[${PYTHON_USEDEP}]
	...
	forecast? ( ~dev-python/numpy-2.4.0[${PYTHON_USEDEP}] )
	forecast? ( ~dev-python/pandas-2.3.3[${PYTHON_USEDEP}] )
	forecast? ( ~dev-python/scikit-learn-1.8.0[${PYTHON_USEDEP}] )
	forecast? ( ~dev-python/scipy-1.16.3[${PYTHON_USEDEP}] )"
