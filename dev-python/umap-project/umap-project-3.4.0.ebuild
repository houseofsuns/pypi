...
DEPENDENCIES="dev-python/django-agnocomplete[${PYTHON_USEDEP}]
	...
	~dev-python/django-5.2.7[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/hatch-1.14.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/isort-7.0.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/mkdocs-material-9.6.23[${PYTHON_USEDEP}] )
	...
	docker? ( ~dev-python/uvicorn-0.38.0[${PYTHON_USEDEP}] )
	s3? ( dev-python/django-storages[${PYTHON_USEDEP}] )
	sync? ( ~dev-python/pydantic-2.12.3[${PYTHON_USEDEP}] )
	sync? ( ~dev-python/redis-6.4.0[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/moto-5.1.14[${PYTHON_USEDEP}] )
