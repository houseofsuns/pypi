...
DEPENDENCIES="dev-python/tzlocal[${PYTHON_USEDEP}]
	...
	test-pandas? ( >dev-python/numpy-2.1.0[${PYTHON_USEDEP}] )
	...
	test-pandas? ( ~dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	test-pandas? ( ~dev-python/matplotlib-3.10.5[${PYTHON_USEDEP}] )
	test-pandas? ( ~dev-python/tables-3.10.2[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/tox-4.28.4[${PYTHON_USEDEP}] )
