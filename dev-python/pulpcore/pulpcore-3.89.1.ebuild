...
DEPENDENCIES="<dev-python/aiodns-3.6[${PYTHON_USEDEP}]
	...
	<dev-python/opentelemetry-api-1.37[${PYTHON_USEDEP}]
	<dev-python/opentelemetry-sdk-1.37[${PYTHON_USEDEP}]
	...
	<dev-python/redis-6.5[${PYTHON_USEDEP}]
