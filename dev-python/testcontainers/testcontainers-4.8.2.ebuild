...
IUSE="arangodb aws azurite chroma clickhouse cosmosdb db2 generic google influxdb k3s keycloak localstack mailpit minio mongodb mssql mysql nats neo4j opensearch oracle oracle-free qdrant rabbitmq redis registry scylla selenium sftp test-module-import trino weaviate"
