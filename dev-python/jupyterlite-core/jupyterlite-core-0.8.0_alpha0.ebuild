...
DEPENDENCIES="<dev-python/doit-1.0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/jupyterlab-4.7[${PYTHON_USEDEP}] )
	all? ( >=dev-python/libarchive-c-4.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/notebook-7.7[${PYTHON_USEDEP}] )
	...
	lab? ( <dev-python/jupyterlab-4.7[${PYTHON_USEDEP}] )
	lab? ( <dev-python/notebook-7.7[${PYTHON_USEDEP}] )
