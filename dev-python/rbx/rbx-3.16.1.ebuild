...
IUSE="auth buildtools exporter notifications platform queues storage tasks test toolkit web"
DEPENDENCIES="<dev-python/arrow-2.0[${PYTHON_USEDEP}]
	...
	platform? ( <dev-python/redis-5.0[${PYTHON_USEDEP}] )
	platform? ( >=dev-python/hiredis-3.0.0[${PYTHON_USEDEP}] )
	...
	queues? ( <dev-python/redis-5.0[${PYTHON_USEDEP}] )
	queues? ( >=dev-python/hiredis-3.0.0[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/hiredis-3.0.0[${PYTHON_USEDEP}] )
