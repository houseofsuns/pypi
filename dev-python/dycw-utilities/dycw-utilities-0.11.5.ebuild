...
IUSE="airium atomicwrites attrs bidict click cryptography cvxpy dev fastapi fastparquet fpdf2 hatch holoviews hypothesis loguru luigi memory-profiler more-itertools numpy pandas pqdm psutil pyinstrument pypi pytest pytest-check scipy scripts semver sqlalchemy test tqdm typed-settings xarray zarr"
