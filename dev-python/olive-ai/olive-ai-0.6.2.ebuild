...
IUSE="azureml bnb cpu directml docker gpu inc lora nvmo openvino optimum ort ort-training tf torch-tensorrt"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	ort? ( dev-python/onnxruntime[${PYTHON_USEDEP}] )
	ort? ( dev-python/onnxruntime-directml[${PYTHON_USEDEP}] )
	ort? ( dev-python/onnxruntime-gpu[${PYTHON_USEDEP}] )
	ort? ( dev-python/onnxruntime-openvino[${PYTHON_USEDEP}] )
	ort-training? ( dev-python/onnxruntime-training[${PYTHON_USEDEP}] )
	ort-training? ( dev-python/torch-ort[${PYTHON_USEDEP}] )
