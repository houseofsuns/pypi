...
IUSE="docs others plots test test-core test_notebooks"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	test? ( dev-python/torch[${PYTHON_USEDEP}] )
	test_notebooks? ( dev-python/jupyter[${PYTHON_USEDEP}] )
	test_notebooks? ( dev-python/nbconvert[${PYTHON_USEDEP}] )
	test_notebooks? ( dev-python/nbformat[${PYTHON_USEDEP}] )
	test_notebooks? ( dev-python/nlp[${PYTHON_USEDEP}] )
	test_notebooks? ( dev-python/transformers[${PYTHON_USEDEP}] )
	test_notebooks? ( dev-python/datasets[${PYTHON_USEDEP}] )
	test_notebooks? ( dev-python/keras[${PYTHON_USEDEP}] )"
