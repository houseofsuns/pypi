...
DESCRIPTION="Provisioner/Manager for Libvirt/Vsphere/Aws/Gcp/Kubevirt/Ovirt/Openstack/IBM Cloud and containers [wheel]"
...
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/docker-2.0[${PYTHON_USEDEP}] )
	...
	kubevirt? ( dev-python/kubernetes[${PYTHON_USEDEP}] )
