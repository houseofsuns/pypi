...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/e2/d2/1055cd2db6cec6278046f71ed486d852ce7578fbff5579d3dd0c147cf7e0/red_discordbot-${REALVERSION}.tar.gz"
...
DEPENDENCIES="~dev-python/aiohttp-3.9.5[${PYTHON_USEDEP}]
	...
	~dev-python/rapidfuzz-3.9.6[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/importlib-metadata-8.4.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/zipp-3.20.1[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/importlib-metadata-8.4.0[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/zipp-3.20.1[${PYTHON_USEDEP}] )
