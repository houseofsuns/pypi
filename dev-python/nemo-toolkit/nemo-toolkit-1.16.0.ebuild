...
IUSE="all asr common core nemo_text_processing nlp slu test tts"
DEPENDENCIES="dev-python/huggingface-hub[${PYTHON_USEDEP}]
	...
	nemo_text_processing? ( dev-python/inflect[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/regex[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/hydra-core[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/omegaconf[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/pytorch-lightning[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/torchmetrics[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/transformers[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/wandb[${PYTHON_USEDEP}] )
	nemo_text_processing? ( dev-python/webdataset[${PYTHON_USEDEP}] )
	...
	tts? ( dev-python/regex[${PYTHON_USEDEP}] )
