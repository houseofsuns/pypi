...
IUSE="arangodb azurite chroma clickhouse cosmosdb generic google influxdb k3s keycloak localstack mailpit minio mongodb mssql mysql nats neo4j opensearch oracle oracle-free qdrant rabbitmq redis registry selenium sftp test-module-import trino weaviate"
