...
DESCRIPTION="ae namespace module portion oaio_client: Our Asynchronously Interchangeable Objects Client"

HOMEPAGE="https://gitlab.com/ae-group/ae_oaio_client"
...
DEPENDENCIES="dev-python/ae-base[${PYTHON_USEDEP}]
	dev-python/ae-cloud-storage[${PYTHON_USEDEP}]
	dev-python/ae-oaio-model[${PYTHON_USEDEP}]
