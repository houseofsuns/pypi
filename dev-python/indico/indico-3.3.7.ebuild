...
DEPENDENCIES="~dev-python/alembic-1.14.0[${PYTHON_USEDEP}]
	...
	~dev-python/fonttools-4.55.2[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/greenlet-3.1.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pytest-localserver-0.9.0_p0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/redis-5.2.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/sqlalchemy-1.4.54[${PYTHON_USEDEP}] )
	dev? ( dev-python/sqlbag[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/sqlparse-0.5.3[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/starlette-0.41.3[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/tomlkit-0.13.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/trove-classifiers-2024.10.21.16[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/uv-0.7.13[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/uvicorn-0.32.1[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/watchfiles-1.0.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/websockets-14.1[${PYTHON_USEDEP}] )
