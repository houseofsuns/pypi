...
DEPENDENCIES="dev-python/ase[${PYTHON_USEDEP}]
	...
	experimental? ( <=dev-python/lxml-6.0.2[${PYTHON_USEDEP}] )
	experimental? ( dev-python/mendeleev[${PYTHON_USEDEP}] )
	experimental? ( <=dev-python/pandas-2.3.2[${PYTHON_USEDEP}] )
	experimental? ( <=dev-python/requests-2.32.5[${PYTHON_USEDEP}] )
	gpaw? ( dev-python/gpaw[${PYTHON_USEDEP}] )
	lammps? ( <=dev-python/jinja2-3.1.6[${PYTHON_USEDEP}] )
	lammps? ( <=dev-python/pandas-2.3.2[${PYTHON_USEDEP}] )
	...
	lammps-phonons? ( <=dev-python/pandas-2.3.2[${PYTHON_USEDEP}] )
