...
IUSE="all dev docs performance performance-mac performance-nvidia tests"
DEPENDENCIES="dev-python/sunpy[${PYTHON_USEDEP}]
	all? ( dev-python/aiapy[${PYTHON_USEDEP}] )
	performance? ( dev-python/jax[${PYTHON_USEDEP}] )
	performance-nvidia? ( dev-python/jax[${PYTHON_USEDEP}] )
	performance-mac? ( dev-python/jax-metal[${PYTHON_USEDEP}] )
