...
IUSE="all dev freqai freqai_rl hdf5 hyperopt jupyter plot"
DEPENDENCIES="dev-python/ccxt[${PYTHON_USEDEP}]
	...
	freqai_rl? ( dev-python/torch[${PYTHON_USEDEP}] )
	freqai_rl? ( dev-python/stable-baselines3[${PYTHON_USEDEP}] )
	freqai_rl? ( dev-python/gym[${PYTHON_USEDEP}] )
	freqai_rl? ( dev-python/sb3-contrib[${PYTHON_USEDEP}] )
	...
	hyperopt? ( dev-python/scikit-optimize[${PYTHON_USEDEP}] )
	hyperopt? ( dev-python/filelock[${PYTHON_USEDEP}] )
	hyperopt? ( dev-python/progressbar2[${PYTHON_USEDEP}] )
