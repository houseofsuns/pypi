...
DESCRIPTION="Source code for APIs for STEAM tools. [top-max 2025.11.1]"
...
DEPENDENCIES="dev-python/gmsh[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/mkdocs-1.6.1[${PYTHON_USEDEP}] )
	all? ( ~dev-python/mkdocs-autorefs-1.4.1[${PYTHON_USEDEP}] )
	all? ( ~dev-python/mkdocs-git-revision-date-localized-plugin-1.4.5[${PYTHON_USEDEP}] )
	all? ( dev-python/mkdocs-include-markdown-plugin[${PYTHON_USEDEP}] )
	all? ( ~dev-python/mkdocs-material-9.6.14[${PYTHON_USEDEP}] )
	all? ( ~dev-python/mkdocs-material-extensions-1.3.1[${PYTHON_USEDEP}] )
	all? ( ~dev-python/mkdocstrings-0.29.0[${PYTHON_USEDEP}] )
	all? ( ~dev-python/mkdocstrings-python-1.16.10[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/griffe-1.7.3[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/mkdocs-git-revision-date-localized-plugin-1.4.5[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/griffe-1.7.3[${PYTHON_USEDEP}] )
