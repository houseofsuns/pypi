...
DEPENDENCIES="~dev-python/amqp-5.3.1[${PYTHON_USEDEP}]
	...
	~dev-python/kombu-5.6.2[${PYTHON_USEDEP}]
	...
	~dev-python/pycurl-7.45.7[${PYTHON_USEDEP}]
	...
	~dev-python/tzdata-2025.3[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/asttokens-3.0.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/ipython-9.8.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/matplotlib-inline-0.2.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/sqlparse-0.5.5[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/stack-data-0.6.3[${PYTHON_USEDEP}] )
	dev? ( dev-python/tablib[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/termcolor-3.3.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/tzdata-2025.3[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/urllib3-2.6.2[${PYTHON_USEDEP}] )
