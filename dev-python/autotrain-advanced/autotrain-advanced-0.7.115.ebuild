...
DEPENDENCIES="dev-python/albumentations[${PYTHON_USEDEP}]
	...
	docs? ( ~dev-python/scikit-learn-1.5.0[${PYTHON_USEDEP}] )
	docs? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/tqdm-4.66.4[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/scikit-learn-1.5.0[${PYTHON_USEDEP}] )
	quality? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/tqdm-4.66.4[${PYTHON_USEDEP}] )
