...
DESCRIPTION="async-service: Lifecycle management for async applications [newver 0.1.0a11]"
...
DEPENDENCIES="dev-python/async_generator[${PYTHON_USEDEP}]
	<dev-python/trio-14.0[${PYTHON_USEDEP}]
	...
	test-trio? ( ~dev-python/pytest-trio-0.5.2[${PYTHON_USEDEP}] )"
