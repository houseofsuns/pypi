...
IUSE="docs graphviz mouselight test"
DEPENDENCIES="dev-python/data-validation-framework[${PYTHON_USEDEP}]
	...
	dev-python/bluepyparallel[${PYTHON_USEDEP}]
	>=dev-python/lxml-4.8[${PYTHON_USEDEP}]
	dev-python/neuroc[${PYTHON_USEDEP}]
	...
	mouselight? ( dev-python/brainglobe-atlasapi[${PYTHON_USEDEP}] )
