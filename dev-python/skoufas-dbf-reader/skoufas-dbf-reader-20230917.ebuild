...
DESCRIPTION="Library for reading legacy DBF file with library data [badver 0.0.4rc180.post1]"
...
DEPENDENCIES="~dev-python/dbfread-2.0.7[${PYTHON_USEDEP}]
	...
	test? ( ~dev-python/pylint-2.17.2[${PYTHON_USEDEP}] )
