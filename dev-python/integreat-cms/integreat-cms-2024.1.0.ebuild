...
DEPENDENCIES="dev-python/aiohttp[${PYTHON_USEDEP}]
	...
	pinned? ( ~dev-python/aiohttp-3.9.1[${PYTHON_USEDEP}] )
	...
	pinned? ( ~dev-python/cbor2-5.6.0[${PYTHON_USEDEP}] )
	pinned? ( ~dev-python/certifi-2023.11.17[${PYTHON_USEDEP}] )
	...
	pinned? ( ~dev-python/cryptography-41.0.7[${PYTHON_USEDEP}] )
	...
	pinned? ( ~dev-python/ipython-8.20.0[${PYTHON_USEDEP}] )
	...
	dev-pinned? ( ~dev-python/astroid-3.0.2[${PYTHON_USEDEP}] )
	dev-pinned? ( ~dev-python/Babel-2.14.0[${PYTHON_USEDEP}] )
	dev-pinned? ( ~dev-python/black-23.12.1[${PYTHON_USEDEP}] )
	...
	dev-pinned? ( ~dev-python/coverage-7.4.0[${PYTHON_USEDEP}] )
	...
	dev-pinned? ( ~dev-python/platformdirs-4.1.0[${PYTHON_USEDEP}] )
