...
DEPENDENCIES="~dev-python/alabaster-0.7.16[${PYTHON_USEDEP}]
	...
	~dev-python/boto3-1.39.10[${PYTHON_USEDEP}]
	~dev-python/botocore-1.39.10[${PYTHON_USEDEP}]
	...
	~dev-python/coverage-7.9.2[${PYTHON_USEDEP}]
	...
	~dev-python/faker-37.4.2[${PYTHON_USEDEP}]
	...
	~dev-python/rpds-py-0.26.0[${PYTHON_USEDEP}]
