...
DEPENDENCIES="dev-python/chevron[${PYTHON_USEDEP}]
	...
	~dev-python/aws-sam-translator-1.90.0[${PYTHON_USEDEP}]
	...
	~dev-python/cfn-lint-1.10.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-psutil-6.0.0.20240621[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/types-setuptools-71.1.0.20240813[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/types-docutils-0.21.0.20240724[${PYTHON_USEDEP}] )
