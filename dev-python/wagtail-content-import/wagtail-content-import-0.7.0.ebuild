...
DESCRIPTION="A module for Wagtail that provides functionality for importing page content from third-party sources. [prod-max (True, <g_sorcery.g_collections.Version object at 0x7fe54a1e8dd0>)]"
