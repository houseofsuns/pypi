...
DESCRIPTION="Generate a digest of comments that occurred since the last checked in date. Useful for including in an email."
...
DEPENDENCIES=">=dev-python/apscheduler-3.11.0[${PYTHON_USEDEP}]
	...
	dev-python/structlog-config[${PYTHON_USEDEP}]
	dev-python/todoist-api-python[${PYTHON_USEDEP}]
	>=dev-python/whatever-0.7[${PYTHON_USEDEP}]
	>=dev-python/whenever-0.9.2[${PYTHON_USEDEP}]"
