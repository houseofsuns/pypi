...
IUSE="dev sql testcore testoptional"
DEPENDENCIES="<dev-python/click-9.0[${PYTHON_USEDEP}]
	...
	dev? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/hypothesis-6.102.1[${PYTHON_USEDEP}] )
	...
	testcore? ( <dev-python/click-8.1.4[${PYTHON_USEDEP}] )
	testcore? ( ~dev-python/hypothesis-6.102.1[${PYTHON_USEDEP}] )
	testcore? ( ~dev-python/httpx-0.27.0[${PYTHON_USEDEP}] )
	testcore? ( ~dev-python/pytest-8.3.2[${PYTHON_USEDEP}] )
	testcore? ( dev-python/pytest-codecov[${PYTHON_USEDEP}] )
	testcore? ( ~dev-python/pytest-asyncio-0.23.8[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/altair[${PYTHON_USEDEP}] )
	testoptional? ( >=dev-python/pandas-1.5.3[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/pandas-stubs[${PYTHON_USEDEP}] )
	testoptional? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/pyarrow-stubs[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/pyarrow-hotfix[${PYTHON_USEDEP}] )
	testoptional? ( ~dev-python/pillow-10.4.0[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/types-Pillow[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/polars[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/anywidget[${PYTHON_USEDEP}] )
	testoptional? ( ~dev-python/ipython-8.12.3[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/openai[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/anthropic[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/google-generativeai[${PYTHON_USEDEP}] )
	testoptional? ( >=dev-python/nbformat-5.10.4[${PYTHON_USEDEP}] )
	testoptional? ( >=dev-python/sympy-1.13.2[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/geopandas[${PYTHON_USEDEP}] )
	testoptional? ( ~dev-python/matplotlib-3.9.2[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/ibis-framework[${PYTHON_USEDEP}] )"
