...
IUSE="autologging cloud-profiler datasets endpoint evaluation full langchain langchain-testing lit metadata pipelines prediction preview private-endpoints ray ray-testing ray_testing reasoningengine tensorboard testing tokenization vizier xai"
DEPENDENCIES="<dev-python/google-api-core-3.0.0_pre0[${PYTHON_USEDEP}]
	...
	evaluation? ( dev-python/immutabledict[${PYTHON_USEDEP}] )
