...
DESCRIPTION="Data and Algorithm Work-flow Generation, Introspection, and Execution (DAWGIE) [prod-max (True, <g_sorcery.g_collections.Version object at 0x7fb7dddc9ee0>)]"
