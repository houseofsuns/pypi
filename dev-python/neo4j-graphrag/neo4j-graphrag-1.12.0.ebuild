...
IUSE="anthropic cohere examples experimental fuzzy-matching google kg-creation-tools mistralai nlp ollama openai pinecone qdrant sentence-transformers weaviate"
DEPENDENCIES="<dev-python/fsspec-2025.0.0[${PYTHON_USEDEP}]
	...
	examples? ( dev-python/langchain-huggingface[${PYTHON_USEDEP}] )
