...
IUSE="checkpoint-engine dev diffusion test tracing"
DEPENDENCIES="dev-python/ipython[${PYTHON_USEDEP}]
	...
	diffusion? ( dev-python/opencv-python-headless[${PYTHON_USEDEP}] )
	...
	diffusion? ( dev-python/runai-model-streamer[${PYTHON_USEDEP}] )
	diffusion? ( dev-python/cache-dit[${PYTHON_USEDEP}] )
