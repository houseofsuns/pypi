...
DEPENDENCIES="dev-python/six[${PYTHON_USEDEP}]
	...
	all-strict? ( ~dev-python/protobuf-3.6.0[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/psutil-5.4.7[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/pygments-2.2.0[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/tensorboard_logger[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/scikit-learn-1.0.2[${PYTHON_USEDEP}] )
	...
	optional? ( dev-python/tensorboard_logger[${PYTHON_USEDEP}] )
	...
	optional-strict? ( ~dev-python/protobuf-3.6.0[${PYTHON_USEDEP}] )
	optional-strict? ( ~dev-python/psutil-5.4.7[${PYTHON_USEDEP}] )
	optional-strict? ( ~dev-python/pygments-2.2.0[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/tensorboard_logger[${PYTHON_USEDEP}] )
	...
	optional-strict? ( ~dev-python/scikit-learn-1.0.2[${PYTHON_USEDEP}] )
