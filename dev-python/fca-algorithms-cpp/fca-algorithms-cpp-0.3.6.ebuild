...
DESCRIPTION="Cpp implementation of the lib fca_algorithms [wheel]"

HOMEPAGE="https://gitlab.com/Lwr/fca_algorithms_cpp"
LICENSE="MIT"
...
IUSE=""
DEPENDENCIES=">=dev-python/pybind11-2.10.4[${PYTHON_USEDEP}]
