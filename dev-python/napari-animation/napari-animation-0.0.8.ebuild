...
DEPENDENCIES="dev-python/imageio[${PYTHON_USEDEP}]
	...
	doc? ( dev-python/sphinx_external_toc[${PYTHON_USEDEP}] )
	...
	doc? ( dev-python/napari-sphinx-theme[${PYTHON_USEDEP}] )
	testing? ( dev-python/pytest[${PYTHON_USEDEP}] )
	testing? ( dev-python/pytest-cov[${PYTHON_USEDEP}] )
	testing? ( dev-python/pytest-qt[${PYTHON_USEDEP}] )
	testing? ( dev-python/lxml-html-clean[${PYTHON_USEDEP}] )"
