...
IUSE="aws azure cassandra ci couchbase delta dev docling docs duckdb elasticsearch faiss gcp ge go grpcio hazelcast hbase ibis ikv k8s milvus mssql mysql nlp opentelemetry postgres pytorch qdrant redis singlestore snowflake spark sqlite-vec trino"
