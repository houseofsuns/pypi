...
DEPENDENCIES="dev-python/flit[${PYTHON_USEDEP}]
	...
	base? ( dev-python/black[${PYTHON_USEDEP}] )
	base? ( dev-python/isort[${PYTHON_USEDEP}] )
	base? ( dev-python/jinja2[${PYTHON_USEDEP}] )
	base? ( dev-python/web3[${PYTHON_USEDEP}] )
	base? ( dev-python/autoflake[${PYTHON_USEDEP}] )
