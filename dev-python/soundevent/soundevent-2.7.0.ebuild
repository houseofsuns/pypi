...
DEPENDENCIES=">=dev-python/email-validator-2.0[${PYTHON_USEDEP}]
	...
	all? ( dev-python/crowsetta[${PYTHON_USEDEP}] )
	all? ( >=dev-python/cython-0.29.36[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/xarray-0.20.2[${PYTHON_USEDEP}] )
	all? ( >=dev-python/xarray-2023.1.0[${PYTHON_USEDEP}] )
	...
	crowsetta? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	crowsetta? ( dev-python/pandera[${PYTHON_USEDEP}] )
	evaluation? ( >=dev-python/scikit-learn-1.3.2[${PYTHON_USEDEP}] )
	geometry? ( dev-python/rasterio[${PYTHON_USEDEP}] )
	geometry? ( >=dev-python/shapely-2.0.6[${PYTHON_USEDEP}] )
