...
IUSE="adaptive all autodoc cli dev docs extras mcp pandas plotting polars profiling pydantic rich test widgets xarray zarr"
DEPENDENCIES="dev-python/cloudpickle[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/sphinx-llms-txt[${PYTHON_USEDEP}] )
	...
	extras? ( dev-python/polars[${PYTHON_USEDEP}] )
	...
	pandas? ( dev-python/xarray[${PYTHON_USEDEP}] )
