...
DEPENDENCIES="all? ( >=dev-python/jupyter-client-7.0.0[${PYTHON_USEDEP}] )
	...
	all-strict? ( dev-python/ipython_genutils[${PYTHON_USEDEP}] )
	...
	jupyter-strict? ( dev-python/ipython_genutils[${PYTHON_USEDEP}] )
	...
	optional-strict? ( dev-python/ipython_genutils[${PYTHON_USEDEP}] )
	...
	optional? ( dev-python/ipython_genutils[${PYTHON_USEDEP}] )
