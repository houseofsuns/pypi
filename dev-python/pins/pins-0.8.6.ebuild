...
DEPENDENCIES=">=dev-python/fsspec-2022.2.0[${PYTHON_USEDEP}]
	>=dev-python/pyyaml-3.13[${PYTHON_USEDEP}]
	>=dev-python/xxhash-1.0.0[${PYTHON_USEDEP}]
	>=dev-python/pandas-0.23.0[${PYTHON_USEDEP}]
	dev-python/jinja[${PYTHON_USEDEP}]
	>=dev-python/joblib-0.12.0[${PYTHON_USEDEP}]
	...
	doc? ( <=dev-python/ipython-8.12.0[${PYTHON_USEDEP}] )
