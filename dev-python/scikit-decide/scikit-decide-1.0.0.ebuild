...
DEPENDENCIES="domains? ( dev-python/Cartopy[${PYTHON_USEDEP}] )
	...
	solvers? ( dev-python/discrete-optimization[${PYTHON_USEDEP}] )
	all? ( dev-python/discrete-optimization[${PYTHON_USEDEP}] )
	...
	domains? ( >=dev-python/numpy-1.20.1[${PYTHON_USEDEP}] )
	solvers? ( >=dev-python/numpy-1.20.1[${PYTHON_USEDEP}] )
	all? ( >=dev-python/numpy-1.20.1[${PYTHON_USEDEP}] )
