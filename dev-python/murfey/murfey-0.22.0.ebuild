...
DEPENDENCIES="dev-python/defusedxml[${PYTHON_USEDEP}]
	...
	developer? ( dev-python/pytest-mock[${PYTHON_USEDEP}] )
	instrument-server? ( dev-python/aiohttp[${PYTHON_USEDEP}] )
	...
	server? ( dev-python/graypy[${PYTHON_USEDEP}] )
	...
	server? ( >dev-python/stomp-py-8.1.1[${PYTHON_USEDEP}] )
