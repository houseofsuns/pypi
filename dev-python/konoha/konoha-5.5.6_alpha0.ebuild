...
IUSE="all janome kytea mecab nagisa remote sentencepiece server sudachi"
DEPENDENCIES="<dev-python/requests-3.0.0[${PYTHON_USEDEP}]
	all? ( ~dev-python/boto3-1.34.0[${PYTHON_USEDEP}] )
	...
	remote? ( ~dev-python/boto3-1.34.0[${PYTHON_USEDEP}] )
