...
DEPENDENCIES="all? ( >=dev-python/jupyter-client-7.0.0[${PYTHON_USEDEP}] )
	...
	jupyter-strict? ( ~dev-python/jinja-3.0.0[${PYTHON_USEDEP}] )
	jupyter-strict? ( ~dev-python/ipython_genutils-0.2.0[${PYTHON_USEDEP}] )
	...
	jupyter? ( >=dev-python/jinja-3.0.0[${PYTHON_USEDEP}] )
	jupyter? ( >=dev-python/ipython_genutils-0.2.0[${PYTHON_USEDEP}] )
	...
	tests-binary-strict? ( dev-python/cmake[${PYTHON_USEDEP}] )
	tests-binary? ( >=dev-python/scikit-build-0.11.1[${PYTHON_USEDEP}] )
	tests-binary? ( dev-python/ninja[${PYTHON_USEDEP}] )
	tests-binary? ( >=dev-python/pybind11-2.7.1[${PYTHON_USEDEP}] )
