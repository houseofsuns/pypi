...
DEPENDENCIES="dev-python/expandvars[${PYTHON_USEDEP}]
	...
	snowflake_tag_propagation? ( dev-python/python-dateutil[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/expandvars[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/tabulate[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/PyYAML[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/click-default-group[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/stackprinter[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/toml[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/acryl-datahub[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/prometheus-client[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/progressbar2[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/click[${PYTHON_USEDEP}] )
	snowflake_tag_propagation? ( dev-python/docker[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/entrypoints[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/python-dateutil[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/expandvars[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/tabulate[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/PyYAML[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/click-default-group[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/stackprinter[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/toml[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/prometheus-client[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/progressbar2[${PYTHON_USEDEP}] )
	tag_propagation? ( dev-python/click[${PYTHON_USEDEP}] )
	...
	term_propagation? ( dev-python/python-dateutil[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/expandvars[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/tabulate[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/PyYAML[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/click-default-group[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/stackprinter[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/toml[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/prometheus-client[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/progressbar2[${PYTHON_USEDEP}] )
	term_propagation? ( dev-python/click[${PYTHON_USEDEP}] )
