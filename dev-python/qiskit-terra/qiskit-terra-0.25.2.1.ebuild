...
IUSE="all bip-mapper crosstalk-pass csp-layout-pass qasm3-import toqm visualization"
DEPENDENCIES="dev-python/rustworkx[${PYTHON_USEDEP}]
	...
	bip-mapper? ( dev-python/cplex[${PYTHON_USEDEP}] )
	bip-mapper? ( dev-python/docplex[${PYTHON_USEDEP}] )
	...
	toqm? ( dev-python/qiskit-toqm[${PYTHON_USEDEP}] )
