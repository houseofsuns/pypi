...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/bb/db/71ed50f8f286033594904a32cd22e67e321e27f78046b9c7a3602cde6563/pytooling-${REALVERSION}.tar.gz"
...
DEPENDENCIES="doc? ( ~dev-python/ruamel-yaml-0.18.6[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/setuptools-70.2[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/mypy-1.10[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/lxml-5.1[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/setuptools-70.2[${PYTHON_USEDEP}] )
	all? ( ~dev-python/coverage-7.5[${PYTHON_USEDEP}] )
