...
IUSE="all apigateway apigatewayv2 appsync awslambda batch cloudformation cognitoidp ds dynamodb dynamodbstreams ebs ec2 efs eks glue iotdata route53resolver s3 s3crc32c server ssm xray"
