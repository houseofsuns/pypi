...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/95/9a/a3a3211c9eeeb8a6a50119317b35a2832c72bca7deab93d9dbeaa5b7b097/${REALNAME}-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/anyio-5.0[${PYTHON_USEDEP}]
	...
	cli? ( <dev-python/watchfiles-1.1.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/mkdocs-git-revision-date-localized-plugin-1.4.5[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/mkdocs-material-9.6.13[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/watchfiles-1.1.0[${PYTHON_USEDEP}] )
	...
	devdocs? ( ~dev-python/mkdocs-git-revision-date-localized-plugin-1.4.5[${PYTHON_USEDEP}] )
	...
	devdocs? ( ~dev-python/mkdocs-material-9.6.13[${PYTHON_USEDEP}] )
	...
	lint? ( <dev-python/watchfiles-1.1.0[${PYTHON_USEDEP}] )
	...
	optionals? ( <dev-python/watchfiles-1.1.0[${PYTHON_USEDEP}] )
	...
	test-core? ( ~dev-python/coverage-7.8.0[${PYTHON_USEDEP}] )
	test-core? ( ~dev-python/dirty-equals-0.9.0[${PYTHON_USEDEP}] )
	test-core? ( ~dev-python/pytest-asyncio-0.26.0[${PYTHON_USEDEP}] )
	...
	types? ( <dev-python/watchfiles-1.1.0[${PYTHON_USEDEP}] )"
