...
DEPENDENCIES=">=dev-python/ubelt-1.2.3[${PYTHON_USEDEP}]
	...
	optional-strict? ( dev-python/torch[${PYTHON_USEDEP}] )
	optional-strict? ( ~dev-python/scipy-1.11.2[${PYTHON_USEDEP}] )
	optional-strict? ( ~dev-python/pandas-2.2.3[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/torch[${PYTHON_USEDEP}] )
	optional-strict? ( ~dev-python/scipy-1.14.1[${PYTHON_USEDEP}] )
	...
	optional? ( dev-python/torch[${PYTHON_USEDEP}] )
	optional? ( >=dev-python/scipy-1.11.2[${PYTHON_USEDEP}] )
	optional? ( >=dev-python/pandas-2.2.3[${PYTHON_USEDEP}] )
	optional? ( dev-python/torch[${PYTHON_USEDEP}] )
	optional? ( >=dev-python/scipy-1.14.1[${PYTHON_USEDEP}] )
