...
IUSE="test with-aiohttp with-crypto with-takproto"
DEPENDENCIES="with-crypto? ( >=dev-python/cryptography-39.0.0[${PYTHON_USEDEP}] )
	with-takproto? ( dev-python/takproto[${PYTHON_USEDEP}] )
	with-aiohttp? ( >=dev-python/aiohttp-3.8.0[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/takproto[${PYTHON_USEDEP}] )"
