...
IUSE="atomic-tools bpython docs notebook pre-commit rest ssh-kerberos tests tui"
DEPENDENCIES="~dev-python/alembic-1.2[${PYTHON_USEDEP}]
	dev-python/archive-path[${PYTHON_USEDEP}]
	~dev-python/asyncssh-2.19.0[${PYTHON_USEDEP}]
	...
	atomic-tools? ( dev-python/PyCifRW[${PYTHON_USEDEP}] )
	atomic-tools? ( dev-python/ase[${PYTHON_USEDEP}] )
	atomic-tools? ( ~dev-python/matplotlib-3.3[${PYTHON_USEDEP}] )
	atomic-tools? ( dev-python/pymatgen[${PYTHON_USEDEP}] )
	atomic-tools? ( ~dev-python/pymysql-0.9.3[${PYTHON_USEDEP}] )
	atomic-tools? ( dev-python/seekpath[${PYTHON_USEDEP}] )
	atomic-tools? ( dev-python/spglib[${PYTHON_USEDEP}] )
	...
	pre-commit? ( dev-python/aiida-core[${PYTHON_USEDEP}] )
	...
	rest? ( ~dev-python/pyparsing-3.0[${PYTHON_USEDEP}] )
	rest? ( ~dev-python/python-memcached-1.59[${PYTHON_USEDEP}] )
	rest? ( dev-python/seekpath[${PYTHON_USEDEP}] )
	ssh-kerberos? ( ~dev-python/gssapi-1.6[${PYTHON_USEDEP}] )
	ssh-kerberos? ( ~dev-python/pyasn1-0.4.8[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/sphinx-7.2.0[${PYTHON_USEDEP}] )
