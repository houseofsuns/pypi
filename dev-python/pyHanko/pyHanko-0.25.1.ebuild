...
LICENSE="MIT"
SRC_URI="https://files.pythonhosted.org/packages/99/59/d165478e7cef237cb7d22ac80e062829fcb13736c3edc71e5f7a1e814163/pyhanko-${REALVERSION}.tar.gz"
...
DEPENDENCIES=">=dev-python/asn1crypto-1.5.1[${PYTHON_USEDEP}]
	...
	live-test? ( <dev-python/pytest-cov-5.1[${PYTHON_USEDEP}] )
	...
	testing-basic? ( ~dev-python/pytest-asyncio-0.23.8[${PYTHON_USEDEP}] )
	testing-basic? ( dev-python/certomancer[${PYTHON_USEDEP}] )
	testing-basic? ( <dev-python/pytest-cov-5.1[${PYTHON_USEDEP}] )
