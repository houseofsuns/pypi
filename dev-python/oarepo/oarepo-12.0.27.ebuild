...
DEPENDENCIES="~dev-python/alabaster-0.7.16[${PYTHON_USEDEP}]
	...
	~dev-python/botocore-1.34.149[${PYTHON_USEDEP}]
	...
	~dev-python/sphinxcontrib-qthelp-1.0.8[${PYTHON_USEDEP}]
	...
	devs? ( ~dev-python/black-24.4.2[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/build-1.2.1[${PYTHON_USEDEP}] )
	devs? ( dev-python/check-manifest[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/coverage-7.6.0[${PYTHON_USEDEP}] )
	...
	devs? ( ~dev-python/pycodestyle-2.12.0[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/pycodestyle-2.12.0[${PYTHON_USEDEP}] )
