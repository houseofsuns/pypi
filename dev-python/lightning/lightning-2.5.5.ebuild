...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	pytorch-test? ( ~dev-python/pytest-rerunfailures-16.0[${PYTHON_USEDEP}] )
	...
	pytorch-examples? ( <dev-python/ipython-10.0[${PYTHON_USEDEP}] )
	...
	fabric-test? ( ~dev-python/pytest-rerunfailures-16.0[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( ~dev-python/pytest-rerunfailures-16.0[${PYTHON_USEDEP}] )
	...
	pytorch-all? ( <dev-python/ipython-10.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( <dev-python/ipython-10.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/pytest-rerunfailures-16.0[${PYTHON_USEDEP}] )
	...
	examples? ( <dev-python/ipython-10.0[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/ipython-10.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/ipython-10.0[${PYTHON_USEDEP}] )
