...
IUSE="accelerate all audio benchmark codecarbon deepspeed deepspeed-testing dev dev-tensorflow dev-torch flax flax-speech ftfy hf-xet hub-kernels integrations ja modelcreation natten num2words onnx onnxruntime open-telemetry optuna quality ray retrieval ruff sagemaker sentencepiece serving sigopt sklearn speech testing tf tf-cpu tf-speech tiktoken timm tokenizers torch torch-speech torch-vision torchhub video vision"
