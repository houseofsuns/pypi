...
DESCRIPTION="Library to systematically track and evaluate LLM based applications. [prod-max (True, <g_sorcery.g_collections.Version object at 0x7f82f9e62260>)]"
