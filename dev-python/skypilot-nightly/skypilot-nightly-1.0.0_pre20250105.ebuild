...
IUSE="all aws azure cloudflare cudo do docker gcp ibm kubernetes lambda oci remote runpod scp vsphere"
DEPENDENCIES="all? ( dev-python/azure-mgmt-network[${PYTHON_USEDEP}] )
