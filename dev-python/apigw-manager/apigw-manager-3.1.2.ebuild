...
DEPENDENCIES="drf? ( >=dev-python/django-1.11.1[${PYTHON_USEDEP}] )
	django? ( >=dev-python/django-1.11.1[${PYTHON_USEDEP}] )
	...
	drf? ( >=dev-python/cryptography-3.1.1[${PYTHON_USEDEP}] )
	demo? ( dev-python/django-environ[${PYTHON_USEDEP}] )
	drf? ( <=dev-python/djangorestframework-3.15.1[${PYTHON_USEDEP}] )
	...
	drf? ( >=dev-python/pyjwt-1.6.4[${PYTHON_USEDEP}] )
