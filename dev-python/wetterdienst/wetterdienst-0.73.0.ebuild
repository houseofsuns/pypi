...
DEPENDENCIES="dev-python/aenum[${PYTHON_USEDEP}]
	...
	cratedb? ( <dev-python/pandas-2.2[${PYTHON_USEDEP}] )
	duckdb? ( <dev-python/pandas-2.2[${PYTHON_USEDEP}] )
	export? ( <dev-python/pandas-2.2[${PYTHON_USEDEP}] )
	mysql? ( <dev-python/pandas-2.2[${PYTHON_USEDEP}] )
	...
	export? ( <dev-python/xarray-2024.2[${PYTHON_USEDEP}] )
