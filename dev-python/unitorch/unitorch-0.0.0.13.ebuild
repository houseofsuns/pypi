...
IUSE="all deepspeed detection diffusers docs fastapi quantization webui"
DEPENDENCIES="webui? ( dev-python/gradio[${PYTHON_USEDEP}] )
	...
	detection? ( dev-python/mmyolo[${PYTHON_USEDEP}] )
	...
	webui? ( dev-python/gradio-client[${PYTHON_USEDEP}] )"
