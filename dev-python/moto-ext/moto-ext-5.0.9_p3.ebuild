...
DEPENDENCIES=">=dev-python/boto3-1.9.201[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/cfn-lint-1.3.0[${PYTHON_USEDEP}] )
	...
	cloudformation? ( >=dev-python/cfn-lint-1.3.0[${PYTHON_USEDEP}] )
	...
	proxy? ( >=dev-python/cfn-lint-1.3.0[${PYTHON_USEDEP}] )
	...
	resourcegroupstaggingapi? ( >=dev-python/cfn-lint-1.3.0[${PYTHON_USEDEP}] )
	...
	server? ( >=dev-python/cfn-lint-1.3.0[${PYTHON_USEDEP}] )
