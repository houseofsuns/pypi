...
IUSE="all build doc examples-extra recommended tests tests-ci tests-core"
DEPENDENCIES="dev-python/bokeh[${PYTHON_USEDEP}]
	...
	examples-extra? ( dev-python/netcdf4[${PYTHON_USEDEP}] )
	examples-extra? ( >dev-python/matplotlib-2.2[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/pandas[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/pyct[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/scipy[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/shapely[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/xarray[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/datashader[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/pooch[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/iris[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/xesmf[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/mock[${PYTHON_USEDEP}] )
	examples-extra? ( dev-python/fiona[${PYTHON_USEDEP}] )
	...
	tests-core? ( dev-python/geopandas[${PYTHON_USEDEP}] )
	tests-core? ( dev-python/netcdf4[${PYTHON_USEDEP}] )
	tests-core? ( >dev-python/matplotlib-2.2[${PYTHON_USEDEP}] )
	tests-core? ( dev-python/pandas[${PYTHON_USEDEP}] )
	tests-core? ( dev-python/scipy[${PYTHON_USEDEP}] )
	tests-core? ( dev-python/shapely[${PYTHON_USEDEP}] )
	tests-core? ( dev-python/xarray[${PYTHON_USEDEP}] )
	tests-core? ( dev-python/pooch[${PYTHON_USEDEP}] )
	tests-core? ( dev-python/pyviz-comms[${PYTHON_USEDEP}] )"
