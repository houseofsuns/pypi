...
DEPENDENCIES="~dev-python/django-5.1.4[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/coverage-7.6.9[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/py-vapid[${PYTHON_USEDEP}] )
	...
	prod? ( ~dev-python/redis-5.2.1[${PYTHON_USEDEP}] )
	prod? ( dev-python/tarantool[${PYTHON_USEDEP}] )
	prod? ( dev-python/pywebpush[${PYTHON_USEDEP}] )
	prod? ( dev-python/py-vapid[${PYTHON_USEDEP}] )
