...
IUSE="anthropic autobuild blendsearch cosmosdb gemini graph jupyter-executor lmm long-context mathchat mistral redis retrievechat retrievechat-pgvector retrievechat-qdrant teachable test together types websockets websurfer"
