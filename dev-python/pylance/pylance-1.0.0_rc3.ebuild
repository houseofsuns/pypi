...
HOMEPAGE=""
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/cp39/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-cp39-abi3-win_amd64.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-cp39-abi3-win_amd64.whl"
RESTRICT="test"

SLOT="0"
KEYWORDS="~amd64 ~x86"

IUSE="benchmarks dev geo tests torch"
DEPENDENCIES=">=dev-python/pyarrow-14.0[${PYTHON_USEDEP}]
	>=dev-python/numpy-1.22[${PYTHON_USEDEP}]
	dev-python/lance-namespace[${PYTHON_USEDEP}]
	...
	tests? ( dev-python/datafusion[${PYTHON_USEDEP}] )
	dev? ( dev-python/ruff[${PYTHON_USEDEP}] )
	dev? ( dev-python/pyright[${PYTHON_USEDEP}] )
	benchmarks? ( dev-python/pytest-benchmark[${PYTHON_USEDEP}] )
	torch? ( dev-python/torch[${PYTHON_USEDEP}] )
	geo? ( dev-python/geoarrow-rust-core[${PYTHON_USEDEP}] )
	geo? ( dev-python/geoarrow-rust-io[${PYTHON_USEDEP}] )
