...
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	dev-tensorflow? ( dev-python/isort[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/flake8[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/docutils[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/myst-parser[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/sphinx[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/sphinx-markdown-tables[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/sphinx-rtd-theme[${PYTHON_USEDEP}] )
	...
	dev-torch? ( dev-python/isort[${PYTHON_USEDEP}] )
	dev-torch? ( dev-python/flake8[${PYTHON_USEDEP}] )
	...
	dev-torch? ( dev-python/docutils[${PYTHON_USEDEP}] )
	dev-torch? ( dev-python/myst-parser[${PYTHON_USEDEP}] )
	dev-torch? ( dev-python/sphinx[${PYTHON_USEDEP}] )
	dev-torch? ( dev-python/sphinx-markdown-tables[${PYTHON_USEDEP}] )
	dev-torch? ( dev-python/sphinx-rtd-theme[${PYTHON_USEDEP}] )
	...
	docs_specific? ( dev-python/docutils[${PYTHON_USEDEP}] )
	docs_specific? ( dev-python/myst-parser[${PYTHON_USEDEP}] )
	docs_specific? ( dev-python/sphinx[${PYTHON_USEDEP}] )
	docs_specific? ( dev-python/sphinx-markdown-tables[${PYTHON_USEDEP}] )
	docs_specific? ( dev-python/sphinx-rtd-theme[${PYTHON_USEDEP}] )
	...
	torchhub? ( dev-python/numpy[${PYTHON_USEDEP}] )
	torchhub? ( dev-python/packaging[${PYTHON_USEDEP}] )
	torchhub? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	torchhub? ( dev-python/regex[${PYTHON_USEDEP}] )
	...
	torchhub? ( dev-python/tqdm[${PYTHON_USEDEP}] )
