...
IUSE="full graphics ipython runtime-compilation semidefinite tests"
DEPENDENCIES=">=dev-python/numpy-1.16.6[${PYTHON_USEDEP}]
	...
	full? ( <dev-python/cython-3.0.0[${PYTHON_USEDEP}] )
	...
	runtime-compilation? ( <dev-python/cython-3.0.0[${PYTHON_USEDEP}] )
