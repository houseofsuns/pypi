...
IUSE="desktop lxml ruamel-yaml tui ujson upath webui"
DEPENDENCIES="dev-python/bidict[${PYTHON_USEDEP}]
	...
	<dev-python/zstandard-0.23.1[${PYTHON_USEDEP}]
