...
IUSE="anthropic aws azure-ai community deepseek fireworks google-genai google-vertexai groq huggingface mistralai model-profiles ollama openai perplexity together xai"
DEPENDENCIES="dev-python/langchain-core[${PYTHON_USEDEP}]
	...
	model-profiles? ( dev-python/langchain-model-profiles[${PYTHON_USEDEP}] )
