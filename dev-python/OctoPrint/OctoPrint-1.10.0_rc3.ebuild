...
LICENSE="AGPL-3"
SRC_URI="https://files.pythonhosted.org/packages/source/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}.sdist.tar.gz"
SOURCEFILE="${REALNAME}-${REALVERSION}.sdist.tar.gz"
RESTRICT="test"
