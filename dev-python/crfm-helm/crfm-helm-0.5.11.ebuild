...
IUSE="accelerate aleph-alpha all allenai amazon anthropic audiolm ci cleva codeinsights cohere decodingtrust dspy google heim human-evaluation ibm ibm-enterprise-scenarios image2struct images lmkt medhelm metrics mistral models mongo openai plots proxy-server ranking reka scenarios seahelm slurm together unitxt vlm writer yandex"
DEPENDENCIES="~dev-python/cattrs-22.2[${PYTHON_USEDEP}]
	...
	dspy? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	dspy? ( ~dev-python/apscheduler-3.11.0[${PYTHON_USEDEP}] )
	dspy? ( ~dev-python/cryptography-43.0.3[${PYTHON_USEDEP}] )
	dspy? ( ~dev-python/python-multipart-0.0.20[${PYTHON_USEDEP}] )
	dspy? ( ~dev-python/email-validator-2.3.0[${PYTHON_USEDEP}] )
	dspy? ( dev-python/fastapi-sso[${PYTHON_USEDEP}] )
	...
	heim? ( >=dev-python/numpy-1.26[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/crfm-helm[${PYTHON_USEDEP}] )
	all? ( dev-python/crfm-helm[${PYTHON_USEDEP}] )
	ci? ( dev-python/crfm-helm[${PYTHON_USEDEP}] )
	ci? ( dev-python/crfm-helm[${PYTHON_USEDEP}] )
	ci? ( dev-python/crfm-helm[${PYTHON_USEDEP}] )
	ci? ( dev-python/crfm-helm[${PYTHON_USEDEP}] )
	ci? ( dev-python/crfm-helm[${PYTHON_USEDEP}] )
