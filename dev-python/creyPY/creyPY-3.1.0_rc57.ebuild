...
LICENSE="MIT"
SRC_URI="https://files.pythonhosted.org/packages/cd/43/46421cc8cd5571e70847596fc044bbe322fa61022cf5ce3410a6ed8fa56a/creypy-${REALVERSION}.tar.gz"
...
IUSE="all auth0 build postgres stripe"
DEPENDENCIES="auth0? ( >=dev-python/pyjwt-2.10.1[${PYTHON_USEDEP}] )
	...
	stripe? ( ~dev-python/stripe-12.3.0[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/stripe-12.3.0[${PYTHON_USEDEP}] )"
