...
IUSE="all dashboard dev docs ray"
DEPENDENCIES=">=dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}]
	...
	dev-python/orquestra-workflow-runtime[${PYTHON_USEDEP}]
	dev-python/orquestra-workflow-shared[${PYTHON_USEDEP}]
	...
	dashboard? ( dev-python/async-timeout[${PYTHON_USEDEP}] )
	dashboard? ( dev-python/ray[${PYTHON_USEDEP}] )
	dashboard? ( dev-python/ray[${PYTHON_USEDEP}] )
	dashboard? ( >=dev-python/virtualenv-20.0.24[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/furo-2023.7.26[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/sphinx-autoapi-2.1.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/sphinxcontrib-autoprogram-0.1.8[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/virtualenv-20.0.24[${PYTHON_USEDEP}] )
	...
	ray? ( >=dev-python/virtualenv-20.0.24[${PYTHON_USEDEP}] )
