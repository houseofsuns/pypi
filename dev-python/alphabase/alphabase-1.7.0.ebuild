...
IUSE="dask dask-stable development hdf stable tests"
DEPENDENCIES="dev-python/numba[${PYTHON_USEDEP}]
	...
	tests? ( dev-python/mudata[${PYTHON_USEDEP}] )
	...
	development? ( dev-python/anndata[${PYTHON_USEDEP}] )
	development? ( dev-python/mudata[${PYTHON_USEDEP}] )
