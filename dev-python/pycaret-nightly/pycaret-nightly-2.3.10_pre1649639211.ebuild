...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="2.3.10.dev1649639211"
DIGEST_SOURCES="yes"
...
DESCRIPTION="Nightly version of PyCaret - An open source, low-code machine learning library in Python. [newver 2.3.10.dev1651454453]"
