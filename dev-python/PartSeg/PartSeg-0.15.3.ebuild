...
LICENSE="BSD"
SRC_URI="https://files.pythonhosted.org/packages/c5/16/41e12abc2c563d84f880bd72f9a4a425de75a228efc8ccdb0f6d0a724bad/partseg-${REALVERSION}.tar.gz"
...
IUSE="accelerate all docs pyinstaller pyinstaller-base pyinstaller_base pyqt pyqt5 pyqt6 pyside pyside2 pyside6 test testing"
DEPENDENCIES=">=dev-python/ipython-7.7.0[${PYTHON_USEDEP}]
	...
	accelerate? ( >=dev-python/pyopengl_accelerate-3.1.5[${PYTHON_USEDEP}] )
	...
	pyinstaller_base? ( >=dev-python/pyopengl_accelerate-3.1.5[${PYTHON_USEDEP}] )
	...
	pyside? ( >=dev-python/pyside2-5.12.3[${PYTHON_USEDEP}] )
