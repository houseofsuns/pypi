...
IUSE="all aws clickhouse deltalake hudi huggingface iceberg lance numpy openai pandas ray spark sql transformers turbopuffer unity video"
DEPENDENCIES=">=dev-python/pyarrow-8.0.0[${PYTHON_USEDEP}]
	...
	spark? ( >=dev-python/grpcio-1.48[${PYTHON_USEDEP}] )
	spark? ( >=dev-python/grpcio-status-1.48[${PYTHON_USEDEP}] )
