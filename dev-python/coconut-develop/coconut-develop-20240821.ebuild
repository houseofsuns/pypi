...
DESCRIPTION="Simple, elegant, Pythonic functional programming. [badver 3.1.1.post0.dev5]"
...
DEPENDENCIES=">=dev-python/setuptools-44.0[${PYTHON_USEDEP}]
	...
	dev? ( >=dev-python/ipython-8.25[${PYTHON_USEDEP}] )
	...
	ipython? ( >=dev-python/ipython-8.25[${PYTHON_USEDEP}] )
	...
	jupyter? ( >=dev-python/ipython-8.25[${PYTHON_USEDEP}] )
	...
	jupyterlab? ( >=dev-python/ipython-8.25[${PYTHON_USEDEP}] )
	...
	jupytext? ( >=dev-python/ipython-8.25[${PYTHON_USEDEP}] )
	...
	kernel? ( >=dev-python/ipython-8.25[${PYTHON_USEDEP}] )
	...
	tests? ( >=dev-python/ipython-8.25[${PYTHON_USEDEP}] )
