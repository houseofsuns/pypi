...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="1.4.0.dev20240418165859"
DIGEST_SOURCES="yes"
...
DEPENDENCIES="dev-python/cirq-aqt[${PYTHON_USEDEP}]
	...
	dev-env? ( ~dev-python/mypy-1.2.0[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/types-backports[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/types-cachetools[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/types-protobuf[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/types-requests[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/types-setuptools-62.6.1[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/pytest[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/pytest-asyncio[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/pytest-cov-3.0[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/pytest-randomly[${PYTHON_USEDEP}] )
	dev-env? ( <=dev-python/coverage-6.2[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/pytest-xdist-2.2.0[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/filelock-3.0.12[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/freezegun-0.3.15[${PYTHON_USEDEP}] )
	...
	dev-env? ( ~dev-python/grpcio-tools-1.56.0[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/mypy-protobuf[${PYTHON_USEDEP}] )
	dev-env? ( >=dev-python/ipython-7.34.0[${PYTHON_USEDEP}] )
	dev-env? ( <=dev-python/notebook-6.4.7[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/ipykernel-5.3.4[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/papermill[${PYTHON_USEDEP}] )
	dev-env? ( >=dev-python/ply-3.6[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/pylatex-1.3.0[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/quimb[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/opt-einsum[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/autoray[${PYTHON_USEDEP}] )
	dev-env? ( dev-python/numba[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/seaborn-0.11.1[${PYTHON_USEDEP}] )
	...
	dev-env? ( ~dev-python/qiskit-aer-0.12.2[${PYTHON_USEDEP}] )
