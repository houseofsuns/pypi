...
DEPENDENCIES="dev-python/absl-py[${PYTHON_USEDEP}]
	...
	huggingface? ( <dev-python/ipykernel-7.0.0[${PYTHON_USEDEP}] )
	...
	huggingface? ( dev-python/mlcroissant[${PYTHON_USEDEP}] )
	...
	huggingface? ( <dev-python/pillow-12.0.0[${PYTHON_USEDEP}] )
	huggingface? ( dev-python/pydub[${PYTHON_USEDEP}] )
	huggingface? ( dev-python/scipy[${PYTHON_USEDEP}] )
	...
	c4? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	c4-wsrs? ( dev-python/apache-beam[${PYTHON_USEDEP}] )
	cats-vs-dogs? ( dev-python/matplotlib[${PYTHON_USEDEP}] )
	colorectal-histology? ( <dev-python/pillow-12.0.0[${PYTHON_USEDEP}] )
	...
	nsynth? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	...
	wider-face? ( <dev-python/pillow-12.0.0[${PYTHON_USEDEP}] )
