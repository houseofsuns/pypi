...
DEPENDENCIES="dev-python/albumentations[${PYTHON_USEDEP}]
	...
	base? ( ~dev-python/loguru-0.7.3[${PYTHON_USEDEP}] )
	...
	base? ( ~dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	base? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	base? ( ~dev-python/tqdm-4.67.1[${PYTHON_USEDEP}] )
	base? ( ~dev-python/werkzeug-3.1.3[${PYTHON_USEDEP}] )
	...
	base? ( ~dev-python/packaging-24.2[${PYTHON_USEDEP}] )
	base? ( ~dev-python/cryptography-44.0.0[${PYTHON_USEDEP}] )
	...
	base? ( ~dev-python/uvicorn-0.34.0[${PYTHON_USEDEP}] )
	base? ( ~dev-python/python-multipart-0.0.20[${PYTHON_USEDEP}] )
	base? ( ~dev-python/pydantic-2.10.4[${PYTHON_USEDEP}] )
	...
	base? ( ~dev-python/httpx-0.28.1[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/loguru-0.7.3[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	docs? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/tqdm-4.67.1[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/werkzeug-3.1.3[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/python-multipart-0.0.20[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/pydantic-2.10.4[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/httpx-0.28.1[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/loguru-0.7.3[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	quality? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/tqdm-4.67.1[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/werkzeug-3.1.3[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/packaging-24.2[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/cryptography-44.0.0[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/uvicorn-0.34.0[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/python-multipart-0.0.20[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pydantic-2.10.4[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/httpx-0.28.1[${PYTHON_USEDEP}] )
