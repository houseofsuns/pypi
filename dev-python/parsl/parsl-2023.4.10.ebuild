...
IUSE="all aws azure docs flux google_cloud gssapi kubernetes monitoring oauth_ssh workqueue"
DEPENDENCIES="dev-python/pyzmq[${PYTHON_USEDEP}]
	...
	google_cloud? ( dev-python/google-auth[${PYTHON_USEDEP}] )
	...
	monitoring? ( dev-python/pydot[${PYTHON_USEDEP}] )
	monitoring? ( dev-python/networkx[${PYTHON_USEDEP}] )
	monitoring? ( dev-python/Flask[${PYTHON_USEDEP}] )
	monitoring? ( dev-python/flask-sqlalchemy[${PYTHON_USEDEP}] )
	monitoring? ( dev-python/pandas[${PYTHON_USEDEP}] )
	monitoring? ( dev-python/plotly[${PYTHON_USEDEP}] )
	monitoring? ( dev-python/python-daemon[${PYTHON_USEDEP}] )
