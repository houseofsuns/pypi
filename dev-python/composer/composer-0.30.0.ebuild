...
IUSE="all coco comet-ml databricks dev gcs libcloud mlflow mlperf neptune nlp oci onnx pandas peft sentencepiece slack streaming system-metrics-monitor tensorboard wandb"
DEPENDENCIES="<dev-python/pyyaml-7.0[${PYTHON_USEDEP}]
	...
	dev? ( <dev-python/pytest-httpserver-1.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/setuptools-78.0.2[${PYTHON_USEDEP}] )
	dev? ( <dev-python/scikit-learn-1.7[${PYTHON_USEDEP}] )
	...
	streaming? ( <dev-python/paramiko-4.0[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/setuptools-78.0.2[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/pytest-httpserver-1.2[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/coverage-7.6.8[${PYTHON_USEDEP}] )"
