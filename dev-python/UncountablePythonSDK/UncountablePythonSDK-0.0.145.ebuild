...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/75/99/6b39b439817c1835b6c8808f79535c7cf75b4e4e079b12f15bda7a1f2244/uncountablepythonsdk-${REALVERSION}.tar.gz"
...
DEPENDENCIES="dev-python/aiotus[${PYTHON_USEDEP}]
	...
	~dev-python/types-psutil-7.0.0[${PYTHON_USEDEP}]
