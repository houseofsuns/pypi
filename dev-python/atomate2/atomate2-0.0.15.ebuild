...
IUSE="abinit amset cclib defects dev docs forcefields lobster mp phonons strict tests"
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	strict? ( dev-python/calorine[${PYTHON_USEDEP}] )
	...
	strict? ( dev-python/sevenn[${PYTHON_USEDEP}] )
	strict? ( dev-python/torch[${PYTHON_USEDEP}] )
