...
IUSE="aws azure dask dataframe docs gcp interactive interactive_test test"
DEPENDENCIES="dev-python/protobuf[${PYTHON_USEDEP}]
	...
	interactive_test? ( dev-python/nbformat[${PYTHON_USEDEP}] )
	interactive_test? ( dev-python/nbconvert[${PYTHON_USEDEP}] )
