...
DEPENDENCIES="~dev-python/alembic-1.10.4[${PYTHON_USEDEP}]
	...
	rdm? ( ~dev-python/docutils-0.21.2[${PYTHON_USEDEP}] )
	...
	rdm? ( ~dev-python/sphinx-7.4.5[${PYTHON_USEDEP}] )
	...
	s3? ( ~dev-python/boto3-1.34.144[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/botocore-1.34.144[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/fsspec-2024.6.1[${PYTHON_USEDEP}] )
	s3? ( dev-python/invenio-s3[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/jmespath-1.0.1[${PYTHON_USEDEP}] )
	s3? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/s3transfer-0.10.2[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/pycodestyle-2.12.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/sphinx-7.4.6[${PYTHON_USEDEP}] )
