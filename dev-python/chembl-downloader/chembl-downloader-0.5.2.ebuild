...
IUSE="docs notebooks pandas rdkit tests"
DEPENDENCIES="dev-python/tqdm[${PYTHON_USEDEP}]
	...
	notebooks? ( dev-python/rdkit[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/seaborn[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/matplotlib-venn[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/scipy[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/pyobo[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/biomappings[${PYTHON_USEDEP}] )
