...
DEPENDENCIES="dev-python/Adafruit-Blinka[${PYTHON_USEDEP}]
	...
	dev-python/adafruit-circuitpython-sht31d[${PYTHON_USEDEP}]
	dev-python/adafruit-circuitpython-bmp280[${PYTHON_USEDEP}]
	dev-python/adafruit-circuitpython-lis3mdl[${PYTHON_USEDEP}]
	dev-python/adafruit-circuitpython-apds9960[${PYTHON_USEDEP}]"
