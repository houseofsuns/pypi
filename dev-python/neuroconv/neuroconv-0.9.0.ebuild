...
DEPENDENCIES=">=dev-python/numpy-1.22.0[${PYTHON_USEDEP}]
	...
	spikeglx? ( dev-python/probeinterface[${PYTHON_USEDEP}] )
	...
	minian? ( dev-python/neuroconv[${PYTHON_USEDEP}] )
