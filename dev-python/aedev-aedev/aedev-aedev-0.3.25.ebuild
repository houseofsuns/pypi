...
IUSE="dev docs tests"
DEPENDENCIES="dev? ( dev-python/aedev-setup-project[${PYTHON_USEDEP}] )
	dev? ( dev-python/aedev-tpl-project[${PYTHON_USEDEP}] )
	dev? ( dev-python/aedev-tpl-namespace-root[${PYTHON_USEDEP}] )
	dev? ( dev-python/aedev-tpl-app[${PYTHON_USEDEP}] )
	dev? ( dev-python/aedev-git-repo-manager[${PYTHON_USEDEP}] )
	dev? ( dev-python/aedev-pythonanywhere[${PYTHON_USEDEP}] )
	dev? ( dev-python/aedev-setup-hook[${PYTHON_USEDEP}] )
	dev? ( dev-python/sphinx[${PYTHON_USEDEP}] )
	dev? ( dev-python/sphinx-rtd-theme[${PYTHON_USEDEP}] )
	dev? ( dev-python/sphinx-autodoc-typehints[${PYTHON_USEDEP}] )
	dev? ( dev-python/sphinx-paramlinks[${PYTHON_USEDEP}] )
	dev? ( dev-python/aedev-setup-project[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/aedev-setup-project[${PYTHON_USEDEP}] )
