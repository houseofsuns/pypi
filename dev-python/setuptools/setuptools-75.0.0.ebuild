...
DEPENDENCIES="check? ( dev-python/pytest-checkdocs[${PYTHON_USEDEP}] )
	check? ( dev-python/pytest-ruff[${PYTHON_USEDEP}] )
	check? ( dev-python/ruff[${PYTHON_USEDEP}] )
	core? ( >=dev-python/packaging-24.0[${PYTHON_USEDEP}] )
	...
	core? ( >=dev-python/platformdirs-2.6.2[${PYTHON_USEDEP}] )
	core? ( dev-python/jaraco-collections[${PYTHON_USEDEP}] )
	core? ( dev-python/jaraco-functools[${PYTHON_USEDEP}] )
	...
	type? ( ~dev-python/mypy-1.11[${PYTHON_USEDEP}] )
