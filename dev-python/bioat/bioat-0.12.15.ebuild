...
DEPENDENCIES=">=dev-python/pandas-1.5[${PYTHON_USEDEP}]
	...
	ai? ( >=dev-python/scikit-learn-1.0.2[${PYTHON_USEDEP}] )
	ai? ( >=dev-python/scipy-1.7.3[${PYTHON_USEDEP}] )
	web? ( >=dev-python/beautifulsoup4-4.12.3[${PYTHON_USEDEP}] )
	web? ( dev-python/playwright[${PYTHON_USEDEP}] )
	web? ( >=dev-python/selenium-4.1.3[${PYTHON_USEDEP}] )"
