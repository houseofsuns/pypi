...
DESCRIPTION="Python interface to qoqo calculator, the calculator backend of the qoqo quantum computing toolkit by HQS Quantum Simulations [wheel]"
...
IUSE="docs"
DEPENDENCIES="docs? ( >=dev-python/sphinx-2.1[${PYTHON_USEDEP}] )
