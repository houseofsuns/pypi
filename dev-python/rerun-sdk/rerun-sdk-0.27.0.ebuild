...
SRC_URI="https://files.pythonhosted.org/packages/cp310/${REALNAME::1}/${REALNAME}/${REALNAME//-/_}-${REALVERSION}-cp310-abi3-manylinux_2_28_x86_64.whl"
SOURCEFILE="${REALNAME//-/_}-${REALVERSION}-cp310-abi3-manylinux_2_28_x86_64.whl"
RESTRICT="test"

SLOT="0"
KEYWORDS="~amd64 ~x86"

IUSE="all datafusion notebook tests"
DEPENDENCIES=">=dev-python/attrs-23.1.0[${PYTHON_USEDEP}]
	...
	all? ( dev-python/rerun-sdk[${PYTHON_USEDEP}] )
	all? ( dev-python/rerun-sdk[${PYTHON_USEDEP}] )
