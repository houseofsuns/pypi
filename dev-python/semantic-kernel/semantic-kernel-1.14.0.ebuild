...
IUSE="anthropic aws azure chroma google hugging-face milvus mistralai mongo notebooks ollama onnx pandas pinecone postgres qdrant redis usearch weaviate"
DEPENDENCIES="~dev-python/aiohttp-3.8[${PYTHON_USEDEP}]
	...
	mongo? ( <dev-python/pymongo-4.9[${PYTHON_USEDEP}] )
