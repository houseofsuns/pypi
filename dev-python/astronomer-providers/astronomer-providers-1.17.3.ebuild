...
IUSE="all amazon apache-hive apache-livy cncf-kubernetes databricks dbt-cloud docs google http microsoft-azure mypy openlineage sftp snowflake test_python_3_11 tests"
DEPENDENCIES="dev-python/apache-airflow[${PYTHON_USEDEP}]
	...
	test_python_3_11? ( dev-python/aiobotocore[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-amazon[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-apache-livy[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-cncf-kubernetes[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-databricks[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-google[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-http[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-snowflake[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-sftp[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-microsoft-azure[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/asyncssh[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/apache-airflow-providers-dbt-cloud[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/gcloud-aio-bigquery[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/gcloud-aio-storage[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/kubernetes-asyncio[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/openlineage-airflow[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/paramiko[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/snowflake-sqlalchemy[${PYTHON_USEDEP}] )
	test_python_3_11? ( dev-python/databricks-sql-connector[${PYTHON_USEDEP}] )
