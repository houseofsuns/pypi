...
IUSE="aiosqlite asyncpg beanie bunnet databases django elasticsearch firestore mongoengine motor odmantic orm ormar piccolo psycopg scylla-driver sqlalchemy sqlmodel tortoise"
DEPENDENCIES="dev-python/fastapi[${PYTHON_USEDEP}]
	...
	psycopg? ( >=dev-python/psycopg-3.3.2[${PYTHON_USEDEP}] )
