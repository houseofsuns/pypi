...
IUSE="dev dev-complete dev-extras docs nbval test tools typing typing-extras"
DEPENDENCIES="dev-python/docstring-inheritance[${PYTHON_USEDEP}]
	...
	dev-extras? ( dev-python/nox[${PYTHON_USEDEP}] )
	...
	typing-extras? ( >=dev-python/mypy-1.5.1[${PYTHON_USEDEP}] )
