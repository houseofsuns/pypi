...
DEPENDENCIES="dev-python/setuptools[${PYTHON_USEDEP}]
	wagtail? ( <dev-python/boto3-1.35[${PYTHON_USEDEP}] )
	storages? ( <dev-python/boto3-1.35[${PYTHON_USEDEP}] )
	...
	<dev-python/dj-database-url-2.2[${PYTHON_USEDEP}]
	...
	<dev-python/sentry-sdk-1.41[${PYTHON_USEDEP}]
