...
DEPENDENCIES="dev-python/aiohttp[${PYTHON_USEDEP}]
	...
	dev? ( <dev-python/hypothesis-6.112.3[${PYTHON_USEDEP}] )
	...
	everest? ( dev-python/seba-sqlite[${PYTHON_USEDEP}] )
