...
DEPENDENCIES=">=dev-python/attrs-24.2.0[${PYTHON_USEDEP}]
	...
	testing? ( >=dev-python/hypothesis-6.118.8[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/pillow-12.1.0[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/sphinxcontrib-typer[${PYTHON_USEDEP}] )
