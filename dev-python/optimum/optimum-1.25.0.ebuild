...
IUSE="amd benchmark dev doc-build exporters exporters-gpu exporters-tf furiosa graphcore habana intel ipex neural-compressor neuronx nncf onnxruntime onnxruntime-gpu onnxruntime-training openvino quality quanto tests"
DEPENDENCIES="dev-python/transformers[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/hf-xet[${PYTHON_USEDEP}] )
	...
	exporters? ( >=dev-python/protobuf-3.20.1[${PYTHON_USEDEP}] )
	exporters? ( dev-python/transformers[${PYTHON_USEDEP}] )
	...
	exporters-gpu? ( >=dev-python/protobuf-3.20.1[${PYTHON_USEDEP}] )
	exporters-gpu? ( dev-python/transformers[${PYTHON_USEDEP}] )
	...
	exporters-tf? ( dev-python/datasets[${PYTHON_USEDEP}] )
	exporters-tf? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	exporters-tf? ( dev-python/transformers[${PYTHON_USEDEP}] )
	...
	ipex? ( dev-python/optimum-intel[${PYTHON_USEDEP}] )
	...
	onnxruntime? ( dev-python/transformers[${PYTHON_USEDEP}] )
	...
	onnxruntime-gpu? ( dev-python/transformers[${PYTHON_USEDEP}] )
	...
	onnxruntime-training? ( dev-python/datasets[${PYTHON_USEDEP}] )
	onnxruntime-training? ( >=dev-python/protobuf-3.20.1[${PYTHON_USEDEP}] )
	onnxruntime-training? ( dev-python/transformers[${PYTHON_USEDEP}] )
	onnxruntime-training? ( dev-python/onnxruntime-training[${PYTHON_USEDEP}] )
	...
	quanto? ( dev-python/optimum-quanto[${PYTHON_USEDEP}] )
