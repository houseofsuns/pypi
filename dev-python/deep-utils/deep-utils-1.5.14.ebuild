...
IUSE="cv tf torch torch-transformers torchvision"
DEPENDENCIES=">=dev-python/numpy-1.21.0[${PYTHON_USEDEP}]
	...
	torch-transformers? ( dev-python/torch[${PYTHON_USEDEP}] )
	torch-transformers? ( dev-python/torchvision[${PYTHON_USEDEP}] )
	torch-transformers? ( dev-python/torchaudio[${PYTHON_USEDEP}] )
	torch-transformers? ( dev-python/transformers[${PYTHON_USEDEP}] )
