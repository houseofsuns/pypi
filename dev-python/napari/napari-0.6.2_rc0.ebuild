...
IUSE="all all-optional bermuda build dev docs gallery optional optional-base optional-numba partsegcore pyqt pyqt5 pyqt6 pyside pyside2 pyside6-experimental qt release testing testing-extra"
DEPENDENCIES=">=dev-python/appdirs-1.4.4[${PYTHON_USEDEP}]
	...
	>=dev-python/superqt-0.7.3[${PYTHON_USEDEP}]
