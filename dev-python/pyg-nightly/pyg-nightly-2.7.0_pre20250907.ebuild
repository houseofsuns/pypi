...
IUSE="benchmark dev full graphgym modelhub rag test"
DEPENDENCIES="rag? ( dev-python/torchmetrics[${PYTHON_USEDEP}] )
	...
	rag? ( dev-python/pcst-fast[${PYTHON_USEDEP}] )
	...
	rag? ( dev-python/accelerate[${PYTHON_USEDEP}] )
