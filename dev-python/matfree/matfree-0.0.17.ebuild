...
IUSE="cpu doc format-and-lint full test"
DEPENDENCIES="cpu? ( dev-python/jax[${PYTHON_USEDEP}] )
	...
	format-and-lint? ( dev-python/matfree[${PYTHON_USEDEP}] )
	format-and-lint? ( dev-python/pre-commit[${PYTHON_USEDEP}] )
	format-and-lint? ( dev-python/blackdoc[${PYTHON_USEDEP}] )
