...
IUSE="aci all aristacv bootstrap citrix-adm device42 dna-center infoblox ipfabric meraki nautobot-device-lifecycle-mgmt pysnow servicenow slurpit solarwinds"
DEPENDENCIES="all? ( dev-python/jinja[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/orionsdk[${PYTHON_USEDEP}] )
	solarwinds? ( dev-python/orionsdk[${PYTHON_USEDEP}] )
