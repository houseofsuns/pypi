...
IUSE="all audio detection dev image multimodal test text typing visual"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	test? ( dev-python/pandas[${PYTHON_USEDEP}] )
	test? ( dev-python/sewar[${PYTHON_USEDEP}] )
	test? ( dev-python/phmdoctest[${PYTHON_USEDEP}] )
	test? ( dev-python/faster-coco-eval[${PYTHON_USEDEP}] )
