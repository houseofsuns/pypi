...
IUSE="all apigateway apigatewayv2 appsync awslambda batch cloudformation cognitoidp dynamodb dynamodbstreams ec2 glue iotdata proxy resourcegroupstaggingapi s3 s3crc32c server ssm xray"
