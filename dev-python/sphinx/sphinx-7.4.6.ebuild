...
DEPENDENCIES="dev-python/sphinxcontrib-applehelp[${PYTHON_USEDEP}]
	...
	lint? ( ~dev-python/types-docutils-0.21.0.20240711[${PYTHON_USEDEP}] )
	lint? ( dev-python/types-requests[${PYTHON_USEDEP}] )
	lint? ( >=dev-python/importlib-metadata-6.0[${PYTHON_USEDEP}] )
	lint? ( >=dev-python/tomli-2.0[${PYTHON_USEDEP}] )
