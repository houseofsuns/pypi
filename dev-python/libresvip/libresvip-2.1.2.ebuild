...
IUSE="cli crypto desktop lxml mobile tui ujson webui yaml12 zstd"
DEPENDENCIES="dev-python/aristaproto[${PYTHON_USEDEP}]
	...
	<=dev-python/ruamel-yaml-0.20.0[${PYTHON_USEDEP}]
	...
	cli? ( <dev-python/rich-14.2.1[${PYTHON_USEDEP}] )
	cli? ( dev-python/typer-slim[${PYTHON_USEDEP}] )
	crypto? ( >=dev-python/cffi-2.0.0[${PYTHON_USEDEP}] )
	...
	desktop? ( dev-python/ttkbootstrap-icons-mat[${PYTHON_USEDEP}] )
	lxml? ( >=dev-python/lxml-6.0.2[${PYTHON_USEDEP}] )
	mobile? ( dev-python/flet-permission-handler[${PYTHON_USEDEP}] )
	mobile? ( dev-python/flet[${PYTHON_USEDEP}] )
	mobile? ( dev-python/fontconfig-py[${PYTHON_USEDEP}] )
	tui? ( dev-python/textual-fspicker[${PYTHON_USEDEP}] )
	ujson? ( >=dev-python/ujson-5.11.0[${PYTHON_USEDEP}] )
	webui? ( dev-python/nicegui[${PYTHON_USEDEP}] )
	yaml12? ( <dev-python/ruamel-yaml-clib-0.3.0[${PYTHON_USEDEP}] )
	zstd? ( <dev-python/zstandard-0.25.1[${PYTHON_USEDEP}] )"
