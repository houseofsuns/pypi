...
DESCRIPTION="A development kit to interact with the Frequenz development platform [newver 0.25.2]"
...
DEPENDENCIES="dev-python/frequenz-api-microgrid[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.2.7[${PYTHON_USEDEP}] )
	...
	dev-mypy? ( ~dev-python/types-setuptools-68.1.0.1[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/pytest-7.4.1[${PYTHON_USEDEP}] )
