...
DESCRIPTION="Programmatically author, schedule and monitor data pipelines [wheel]"
...
DEPENDENCIES="dev-python/apache-airflow-core[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/uv-0.6.17[${PYTHON_USEDEP}] )
	...
	uv? ( >=dev-python/uv-0.6.17[${PYTHON_USEDEP}] )
