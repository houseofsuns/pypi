...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/e7/5c/c28519d3e5726bf65e7bb037d844d5e089924089acb3289c7d4f38f88d5f/${REALNAME}-${REALVERSION}.tar.gz"
...
IUSE="confluent dev devdocs kafka lint nats optionals otel rabbit redis test-core testing types"
DEPENDENCIES="<dev-python/anyio-5.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/mkdocs-macros-plugin-1.0.5[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/mkdocs-material-9.5.31[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/mkdocs-minify-plugin-0.8.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/mkdocs-static-i18n-1.2.3[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/mkdocstrings-0.25.2[${PYTHON_USEDEP}] )
	...
	devdocs? ( dev-python/griffe-typingdoc[${PYTHON_USEDEP}] )
	devdocs? ( dev-python/mdx-include[${PYTHON_USEDEP}] )
	devdocs? ( dev-python/mike[${PYTHON_USEDEP}] )
	devdocs? ( ~dev-python/mkdocs-git-revision-date-localized-plugin-1.2.6[${PYTHON_USEDEP}] )
	...
	test-core? ( ~dev-python/coverage-7.6.1[${PYTHON_USEDEP}] )
	test-core? ( ~dev-python/dirty-equals-0.7.1_p0[${PYTHON_USEDEP}] )
	test-core? ( ~dev-python/pytest-asyncio-0.23.8[${PYTHON_USEDEP}] )
	test-core? ( ~dev-python/pytest-8.3.2[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/coverage-7.6.1[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/dirty-equals-0.7.1_p0[${PYTHON_USEDEP}] )
	...
	testing? ( ~dev-python/pytest-asyncio-0.23.8[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/pytest-8.3.2[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/watchfiles-0.23.0[${PYTHON_USEDEP}] )
