...
IUSE="aws azure bitbucket bundles dask databricks dbt docker email gcp github gitlab kubernetes otel ray redis shell slack snowflake sqlalchemy"
DEPENDENCIES="<dev-python/aiosqlite-1.0.0[${PYTHON_USEDEP}]
	...
	dev-python/pydocket[${PYTHON_USEDEP}]
	...
	bundles? ( >=dev-python/uv-0.6.0[${PYTHON_USEDEP}] )
