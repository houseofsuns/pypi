...
DEPENDENCIES="~dev-python/alembic-1.14.0[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/psycopg-pool[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/psycopg-3.3.2[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/results[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/starlette-0.49.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/uv-0.9.9[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/werkzeug-3.1.4[${PYTHON_USEDEP}] )
