...
IUSE="anthropic argilla cohere dev docs groq hf-inference-endpoints hf-transformers instructor litellm llama-cpp mistralai ollama openai outlines tests vertexai vllm"
DEPENDENCIES="dev-python/datasets[${PYTHON_USEDEP}]
	...
	vllm? ( dev-python/outlines[${PYTHON_USEDEP}] )
