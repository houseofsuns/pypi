...
DEPENDENCIES="dev-python/chevron[${PYTHON_USEDEP}]
	...
	~dev-python/cfn-lint-1.14.2[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-psutil-6.0.0.20240901[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/types-setuptools-75.1.0.20240917[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/types-docutils-0.21.0.20240907[${PYTHON_USEDEP}] )
