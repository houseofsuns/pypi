...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/21/3f/dcfd7c1e8890af2e9962f6fba14e2f9df1e887b9f15ecad0e209cfcb1af8/pytooling-${REALVERSION}.tar.gz"
...
DEPENDENCIES="doc? ( ~dev-python/sphinx-8.1[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/setuptools-75.4[${PYTHON_USEDEP}] )
	...
	packaging? ( ~dev-python/setuptools-75.3[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/setuptools-75.4[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/setuptools-75.3[${PYTHON_USEDEP}] )
