...
DEPENDENCIES="dev-python/billiard[${PYTHON_USEDEP}]
	...
	auth? ( ~dev-python/cryptography-41.0.7[${PYTHON_USEDEP}] )
	...
	elasticsearch? ( <=dev-python/elasticsearch-8.11.1[${PYTHON_USEDEP}] )
	elasticsearch? ( <=dev-python/elastic-transport-8.11.0[${PYTHON_USEDEP}] )
