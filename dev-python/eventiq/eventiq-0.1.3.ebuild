...
IUSE="all cli commons kafka nats orjson ormsgpack prometheus pubsub rabbitmq redis"
DEPENDENCIES="all? ( dev-python/aio-pika[${PYTHON_USEDEP}] )
	...
	commons? ( dev-python/aiorun[${PYTHON_USEDEP}] )
	...
	commons? ( dev-python/orjson[${PYTHON_USEDEP}] )
	...
	commons? ( dev-python/prometheus-client[${PYTHON_USEDEP}] )
