...
IUSE="adlfs bodo daft datafusion duckdb dynamodb gcp-auth gcsfs glue hf hive hive-kerberos pandas polars pyarrow pyiceberg-core ray rest-sigv4 s3fs snappy sql-postgres sql-sqlite zstandard"
