...
IUSE="aiobotocore apache-hive cncf-kubernetes common-messaging exasol fab ftp google imap microsoft-azure mongo openlineage pandas python3-saml s3fs salesforce ssh standard"
DEPENDENCIES="dev-python/apache-airflow[${PYTHON_USEDEP}]
	...
	>=dev-python/boto3-1.37.2[${PYTHON_USEDEP}]
	...
	dev-python/PyDynamoDB[${PYTHON_USEDEP}]
	...
	python3-saml? ( >=dev-python/xmlsec-1.3.14[${PYTHON_USEDEP}] )
	python3-saml? ( >=dev-python/lxml-6.0.0[${PYTHON_USEDEP}] )
