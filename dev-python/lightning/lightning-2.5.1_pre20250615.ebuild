...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	fabric-dev? ( ~dev-python/coverage-7.8.2[${PYTHON_USEDEP}] )
	fabric-dev? ( dev-python/lightning-utilities[${PYTHON_USEDEP}] )
	fabric-dev? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-cov-6.1.1[${PYTHON_USEDEP}] )
	...
	fabric-test? ( ~dev-python/coverage-7.8.2[${PYTHON_USEDEP}] )
	fabric-test? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-cov-6.1.1[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/coverage-7.8.2[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/pytest-cov-6.1.1[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/coverage-7.8.2[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/pytest-cov-6.1.1[${PYTHON_USEDEP}] )
