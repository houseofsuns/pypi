...
IUSE="azure azure-cosmos-mongo-vcore azureml-core cognitive-search data-generation document-parsing elasticsearch faiss hugging-face langchain local-tests milvus pinecone remote-tests validate-deployments weaviate"
DEPENDENCIES="dev-python/azureml-dataprep[${PYTHON_USEDEP}]
	...
	weaviate? ( dev-python/weaviate[${PYTHON_USEDEP}] )
	weaviate? ( dev-python/langchain-weaviate[${PYTHON_USEDEP}] )
