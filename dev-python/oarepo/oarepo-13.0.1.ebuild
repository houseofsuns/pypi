...
DEPENDENCIES="dev-python/aiobotocore[${PYTHON_USEDEP}]
	...
	~dev-python/botocore-1.39.8[${PYTHON_USEDEP}]
	...
	~dev-python/elementpath-5.0.3[${PYTHON_USEDEP}]
	...
	~dev-python/regex-2025.7.29[${PYTHON_USEDEP}]
	...
	test? ( ~dev-python/time-machine-2.16.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/build-1.2.2_p1[${PYTHON_USEDEP}] )
	tests? ( dev-python/check-manifest[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/coverage-7.10.1[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/selenium-4.34.2[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/time-machine-2.16.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/selenium-4.34.2[${PYTHON_USEDEP}] )
	...
	devs? ( ~dev-python/build-1.2.2_p1[${PYTHON_USEDEP}] )
	devs? ( dev-python/check-manifest[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/coverage-7.10.1[${PYTHON_USEDEP}] )
	...
	devs? ( dev-python/PySocks[${PYTHON_USEDEP}] )
	...
	devs? ( ~dev-python/selenium-4.34.2[${PYTHON_USEDEP}] )
	...
	devs? ( ~dev-python/time-machine-2.16.0[${PYTHON_USEDEP}] )
