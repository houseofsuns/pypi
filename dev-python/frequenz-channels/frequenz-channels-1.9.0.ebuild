...
DEPENDENCIES="<dev-python/typing-extensions-5.0[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.6.12[${PYTHON_USEDEP}] )
	dev-mkdocs? ( ~dev-python/mkdocstrings-0.29.1[${PYTHON_USEDEP}] )
	dev-mkdocs? ( ~dev-python/mkdocstrings-python-1.16.10[${PYTHON_USEDEP}] )
	...
	dev-pylint? ( ~dev-python/pylint-3.3.6[${PYTHON_USEDEP}] )
