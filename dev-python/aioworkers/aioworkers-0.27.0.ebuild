...
DEPENDENCIES="aiohttp? ( dev-python/aioworkers-aiohttp[${PYTHON_USEDEP}] )
	...
	dev-interactive? ( dev-python/ipykernel[${PYTHON_USEDEP}] )
	dev-interactive? ( dev-python/ipython[${PYTHON_USEDEP}] )
	...
	dev-test? ( dev-python/msgpack[${PYTHON_USEDEP}] )
	...
	dev-test? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
