...
DEPENDENCIES="<dev-python/django-5.3[${PYTHON_USEDEP}]
	...
	~dev-python/selenium-4.38[${PYTHON_USEDEP}]
	...
	~dev-python/prometheus-client-0.23[${PYTHON_USEDEP}]
	...
	testing? ( ~dev-python/flake8-7.3[${PYTHON_USEDEP}] )
	...
	testing? ( ~dev-python/responses-0.25[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/twine-6.2[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/watchdog-6.0[${PYTHON_USEDEP}] )"
