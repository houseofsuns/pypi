...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="4.9.4.dev202403150044"
DIGEST_SOURCES="yes"
...
DESCRIPTION="tensorflow/datasets is a library of datasets ready to use with TensorFlow. [wheel]"
...
IUSE="aflw2k3d beir ble_wind_field c4 c4_wsrs cats_vs_dogs colorectal_histology common_voice dev duke_ultrasound eurosat groove gtzan huggingface imagenet2012_corrupted librispeech locomotion lsun matplotlib nsynth ogbg_molpcba pet_finder qm9 robonet robosuite_panda_pick_place_can smartwatch_gestures svhn tensorflow tensorflow-data-validation tests-all tf-nightly the300w_lp wider_face wiki_dialog wikipedia wsc273 youtube_vis"
