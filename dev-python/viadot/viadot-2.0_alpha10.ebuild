...
DESCRIPTION="A simple data ingestion library to guide data flows from some places to other places [newver 0.4.24]"
...
IUSE=""
DEPENDENCIES="dev-python/sharepy[${PYTHON_USEDEP}]
