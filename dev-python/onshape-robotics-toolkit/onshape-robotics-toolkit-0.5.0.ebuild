...
DEPENDENCIES=">=dev-python/loguru-0.7.0[${PYTHON_USEDEP}]
	...
	simulation? ( dev-python/mujoco[${PYTHON_USEDEP}] )
	simulation? ( dev-python/optuna[${PYTHON_USEDEP}] )
	simulation? ( >=dev-python/plotly-6.5.0[${PYTHON_USEDEP}] )
	simulation? ( dev-python/usd-core[${PYTHON_USEDEP}] )"
