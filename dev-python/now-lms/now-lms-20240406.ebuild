...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.0.1a15.dev20240406"
DIGEST_SOURCES="yes"
...
DESCRIPTION="Simple to {install, use, configure, mantain} learning management system. [badver 0.0.1a15.dev20240406]"
...
DEPENDENCIES="dev-python/alembic[${PYTHON_USEDEP}]
	...
	dev-python/Flask-Mailing[${PYTHON_USEDEP}]
