...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/py3/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-py3-none-macosx_10_15_universal2.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-py3-none-macosx_10_15_universal2.whl"
RESTRICT="test"
