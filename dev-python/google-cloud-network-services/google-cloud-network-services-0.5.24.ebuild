...
DESCRIPTION="Google Cloud Network Services API client library"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-network-services"
LICENSE="Apache-2.0"
