...
IUSE="connectors dev docs test transformers"
DEPENDENCIES="dev-python/arrow[${PYTHON_USEDEP}]
	...
	connectors? ( dev-python/exchangelib[${PYTHON_USEDEP}] )
	connectors? ( dev-python/google-auth-oauthlib[${PYTHON_USEDEP}] )
	connectors? ( dev-python/google-api-python-client[${PYTHON_USEDEP}] )
