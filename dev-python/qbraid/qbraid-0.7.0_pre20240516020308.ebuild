...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.7.0.dev20240516020308"
DIGEST_SOURCES="yes"
...
IUSE="braket docs lint qiskit runtime test visualization"
DEPENDENCIES="<dev-python/networkx-4.0[${PYTHON_USEDEP}]
	...
	docs? ( <dev-python/sphinx-autodoc-typehints-2.2[${PYTHON_USEDEP}] )
	...
	runtime? ( dev-python/qbraid-core[${PYTHON_USEDEP}] )
