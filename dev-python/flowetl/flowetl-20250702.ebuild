...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="1.33.1.post0.dev19"
DIGEST_SOURCES="yes"
...
DESCRIPTION="FlowETL is a collection of special purposes Airflow operators and sensors for use with FlowKit. [badver 1.33.1.post0.dev19, wheel]"
