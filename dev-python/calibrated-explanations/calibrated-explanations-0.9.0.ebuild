...
IUSE="dev eval external-plugins lime notebooks viz"
DEPENDENCIES="dev-python/crepes[${PYTHON_USEDEP}]
	...
	external-plugins? ( >=dev-python/numpy-1.24[${PYTHON_USEDEP}] )
	external-plugins? ( >=dev-python/pandas-2.0[${PYTHON_USEDEP}] )
	external-plugins? ( >=dev-python/scikit-learn-1.3[${PYTHON_USEDEP}] )"
