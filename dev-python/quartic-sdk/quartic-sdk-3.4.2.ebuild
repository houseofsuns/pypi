...
DESCRIPTION="QuarticSDK is the SDK package which exposes the APIs to the user [top-max 3.5.0]"
...
DEPENDENCIES="~dev-python/aiofiles-22.1.0[${PYTHON_USEDEP}]
	...
	complete? ( ~dev-python/aiofiles-22.1.0[${PYTHON_USEDEP}] )
	complete? ( dev-python/aiogqlc[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/aiohttp-3.8.1[${PYTHON_USEDEP}] )
	complete? ( dev-python/aiokafka[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/aiosignal-1.3.1[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/aiosqlite-0.17.0[${PYTHON_USEDEP}] )
	...
	complete? ( dev-python/asyncua[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/cffi-1.16.0[${PYTHON_USEDEP}] )
	...
	complete? ( dev-python/confluent-kafka[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/cryptography-38.0.4[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/pycparser-2.21[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/pydantic-1.8.2[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/pygments-2.17.2[${PYTHON_USEDEP}] )
	complete? ( dev-python/pyodbc[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/pytest-asyncio-0.15.1[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/pytest-mock-3.6.1[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/sortedcontainers-2.4.0[${PYTHON_USEDEP}] )
