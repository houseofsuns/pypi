...
DEPENDENCIES="~dev-python/amqp-5.3.1[${PYTHON_USEDEP}]
	...
	test? ( ~dev-python/faker-37.0.2[${PYTHON_USEDEP}] )
	test? ( ~dev-python/feedparser-6.0.11[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/pyyaml-env-tag-0.1[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/watchdog-6.0.0[${PYTHON_USEDEP}] )
	report? ( ~dev-python/coverage-7.7.0[${PYTHON_USEDEP}] )
	report? ( ~dev-python/flake8-7.1.2[${PYTHON_USEDEP}] )
	report? ( ~dev-python/pytest-cov-6.0.0[${PYTHON_USEDEP}] )
