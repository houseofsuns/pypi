...
IUSE="all all-aarch64 blackwell blackwell-aarch64 cu130 cu130-all decord dev test tracing"
DEPENDENCIES="dev-python/ipython[${PYTHON_USEDEP}]
	...
	decord? ( dev-python/decord2[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/sglang[${PYTHON_USEDEP}] )
	all-aarch64? ( dev-python/sglang[${PYTHON_USEDEP}] )
