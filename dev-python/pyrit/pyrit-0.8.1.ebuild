...
DESCRIPTION="The Python Risk Identification Tool for LLMs (PyRIT) is a library used to assess the robustness of LLMs [prod-max (True, <g_sorcery.g_collections.Version object at 0x7f72498306d0>)]"
