...
DEPENDENCIES="dev-python/ansys-dpf-core[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/ipython-8.21.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/jupyterlab-4.1.1[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/pandas-2.2.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/ipython-8.21.0[${PYTHON_USEDEP}] )"
