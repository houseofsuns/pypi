...
DEPENDENCIES=">=dev-python/fsspec-2025.2[${PYTHON_USEDEP}]
	...
	docs? ( dev-python/obstore[${PYTHON_USEDEP}] )
	...
	kerchunk? ( >=dev-python/h5py-3.14.0[${PYTHON_USEDEP}] )
	kerchunk? ( dev-python/kerchunk[${PYTHON_USEDEP}] )
	kerchunk? ( >=dev-python/xarray-2025.4.0[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/h5py-3.14.0[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/obstore[${PYTHON_USEDEP}] )
	...
	virtualizarr? ( dev-python/fastparquet[${PYTHON_USEDEP}] )
	virtualizarr? ( >=dev-python/h5py-3.14.0[${PYTHON_USEDEP}] )
	virtualizarr? ( dev-python/kerchunk[${PYTHON_USEDEP}] )
	virtualizarr? ( dev-python/numcodecs[${PYTHON_USEDEP}] )
	virtualizarr? ( >=dev-python/numpy-1.26.4[${PYTHON_USEDEP}] )
	virtualizarr? ( dev-python/obstore[${PYTHON_USEDEP}] )
	virtualizarr? ( dev-python/virtualizarr[${PYTHON_USEDEP}] )
	virtualizarr? ( dev-python/xarray[${PYTHON_USEDEP}] )
