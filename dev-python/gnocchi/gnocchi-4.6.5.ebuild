...
IUSE="amqp1 ceph-alternative doc keystone mysql postgresql prometheus redis s3 swift test test-swift"
DEPENDENCIES=">=dev-python/numpy-1.14.0[${PYTHON_USEDEP}]
	...
	ceph-alternative? ( dev-python/python-rados[${PYTHON_USEDEP}] )
	prometheus? ( dev-python/python-snappy[${PYTHON_USEDEP}] )
	prometheus? ( >=dev-python/protobuf-3.19.0[${PYTHON_USEDEP}] )
