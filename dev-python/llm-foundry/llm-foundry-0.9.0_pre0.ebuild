...
IUSE="all all-cpu all-flash2 databricks dev gpu gpu-flash2 megablocks openai peft tensorboard"
DEPENDENCIES="dev-python/mosaicml[${PYTHON_USEDEP}]
	...
	all-cpu? ( ~dev-python/coverage-7.4.4[${PYTHON_USEDEP}] )
	...
	all-flash2? ( ~dev-python/coverage-7.4.4[${PYTHON_USEDEP}] )
	all-flash2? ( dev-python/mosaicml[${PYTHON_USEDEP}] )
