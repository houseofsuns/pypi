...
DEPENDENCIES="~dev-python/black-25.1.0[${PYTHON_USEDEP}]
	...
	~dev-python/mypy-1.16.0[${PYTHON_USEDEP}]
	...
	core? ( ~dev-python/psycopg-3.2.9[${PYTHON_USEDEP}] )
	...
	extension? ( ~dev-python/psycopg-3.2.9[${PYTHON_USEDEP}] )
	extension? ( <dev-python/tornado-7.0[${PYTHON_USEDEP}] )
	async? ( ~dev-python/pytest-asyncio-1.0.0[${PYTHON_USEDEP}] )
