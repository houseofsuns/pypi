...
IUSE="airium atomicwrites attrs beartype bidict click cryptography cvxpy dev fastapi fastparquet fpdf2 hatch holoviews hypothesis loguru luigi memory-profiler more-itertools numpy pandas pqdm psutil pyinstrument pypi pytest pytest-check scipy scripts semver sqlalchemy test tqdm typed-settings xarray zarr"
DEPENDENCIES="dev-python/typing-extensions[${PYTHON_USEDEP}]
	...
	numpy? ( dev-python/numba[${PYTHON_USEDEP}] )
