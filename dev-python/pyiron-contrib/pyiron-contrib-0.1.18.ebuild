...
DEPENDENCIES=">=dev-python/matplotlib-3.9.1[${PYTHON_USEDEP}]
	...
	generic? ( >=dev-python/boto3-1.34.152[${PYTHON_USEDEP}] )
	generic? ( >=dev-python/moto-5.0.9[${PYTHON_USEDEP}] )
	image? ( >=dev-python/scikit-image-0.24.0[${PYTHON_USEDEP}] )
