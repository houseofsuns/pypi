...
IUSE="adbc all async calamine cloudpickle connectorx database deltalake excel fsspec gpu graph iceberg numpy openpyxl pandas plot pyarrow pydantic sqlalchemy style xlsx2csv xlsxwriter"
DEPENDENCIES="numpy? ( >=dev-python/numpy-1.16.0[${PYTHON_USEDEP}] )
	pandas? ( dev-python/pandas[${PYTHON_USEDEP}] )
	pandas? ( dev-python/polars-u64-idx[${PYTHON_USEDEP}] )
	...
	excel? ( dev-python/polars-u64-idx[${PYTHON_USEDEP}] )
	...
	sqlalchemy? ( dev-python/polars-u64-idx[${PYTHON_USEDEP}] )
	database? ( dev-python/polars-u64-idx[${PYTHON_USEDEP}] )
	database? ( dev-python/nest-asyncio[${PYTHON_USEDEP}] )
