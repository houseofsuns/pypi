...
LICENSE="MIT"
SRC_URI="https://files.pythonhosted.org/packages/59/5f/e294c13355b8cfeb2a8fccd39a596ef653f3c978db72d5dbe8bf237db88d/rstcheck_core-${REALVERSION}.tar.gz"
SOURCEFILE="rstcheck_core-${REALVERSION}.tar.gz"
RESTRICT="test"
