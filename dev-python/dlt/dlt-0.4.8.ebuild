...
IUSE="athena az bigquery cli databricks dbt dremio duckdb filesystem gcp gs motherduck mssql parquet postgres qdrant redshift s3 snowflake synapse weaviate"
