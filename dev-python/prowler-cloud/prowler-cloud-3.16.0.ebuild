...
DEPENDENCIES="dev-python/alive-progress[${PYTHON_USEDEP}]
	...
	~dev-python/google-api-python-client-2.124.0[${PYTHON_USEDEP}]
	<dev-python/google-auth-httplib2-0.3[${PYTHON_USEDEP}]
	~dev-python/jsonschema-4.21.1[${PYTHON_USEDEP}]
	~dev-python/mkdocs-git-revision-date-localized-plugin-1.2.4[${PYTHON_USEDEP}]
	~dev-python/mkdocs-material-9.5.17[${PYTHON_USEDEP}]
