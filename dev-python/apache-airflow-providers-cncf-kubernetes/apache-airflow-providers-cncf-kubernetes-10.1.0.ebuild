...
DESCRIPTION="Provider package apache-airflow-providers-cncf-kubernetes for Apache Airflow [prod-max (True, <g_sorcery.g_collections.Version object at 0x7feaa8e7ace0>)]"
