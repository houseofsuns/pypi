...
DEPENDENCIES="all? ( dev-python/hdbscan[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/pytest-8.3.3[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/selenium-4.25.0[${PYTHON_USEDEP}] )
	...
	all-latest? ( dev-python/GPUtil[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/matplotlib-3.9.2[${PYTHON_USEDEP}] )
	classification? ( dev-python/mat73[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/natsort-8.4.0[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/numpy-2.0.2[${PYTHON_USEDEP}] )
	classification? ( dev-python/optuna[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/pytest-8.3.3[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/scikit-learn-1.5.2[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/scipy-1.14.1[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/seaborn-0.13.2[${PYTHON_USEDEP}] )
	classification? ( dev-python/sparse[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/tqdm-4.66.5[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/psutil-6.1.0[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/matplotlib-3.9.2[${PYTHON_USEDEP}] )
	core? ( dev-python/mat73[${PYTHON_USEDEP}] )
	core? ( ~dev-python/natsort-8.4.0[${PYTHON_USEDEP}] )
	core? ( ~dev-python/numpy-2.0.2[${PYTHON_USEDEP}] )
	core? ( dev-python/optuna[${PYTHON_USEDEP}] )
	core? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	core? ( ~dev-python/pytest-8.3.3[${PYTHON_USEDEP}] )
	core? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	core? ( ~dev-python/scikit-learn-1.5.2[${PYTHON_USEDEP}] )
	core? ( ~dev-python/scipy-1.14.1[${PYTHON_USEDEP}] )
	core? ( ~dev-python/seaborn-0.13.2[${PYTHON_USEDEP}] )
	core? ( dev-python/sparse[${PYTHON_USEDEP}] )
	core? ( ~dev-python/tqdm-4.66.5[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/psutil-6.1.0[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/matplotlib-3.9.2[${PYTHON_USEDEP}] )
	tracking? ( dev-python/mat73[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/natsort-8.4.0[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/numpy-2.0.2[${PYTHON_USEDEP}] )
	tracking? ( dev-python/optuna[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/pytest-8.3.3[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/scikit-learn-1.5.2[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/scipy-1.14.1[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/seaborn-0.13.2[${PYTHON_USEDEP}] )
	tracking? ( dev-python/sparse[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/tqdm-4.66.5[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/psutil-6.1.0[${PYTHON_USEDEP}] )
