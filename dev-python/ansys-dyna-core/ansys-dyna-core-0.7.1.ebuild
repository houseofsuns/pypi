...
DEPENDENCIES="dev-python/ansys-dpf-core[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/scikit-learn-1.6.1[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/ipython-8.32.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/jupyterlab-4.3.5[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/scikit-learn-1.6.1[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/pytest-xdist-3.6.1[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/ipython-8.32.0[${PYTHON_USEDEP}] )
