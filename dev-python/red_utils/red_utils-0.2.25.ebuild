...
IUSE="all ci data dataframes docs fastapi http standard tests"
DEPENDENCIES="all? ( >=dev-python/diskcache-5.6.3[${PYTHON_USEDEP}] )
	all? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	all? ( >=dev-python/uvicorn-0.27.1[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/hishel-0.0.26[${PYTHON_USEDEP}] )
	...
	ci? ( >=dev-python/nox-2023.4.22[${PYTHON_USEDEP}] )
	...
	dataframes? ( >=dev-python/pyarrow-15.0.0[${PYTHON_USEDEP}] )
	...
	http? ( dev-python/pendulum[${PYTHON_USEDEP}] )
	http? ( >=dev-python/hishel-0.0.26[${PYTHON_USEDEP}] )
	http? ( >=dev-python/chardet-5.2.0[${PYTHON_USEDEP}] )
	...
	standard? ( >=dev-python/chardet-5.2.0[${PYTHON_USEDEP}] )
	standard? ( >=dev-python/hishel-0.0.26[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/loguru-0.7.2[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/httpx-0.27.0[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/hishel-0.0.26[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/chardet-5.2.0[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/sqlalchemy-2.0.30[${PYTHON_USEDEP}] )
	tests? ( dev-python/pendulum[${PYTHON_USEDEP}] )
