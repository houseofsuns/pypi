...
SRC_URI="https://files.pythonhosted.org/packages/e8/54/37629c9750adfd4e95541af8200fe998dbf77d53843137e12f3808805d09/autorag-${REALVERSION}.tar.gz"
...
DEPENDENCIES=">=dev-python/aiohttp-3.12.13[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/jq-1.9.1[${PYTHON_USEDEP}] )
	all? ( dev-python/kiwipiepy[${PYTHON_USEDEP}] )
	all? ( dev-python/konlpy[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/llmlingua[${PYTHON_USEDEP}] )
