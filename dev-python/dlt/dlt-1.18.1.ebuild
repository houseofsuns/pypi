...
IUSE="athena az bigquery cli clickhouse databricks dbml deltalake dremio duckdb ducklake filesystem gcp gs http lancedb motherduck mssql parquet postgis postgres pyiceberg qdrant redshift s3 sftp snowflake sql-database sqlalchemy synapse weaviate workspace"
DEPENDENCIES=">=dev-python/click-7.1[${PYTHON_USEDEP}]
	...
	ducklake? ( dev-python/duckdb[${PYTHON_USEDEP}] )
	ducklake? ( >=dev-python/pyarrow-16.0.0[${PYTHON_USEDEP}] )
	...
	http? ( >dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}] )
	...
	workspace? ( dev-python/duckdb[${PYTHON_USEDEP}] )
	workspace? ( dev-python/ibis-framework[${PYTHON_USEDEP}] )
	workspace? ( dev-python/marimo[${PYTHON_USEDEP}] )
	workspace? ( dev-python/mcp[${PYTHON_USEDEP}] )
	workspace? ( >=dev-python/pathspec-0.11.2[${PYTHON_USEDEP}] )
	workspace? ( >=dev-python/pyarrow-16.0.0[${PYTHON_USEDEP}] )"
