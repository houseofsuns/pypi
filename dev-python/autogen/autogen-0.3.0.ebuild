...
IUSE="anthropic autobuild bedrock blendsearch cohere cosmosdb gemini graph groq jupyter-executor lmm long-context mathchat mistral ollama redis retrievechat retrievechat-mongodb retrievechat-pgvector retrievechat-qdrant teachable test together types websockets websurfer"
DEPENDENCIES="dev-python/diskcache[${PYTHON_USEDEP}]
	...
	retrievechat? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	...
	retrievechat-mongodb? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	...
	retrievechat-pgvector? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	...
	retrievechat-qdrant? ( dev-python/protobuf[${PYTHON_USEDEP}] )
