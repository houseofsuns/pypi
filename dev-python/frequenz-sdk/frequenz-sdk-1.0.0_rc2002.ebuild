...
DEPENDENCIES="dev-python/frequenz-client-microgrid[${PYTHON_USEDEP}]
	...
	dev-mypy? ( ~dev-python/mypy-1.15.0[${PYTHON_USEDEP}] )
	dev-mypy? ( dev-python/types-Markdown[${PYTHON_USEDEP}] )
	dev-mypy? ( dev-python/types-protobuf[${PYTHON_USEDEP}] )
	dev-mypy? ( ~dev-python/types-setuptools-80.3.0.20250505[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/hypothesis-6.131.9[${PYTHON_USEDEP}] )
