...
IUSE="accelerate agents all audio benchmark codecarbon deepspeed deepspeed-testing dev dev-tensorflow dev-torch flax flax-speech ftfy integrations ja modelcreation natten onnx onnxruntime optuna quality ray retrieval ruff sagemaker sentencepiece serving sigopt sklearn speech testing tf tf-cpu tf-speech timm tokenizers torch torch-speech torch-vision torchhub video vision"
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	torchhub? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
