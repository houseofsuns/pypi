...
IUSE="athena az bigquery cli clickhouse databricks deltalake dremio duckdb filesystem gcp gs lancedb motherduck mssql parquet postgis postgres qdrant redshift s3 sftp snowflake sql-database sqlalchemy synapse weaviate"
