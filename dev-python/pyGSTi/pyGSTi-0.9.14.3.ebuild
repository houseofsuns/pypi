...
IUSE="complete diamond-norm evolutionary-optimization extensions html-reports ibmq interpygate linting memory-profiling mongodb msgpack multiprocessor no-mpi notebooks pytorch report-pdf-figures reports testing testing-no-cython testing-no-cython-mpi"
DEPENDENCIES=">=dev-python/numpy-1.15.0[${PYTHON_USEDEP}]
	dev-python/scipy[${PYTHON_USEDEP}]
	dev-python/stim[${PYTHON_USEDEP}]
	>=dev-python/plotly-3.8.0[${PYTHON_USEDEP}]
	...
	ibmq? ( >dev-python/qiskit-1.0[${PYTHON_USEDEP}] )
	ibmq? ( dev-python/qiskit-ibm-runtime[${PYTHON_USEDEP}] )
	ibmq? ( dev-python/dill[${PYTHON_USEDEP}] )
