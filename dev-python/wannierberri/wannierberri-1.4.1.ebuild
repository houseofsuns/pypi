...
DESCRIPTION="Constructuion of Wannier functions and Wannier interpolation [top-max 1.4.2]"
...
DEPENDENCIES=">=dev-python/numpy-2.0[${PYTHON_USEDEP}]
	...
	symmetry? ( dev-python/spgrep[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/spgrep[${PYTHON_USEDEP}] )
