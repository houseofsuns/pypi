...
DESCRIPTION="Customer is not fetched correctly in one scanned grayscale PDF file, and on refresh, the customer name is not extracted in OCR (PPO), preventing YML template creation. [wheel]"
