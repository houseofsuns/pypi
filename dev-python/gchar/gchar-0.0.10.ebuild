...
DEPENDENCIES="dev-python/hbutils[${PYTHON_USEDEP}]
	...
	crawl? ( dev-python/pandas[${PYTHON_USEDEP}] )
	crawl? ( dev-python/GitPython[${PYTHON_USEDEP}] )
	crawl? ( dev-python/pillow[${PYTHON_USEDEP}] )
	crawl? ( dev-python/dghs-imgutils[${PYTHON_USEDEP}] )
