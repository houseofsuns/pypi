...
IUSE="all-plugins all-plugins-pypy dev docs ffmpeg fits freeimage full gdal itk linting pillow-heif pyav rawpy test tifffile"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	>=dev-python/pillow-8.3.2[${PYTHON_USEDEP}]
	ffmpeg? ( dev-python/imageio-ffmpeg[${PYTHON_USEDEP}] )
	ffmpeg? ( dev-python/psutil[${PYTHON_USEDEP}] )
	freeimage? ( dev-python/fsspec[${PYTHON_USEDEP}] )
	...
	all-plugins? ( dev-python/fsspec[${PYTHON_USEDEP}] )
	...
	all-plugins-pypy? ( dev-python/fsspec[${PYTHON_USEDEP}] )
