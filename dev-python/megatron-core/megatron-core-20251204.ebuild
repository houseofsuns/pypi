...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.16.0rc0.dev111262"
DIGEST_SOURCES="yes"
...
DESCRIPTION="Megatron Core - a library for efficient and scalable training of transformer based models [badver 0.16.0rc0.dev111262]"
...
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	lts? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	lts? ( dev-python/datasets[${PYTHON_USEDEP}] )"
