...
LICENSE="LGPL-3"
SRC_URI="https://files.pythonhosted.org/packages/ba/e8/42fd1fe02266a8dd811812749053899bf17d8ae683ac52a98be94c525c3e/godoo_cli-${REALVERSION}.tar.gz"
...
DEPENDENCIES="dev-python/python-dotenv[${PYTHON_USEDEP}]
	...
	devcontainer? ( dev-python/pre-commit[${PYTHON_USEDEP}] )
