...
IUSE="all docs druid exasol hiveserver2 presto pyspark rest s3 snowflake ssh ssh_paramiko test webhdfs"
DEPENDENCIES="dev-python/future[${PYTHON_USEDEP}]
	...
	ssh_paramiko? ( dev-python/paramiko[${PYTHON_USEDEP}] )
	ssh_paramiko? ( dev-python/pexpect[${PYTHON_USEDEP}] )
