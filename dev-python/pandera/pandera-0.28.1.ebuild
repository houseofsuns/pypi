...
IUSE="all dask fastapi frictionless geopandas hypotheses ibis io modin modin-dask modin-ray mypy pandas polars pyspark strategies"
DEPENDENCIES=">=dev-python/packaging-20.0[${PYTHON_USEDEP}]
	...
	frictionless? ( dev-python/frictionless[${PYTHON_USEDEP}] )
	mypy? ( dev-python/pandas-stubs[${PYTHON_USEDEP}] )
	mypy? ( dev-python/scipy-stubs[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/scipy-stubs[${PYTHON_USEDEP}] )
