...
DEPENDENCIES=">=dev-python/requests-2.26.0[${PYTHON_USEDEP}]
	...
	>=dev-python/sqlglot-23.0.0[${PYTHON_USEDEP}]
	...
	bigquery? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	parquet? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	motherduck? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	athena? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	synapse? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	clickhouse? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	dremio? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	lancedb? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	deltalake? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
	pyiceberg? ( >=dev-python/pyarrow-14.0.0[${PYTHON_USEDEP}] )
