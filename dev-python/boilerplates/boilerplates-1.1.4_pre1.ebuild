...
DEPENDENCIES="setup? ( ~dev-python/build-1.2[${PYTHON_USEDEP}] )
	...
	setup? ( dev-python/version-query[${PYTHON_USEDEP}] )
	...
	packaging-tests? ( dev-python/version-query[${PYTHON_USEDEP}] )
