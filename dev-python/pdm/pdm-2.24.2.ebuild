...
DEPENDENCIES="dev-python/blinker[${PYTHON_USEDEP}]
	...
	locked? ( ~dev-python/dep-logic-0.5.0[${PYTHON_USEDEP}] )
	...
	locked? ( ~dev-python/findpython-0.6.3[${PYTHON_USEDEP}] )
	...
	locked? ( ~dev-python/pbs-installer-2025.5.17[${PYTHON_USEDEP}] )
	...
	locked? ( ~dev-python/urllib3-2.2.1[${PYTHON_USEDEP}] )
