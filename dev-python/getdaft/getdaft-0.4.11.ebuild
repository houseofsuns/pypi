...
IUSE="all aws deltalake hudi iceberg lance numpy pandas ray sql unity"
DEPENDENCIES="<=dev-python/pyarrow-16.0.0[${PYTHON_USEDEP}]
	...
	hudi? ( <=dev-python/pyarrow-16.0.0[${PYTHON_USEDEP}] )
