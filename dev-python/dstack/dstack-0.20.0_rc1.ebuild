...
IUSE="all aws azure datacrunch gateway gcp kubernetes lambda nebius oci server verda"
DEPENDENCIES="<dev-python/apscheduler-4.0[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/uvicorn[${PYTHON_USEDEP}] )
	all? ( dev-python/verda[${PYTHON_USEDEP}] )
	...
	aws? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	azure? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	datacrunch? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	datacrunch? ( dev-python/verda[${PYTHON_USEDEP}] )
	...
	gcp? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	kubernetes? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	lambda? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	nebius? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	oci? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	server? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	...
	verda? ( dev-python/aiocache[${PYTHON_USEDEP}] )
	verda? ( dev-python/aiorwlock[${PYTHON_USEDEP}] )
	verda? ( dev-python/aiosqlite[${PYTHON_USEDEP}] )
	verda? ( dev-python/alembic-postgresql-enum[${PYTHON_USEDEP}] )
	verda? ( >=dev-python/alembic-1.16.0[${PYTHON_USEDEP}] )
	verda? ( dev-python/asyncpg[${PYTHON_USEDEP}] )
	verda? ( dev-python/backports-entry-points-selectable[${PYTHON_USEDEP}] )
	verda? ( >=dev-python/docker-6.0.0[${PYTHON_USEDEP}] )
	verda? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	verda? ( >=dev-python/grpcio-1.50[${PYTHON_USEDEP}] )
	verda? ( dev-python/httpx[${PYTHON_USEDEP}] )
	verda? ( dev-python/jinja2[${PYTHON_USEDEP}] )
	verda? ( dev-python/prometheus-client[${PYTHON_USEDEP}] )
	verda? ( dev-python/python-dxf[${PYTHON_USEDEP}] )
	verda? ( >=dev-python/python-json-logger-3.1.0[${PYTHON_USEDEP}] )
	verda? ( dev-python/sentry-sdk[${PYTHON_USEDEP}] )
	verda? ( dev-python/SQLAlchemy-Utils[${PYTHON_USEDEP}] )
	verda? ( >=dev-python/sqlalchemy-2.0.0[${PYTHON_USEDEP}] )
	verda? ( >=dev-python/starlette-0.26.0[${PYTHON_USEDEP}] )
	verda? ( dev-python/uvicorn[${PYTHON_USEDEP}] )
	verda? ( dev-python/verda[${PYTHON_USEDEP}] )
	verda? ( dev-python/watchfiles[${PYTHON_USEDEP}] )"
