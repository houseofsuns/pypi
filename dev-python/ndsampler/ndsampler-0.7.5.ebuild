...
DESCRIPTION="Fast sampling from large images [top-max 0.8.0]"
...
DEPENDENCIES="dev-python/ubelt[${PYTHON_USEDEP}]
	...
	all-strict? ( ~dev-python/xdoctest-0.15.6[${PYTHON_USEDEP}] )
	...
	tests-strict? ( ~dev-python/xdoctest-0.15.6[${PYTHON_USEDEP}] )
