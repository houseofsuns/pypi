...
IUSE="complete complete-with-docs csv database docs gui layout-validation snt test"
DEPENDENCIES="~dev-python/appdirs-1.4[${PYTHON_USEDEP}]
	...
	~dev-python/rdflib-7.1[${PYTHON_USEDEP}]
	...
	test? ( >=dev-python/scikit-image-0.21.0[${PYTHON_USEDEP}] )
	...
	complete-with-docs? ( dev-python/scikit-image[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/ssnolib[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/mongomock[${PYTHON_USEDEP}] )
	complete-with-docs? ( <=dev-python/xmltodict-0.13.0[${PYTHON_USEDEP}] )
	complete-with-docs? ( >=dev-python/scipy-1.10.1[${PYTHON_USEDEP}] )
	complete-with-docs? ( >=dev-python/scikit-image-0.21.0[${PYTHON_USEDEP}] )
	complete-with-docs? ( >=dev-python/pandas-1.4.3[${PYTHON_USEDEP}] )
	complete-with-docs? ( <=dev-python/xmltodict-0.13.0[${PYTHON_USEDEP}] )
	complete-with-docs? ( <=dev-python/tabulate-0.9.0[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/python-gitlab[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/pypandoc[${PYTHON_USEDEP}] )
	complete-with-docs? ( <=dev-python/pymongo-4.10.1[${PYTHON_USEDEP}] )
	complete-with-docs? ( >=dev-python/pandas-1.4.3[${PYTHON_USEDEP}] )
	complete-with-docs? ( <=dev-python/xmltodict-0.13.0[${PYTHON_USEDEP}] )
	complete-with-docs? ( <=dev-python/tabulate-0.9.0[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/python-gitlab[${PYTHON_USEDEP}] )
	...
	complete-with-docs? ( dev-python/pypandoc[${PYTHON_USEDEP}] )
	complete-with-docs? ( <=dev-python/pymongo-4.10.1[${PYTHON_USEDEP}] )
	complete-with-docs? ( ~dev-python/sphinx-8.0.0[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/sphinx-book-theme[${PYTHON_USEDEP}] )
	complete-with-docs? ( ~dev-python/sphinx-copybutton-0.5.2[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/sphinx_design[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/myst-nb[${PYTHON_USEDEP}] )
	complete-with-docs? ( ~dev-python/sphinxcontrib-bibtex-2.6.3[${PYTHON_USEDEP}] )
	complete-with-docs? ( >=dev-python/scikit-image-0.21.0[${PYTHON_USEDEP}] )
	complete-with-docs? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )"
