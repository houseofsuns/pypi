...
IUSE="dev jupyterlab notebook packaging-tools polars test"
DEPENDENCIES="dev-python/anywidget[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/pl-series-hash[${PYTHON_USEDEP}] )
	...
	packaging-tools? ( dev-python/build[${PYTHON_USEDEP}] )
	packaging-tools? ( dev-python/twine[${PYTHON_USEDEP}] )
