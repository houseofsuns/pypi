...
DEPENDENCIES="dev-python/aiohttp[${PYTHON_USEDEP}]
	...
	dev-python/graphite-maps[${PYTHON_USEDEP}]
	...
	dev-python/ropt-dakota[${PYTHON_USEDEP}]
	dev-python/ropt[${PYTHON_USEDEP}]
	dev-python/ruamel-yaml[${PYTHON_USEDEP}]
	>=dev-python/scipy-1.10.1[${PYTHON_USEDEP}]
	dev-python/seaborn[${PYTHON_USEDEP}]
	dev-python/surfio[${PYTHON_USEDEP}]
	...
	dev-python/resfo-utilities[${PYTHON_USEDEP}]
	dev? ( dev-python/furo[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/hypothesis-6.85[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/pytest-durations[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/xlsxwriter-3.2.3[${PYTHON_USEDEP}] )
	dev? ( dev-python/resfo-utilities[${PYTHON_USEDEP}] )
