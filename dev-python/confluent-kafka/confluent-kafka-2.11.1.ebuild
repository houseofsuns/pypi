...
DEPENDENCIES="schemaregistry? ( >=dev-python/attrs-21.2.0[${PYTHON_USEDEP}] )
	...
	schema-registry? ( >=dev-python/orjson-3.10[${PYTHON_USEDEP}] )
	...
	rules? ( >=dev-python/orjson-3.10[${PYTHON_USEDEP}] )
	...
	avro? ( >=dev-python/orjson-3.10[${PYTHON_USEDEP}] )
	...
	protobuf? ( >=dev-python/orjson-3.10[${PYTHON_USEDEP}] )
