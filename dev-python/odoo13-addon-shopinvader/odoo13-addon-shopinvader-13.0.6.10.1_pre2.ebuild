...
DEPENDENCIES="dev-python/cerberus[${PYTHON_USEDEP}]
	...
	dev-python/odoo13-addon-base-sparse-field-list-support[${PYTHON_USEDEP}]
	dev-python/odoo13-addon-base-url[${PYTHON_USEDEP}]
	dev-python/odoo13-addon-component-event[${PYTHON_USEDEP}]
	dev-python/odoo13-addon-onchange-helper[${PYTHON_USEDEP}]
