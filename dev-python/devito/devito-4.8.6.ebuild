...
IUSE="extras mpi nvidia python-version-3-8- tests"
DEPENDENCIES=">=dev-python/pip-9.0.1[${PYTHON_USEDEP}]
	...
	mpi? ( <dev-python/mpi4py-3.1.7[${PYTHON_USEDEP}] )
	mpi? ( <dev-python/ipyparallel-8.9[${PYTHON_USEDEP}] )
	...
	python-version-3-8-? ( dev-python/pooch[${PYTHON_USEDEP}] )
