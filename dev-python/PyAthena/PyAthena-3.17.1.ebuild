...
SRC_URI="https://files.pythonhosted.org/packages/92/7b/bfc80efc820c3954afa634c1b99f2fad8a824d17b67506491044ddf65520/pyathena-${REALVERSION}.tar.gz"
...
DEPENDENCIES="arrow? ( >=dev-python/pyarrow-7.0.0[${PYTHON_USEDEP}] )
