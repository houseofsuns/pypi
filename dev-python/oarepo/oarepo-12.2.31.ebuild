...
DEPENDENCIES="~dev-python/alabaster-0.7.16[${PYTHON_USEDEP}]
	...
	~dev-python/boto3-1.40.42[${PYTHON_USEDEP}]
	~dev-python/botocore-1.40.42[${PYTHON_USEDEP}]
	...
	~dev-python/pymdown-extensions-10.16.1[${PYTHON_USEDEP}]
	...
	~dev-python/pyyaml-env-tag-1.1[${PYTHON_USEDEP}]
