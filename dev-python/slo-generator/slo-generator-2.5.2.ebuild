...
IUSE="api bigquery cloud_monitoring cloud_service_monitoring cloud_storage cloudevent datadog dev dynatrace elasticsearch opensearch prometheus pubsub splunk"
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	cloud_monitoring? ( dev-python/google-api-python-client[${PYTHON_USEDEP}] )
	cloud_monitoring? ( dev-python/google-cloud-monitoring[${PYTHON_USEDEP}] )
	cloud_service_monitoring? ( dev-python/google-api-python-client[${PYTHON_USEDEP}] )
	cloud_service_monitoring? ( dev-python/google-cloud-monitoring[${PYTHON_USEDEP}] )
	cloud_storage? ( dev-python/google-api-python-client[${PYTHON_USEDEP}] )
