...
DEPENDENCIES="<dev-python/starlette-0.49.0[${PYTHON_USEDEP}]
	<dev-python/pydantic-3.0.0[${PYTHON_USEDEP}]
	>=dev-python/typing-extensions-4.8.0[${PYTHON_USEDEP}]
	standard? ( dev-python/fastapi-cli[${PYTHON_USEDEP}] )
	standard? ( <dev-python/httpx-1.0.0[${PYTHON_USEDEP}] )
	...
	standard-no-fastapi-cloud-cli? ( <dev-python/httpx-1.0.0[${PYTHON_USEDEP}] )
