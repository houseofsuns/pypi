...
DEPENDENCIES=">=dev-python/requests-toolbelt-0.10.1[${PYTHON_USEDEP}]
	...
	python-version-2-7-? ( dev-python/futures[${PYTHON_USEDEP}] )
	python-version-2-7-? ( dev-python/configparser[${PYTHON_USEDEP}] )
	python-version-2-7-? ( >=dev-python/certifi-2022.12.7[${PYTHON_USEDEP}] )
