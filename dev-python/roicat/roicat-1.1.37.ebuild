...
DEPENDENCIES="all? ( dev-python/hdbscan[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/scikit-learn-1.4.2[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/selenium-4.19.0[${PYTHON_USEDEP}] )
	...
	all-latest? ( dev-python/opencv-contrib-python[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/matplotlib-3.8.4[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/pillow-10.3.0[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/pytest-8.1.1[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/scikit-learn-1.4.2[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/scipy-1.13.0[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/matplotlib-3.8.4[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/pillow-10.3.0[${PYTHON_USEDEP}] )
	core? ( ~dev-python/pytest-8.1.1[${PYTHON_USEDEP}] )
	core? ( ~dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	core? ( ~dev-python/scikit-learn-1.4.2[${PYTHON_USEDEP}] )
	core? ( ~dev-python/scipy-1.13.0[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/matplotlib-3.8.4[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/pillow-10.3.0[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/pytest-8.1.1[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/scikit-learn-1.4.2[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/scipy-1.13.0[${PYTHON_USEDEP}] )
