...
DESCRIPTION="Provider package apache-airflow-providers-microsoft-mssql for Apache Airflow [prod-max (True, <g_sorcery.g_collections.Version object at 0x7f4b0070f5a0>)]"
