...
DEPENDENCIES="<dev-python/pyjwt-3.0.0[${PYTHON_USEDEP}]
	...
	django? ( <dev-python/pyotp-3.0[${PYTHON_USEDEP}] )
	...
	django2x? ( <dev-python/pyotp-3.0[${PYTHON_USEDEP}] )
	...
	drf? ( <dev-python/pyotp-3.0[${PYTHON_USEDEP}] )
	...
	fastapi? ( <dev-python/pyotp-3.0[${PYTHON_USEDEP}] )
	...
	flask? ( <dev-python/pyotp-3.0[${PYTHON_USEDEP}] )"
