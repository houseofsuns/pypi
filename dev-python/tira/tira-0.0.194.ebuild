...
DEPENDENCIES="~dev-python/requests-2.0[${PYTHON_USEDEP}]
	...
	ir? ( dev-python/pyterrier-alpha[${PYTHON_USEDEP}] )
	ir? ( dev-python/python-terrier[${PYTHON_USEDEP}] )
	ir? ( dev-python/ir-datasets[${PYTHON_USEDEP}] )
	ir? ( dev-python/trectools[${PYTHON_USEDEP}] )
	all? ( ~dev-python/docker-7.0[${PYTHON_USEDEP}] )
	all? ( ~dev-python/numpy-1.0[${PYTHON_USEDEP}] )
	all? ( dev-python/pyterrier-alpha[${PYTHON_USEDEP}] )
	all? ( dev-python/python-terrier[${PYTHON_USEDEP}] )
	all? ( dev-python/ir-datasets[${PYTHON_USEDEP}] )
	all? ( dev-python/trectools[${PYTHON_USEDEP}] )"
