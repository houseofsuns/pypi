...
DEPENDENCIES=">=dev-python/scipy-1.14.1[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/scikit-image-0.24.0[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/lazy-loader-0.4[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/itk-io[${PYTHON_USEDEP}] )
	docs? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	docs? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/shapely-2.0.6[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/scikit-image-0.24.0[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/lazy-loader-0.4[${PYTHON_USEDEP}] )
	...
	optional? ( dev-python/itk-io[${PYTHON_USEDEP}] )
	optional? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	optional? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/shapely-2.0.6[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/scikit-image-0.24.0[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/lazy-loader-0.4[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/shapely-2.0.6[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/scikit-image-0.24.0[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/lazy-loader-0.4[${PYTHON_USEDEP}] )
	...
	all-strict? ( dev-python/itk-io[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	...
	docs-strict? ( dev-python/itk-io[${PYTHON_USEDEP}] )
	docs-strict? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	docs-strict? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/lazy-loader-0.4[${PYTHON_USEDEP}] )
	...
	optional-strict? ( dev-python/itk-io[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/itk-filtering[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/shapely-2.0.6[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/scikit-image-0.24.0[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/lazy-loader-0.4[${PYTHON_USEDEP}] )
