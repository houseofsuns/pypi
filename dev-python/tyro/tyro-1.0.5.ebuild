...
DEPENDENCIES="dev-python/docstring_parser[${PYTHON_USEDEP}]
	...
	dev? ( >=dev-python/shtab-1.5.6[${PYTHON_USEDEP}] )
	dev? ( dev-python/universal-pathlib[${PYTHON_USEDEP}] )
	...
	dev-nn? ( >=dev-python/shtab-1.5.6[${PYTHON_USEDEP}] )
	dev-nn? ( dev-python/torch[${PYTHON_USEDEP}] )
	dev-nn? ( dev-python/universal-pathlib[${PYTHON_USEDEP}] )"
