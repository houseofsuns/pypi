...
DEPENDENCIES="dev-python/acryl-datahub[${PYTHON_USEDEP}]
	...
	integration-tests? ( >=dev-python/flake8-3.8.3[${PYTHON_USEDEP}] )
	...
	integration-tests? ( dev-python/acryl-datahub[${PYTHON_USEDEP}] )
	integration-tests? ( dev-python/acryl-datahub[${PYTHON_USEDEP}] )
	integration-tests? ( >=dev-python/isort-5.7.0[${PYTHON_USEDEP}] )
