...
IUSE="all can dk6 examples jlink lauterbach oscca pemicro pkcs11 pqc rblhost"
DEPENDENCIES="<dev-python/asn1crypto-2.0[${PYTHON_USEDEP}]
	...
	>dev-python/ruamel-yaml-clib-0.2.13[${PYTHON_USEDEP}]
	...
	pkcs11? ( dev-python/spsdk-pkcs11[${PYTHON_USEDEP}] )
	pqc? ( dev-python/spsdk-pqc[${PYTHON_USEDEP}] )
	rblhost? ( dev-python/pymboot-rs[${PYTHON_USEDEP}] )"
