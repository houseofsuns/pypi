...
IUSE="all api athena avro bigquery csv databricks dbml dbt dev excel iceberg kafka oracle parquet postgres protobuf rdf s3 snowflake sqlserver trino"
DEPENDENCIES="<dev-python/typer-0.20[${PYTHON_USEDEP}]
	...
	<dev-python/sqlglot-29.0.0[${PYTHON_USEDEP}]
	...
	oracle? ( dev-python/soda-core-oracle[${PYTHON_USEDEP}] )
	...
	api? ( ~dev-python/uvicorn-0.38.0[${PYTHON_USEDEP}] )
