...
IUSE="accelerate all audio benchmark chat-template codecarbon deepspeed deepspeed-testing dev dev-tensorflow dev-torch flax flax-speech ftfy hf-xet hub-kernels integrations ja mistral-common modelcreation natten num2words onnx onnxruntime open-telemetry optuna quality ray retrieval ruff sagemaker sentencepiece serving sigopt sklearn speech testing tf tf-cpu tf-speech tiktoken timm tokenizers torch torch-speech torch-vision torchhub video vision"
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	dev-tensorflow? ( >=dev-python/parameterized-0.9[${PYTHON_USEDEP}] )
	...
	dev-tensorflow? ( >=dev-python/pydantic-2.0[${PYTHON_USEDEP}] )
	...
	dev-tensorflow? ( dev-python/mistral-common[${PYTHON_USEDEP}] )
	...
	dev-tensorflow? ( <dev-python/pandas-2.3.0[${PYTHON_USEDEP}] )
