...
DEPENDENCIES="dev-python/setuptools[${PYTHON_USEDEP}]
	...
	all? ( dev-python/dominate[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/elasticsearch[${PYTHON_USEDEP}] )
	...
	es? ( dev-python/elasticsearch[${PYTHON_USEDEP}] )
	es8? ( dev-python/elasticsearch[${PYTHON_USEDEP}] )
	excel? ( dev-python/xlwt[${PYTHON_USEDEP}] )
	excel? ( dev-python/XlsxWriter[${PYTHON_USEDEP}] )
	from? ( dev-python/pytablereader[${PYTHON_USEDEP}] )
	html? ( dev-python/dominate[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/dominate[${PYTHON_USEDEP}] )
