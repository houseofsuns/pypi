...
DEPENDENCIES="dev-python/bec-ipython-client[${PYTHON_USEDEP}]
	...
	pyqt5? ( >=dev-python/PyQtWebEngine-5.9[${PYTHON_USEDEP}] )
	pyqt6? ( >=dev-python/PyQt6-WebEngine-6.7[${PYTHON_USEDEP}] )
	pyqt6? ( >=dev-python/PyQt6-6.7[${PYTHON_USEDEP}] )
	pyside6? ( >=dev-python/pyside6-6.7[${PYTHON_USEDEP}] )"
