...
IUSE="archive bayes fp healpix kafka light-curve plot"
DEPENDENCIES="dev-python/ampel-alerts[${PYTHON_USEDEP}]
	dev-python/ampel-catalogmatch[${PYTHON_USEDEP}]
	...
	archive? ( dev-python/ampel-ztf-archive[${PYTHON_USEDEP}] )
	...
	bayes? ( <dev-python/pandas-3.0.0[${PYTHON_USEDEP}] )
	fp? ( <dev-python/pandas-3.0.0[${PYTHON_USEDEP}] )
