...
DEPENDENCIES="dev-python/acme[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/amqp[${PYTHON_USEDEP}] )
	dev? ( dev-python/aniso8601[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/aws-sam-translator[${PYTHON_USEDEP}] )
	dev? ( dev-python/aws-xray-sdk[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/cfn-lint[${PYTHON_USEDEP}] )
	dev? ( dev-python/charset-normalizer[${PYTHON_USEDEP}] )
	dev? ( dev-python/click[${PYTHON_USEDEP}] )
	dev? ( dev-python/click-didyoumean[${PYTHON_USEDEP}] )
	dev? ( dev-python/click-plugins[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/configobj[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/flask-migrate[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/josepy[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/jsonschema-path[${PYTHON_USEDEP}] )
	dev? ( dev-python/jsonschema-specifications[${PYTHON_USEDEP}] )
	dev? ( dev-python/junit-xml[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/openapi-schema-validator[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/parsedatetime[${PYTHON_USEDEP}] )
	dev? ( dev-python/pathable[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/pydantic-core[${PYTHON_USEDEP}] )
	dev? ( dev-python/pyflakes[${PYTHON_USEDEP}] )
	dev? ( dev-python/pygments[${PYTHON_USEDEP}] )
	dev? ( dev-python/pyhcl[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/pyrfc3339[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/python-json-logger[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/referencing[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/rfc3339-validator[${PYTHON_USEDEP}] )
	dev? ( dev-python/rfc3986[${PYTHON_USEDEP}] )
	dev? ( dev-python/rich[${PYTHON_USEDEP}] )
	dev? ( dev-python/rpds-py[${PYTHON_USEDEP}] )
	dev? ( dev-python/rsa[${PYTHON_USEDEP}] )
	dev? ( dev-python/s3transfer[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/sshpubkeys[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/vine[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/annotated-types[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/deprecated[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/jsonschema-path[${PYTHON_USEDEP}] )
	docs? ( dev-python/jsonschema-specifications[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/ordered-set[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/pydantic-core[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/pyspnego[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/rpds-py[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/deprecated[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/inflection[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/jsonschema-path[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/ordered-set[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/pyasn1-modules[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/requests-ntlm[${PYTHON_USEDEP}] )
	tests? ( dev-python/responses[${PYTHON_USEDEP}] )
	tests? ( dev-python/retrying[${PYTHON_USEDEP}] )
