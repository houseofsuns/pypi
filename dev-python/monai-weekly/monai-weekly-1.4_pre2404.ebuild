...
IUSE="all clearml cucim einops fire gdown h5py huggingface_hub ignite imagecodecs itk jsonschema lmdb lpips matplotlib mlflow nibabel ninja nni onnx openslide optuna pandas pillow psutil pydicom pynrrd pynvml pyyaml scipy skimage tensorboard tensorboardx tifffile torchvision tqdm transformers zarr"
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	huggingface_hub? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
