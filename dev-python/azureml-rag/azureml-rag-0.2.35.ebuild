...
IUSE="azure azure-cosmos-mongo-vcore azure-cosmos-nosql azureml-core cognitive-search data-generation document-parsing elasticsearch faiss hugging-face langchain local-tests milvus pinecone qdrant remote-tests validate-deployments weaviate"
