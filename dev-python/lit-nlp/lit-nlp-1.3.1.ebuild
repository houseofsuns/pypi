...
IUSE="examples-common examples-discriminative-ai examples-generative-ai test umap"
DEPENDENCIES=">=dev-python/absl-py-1.4.0[${PYTHON_USEDEP}]
	...
	>=dev-python/levenshtein-0.21.1[${PYTHON_USEDEP}]
	...
	examples-common? ( dev-python/gunicorn[${PYTHON_USEDEP}] )
	examples-common? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	examples-common? ( dev-python/transformers[${PYTHON_USEDEP}] )
	examples-discriminative-ai? ( dev-python/lit-nlp[${PYTHON_USEDEP}] )
	examples-discriminative-ai? ( dev-python/tensorflow-datasets[${PYTHON_USEDEP}] )
	examples-discriminative-ai? ( dev-python/tf-keras[${PYTHON_USEDEP}] )
	examples-generative-ai? ( dev-python/lit-nlp[${PYTHON_USEDEP}] )
	examples-generative-ai? ( dev-python/google-cloud-aiplatform[${PYTHON_USEDEP}] )
	examples-generative-ai? ( dev-python/keras[${PYTHON_USEDEP}] )
	examples-generative-ai? ( dev-python/keras-nlp[${PYTHON_USEDEP}] )
	examples-generative-ai? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	examples-generative-ai? ( dev-python/tensorflow-text[${PYTHON_USEDEP}] )
	examples-generative-ai? ( dev-python/torch[${PYTHON_USEDEP}] )
	examples-generative-ai? ( dev-python/vertexai[${PYTHON_USEDEP}] )
	umap? ( dev-python/umap-learn[${PYTHON_USEDEP}] )
	test? ( dev-python/lit-nlp[${PYTHON_USEDEP}] )
	test? ( dev-python/lit-nlp[${PYTHON_USEDEP}] )
	test? ( dev-python/lit-nlp[${PYTHON_USEDEP}] )
	test? ( dev-python/lime[${PYTHON_USEDEP}] )
	test? ( <dev-python/pytest-8.0.0[${PYTHON_USEDEP}] )
	test? ( >=dev-python/webtest-2.0[${PYTHON_USEDEP}] )"
