...
IUSE="aiobotocore airbyte alibaba amazon apache-atlas apache-beam apache-cassandra apache-drill apache-druid apache-flink apache-hdfs apache-hive apache-iceberg apache-impala apache-kafka apache-kylin apache-livy apache-pig apache-pinot apache-spark apache-webhdfs apprise arangodb asana async atlassian-jira celery cgroups cloudant cloudpickle cncf-kubernetes cohere common-compat common-io common-messaging common-sql databricks datadog dbt-cloud dingding discord docker edge elasticsearch exasol fab facebook ftp github github-enterprise google google-auth graphviz grpc hashicorp http imap influxdb jdbc jenkins kerberos ldap leveldb microsoft-azure microsoft-mssql microsoft-psrp microsoft-winrm mongo mysql neo4j odbc openai openfaas openlineage opensearch opsgenie oracle otel pagerduty pandas papermill password pgvector pinecone postgres presto qdrant rabbitmq redis s3fs salesforce samba segment sendgrid sentry sftp singularity slack smtp snowflake sqlite ssh standard statsd tableau telegram teradata trino uv vertica weaviate yandex ydb zendesk"
DEPENDENCIES=">=dev-python/a2wsgi-1.10.8[${PYTHON_USEDEP}]
	...
	dev-python/cadwyn[${PYTHON_USEDEP}]
	...
	uv? ( >=dev-python/uv-0.5.14[${PYTHON_USEDEP}] )
