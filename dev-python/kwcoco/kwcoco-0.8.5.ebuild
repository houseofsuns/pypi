...
DEPENDENCIES="dev-python/delayed-image[${PYTHON_USEDEP}]
	...
	all-strict? ( ~dev-python/pandas-1.4.2[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/pandas-1.4.2[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/sqlalchemy-1.4.26[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/jq-1.2.2[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/scipy-1.8.0[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/numpy-1.21.6[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/pandas-1.4.2[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/scikit-learn-1.1.0[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/psutil-5.9.1[${PYTHON_USEDEP}] )
	...
	docs-strict? ( dev-python/rich-argparse[${PYTHON_USEDEP}] )
	docs? ( dev-python/opencv-python-headless[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/matplotlib-3.8.2[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/sqlalchemy-1.4.26[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/jq-1.2.2[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/scipy-1.8.0[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/numpy-1.21.6[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/pandas-1.4.2[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/scikit-learn-1.1.0[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/psutil-5.9.1[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/pandas-1.4.2[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/pandas-1.4.2[${PYTHON_USEDEP}] )
