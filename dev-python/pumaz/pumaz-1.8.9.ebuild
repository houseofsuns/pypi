...
DESCRIPTION="PUMA (PET Universal Multi-tracer Aligner) aligns multi-tracer PET/CT studies using advanced diffeomorphic imaging."
...
DEPENDENCIES="dev-python/nibabel[${PYTHON_USEDEP}]
	...
	dev-python/nifti2dicom[${PYTHON_USEDEP}]
	dev-python/requests[${PYTHON_USEDEP}]
	dev-python/moosez[${PYTHON_USEDEP}]
	dev-python/emoji[${PYTHON_USEDEP}]
	dev-python/click[${PYTHON_USEDEP}]
	dev-python/rich-click[${PYTHON_USEDEP}]
	dev-python/cfonts[${PYTHON_USEDEP}]
