...
DEPENDENCIES="dev-python/chevron[${PYTHON_USEDEP}]
	...
	~dev-python/aws-sam-translator-1.98.0[${PYTHON_USEDEP}]
	...
	~dev-python/cfn-lint-1.35.4[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-setuptools-80.9.0.20250529[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/types-docutils-0.21.0.20250526[${PYTHON_USEDEP}] )
