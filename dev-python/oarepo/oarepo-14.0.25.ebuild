...
DEPENDENCIES="dev-python/aiobotocore[${PYTHON_USEDEP}]
	...
	~dev-python/alembic-1.18.0[${PYTHON_USEDEP}]
	...
	~dev-python/fsspec-2026.1.0[${PYTHON_USEDEP}]
	...
	~dev-python/ipython-9.9.0[${PYTHON_USEDEP}]
	...
	~dev-python/xmlschema-4.3.0[${PYTHON_USEDEP}]
