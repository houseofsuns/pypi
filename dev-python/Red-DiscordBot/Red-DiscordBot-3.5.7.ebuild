...
DEPENDENCIES="~dev-python/aiohttp-3.9.3[${PYTHON_USEDEP}]
	...
	~dev-python/apsw-3.45.2.0[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/certifi-2024.2.2[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/importlib-metadata-7.1.0[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/urllib3-2.2.1[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/zipp-3.18.1[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/astroid-3.1.0[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/tomlkit-0.12.4[${PYTHON_USEDEP}] )
