...
DEPENDENCIES="dev-python/chevron[${PYTHON_USEDEP}]
	...
	~dev-python/cfn-lint-0.85.2[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-setuptools-69.1.0.20240229[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/types-docutils-0.20.0.20240227[${PYTHON_USEDEP}] )
