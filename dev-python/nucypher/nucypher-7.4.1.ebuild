...
DEPENDENCIES="~dev-python/async-timeout-4.0.3[${PYTHON_USEDEP}]
	...
	~dev-python/rpds-py-0.19.1[${PYTHON_USEDEP}]
	...
	~dev-python/time-machine-2.14.2[${PYTHON_USEDEP}]
	...
	dev-python/abnf[${PYTHON_USEDEP}]
	~dev-python/aiohappyeyeballs-2.3.2[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/autobahn-23.6.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/humanize-4.10.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/marshmallow-3.21.3[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pytest-twisted-1.14.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/sqlalchemy-2.0.31[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/stack-data-0.6.3[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/tabulate-0.9.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/time-machine-2.14.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/zope-interface-6.4_p2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/aiohappyeyeballs-2.3.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/annotated-types-0.7.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pydantic-core-2.20.1[${PYTHON_USEDEP}] )
