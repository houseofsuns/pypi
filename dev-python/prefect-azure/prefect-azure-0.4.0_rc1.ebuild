...
IUSE="all-extras blob-storage cosmos-db dev ml-datastore"
DEPENDENCIES="dev-python/aiohttp[${PYTHON_USEDEP}]
	...
	all-extras? ( dev-python/azure-cosmos[${PYTHON_USEDEP}] )
	all-extras? ( dev-python/azure-storage-blob[${PYTHON_USEDEP}] )
	all-extras? ( dev-python/azureml-core[${PYTHON_USEDEP}] )
	blob-storage? ( dev-python/azure-storage-blob[${PYTHON_USEDEP}] )
	cosmos-db? ( dev-python/azure-cosmos[${PYTHON_USEDEP}] )
	...
	ml-datastore? ( dev-python/azureml-core[${PYTHON_USEDEP}] )"
