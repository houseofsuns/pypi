...
IUSE="examples-common examples-descai examples-genai test"
DEPENDENCIES=">=dev-python/absl-py-1.4.0[${PYTHON_USEDEP}]
	...
	examples-descai? ( dev-python/lit-nlp[${PYTHON_USEDEP}] )
	examples-descai? ( dev-python/tensorflow-datasets[${PYTHON_USEDEP}] )
	examples-descai? ( dev-python/tf-keras[${PYTHON_USEDEP}] )
	examples-genai? ( dev-python/lit-nlp[${PYTHON_USEDEP}] )
	examples-genai? ( dev-python/google-cloud-aiplatform[${PYTHON_USEDEP}] )
	examples-genai? ( dev-python/keras[${PYTHON_USEDEP}] )
	examples-genai? ( dev-python/keras-nlp[${PYTHON_USEDEP}] )
	examples-genai? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	examples-genai? ( dev-python/tensorflow-text[${PYTHON_USEDEP}] )
	examples-genai? ( dev-python/torch[${PYTHON_USEDEP}] )
	examples-genai? ( dev-python/vertexai[${PYTHON_USEDEP}] )
