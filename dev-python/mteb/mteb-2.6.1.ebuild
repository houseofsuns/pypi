...
IUSE="ark blip2 bm25s codecarbon cohere colpali-engine colqwen3 eager-embed faiss-cpu flagembedding flash-attention gritlm image jina jina-v4 leaderboard llama-embed-nemotron llm2vec model2vec nomic open-clip-torch openai peft pylate timm vertexai voyage-v voyageai xet xformers youtu"
DEPENDENCIES="dev-python/polars[${PYTHON_USEDEP}]
	...
	colqwen3? ( dev-python/transformers[${PYTHON_USEDEP}] )
	colqwen3? ( dev-python/torchvision[${PYTHON_USEDEP}] )
	...
	eager-embed? ( dev-python/qwen-vl-utils[${PYTHON_USEDEP}] )"
