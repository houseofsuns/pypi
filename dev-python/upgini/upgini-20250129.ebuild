...
DESCRIPTION="Intelligent data search & enrichment for Machine Learning [badver 1.2.34a3657.dev4]"
...
IUSE=""
DEPENDENCIES=">=dev-python/ipywidgets-8.1.0[${PYTHON_USEDEP}]
