...
IUSE="all-codecs all-viewers blosc boss compresso crackle dask em-codecs fp-codecs fpzip jpeg jpegxl mesh-viewer png seg-codecs skeleton-viewer test zarr zfpc"
