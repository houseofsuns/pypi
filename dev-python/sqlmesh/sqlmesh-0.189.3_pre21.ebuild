...
IUSE="athena azuresql bigframes bigquery clickhouse databricks dbt dev dlt gcppostgres github llm lsp mssql mwaa mysql postgres redshift risingwave slack snowflake trino web"
DEPENDENCIES="dev-python/astor[${PYTHON_USEDEP}]
	...
	~dev-python/sqlglot-26.25.3[${PYTHON_USEDEP}]
