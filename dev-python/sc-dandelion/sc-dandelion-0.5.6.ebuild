...
IUSE="docs palantir scirpy scrubet"
DEPENDENCIES="dev-python/airr[${PYTHON_USEDEP}]
	<dev-python/setuptools-scm-9.2.1[${PYTHON_USEDEP}]
	...
	<dev-python/h5py-3.14.1[${PYTHON_USEDEP}]
	...
	scirpy? ( <dev-python/awkward-2.8.9[${PYTHON_USEDEP}] )
