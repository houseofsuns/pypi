...
IUSE="all dev doc gpu lint test"
DEPENDENCIES="dev-python/h5py[${PYTHON_USEDEP}]
	...
	all? ( dev-python/xpart[${PYTHON_USEDEP}] )
	all? ( dev-python/xtrack[${PYTHON_USEDEP}] )
	all? ( dev-python/cupy-cuda12x[${PYTHON_USEDEP}] )
	all? ( dev-python/MonkeyType[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/xpart[${PYTHON_USEDEP}] )
	test? ( dev-python/xtrack[${PYTHON_USEDEP}] )
