...
IUSE="anthropic docs duckdb elasticsearch eval google-genai legacy-partitioners local-inference neo4j opensearch pinecone qdrant weaviate"
DEPENDENCIES="<dev-python/aiohttp-4.0.0[${PYTHON_USEDEP}]
	...
	dev-python/aryn-sdk[${PYTHON_USEDEP}]
	...
	legacy-partitioners? ( dev-python/nltk[${PYTHON_USEDEP}] )
