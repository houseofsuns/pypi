...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.16.0rc0.dev122519"
DIGEST_SOURCES="yes"
...
DESCRIPTION="Megatron Core - a library for efficient and scalable training of transformer based models [badver 0.16.0rc0.dev122519]"
