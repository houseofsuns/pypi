...
IUSE="all audio benchmark dev doc embedding image intel llama-cpp mlx rerank sglang transformers video virtualenv vllm"
DEPENDENCIES="dev-python/xoscar[${PYTHON_USEDEP}]
	...
	all? ( dev-python/gptqmodel[${PYTHON_USEDEP}] )
	...
	transformers? ( dev-python/gptqmodel[${PYTHON_USEDEP}] )
