...
IUSE="coveralls mock pre-commit pytest pytest-cov pytest-freezegun pytest-httpserver pytest-mock pytest-xdist ruff"
DEPENDENCIES="dev-python/alembic[${PYTHON_USEDEP}]
	...
	pytest-httpserver? ( dev-python/pytest-httpserver[${PYTHON_USEDEP}] )"
