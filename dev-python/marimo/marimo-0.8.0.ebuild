...
DEPENDENCIES="<dev-python/click-9.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-psutil-5.9.5.20240423[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pytest-asyncio-0.23.4[${PYTHON_USEDEP}] )
	...
	testcore? ( ~dev-python/httpx-0.26.0[${PYTHON_USEDEP}] )
	testcore? ( ~dev-python/pytest-7.4.0[${PYTHON_USEDEP}] )
	testcore? ( dev-python/pytest-codecov[${PYTHON_USEDEP}] )
	testcore? ( ~dev-python/pytest-asyncio-0.23.4[${PYTHON_USEDEP}] )
	testoptional? ( dev-python/altair[${PYTHON_USEDEP}] )
	testoptional? ( >=dev-python/pandas-1.3.0[${PYTHON_USEDEP}] )
	...
	testoptional? ( ~dev-python/pillow-10.2.0[${PYTHON_USEDEP}] )
	...
	testoptional? ( >=dev-python/nbformat-5.0.0[${PYTHON_USEDEP}] )"
