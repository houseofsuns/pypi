...
DEPENDENCIES="all? ( dev-python/hdbscan[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/pillow-10.4.0[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/psutil-6.0.0[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/pillow-10.4.0[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/psutil-6.0.0[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/pillow-10.4.0[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/psutil-6.0.0[${PYTHON_USEDEP}] )
