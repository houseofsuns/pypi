...
IUSE="bedrock chromadb connectors excel flask ggplot google-ai google-sheets ibm-watsonx-ai lancedb langchain milvus modin numpy pinecone plotly polars qdrant scikit-learn seaborn sentencec-transformers statsmodels streamlit text-generation yfinance"
DEPENDENCIES="<dev-python/python-dotenv-2.0.0[${PYTHON_USEDEP}]
	...
	sentencec-transformers? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
	<dev-python/sqlglot-26.0.0[${PYTHON_USEDEP}]
	milvus? ( dev-python/pymilvus[${PYTHON_USEDEP}] )
	milvus? ( dev-python/milvus-model[${PYTHON_USEDEP}] )
