...
IUSE="aws aws-request-auth keyring pykeepass redshift s3 sqlalchemy toml"
DEPENDENCIES=">=dev-python/pydantic-2.0[${PYTHON_USEDEP}]
	...
	redshift? ( >=dev-python/boto3-1.33[${PYTHON_USEDEP}] )
	s3? ( >=dev-python/boto3-1.33[${PYTHON_USEDEP}] )
	aws? ( >=dev-python/boto3-1.33[${PYTHON_USEDEP}] )
