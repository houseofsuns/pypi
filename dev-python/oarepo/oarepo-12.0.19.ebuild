...
DEPENDENCIES="~dev-python/alembic-1.10.4[${PYTHON_USEDEP}]
	...
	~dev-python/Faker-25.2.0[${PYTHON_USEDEP}]
	...
	~dev-python/jupyter-client-8.6.1[${PYTHON_USEDEP}]
	...
	s3? ( ~dev-python/boto3-1.34.108[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/botocore-1.34.108[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/coverage-7.5.1[${PYTHON_USEDEP}] )
