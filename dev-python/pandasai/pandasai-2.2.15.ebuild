...
IUSE="bedrock chromadb connectors excel flask ggplot google-ai google-sheets ibm-watsonx-ai lancedb langchain modin numpy pinecone plotly polars qdrant scikit-learn seaborn sentencec-transformers statsmodels streamlit text-generation yfinance"
