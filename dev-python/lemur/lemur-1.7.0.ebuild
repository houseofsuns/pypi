...
DEPENDENCIES="dev-python/acme[${PYTHON_USEDEP}]
	...
	~dev-python/botocore-1.34.19[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/boto3-1.34.19[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/botocore-1.34.19[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/kombu-5.3.3[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/moto-4.2.10[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pyopenssl-23.3.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/s3transfer-0.10.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/sarif-om-1.0.4[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/secretstorage-3.3.3[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/sentry-sdk-1.37.1[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/boto3-1.34.19[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/botocore-1.34.19[${PYTHON_USEDEP}] )
	docs? ( dev-python/celery[${PYTHON_USEDEP}] )
	docs? ( dev-python/certbot[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/certifi-2023.11.17[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/kombu-5.3.3[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/moto-4.2.10[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/mpmath-1.3.0[${PYTHON_USEDEP}] )
	docs? ( dev-python/multipart[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/mypy-1.8.0[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/pyopenssl-23.3.0[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/pytest-7.4.4[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/s3transfer-0.10.0[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/sarif-om-1.0.4[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/sentry-sdk-1.37.1[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/bandit-1.7.6[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/boto3-1.34.19[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/botocore-1.34.19[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/kombu-5.3.3[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/moto-4.2.10[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/pyopenssl-23.3.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/s3transfer-0.10.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/sarif-om-1.0.4[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/sentry-sdk-1.37.1[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/zipp-3.17.0[${PYTHON_USEDEP}] )"
