...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/d5/ab/e507101dcfd4f8a0c3b49a03338938b8bcea85022e54864be9e54ea603ad/scriptcollection-${REALVERSION}-py3-none-any.whl"
...
DEPENDENCIES=">=dev-python/build-1.2.2_p1[${PYTHON_USEDEP}]
	>=dev-python/coverage-7.7.1[${PYTHON_USEDEP}]
	...
	>=dev-python/xmlschema-3.4.5[${PYTHON_USEDEP}]
