...
DEPENDENCIES="dev-python/Flask-WTF[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/freezegun-1.5.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/hypothesis-6.135.14[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/moto-5.1.6[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/testfixtures-8.3.0[${PYTHON_USEDEP}] )
