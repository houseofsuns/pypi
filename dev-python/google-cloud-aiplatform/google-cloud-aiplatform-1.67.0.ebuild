...
DEPENDENCIES="<dev-python/google-api-core-3.0.0_pre0[${PYTHON_USEDEP}]
	...
	evaluation? ( <dev-python/pandas-2.2.0[${PYTHON_USEDEP}] )
	...
	langchain? ( <=dev-python/orjson-3.10.6[${PYTHON_USEDEP}] )
	langchain-testing? ( dev-python/langchain-core[${PYTHON_USEDEP}] )
	langchain-testing? ( <=dev-python/orjson-3.10.6[${PYTHON_USEDEP}] )
