...
IUSE="all datasets docs models style tests"
DEPENDENCIES="dev-python/einops[${PYTHON_USEDEP}]
	...
	datasets? ( >=dev-python/requests-2.23.0[${PYTHON_USEDEP}] )
	datasets? ( dev-python/rioxarray[${PYTHON_USEDEP}] )
	...
	datasets? ( >=dev-python/xarray-0.17[${PYTHON_USEDEP}] )
