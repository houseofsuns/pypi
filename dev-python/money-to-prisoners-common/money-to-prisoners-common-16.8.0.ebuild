...
IUSE="testing"
DEPENDENCIES="testing? ( ~dev-python/twine-5.0[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/watchdog-4.0[${PYTHON_USEDEP}] )
	...
	~dev-python/selenium-4.17[${PYTHON_USEDEP}]
	...
	~dev-python/sentry-sdk-1.40[${PYTHON_USEDEP}]
