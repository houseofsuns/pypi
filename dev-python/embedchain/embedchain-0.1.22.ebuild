...
IUSE="cohere community dataloaders discord elasticsearch git gmail huggingface-hub images json llama2 milvus mysql opensearch opensource pinecone poe postgres qdrant slack vertexai weaviate whatsapp youtube"
