...
DEPENDENCIES="dev-python/chevron[${PYTHON_USEDEP}]
	...
	~dev-python/cfn-lint-1.19.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-psutil-6.1.0.20241102[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/types-setuptools-75.3.0.20241107[${PYTHON_USEDEP}] )
