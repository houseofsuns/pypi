...
DEPENDENCIES="~dev-python/alembic-1.10.4[${PYTHON_USEDEP}]
	...
	~dev-python/Faker-24.9.0[${PYTHON_USEDEP}]
	...
	~dev-python/validators-0.28.0[${PYTHON_USEDEP}]
	...
	s3? ( ~dev-python/boto3-1.34.84[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/botocore-1.34.84[${PYTHON_USEDEP}] )
