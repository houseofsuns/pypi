...
DESCRIPTION="Google Cloud Apigee Registry API client library [top-max 0.8.0]"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-apigee-registry"
LICENSE="Apache-2.0"
