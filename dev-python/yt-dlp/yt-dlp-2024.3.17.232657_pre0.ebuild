...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="2024.3.17.232657.dev0"
DIGEST_SOURCES="yes"
...
IUSE="build curl-cffi dev py2exe pyinstaller pyinstaller-macos secretstorage"
DEPENDENCIES="dev-python/Brotli[${PYTHON_USEDEP}]
	...
	pyinstaller-macos? ( dev-python/pyinstaller[${PYTHON_USEDEP}] )
