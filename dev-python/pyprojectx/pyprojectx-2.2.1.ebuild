...
DEPENDENCIES="~dev-python/userpath-1.9.1[${PYTHON_USEDEP}]
	...
	locked? ( ~dev-python/filelock-3.15.1[${PYTHON_USEDEP}] )
	locked? ( ~dev-python/platformdirs-3.11.0[${PYTHON_USEDEP}] )
	locked? ( ~dev-python/tomlkit-0.12.5[${PYTHON_USEDEP}] )
	locked? ( ~dev-python/userpath-1.9.1[${PYTHON_USEDEP}] )
	locked? ( ~dev-python/virtualenv-20.24.6[${PYTHON_USEDEP}] )"
