...
DEPENDENCIES="dev-python/chevron[${PYTHON_USEDEP}]
	...
	~dev-python/boto3-1.42.26[${PYTHON_USEDEP}]
	...
	~dev-python/aws-sam-translator-1.106.0[${PYTHON_USEDEP}]
	...
	~dev-python/cfn-lint-1.43.1[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-docutils-0.22.3.20251115[${PYTHON_USEDEP}] )
