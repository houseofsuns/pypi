...
DESCRIPTION="Google Cloud Policy Troubleshooter API client library"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-policy-troubleshooter"
LICENSE="Apache-2.0"
