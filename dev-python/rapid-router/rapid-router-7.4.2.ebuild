...
DEPENDENCIES="~dev-python/asgiref-3.8.1[${PYTHON_USEDEP}]
	...
	~dev-python/django-otp-1.5.4[${PYTHON_USEDEP}]
	...
	~dev-python/ipython-9.0.2[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/django-4.2.20[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/django-otp-1.5.4[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/djangorestframework-3.15.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/numpy-2.2.3[${PYTHON_USEDEP}] )
