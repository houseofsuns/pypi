...
IUSE="all audio clustering detection dev image multimodal text typing video visual"
DEPENDENCIES=">dev-python/numpy-1.20.0[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/mypy-1.17.1[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/einops[${PYTHON_USEDEP}] )
	all? ( dev-python/vmaf-torch[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/requests-2.19.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/torch-linear-assignment[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/transformers[${PYTHON_USEDEP}] )
	dev? ( <dev-python/tqdm-4.68.0[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/einops[${PYTHON_USEDEP}] )
	dev? ( dev-python/vmaf-torch[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/matplotlib-3.6.0[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/properscoring[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/permetrics[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/aeon[${PYTHON_USEDEP}] )"
