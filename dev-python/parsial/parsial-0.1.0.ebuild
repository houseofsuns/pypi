...
DESCRIPTION="Python library that transforms any string parser into a parser that skips portions of the input that contain syntax errors."
...
DEPENDENCIES="coveralls? ( dev-python/coveralls[${PYTHON_USEDEP}] )
	...
	lint? ( ~dev-python/pylint-2.17[${PYTHON_USEDEP}] )
