...
IUSE="airflow alldb aws bigquery cli db docs gcs google-api-client gsheets itest mysql pandas parquet postgres-base postgres-binary postgres-source pytest redshift-base redshift-binary redshift-source smart-open typecheck unittest vertica"
DEPENDENCIES="dev-python/timeout-decorator[${PYTHON_USEDEP}]
	...
	alldb? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	aws? ( dev-python/awscli[${PYTHON_USEDEP}] )
	aws? ( dev-python/boto3[${PYTHON_USEDEP}] )
	aws? ( dev-python/s3-concat[${PYTHON_USEDEP}] )
	aws? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	...
	gsheets? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	...
	itest? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	mysql? ( dev-python/pymysql[${PYTHON_USEDEP}] )
	mysql? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	pandas? ( <dev-python/pandas-2.0[${PYTHON_USEDEP}] )
	parquet? ( dev-python/pyarrow[${PYTHON_USEDEP}] )
	postgres-base? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	postgres-binary? ( dev-python/psycopg2-binary[${PYTHON_USEDEP}] )
	postgres-binary? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	postgres-source? ( dev-python/psycopg2[${PYTHON_USEDEP}] )
	postgres-source? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	pytest? ( <dev-python/pytest-8.2[${PYTHON_USEDEP}] )
	pytest? ( dev-python/pytest-cov[${PYTHON_USEDEP}] )
	redshift-base? ( dev-python/sqlalchemy-redshift[${PYTHON_USEDEP}] )
	redshift-base? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	redshift-binary? ( dev-python/psycopg2-binary[${PYTHON_USEDEP}] )
	redshift-binary? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	redshift-source? ( dev-python/psycopg2[${PYTHON_USEDEP}] )
	redshift-source? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	smart-open? ( dev-python/smart-open[${PYTHON_USEDEP}] )
	...
	unittest? ( dev-python/records-mover[${PYTHON_USEDEP}] )
	vertica? ( dev-python/sqlalchemy-vertica-python[${PYTHON_USEDEP}] )
	vertica? ( dev-python/records-mover[${PYTHON_USEDEP}] )"
