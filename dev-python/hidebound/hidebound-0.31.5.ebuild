...
DEPENDENCIES="dev-python/boto3[${PYTHON_USEDEP}]
	...
	dev-python/dask_gateway[${PYTHON_USEDEP}]
	dev-python/flasgger[${PYTHON_USEDEP}]
	dev-python/flask-healthz[${PYTHON_USEDEP}]
	>=dev-python/flask-2.1.2[${PYTHON_USEDEP}]
	dev-python/flask_healthz[${PYTHON_USEDEP}]
	dev-python/flask_monitoringdashboard[${PYTHON_USEDEP}]
	dev-python/girder-client[${PYTHON_USEDEP}]
	dev-python/jinja2[${PYTHON_USEDEP}]
	dev-python/json_logging[${PYTHON_USEDEP}]
