...
DEPENDENCIES="<dev-python/jinja-4.0[${PYTHON_USEDEP}]
	...
	dev? ( <dev-python/uvicorn-0.26.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/itsdangerous-2.2.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/pillow-9.6.0[${PYTHON_USEDEP}] )
	test? ( dev-python/psycopg2-binary[${PYTHON_USEDEP}] )
	test? ( <dev-python/pydantic-2.6.0[${PYTHON_USEDEP}] )
