...
DESCRIPTION="Data science toolkit support for OmniSciDB [newver 0.28.2]"
...
DEPENDENCIES="~dev-python/pyarrow-0.15.0[${PYTHON_USEDEP}]
	...
	dev-python/rbc-project[${PYTHON_USEDEP}]
