...
IUSE="all azure clarifai cli cohere docarray embeddings extended-testing javascript llms openai qdrant text-helpers"
DEPENDENCIES="all? ( dev-python/O365[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/azure-ai-textanalytics[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/dgml-utils[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/hologres-vector[${PYTHON_USEDEP}] )
