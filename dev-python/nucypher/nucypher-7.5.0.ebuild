...
DEPENDENCIES="dev-python/abnf[${PYTHON_USEDEP}]
	...
	~dev-python/automat-24.8.1[${PYTHON_USEDEP}]
	~dev-python/bitarray-3.2.0[${PYTHON_USEDEP}]
	...
	~dev-python/protobuf-6.30.1[${PYTHON_USEDEP}]
	...
	~dev-python/setuptools-78.0.1[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/aiohttp-3.11.14[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/aiosignal-1.3.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/automat-24.8.1[${PYTHON_USEDEP}] )
	dev? ( dev-python/base58[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/bitarray-3.2.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/mako-1.3.9[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/prometheus-client-0.21.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pyasn1-modules-0.4.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pydantic-core-2.27.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pyopenssl-25.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/rpds-py-0.23.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/setuptools-78.0.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/sqlalchemy-2.0.39[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/yarl-1.18.3[${PYTHON_USEDEP}] )
