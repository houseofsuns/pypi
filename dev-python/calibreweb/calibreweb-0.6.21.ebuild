...
DEPENDENCIES="dev-python/Werkzeug[${PYTHON_USEDEP}]
	...
	comics? ( <dev-python/natsort-8.4.0[${PYTHON_USEDEP}] )
	comics? ( dev-python/comicapi[${PYTHON_USEDEP}] )
	gdrive? ( <dev-python/google-api-python-client-2.98.0[${PYTHON_USEDEP}] )
	gdrive? ( dev-python/gevent[${PYTHON_USEDEP}] )
	gdrive? ( <dev-python/greenlet-2.1.0[${PYTHON_USEDEP}] )
	...
	metadata? ( >=dev-python/rarfile-3.2[${PYTHON_USEDEP}] )
	metadata? ( dev-python/scholarly[${PYTHON_USEDEP}] )
	metadata? ( <dev-python/markdown2-2.5.0[${PYTHON_USEDEP}] )
	metadata? ( <dev-python/html2text-2022.1.1[${PYTHON_USEDEP}] )
	metadata? ( <dev-python/python-dateutil-2.9.0[${PYTHON_USEDEP}] )
