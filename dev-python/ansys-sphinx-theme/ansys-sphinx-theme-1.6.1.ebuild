...
DEPENDENCIES=">=dev-python/importlib-metadata-4.0[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/pandas-2.3.2[${PYTHON_USEDEP}] )
	doc? ( >=dev-python/pillow-9.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/plotly-6.3.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/pygithub-2.7.0[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/tox-4.28.4[${PYTHON_USEDEP}] )
