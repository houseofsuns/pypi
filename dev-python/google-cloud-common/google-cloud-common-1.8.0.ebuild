...
DESCRIPTION="Google Cloud Common API client library [wheel]"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-common"
LICENSE="Apache-2.0"
