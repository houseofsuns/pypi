...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/44/47/03db5736a8da492f259f1e54db0792f40d48f2735c26cf8aba0535a0d409/${REALNAME//-/_}-${REALVERSION}-py3-none-any.whl"
...
IUSE="clip easy-ocr gaze grounding-dino hosted http sam sam3 transformers yolo-world"
DEPENDENCIES="dev-python/aiortc[${PYTHON_USEDEP}]
	...
	dev-python/inference-models[${PYTHON_USEDEP}]
	...
	gaze? ( dev-python/rf-mediapipe[${PYTHON_USEDEP}] )
	...
	sam? ( dev-python/rf-sam_2[${PYTHON_USEDEP}] )
	sam? ( dev-python/rasterio[${PYTHON_USEDEP}] )
	sam? ( dev-python/pycocotools[${PYTHON_USEDEP}] )
	...
	sam3? ( dev-python/sam3[${PYTHON_USEDEP}] )
