...
IUSE="aic anthropic assemblyai asyncai aws aws-nova-sonic azure cartesia daily deepgram elevenlabs fal fish gladia google gradium groq gstreamer heygen hume koala krisp langchain livekit lmnt local local-smart-turn local-smart-turn-v3 mcp mem0 mlx-whisper moondream neuphonic noisereduce nvidia openai openpipe playht rime riva runner sagemaker sarvam sentry silero simli soniox soundfile speechmatics strands tracing ultravox webrtc websocket websockets-base whisper"
DEPENDENCIES="<dev-python/aiofiles-25.0[${PYTHON_USEDEP}]
	...
	deepgram? ( dev-python/pipecat-ai[${PYTHON_USEDEP}] )
	...
	gradium? ( dev-python/pipecat-ai[${PYTHON_USEDEP}] )
	...
	livekit? ( >=dev-python/pyjwt-2.10.1[${PYTHON_USEDEP}] )
	...
	nvidia? ( dev-python/nvidia-riva-client[${PYTHON_USEDEP}] )
	...
	riva? ( dev-python/pipecat-ai[${PYTHON_USEDEP}] )
	...
	sagemaker? ( dev-python/aws-sdk-sagemaker-runtime-http2[${PYTHON_USEDEP}] )
	sarvam? ( dev-python/sarvamai[${PYTHON_USEDEP}] )
	...
	soundfile? ( ~dev-python/soundfile-0.13.1[${PYTHON_USEDEP}] )
	...
	ultravox? ( dev-python/pipecat-ai[${PYTHON_USEDEP}] )
