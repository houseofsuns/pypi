...
IUSE="audio aws elasticsearch epsilla full hnswlib image jac jax mesh milvus mongo pandas proto qdrant redis torch video weaviate web"
DEPENDENCIES=">=dev-python/pydantic-1.10.8[${PYTHON_USEDEP}]
	...
	mongo? ( >=dev-python/pymongo-4.6.2[${PYTHON_USEDEP}] )"
