...
HOMEPAGE="https://github.com/localcosmos/app-kit"
...
IUSE=""
DEPENDENCIES="dev-python/localcosmos-server[${PYTHON_USEDEP}]
	dev-python/localcosmos-cordova-builder[${PYTHON_USEDEP}]
