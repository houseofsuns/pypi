...
DESCRIPTION="OTPme: A flexible One-Time-Password system [wheel]"
...
DEPENDENCIES="dev-python/service-identity[${PYTHON_USEDEP}]
	...
	dev-python/tlssysloghandler[${PYTHON_USEDEP}]
	dev-python/relppy[${PYTHON_USEDEP}]
