...
IUSE="abf alphaomega audio aws axona behavior biocam blackrock brukertiff caiman cellexplorer cnmfe compressors dandi deeplabcut docs ecephys ecephys-minimal edf excel extract fiber-photometry full hdf5 hdf5imaging icephys image intan kilosort lightningpose maxwell mcsraw mearec medpc micromanagertiff miniscope neuralynx neuroscope openephys ophys ophys-minimal phy plexon plexon2 sbx scanbox scanimage scanimage-legacy sima sleap sorting-analyzer spike2 spikegadgets spikeglx suite2p tdt tdt-fp test text thor tiff video whitematter"
