...
DEPENDENCIES="~dev-python/aiodns-3.0.0[${PYTHON_USEDEP}]
	...
	jupyter? ( dev-python/jinja2-iso8601[${PYTHON_USEDEP}] )
	jupyter? ( ~dev-python/jinja2-time-0.2.0[${PYTHON_USEDEP}] )
	jupyter? ( dev-python/jinja2-humanize-extension[${PYTHON_USEDEP}] )
