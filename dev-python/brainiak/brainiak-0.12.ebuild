...
IUSE="all dev examples matnormal"
DEPENDENCIES=">=dev-python/numpy-1.23.5[${PYTHON_USEDEP}]
	...
	matnormal? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	matnormal? ( dev-python/tensorflow-probability[${PYTHON_USEDEP}] )
	examples? ( dev-python/nilearn[${PYTHON_USEDEP}] )
	examples? ( dev-python/nxviz[${PYTHON_USEDEP}] )
	examples? ( dev-python/timecorr[${PYTHON_USEDEP}] )
	examples? ( dev-python/seaborn[${PYTHON_USEDEP}] )
	examples? ( dev-python/holoviews[${PYTHON_USEDEP}] )
	examples? ( dev-python/pyopenssl[${PYTHON_USEDEP}] )
	examples? ( dev-python/awscli[${PYTHON_USEDEP}] )
	examples? ( dev-python/bcrypt[${PYTHON_USEDEP}] )
	examples? ( dev-python/indexed-gzip[${PYTHON_USEDEP}] )
	examples? ( dev-python/inflect[${PYTHON_USEDEP}] )
	examples? ( dev-python/ipython[${PYTHON_USEDEP}] )
	examples? ( dev-python/jupyter[${PYTHON_USEDEP}] )
	examples? ( dev-python/mypy[${PYTHON_USEDEP}] )
	examples? ( dev-python/nibabel[${PYTHON_USEDEP}] )
	examples? ( dev-python/nilearn[${PYTHON_USEDEP}] )
	examples? ( dev-python/nodejs[${PYTHON_USEDEP}] )
	...
	examples? ( dev-python/rpyc[${PYTHON_USEDEP}] )
	examples? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
	examples? ( >=dev-python/scipy-1.6.0[${PYTHON_USEDEP}] )
	examples? ( dev-python/toml[${PYTHON_USEDEP}] )
	examples? ( dev-python/tornado[${PYTHON_USEDEP}] )
	examples? ( dev-python/websocket-client[${PYTHON_USEDEP}] )
	examples? ( dev-python/wsaccel[${PYTHON_USEDEP}] )
	examples? ( dev-python/inotify[${PYTHON_USEDEP}] )
	examples? ( dev-python/pybids[${PYTHON_USEDEP}] )
	examples? ( dev-python/watchdog[${PYTHON_USEDEP}] )
	all? ( dev-python/brainiak[${PYTHON_USEDEP}] )"
