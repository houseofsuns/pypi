...
IUSE="azure azure-cosmos-mongo-vcore azureml-core cognitive-search data-generation document-parsing elasticsearch faiss hugging-face langchain local-tests milvus pinecone remote-tests validate-deployments"
