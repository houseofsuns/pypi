...
LICENSE="MIT"
SRC_URI="https://files.pythonhosted.org/packages/cp311/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-cp311-cp311-macosx_10_13_universal2.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-cp311-cp311-macosx_10_13_universal2.whl"
RESTRICT="test"
