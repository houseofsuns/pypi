...
IUSE="bedrock chromadb connectors excel ggplot google-ai google-sheets langchain modin numpy plotly polars scikit-learn seaborn statsmodels streamlit text-generation yfinance"
