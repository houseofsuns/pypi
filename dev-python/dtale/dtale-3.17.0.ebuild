...
IUSE="arctic arcticdb dash-bio ngrok r redis streamlit swifter tests"
DEPENDENCIES="dev-python/dash-daq[${PYTHON_USEDEP}]
	...
	ngrok? ( dev-python/flask-ngrok[${PYTHON_USEDEP}] )
