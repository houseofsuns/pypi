...
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	build-docs? ( dev-python/pydata-sphinx-theme[${PYTHON_USEDEP}] )
	build-docs? ( dev-python/jupytext[${PYTHON_USEDEP}] )
	build-docs? ( dev-python/myst-nb[${PYTHON_USEDEP}] )
	build-docs? ( dev-python/myst-parser[${PYTHON_USEDEP}] )
