...
IUSE="celery channels health procrastinate psycopg psycopg2 storages wagtail"
DEPENDENCIES="dev-python/setuptools[${PYTHON_USEDEP}]
	wagtail? ( <dev-python/boto3-1.43[${PYTHON_USEDEP}] )
	storages? ( <dev-python/boto3-1.43[${PYTHON_USEDEP}] )
