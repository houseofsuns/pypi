...
IUSE="all apigateway apigatewayv2 appsync awslambda batch cloudformation cognitoidp dynamodb dynamodbstreams events glue iotdata proxy resourcegroupstaggingapi s3 s3crc32c server ssm stepfunctions xray"
DEPENDENCIES="all? ( >=dev-python/docker-3.0.0[${PYTHON_USEDEP}] )
