...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="1.32.0.post0.dev11"
DIGEST_SOURCES="yes"
...
DESCRIPTION="FlowETL is a collection of special purposes Airflow operators and sensors for use with FlowKit. [badver 1.32.0.post0.dev11, wheel]"
