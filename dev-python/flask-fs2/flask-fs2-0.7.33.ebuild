...
DEPENDENCIES=">=dev-python/flask-2.0.0[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/sphinx-9.1.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/alabaster-1.0.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/pillow-12.1.0[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/pillow-12.1.0[${PYTHON_USEDEP}] )
	...
	qa? ( ~dev-python/pytest-9.0.2[${PYTHON_USEDEP}] )
	qa? ( dev-python/pytest-faker[${PYTHON_USEDEP}] )
	qa? ( ~dev-python/pytest-sugar-1.1.1[${PYTHON_USEDEP}] )
	qa? ( ~dev-python/pytest-mock-3.15.1[${PYTHON_USEDEP}] )
	qa? ( ~dev-python/pillow-12.1.0[${PYTHON_USEDEP}] )
	...
	ci? ( ~dev-python/pytest-9.0.2[${PYTHON_USEDEP}] )
