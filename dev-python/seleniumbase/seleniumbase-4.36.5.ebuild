...
DEPENDENCIES=">=dev-python/pip-25.0.1[${PYTHON_USEDEP}]
	...
	~dev-python/selenium-4.30.0[${PYTHON_USEDEP}]
	...
	coverage? ( >=dev-python/pytest-cov-6.1.0[${PYTHON_USEDEP}] )
	...
	pdfminer? ( ~dev-python/cryptography-44.0.2[${PYTHON_USEDEP}] )
	pdfminer? ( ~dev-python/cffi-1.17.1[${PYTHON_USEDEP}] )
	pdfminer? ( ~dev-python/pycparser-2.22[${PYTHON_USEDEP}] )
	pillow? ( >=dev-python/pillow-11.2.0[${PYTHON_USEDEP}] )
