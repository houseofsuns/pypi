...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.14.0.dev20210103233300"
DIGEST_SOURCES="yes"
...
DESCRIPTION="owmeta-core is a platform for sharing relational data over the internet. [newver 0.14.0.dev20230602050557]"
