...
IUSE="dbt-bigquery dbt-databricks dbt-postgres dbt-redshift dbt-snowflake dev-packages sql-client-packages"
DEPENDENCIES="dev-python/click[${PYTHON_USEDEP}]
	...
	dev-packages? ( dev-python/types-jsonschema[${PYTHON_USEDEP}] )
	...
	sql-client-packages? ( dev-python/duckdb-engine[${PYTHON_USEDEP}] )
	sql-client-packages? ( dev-python/duckdb[${PYTHON_USEDEP}] )
