...
IUSE="all generative human-evaluation jax olmo openai quantization"
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	olmo? ( dev-python/rouge-score[${PYTHON_USEDEP}] )
	...
	olmo? ( dev-python/bert-score[${PYTHON_USEDEP}] )
	...
	olmo? ( dev-python/demjson3[${PYTHON_USEDEP}] )
	...
	olmo? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	...
	olmo? ( <dev-python/boto3-2.0.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/boto3-2.0.0[${PYTHON_USEDEP}] )
	olmo? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
