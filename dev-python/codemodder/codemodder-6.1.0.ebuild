...
DEPENDENCIES="<dev-python/boltons-25.1[${PYTHON_USEDEP}]
	...
	dev-python/sarif-pydantic[${PYTHON_USEDEP}]
	~dev-python/setuptools-80.0[${PYTHON_USEDEP}]
	semgrep? ( dev-python/semgrep[${PYTHON_USEDEP}] )
	test? ( dev-python/azure-ai-inference[${PYTHON_USEDEP}] )
	test? ( <dev-python/coverage-7.9[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/unidiff-0.7.5[${PYTHON_USEDEP}] )
	test? ( dev-python/semgrep[${PYTHON_USEDEP}] )
