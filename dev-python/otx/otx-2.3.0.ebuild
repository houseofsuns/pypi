...
IUSE="base ci-benchmark ci-publish ci-tox dev docs mmlab transformers"
DEPENDENCIES="dev-python/datumaro[${PYTHON_USEDEP}]
	...
	transformers? ( dev-python/diffusers[${PYTHON_USEDEP}] )
	transformers? ( dev-python/torchmetrics[${PYTHON_USEDEP}] )
	...
	ci-tox? ( ~dev-python/tox-4.23.2[${PYTHON_USEDEP}] )
	ci-publish? ( ~dev-python/build-1.2.2_p1[${PYTHON_USEDEP}] )
	ci-benchmark? ( <dev-python/pandas-2.3[${PYTHON_USEDEP}] )
	ci-benchmark? ( ~dev-python/matplotlib-3.10.0[${PYTHON_USEDEP}] )
	ci-benchmark? ( ~dev-python/nbconvert-7.16.5[${PYTHON_USEDEP}] )
	ci-benchmark? ( ~dev-python/ipython-8.31.0[${PYTHON_USEDEP}] )
