...
DEPENDENCIES="dev-python/albumentations[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/triton[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/triton[${PYTHON_USEDEP}] )
	...
	quality? ( dev-python/boto3[${PYTHON_USEDEP}] )
	...
	quality? ( dev-python/librosa[${PYTHON_USEDEP}] )
	...
	quality? ( dev-python/psycopg2[${PYTHON_USEDEP}] )
	...
	quality? ( dev-python/sacrebleu[${PYTHON_USEDEP}] )
	...
	quality? ( dev-python/PyJWT[${PYTHON_USEDEP}] )
	quality? ( dev-python/cryptography[${PYTHON_USEDEP}] )
	quality? ( dev-python/diffusers[${PYTHON_USEDEP}] )
	quality? ( dev-python/accelerate[${PYTHON_USEDEP}] )
	quality? ( dev-python/triton[${PYTHON_USEDEP}] )
	quality? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	quality? ( dev-python/python-slugify[${PYTHON_USEDEP}] )
