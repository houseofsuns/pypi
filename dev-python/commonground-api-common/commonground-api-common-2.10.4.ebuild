...
IUSE="coverage djangorestframework-gis docs drf-extra-fields markdown-docs oas release setup-configuration tests testutils"
DEPENDENCIES=">=dev-python/django-4.2.0[${PYTHON_USEDEP}]
	...
	oas? ( dev-python/requests-mock[${PYTHON_USEDEP}] )
