...
DESCRIPTION="A modern, enterprise-ready MLOps Python SDK [wheel]"
...
IUSE="+bin-wheel connector_azure connector_bigquery connector_duckdb connector_mysql connector_postgres connector_redshift connector_saphana connector_snowflake connectors drift fe filemanager fs ml pipeline testing"
DEPENDENCIES="~dev-python/boto3-1.19.12[${PYTHON_USEDEP}]
	...
	connector_azure? ( <dev-python/pandas-1.5.0[${PYTHON_USEDEP}] )
	connector_bigquery? ( dev-python/db-dtypes[${PYTHON_USEDEP}] )
	connector_bigquery? ( dev-python/google-cloud-bigquery[${PYTHON_USEDEP}] )
	connector_duckdb? ( dev-python/duckdb[${PYTHON_USEDEP}] )
	connector_mysql? ( dev-python/mysql-connector-python[${PYTHON_USEDEP}] )
	connector_mysql? ( <dev-python/pandas-1.5.0[${PYTHON_USEDEP}] )
	connector_postgres? ( <dev-python/pandas-1.5.0[${PYTHON_USEDEP}] )
	connector_postgres? ( dev-python/psycopg2-binary[${PYTHON_USEDEP}] )
	connector_redshift? ( dev-python/redshift-connector[${PYTHON_USEDEP}] )
	connector_saphana? ( dev-python/hana-ml[${PYTHON_USEDEP}] )
	connector_snowflake? ( <dev-python/pandas-1.5.0[${PYTHON_USEDEP}] )
	connector_snowflake? ( dev-python/snowflake-connector-python[${PYTHON_USEDEP}] )
	connectors? ( dev-python/azure[${PYTHON_USEDEP}] )
	connectors? ( dev-python/db-dtypes[${PYTHON_USEDEP}] )
	connectors? ( dev-python/duckdb[${PYTHON_USEDEP}] )
	connectors? ( dev-python/hana-ml[${PYTHON_USEDEP}] )
	connectors? ( dev-python/google-cloud-bigquery[${PYTHON_USEDEP}] )
	connectors? ( dev-python/mysql-connector-python[${PYTHON_USEDEP}] )
	connectors? ( <dev-python/pandas-1.5.0[${PYTHON_USEDEP}] )
	connectors? ( dev-python/psycopg2-binary[${PYTHON_USEDEP}] )
	connectors? ( dev-python/redshift-connector[${PYTHON_USEDEP}] )
