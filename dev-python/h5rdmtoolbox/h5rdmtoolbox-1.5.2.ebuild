...
DEPENDENCIES=">=dev-python/appdirs-1.4.4[${PYTHON_USEDEP}]
	...
	complete? ( <dev-python/pymongo-4.9.0[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/sphinx-4.5.0[${PYTHON_USEDEP}] )
	...
	database? ( <dev-python/pymongo-4.9.0[${PYTHON_USEDEP}] )
	...
	docs? ( <dev-python/pymongo-4.9.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/pymongo-4.9.0[${PYTHON_USEDEP}] )"
