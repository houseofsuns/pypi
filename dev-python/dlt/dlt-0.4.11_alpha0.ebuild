...
IUSE="athena az bigquery cli clickhouse databricks dbt dremio duckdb filesystem gcp gs motherduck mssql parquet postgres qdrant redshift s3 snowflake synapse weaviate"
DEPENDENCIES=">=dev-python/requests-2.26.0[${PYTHON_USEDEP}]
	...
	dbt? ( dev-python/dbt-databricks[${PYTHON_USEDEP}] )
