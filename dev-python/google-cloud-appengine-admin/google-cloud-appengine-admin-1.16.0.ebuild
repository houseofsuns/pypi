...
DESCRIPTION="Google Cloud Appengine Admin API client library [wheel]"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-appengine-admin"
LICENSE="Apache-2.0"
