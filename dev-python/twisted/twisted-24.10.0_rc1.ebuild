...
IUSE="all-non-platform conch dev dev-release gtk-platform http2 macos-platform mypy osx-platform serial test tls windows-platform"
DEPENDENCIES=">=dev-python/attrs-22.2.0[${PYTHON_USEDEP}]
	...
	mypy? ( dev-python/python-subunit[${PYTHON_USEDEP}] )
