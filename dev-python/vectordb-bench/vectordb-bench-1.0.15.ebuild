...
IUSE="alisql aliyun-opensearch all chromadb clickhouse cockroachdb doris elastic lancedb mariadb memorydb mongodb oceanbase opensearch pgvecto-rs pgvector pinecone qdrant redis test tidb vespa weaviate"
