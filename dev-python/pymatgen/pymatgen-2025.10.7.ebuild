...
IUSE="abinit ase electronic-structure matcalc mlp numba numpy-v1 optional prototypes symmetry tblite vis zeopp"
DEPENDENCIES=">=dev-python/bibtexparser-1.4.0[${PYTHON_USEDEP}]
	...
	optional? ( dev-python/pymatgen-analysis-alloys[${PYTHON_USEDEP}] )
