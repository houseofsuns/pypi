...
IUSE="aflw2k3d beir ble_wind_field c4 cats_vs_dogs colorectal_histology common_voice dev duke_ultrasound eurosat groove gtzan imagenet2012_corrupted librispeech lsun matplotlib nsynth ogbg_molpcba pet_finder robonet robosuite_panda_pick_place_can smartwatch_gestures svhn tensorflow tensorflow-data-validation tests-all the300w_lp wider_face wiki_dialog wikipedia wsc273 youtube_vis"
DEPENDENCIES="dev-python/absl-py[${PYTHON_USEDEP}]
	...
	tests-all? ( dev-python/pyarrow[${PYTHON_USEDEP}] )
	tests-all? ( dev-python/google-cloud-bigquery[${PYTHON_USEDEP}] )
	tests-all? ( dev-python/pydantic[${PYTHON_USEDEP}] )
	tests-all? ( dev-python/fsspec[${PYTHON_USEDEP}] )
	...
	youtube_vis? ( dev-python/pycocotools[${PYTHON_USEDEP}] )"
