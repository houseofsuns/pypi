...
DEPENDENCIES="docs? ( ~dev-python/sphinx-autoapi-2.1.1[${PYTHON_USEDEP}] )
	...
	ray? ( dev-python/orquestra-workflow-runtime[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/orquestra-workflow-runtime[${PYTHON_USEDEP}] )
	dashboard? ( dev-python/orquestra-workflow-runtime[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/orquestra-workflow-runtime[${PYTHON_USEDEP}] )
