...
DEPENDENCIES="<=dev-python/pandas-1.3.5[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/protobuf-3.19.5[${PYTHON_USEDEP}] )
	all? ( dev-python/ray[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/bigdl-orca-spark3[${PYTHON_USEDEP}] )
	...
	distributed? ( dev-python/bigdl-orca-spark3[${PYTHON_USEDEP}] )
	distributed? ( ~dev-python/grpcio-1.53.0[${PYTHON_USEDEP}] )
	distributed? ( dev-python/pyarrow[${PYTHON_USEDEP}] )
	distributed? ( dev-python/ray[${PYTHON_USEDEP}] )
	distributed? ( ~dev-python/aiohttp-3.8.1[${PYTHON_USEDEP}] )
