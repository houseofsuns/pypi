...
DEPENDENCIES="dev-python/aiobotocore[${PYTHON_USEDEP}]
	...
	test? ( ~dev-python/time-machine-2.18.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/time-machine-2.18.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/time-machine-2.18.0[${PYTHON_USEDEP}] )
	...
	devs? ( ~dev-python/time-machine-2.18.0[${PYTHON_USEDEP}] )
