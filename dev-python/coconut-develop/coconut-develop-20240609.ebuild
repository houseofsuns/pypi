...
DESCRIPTION="Simple, elegant, Pythonic functional programming. [badver 3.1.1.post0.dev1]"
...
DEPENDENCIES="xonsh? ( dev-python/xonsh[${PYTHON_USEDEP}] )
