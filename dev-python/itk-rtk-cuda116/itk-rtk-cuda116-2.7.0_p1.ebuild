...
DESCRIPTION="The Reconstruction Toolkit (RTK) for fast circular cone-beam CT reconstruction [wheel]"
...
IUSE=""
DEPENDENCIES="dev-python/itk-cudacommon-cuda116[${PYTHON_USEDEP}]
