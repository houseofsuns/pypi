...
DESCRIPTION="Logging, data connectors, monitoring, secret handling and general lifehacks to make data people lives easier. [badver 3.3.22a532.dev8]"
...
DEPENDENCIES="<dev-python/requests-3.0[${PYTHON_USEDEP}]
	...
	excel? ( dev-python/fastexcel[${PYTHON_USEDEP}] )
