...
IUSE="debug dev docs mkdocs trio yaml"
DEPENDENCIES=">=dev-python/attrs-23.1.0[${PYTHON_USEDEP}]
	...
	mkdocs? ( >=dev-python/markdown-3.3[${PYTHON_USEDEP}] )
	mkdocs? ( >=dev-python/mkdocs-1.4.0[${PYTHON_USEDEP}] )
	mkdocs? ( >=dev-python/pymdown-extensions-10.0[${PYTHON_USEDEP}] )
