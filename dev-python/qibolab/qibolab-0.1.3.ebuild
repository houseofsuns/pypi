...
DEPENDENCIES="zh? ( dev-python/laboneq[${PYTHON_USEDEP}] )
	...
	rfsoc? ( dev-python/qcodes[${PYTHON_USEDEP}] )
	qblox? ( dev-python/qcodes_contrib_drivers[${PYTHON_USEDEP}] )
	rfsoc? ( dev-python/qcodes_contrib_drivers[${PYTHON_USEDEP}] )
	...
	qm? ( dev-python/setuptools[${PYTHON_USEDEP}] )"
