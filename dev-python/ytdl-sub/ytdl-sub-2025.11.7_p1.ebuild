...
DEPENDENCIES="dev-python/yt-dlp[${PYTHON_USEDEP}]
	...
	~dev-python/mediafile-0.12[${PYTHON_USEDEP}]
	~dev-python/pyyaml-6.0[${PYTHON_USEDEP}]
	test? ( <dev-python/coverage-8.0[${PYTHON_USEDEP}] )
	test? ( <dev-python/pytest-9.0[${PYTHON_USEDEP}] )
	test? ( <dev-python/pytest-rerunfailures-17.0[${PYTHON_USEDEP}] )
	lint? ( ~dev-python/black-24.10.0[${PYTHON_USEDEP}] )
	lint? ( ~dev-python/isort-7.0.0[${PYTHON_USEDEP}] )
	lint? ( ~dev-python/pylint-4.0.1[${PYTHON_USEDEP}] )
