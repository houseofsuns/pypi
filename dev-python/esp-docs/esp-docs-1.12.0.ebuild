...
DEPENDENCIES="<dev-python/docutils-0.18[${PYTHON_USEDEP}]
	...
	<dev-python/sphinxcontrib-applehelp-1.0.5[${PYTHON_USEDEP}]
	<dev-python/sphinxcontrib-devhelp-1.0.3[${PYTHON_USEDEP}]
	<dev-python/sphinxcontrib-htmlhelp-2.0.2[${PYTHON_USEDEP}]
	<dev-python/sphinxcontrib-serializinghtml-1.1.6[${PYTHON_USEDEP}]
