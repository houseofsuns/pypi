...
IUSE="all analytics dask dev docs kafka llm-agent ml-dev mlflow mongo mqtt nvidia tensorboard"
DEPENDENCIES="dev-python/Flask-RESTful[${PYTHON_USEDEP}]
	...
	llm-agent? ( dev-python/faiss-cpu[${PYTHON_USEDEP}] )
	llm-agent? ( dev-python/langchain-community[${PYTHON_USEDEP}] )
	llm-agent? ( dev-python/mcp[${PYTHON_USEDEP}] )
	llm-agent? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
	llm-agent? ( dev-python/tiktoken[${PYTHON_USEDEP}] )
