...
DEPENDENCIES="all? ( dev-python/hdbscan[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/scikit-learn-1.5.1[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/pytest-8.3.2[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/scikit-learn-1.5.1[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/scipy-1.13.1[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/seaborn-0.13.2[${PYTHON_USEDEP}] )
	classification? ( dev-python/sparse[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/tqdm-4.66.4[${PYTHON_USEDEP}] )
	...
	classification? ( dev-python/opencv-contrib-python-headless[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/pytest-8.3.2[${PYTHON_USEDEP}] )
	core? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	core? ( ~dev-python/scikit-learn-1.5.1[${PYTHON_USEDEP}] )
	core? ( ~dev-python/scipy-1.13.1[${PYTHON_USEDEP}] )
	core? ( ~dev-python/seaborn-0.13.2[${PYTHON_USEDEP}] )
	core? ( dev-python/sparse[${PYTHON_USEDEP}] )
	core? ( ~dev-python/tqdm-4.66.4[${PYTHON_USEDEP}] )
	...
	core? ( dev-python/opencv-contrib-python-headless[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/pytest-8.3.2[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/scikit-learn-1.5.1[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/scipy-1.13.1[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/seaborn-0.13.2[${PYTHON_USEDEP}] )
	tracking? ( dev-python/sparse[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/tqdm-4.66.4[${PYTHON_USEDEP}] )
