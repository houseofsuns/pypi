...
IUSE="complete dev hapi solar test"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	solar? ( dev-python/astropy[${PYTHON_USEDEP}] )
	hapi? ( dev-python/hitran-api[${PYTHON_USEDEP}] )
	...
	complete? ( dev-python/sasktran2[${PYTHON_USEDEP}] )"
