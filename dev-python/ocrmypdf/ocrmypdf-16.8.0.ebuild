...
IUSE="docs extended-test test watcher webservice"
DEPENDENCIES=">=dev-python/deprecation-2.1.0[${PYTHON_USEDEP}]
	...
	extended-test? ( dev-python/PyMuPDF[${PYTHON_USEDEP}] )
	...
	watcher? ( dev-python/typer-slim[${PYTHON_USEDEP}] )
	watcher? ( >=dev-python/watchdog-1.0.2[${PYTHON_USEDEP}] )
	webservice? ( dev-python/port-for[${PYTHON_USEDEP}] )
