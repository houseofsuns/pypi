...
DESCRIPTION="Google Cloud Network Security API client library"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-network-security"
LICENSE="Apache-2.0"
