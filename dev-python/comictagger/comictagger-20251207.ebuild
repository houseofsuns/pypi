...
DESCRIPTION="A cross-platform GUI/CLI app for writing metadata to comic archives [badver 1.6.0b11.dev0]"
...
DEPENDENCIES="~dev-python/appdirs-1.4.4[${PYTHON_USEDEP}]
	...
	pyinstaller? ( dev-python/pyqt6[${PYTHON_USEDEP}] )
	...
	qtw? ( dev-python/pyqt6[${PYTHON_USEDEP}] )
	qtw? ( dev-python/pyqt6-webengine[${PYTHON_USEDEP}] )"
