...
DEPENDENCIES="dev-python/Flask-WTF[${PYTHON_USEDEP}]
	...
	<dev-python/python-json-logger-5.0.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/freezegun-1.5.5[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/hypothesis-6.142.1[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/moto-5.1.15[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pytest-datadir-1.8.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/requests-mock-1.12.1[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/testfixtures-9.2.0[${PYTHON_USEDEP}] )
