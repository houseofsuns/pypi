...
DESCRIPTION="A python package for interacting with Inscopix data. [wheel]"

HOMEPAGE="https://github.com/inscopix/pyisx"
LICENSE=""
...
IUSE="build deploy docs test"
DEPENDENCIES=">=dev-python/h5py-2.8.0[${PYTHON_USEDEP}]
	>=dev-python/numpy-1.14[${PYTHON_USEDEP}]
	>=dev-python/scipy-1.0[${PYTHON_USEDEP}]
	>=dev-python/tifffile-0.15.1[${PYTHON_USEDEP}]
