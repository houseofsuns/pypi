...
IUSE="all gui invoice serial wallet"
DEPENDENCIES="dev-python/base58[${PYTHON_USEDEP}]
	...
	invoice? ( dev-python/pycryptodome[${PYTHON_USEDEP}] )
	invoice? ( dev-python/requests[${PYTHON_USEDEP}] )
	invoice? ( dev-python/dkimpy[${PYTHON_USEDEP}] )
