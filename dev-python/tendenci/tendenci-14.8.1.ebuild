...
DEPENDENCIES="dev-python/future[${PYTHON_USEDEP}]
	...
	>=dev-python/simplejson-3.17.3[${PYTHON_USEDEP}]
	...
	~dev-python/boto3-1.29.3[${PYTHON_USEDEP}]
	...
	~dev-python/xlsxwriter-1.4.4[${PYTHON_USEDEP}]
	...
	>=dev-python/phonenumbers-8.12.51[${PYTHON_USEDEP}]
