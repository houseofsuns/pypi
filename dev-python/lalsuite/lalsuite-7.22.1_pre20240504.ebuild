...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="7.22.1.dev20240504"
DIGEST_SOURCES="yes"
...
LICENSE="GPL-2+"
SRC_URI="https://files.pythonhosted.org/packages/cp311/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-cp311-cp311-manylinux_2_28_aarch64.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-cp311-cp311-manylinux_2_28_aarch64.whl"
RESTRICT="test"
