...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/72/3b/5bf1f552cfc2faf92606599c6d3a26680814aa77d89700b93ee47b375555/pytooling-${REALVERSION}.tar.gz"
...
DEPENDENCIES="doc? ( ~dev-python/sphinx-8.2[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/setuptools-78.1[${PYTHON_USEDEP}] )
	...
	packaging? ( ~dev-python/setuptools-78.1[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/setuptools-78.1[${PYTHON_USEDEP}] )
