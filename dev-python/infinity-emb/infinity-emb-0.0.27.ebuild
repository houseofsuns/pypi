...
IUSE="all cache ct2 fastembed logging onnxruntime-gpu optimum server tensorrt torch"
DEPENDENCIES="ct2? ( dev-python/ctranslate2[${PYTHON_USEDEP}] )
	...
	torch? ( dev-python/hf-transfer[${PYTHON_USEDEP}] )
	...
	server? ( <dev-python/orjson-4.0[${PYTHON_USEDEP}] )
