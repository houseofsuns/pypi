...
IUSE="da doc hgq hgq2 keras-v3 onnx optimization profiling qkeras quartus-report sr testing"
DEPENDENCIES="dev-python/h5py[${PYTHON_USEDEP}]
	dev-python/numpy[${PYTHON_USEDEP}]
	dev-python/pyDigitalWaveTools[${PYTHON_USEDEP}]
	dev-python/pyyaml[${PYTHON_USEDEP}]
	dev-python/quantizers[${PYTHON_USEDEP}]
	da? ( dev-python/da4ml[${PYTHON_USEDEP}] )
	...
	hgq2? ( dev-python/hgq2[${PYTHON_USEDEP}] )
	keras-v3? ( dev-python/keras[${PYTHON_USEDEP}] )
