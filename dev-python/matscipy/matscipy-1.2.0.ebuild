...
IUSE="all cli dislocation docs test"
DEPENDENCIES=">=dev-python/numpy-2.0.0[${PYTHON_USEDEP}]
	...
	test? ( dev-python/matscipy[${PYTHON_USEDEP}] )
	test? ( dev-python/sympy[${PYTHON_USEDEP}] )
	dislocation? ( dev-python/nglview[${PYTHON_USEDEP}] )
	dislocation? ( dev-python/ovito[${PYTHON_USEDEP}] )
	dislocation? ( dev-python/atomman[${PYTHON_USEDEP}] )
	docs? ( dev-python/matscipy[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/matscipy[${PYTHON_USEDEP}] )"
