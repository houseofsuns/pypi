...
IUSE="dev docs harmony llm stretch"
DEPENDENCIES="~dev-python/astor-0.7.1[${PYTHON_USEDEP}]
	...
	dev? ( <dev-python/pygments-3.0.0[${PYTHON_USEDEP}] )
	...
	harmony? ( dev-python/safetensors[${PYTHON_USEDEP}] )
