...
DEPENDENCIES="~dev-python/alembic-1.10.4[${PYTHON_USEDEP}]
	...
	~dev-python/Faker-25.3.0[${PYTHON_USEDEP}]
	...
	~dev-python/prompt-toolkit-3.0.45[${PYTHON_USEDEP}]
	...
	~dev-python/sentry-sdk-1.45.0[${PYTHON_USEDEP}]
	...
	rdm? ( ~dev-python/alabaster-0.7.16[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/bibtexparser-1.4.1[${PYTHON_USEDEP}] )
	rdm? ( dev-python/dateparser[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/docutils-0.19[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/ghp-import-2.1.0[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/imagesize-1.4.1[${PYTHON_USEDEP}] )
	rdm? ( dev-python/invenio-app-rdm[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/markdown-3.6[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/mergedeep-1.3.4[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/mkdocs-1.6.0[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/mkdocs-get-deps-0.2.0[${PYTHON_USEDEP}] )
	rdm? ( dev-python/mkdocs-jupyter[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/mkdocs-material-8.5.11[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/mkdocs-material-extensions-1.3.1[${PYTHON_USEDEP}] )
	...
	rdm? ( ~dev-python/sphinx-autodoc-typehints-1.25.3[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/sphinxcontrib-applehelp-1.0.8[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/sphinxcontrib-devhelp-1.0.6[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/sphinxcontrib-htmlhelp-2.0.5[${PYTHON_USEDEP}] )
	rdm? ( dev-python/sphinxcontrib-issuetracker[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/sphinxcontrib-jsmath-1.0.1[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/sphinxcontrib-qthelp-1.0.7[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/sphinxcontrib-serializinghtml-1.1.10[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/tomli-2.0.1[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/tqdm-4.66.4[${PYTHON_USEDEP}] )
	rdm? ( dev-python/types-beautifulsoup4[${PYTHON_USEDEP}] )
	rdm? ( dev-python/types-bleach[${PYTHON_USEDEP}] )
	rdm? ( dev-python/types-dateparser[${PYTHON_USEDEP}] )
	rdm? ( dev-python/types-html5lib[${PYTHON_USEDEP}] )
	rdm? ( dev-python/types-PyYAML[${PYTHON_USEDEP}] )
	rdm? ( dev-python/types-xmltodict[${PYTHON_USEDEP}] )
	rdm? ( ~dev-python/tzlocal-5.2[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/boto3-1.34.117[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/botocore-1.34.117[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/fsspec-2024.5.0[${PYTHON_USEDEP}] )
	s3? ( dev-python/invenio-s3[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/jmespath-1.0.1[${PYTHON_USEDEP}] )
	s3? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/s3transfer-0.10.1[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/coverage-7.5.3[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/pyproject-hooks-1.1.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/sphinx-7.3.7[${PYTHON_USEDEP}] )
