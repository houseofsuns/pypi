...
IUSE="amd benchmark dev diffusers doc-build exporters exporters-gpu exporters-tf furiosa graphcore habana intel ipex neural-compressor neuron neuronx nncf onnxruntime onnxruntime-gpu onnxruntime-training openvino quality quanto tests"
DEPENDENCIES="dev-python/transformers[${PYTHON_USEDEP}]
	...
	neuron? ( dev-python/transformers[${PYTHON_USEDEP}] )
	neuronx? ( dev-python/optimum-neuron[${PYTHON_USEDEP}] )
	neuronx? ( dev-python/transformers[${PYTHON_USEDEP}] )
