...
DEPENDENCIES=">=dev-python/requests-2.16.0[${PYTHON_USEDEP}]
	...
	tests? ( >=dev-python/requests-2.16.0[${PYTHON_USEDEP}] )
	tests? ( dev-python/packaging[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/cachecontrol-0.14.0[${PYTHON_USEDEP}] )
	...
	build? ( >=dev-python/requests-2.16.0[${PYTHON_USEDEP}] )
	build? ( dev-python/packaging[${PYTHON_USEDEP}] )
	build? ( >=dev-python/cachecontrol-0.14.0[${PYTHON_USEDEP}] )
