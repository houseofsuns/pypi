...
DEPENDENCIES="dev-python/django[${PYTHON_USEDEP}]
	...
	all? ( dev-python/django-stubs[${PYTHON_USEDEP}] )
	all? ( dev-python/djangorestframework-stubs[${PYTHON_USEDEP}] )
	all? ( dev-python/celery-stubs[${PYTHON_USEDEP}] )
	all? ( dev-python/drf-yasg-stubs[${PYTHON_USEDEP}] )
	all? ( dev-python/django-filter-stubs[${PYTHON_USEDEP}] )
	all? ( dev-python/types-PyMySQL[${PYTHON_USEDEP}] )
	all? ( dev-python/types-Markdown[${PYTHON_USEDEP}] )
	all? ( dev-python/types-docutils[${PYTHON_USEDEP}] )
