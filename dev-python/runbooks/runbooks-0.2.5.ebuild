...
DEPENDENCIES=">=dev-python/requests-2.32.3[${PYTHON_USEDEP}]
	...
	dev-python/mkdocstrings[${PYTHON_USEDEP}]
	dev-python/mkdocs-drawio-exporter[${PYTHON_USEDEP}]
	...
	dev-python/mkdocs-techdocs-core[${PYTHON_USEDEP}]
	...
	>=dev-python/botocore-1.35.95[${PYTHON_USEDEP}]
	...
	dev-python/vizro-ai[${PYTHON_USEDEP}]
	dev-python/runbooks[${PYTHON_USEDEP}]"
