...
DESCRIPTION="Provider package apache-airflow-providers-amazon for Apache Airflow [prod-max (True, <g_sorcery.g_collections.Version object at 0x7fac07edd5b0>)]"
