...
DEPENDENCIES=">=dev-python/aiofiles-24.0[${PYTHON_USEDEP}]
	...
	>=dev-python/croniter-5.0[${PYTHON_USEDEP}]
	...
	>=dev-python/lazy-object-proxy-1.0[${PYTHON_USEDEP}]
	...
	~dev-python/sqlglot-25.0[${PYTHON_USEDEP}]
	...
	server? ( dev-python/weasyprint[${PYTHON_USEDEP}] )
