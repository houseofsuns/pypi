...
IUSE="all coco comet_ml databricks deepspeed dev gcs libcloud mlflow mlperf nlp oci onnx pandas peft sentencepiece slack streaming system_metrics_monitor tensorboard wandb"
DEPENDENCIES="<dev-python/pyyaml-7.0[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/ipykernel-6.29.0[${PYTHON_USEDEP}] )
