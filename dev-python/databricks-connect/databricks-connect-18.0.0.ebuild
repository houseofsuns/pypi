...
DEPENDENCIES="dev-python/databricks-sdk[${PYTHON_USEDEP}]
	...
	connect? ( >=dev-python/pyarrow-11.0.0[${PYTHON_USEDEP}] )
	...
	pandas-on-spark? ( >=dev-python/pyarrow-11.0.0[${PYTHON_USEDEP}] )
	...
	pipelines? ( >=dev-python/pyarrow-11.0.0[${PYTHON_USEDEP}] )
	...
	sql? ( >=dev-python/pyarrow-11.0.0[${PYTHON_USEDEP}] )
