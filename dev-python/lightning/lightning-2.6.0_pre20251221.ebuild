...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	fabric-test? ( ~dev-python/coverage-7.13.0[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/coverage-7.13.0[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/pytest-9.0.2[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( ~dev-python/click-8.3.1[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/coverage-7.13.0[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( ~dev-python/pytest-9.0.2[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/coverage-7.13.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/pytest-9.0.2[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/click-8.3.1[${PYTHON_USEDEP}] )
