...
IUSE="arangodb auth azureblockblob brotli cassandra consul cosmosdbsql couchdb django dynamodb elasticsearch gcs gevent librabbitmq memcache mongodb msgpack pymemcache pyro pytest redis s3 slmq solar sqlalchemy sqs tblib yaml zookeeper zstd"
DEPENDENCIES="dev-python/billiard[${PYTHON_USEDEP}]
	...
	auth? ( ~dev-python/cryptography-43.0.0[${PYTHON_USEDEP}] )
	...
	elasticsearch? ( <=dev-python/elastic-transport-8.13.1[${PYTHON_USEDEP}] )
	...
	mongodb? ( <dev-python/pymongo-4.9[${PYTHON_USEDEP}] )
