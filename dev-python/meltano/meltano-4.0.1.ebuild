...
IUSE="azure containers gcs mssql postgres psycopg2 s3"
DEPENDENCIES="<dev-python/alembic-2.0[${PYTHON_USEDEP}]
	...
	<dev-python/click-didyoumean-0.4[${PYTHON_USEDEP}]
	...
	<dev-python/uv-0.10[${PYTHON_USEDEP}]
	...
	containers? ( dev-python/aiodocker[${PYTHON_USEDEP}] )
	...
	s3? ( <dev-python/boto3-1.41[${PYTHON_USEDEP}] )"
