...
IUSE="abf alphaomega audio aws axon axona behavior biocam blackrock brukertiff caiman cellexplorer cnmfe compressors dandi deeplabcut ecephys ecephys-minimal edf excel extract femtonics fiber-photometry full hdf5 hdf5imaging icephys image inscopix intan kilosort lightningpose maxwell mcsraw mearec medpc micromanagertiff miniscope neuralynx neuroscope openephys ophys ophys-minimal phy plexon plexon2 sbx scanbox scanimage scanimage-legacy sima sleap sorting-analyzer spike2 spikegadgets spikeglx suite2p tdt tdt-fp text thor tiff video whitematter"
DEPENDENCIES=">=dev-python/numpy-1.22.0[${PYTHON_USEDEP}]
	...
	axon? ( dev-python/neuroconv[${PYTHON_USEDEP}] )
	...
	plexon2? ( dev-python/neuroconv[${PYTHON_USEDEP}] )
	...
	fiber-photometry? ( dev-python/pynwb[${PYTHON_USEDEP}] )
	...
	brukertiff? ( dev-python/natsort[${PYTHON_USEDEP}] )
	...
	femtonics? ( dev-python/neuroconv[${PYTHON_USEDEP}] )
	hdf5? ( dev-python/neuroconv[${PYTHON_USEDEP}] )
	hdf5imaging? ( dev-python/neuroconv[${PYTHON_USEDEP}] )
	inscopix? ( dev-python/isx[${PYTHON_USEDEP}] )
	inscopix? ( dev-python/neuroconv[${PYTHON_USEDEP}] )
	...
	scanbox? ( dev-python/neuroconv[${PYTHON_USEDEP}] )
