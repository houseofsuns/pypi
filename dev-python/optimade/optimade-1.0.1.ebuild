...
IUSE="aiida all ase cif client dev docs elastic http-client http_client jarvis mongo pymatgen server testing"
DEPENDENCIES="dev-python/lark[${PYTHON_USEDEP}]
	...
	http-client? ( dev-python/httpx[${PYTHON_USEDEP}] )
	http-client? ( dev-python/rich[${PYTHON_USEDEP}] )
	http-client? ( dev-python/click[${PYTHON_USEDEP}] )
	http_client? ( dev-python/optimade[${PYTHON_USEDEP}] )
