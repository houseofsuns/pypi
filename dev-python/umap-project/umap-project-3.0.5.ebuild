...
DEPENDENCIES="dev-python/django-agnocomplete[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/pymdown-extensions-10.14.3[${PYTHON_USEDEP}] )
	dev? ( dev-python/ruff[${PYTHON_USEDEP}] )
	dev? ( dev-python/vermin[${PYTHON_USEDEP}] )
	docker? ( ~dev-python/uvicorn-0.34.2[${PYTHON_USEDEP}] )
	s3? ( dev-python/django-storages[${PYTHON_USEDEP}] )
	sync? ( ~dev-python/pydantic-2.11.3[${PYTHON_USEDEP}] )
	sync? ( ~dev-python/redis-5.2.1[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/moto-5.1.4[${PYTHON_USEDEP}] )
