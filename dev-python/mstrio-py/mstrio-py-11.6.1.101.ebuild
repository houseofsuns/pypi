...
DEPENDENCIES=">=dev-python/packaging-24.2[${PYTHON_USEDEP}]
	...
	all? ( dev-python/jupyterlab-scenes[${PYTHON_USEDEP}] )
	...
	jupyter? ( dev-python/jupyterlab-scenes[${PYTHON_USEDEP}] )
	...
	pre-commit? ( dev-python/flake8-black[${PYTHON_USEDEP}] )
	...
	strict? ( >=dev-python/jinja2-3.1.5[${PYTHON_USEDEP}] )
