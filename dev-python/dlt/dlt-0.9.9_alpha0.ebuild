...
IUSE="athena az bigquery cli clickhouse databricks deltalake dremio duckdb filesystem gcp gs lancedb motherduck mssql parquet postgres qdrant redshift s3 snowflake sql-database synapse weaviate"
