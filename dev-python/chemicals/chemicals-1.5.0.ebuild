...
DEPENDENCIES="dev-python/fluids[${PYTHON_USEDEP}]
	...
	test-multiarch? ( dev-python/thefuzz[${PYTHON_USEDEP}] )
	...
	test-multiarch? ( dev-python/joblib[${PYTHON_USEDEP}] )
	...
	prerelease? ( dev-python/chemicals[${PYTHON_USEDEP}] )
	prerelease? ( dev-python/chemicals[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/chemicals[${PYTHON_USEDEP}] )
