...
DEPENDENCIES="docs? ( ~dev-python/markdown-3.8.2[${PYTHON_USEDEP}] )
	...
	black? ( ~dev-python/click-8.2.1[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/pymdown-extensions-10.16[${PYTHON_USEDEP}] )
	...
	cli? ( ~dev-python/requests-2.32.4[${PYTHON_USEDEP}] )
	safety? ( dev-python/safety[${PYTHON_USEDEP}] )
	cli? ( ~dev-python/tox-4.34.1[${PYTHON_USEDEP}] )
	tox? ( ~dev-python/tox-4.34.1[${PYTHON_USEDEP}] )
