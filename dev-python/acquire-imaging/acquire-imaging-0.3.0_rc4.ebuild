...
HOMEPAGE=""
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/cp38/${REALNAME::1}/${REALNAME}/${REALNAME//-/_}-${REALVERSION}-cp38-abi3-win_amd64.whl"
SOURCEFILE="${REALNAME//-/_}-${REALVERSION}-cp38-abi3-win_amd64.whl"
RESTRICT="test"
