...
DEPENDENCIES="dev-python/tomli[${PYTHON_USEDEP}]
	...
	skillseeker? ( >=dev-python/beautifulsoup4-4.12[${PYTHON_USEDEP}] )
	skillseeker? ( >=dev-python/pygithub-2.2[${PYTHON_USEDEP}] )
	skillseeker? ( dev-python/PyMuPDF[${PYTHON_USEDEP}] )"
