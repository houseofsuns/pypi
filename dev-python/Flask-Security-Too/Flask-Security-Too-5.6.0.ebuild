...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/35/77/0eb381f7cb9cc36a96bb0468354a9092377b33f7440c68c909656516f06b/flask_security_too-${REALVERSION}.tar.gz"
...
DEPENDENCIES=">=dev-python/flask-3.0.0[${PYTHON_USEDEP}]
	...
	low? ( ~dev-python/flask-babel-3.1.0[${PYTHON_USEDEP}] )
	...
	low? ( dev-python/setuptools[${PYTHON_USEDEP}] )
