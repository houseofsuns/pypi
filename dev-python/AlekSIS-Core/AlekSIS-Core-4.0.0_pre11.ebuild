...
SRC_URI="https://files.pythonhosted.org/packages/43/93/98765ee143e2f2c9a76cf343a88dbe85fc05f979f956242ae6c3e29ad653/aleksis_core-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/django-6.0[${PYTHON_USEDEP}]
	...
	ldap? ( <dev-python/django-auth-ldap-5.0[${PYTHON_USEDEP}] )
	...
	<dev-python/recurring-ical-events-3.0.0[${PYTHON_USEDEP}]
