...
IUSE="all build dev docs gallery optional optional-base optional-numba pyqt pyqt5 pyqt6 pyside pyside2 pyside6-experimental qt release testing testing-extra"
DEPENDENCIES=">=dev-python/appdirs-1.4.4[${PYTHON_USEDEP}]
	...
	optional? ( dev-python/PartSegCore-compiled-backend[${PYTHON_USEDEP}] )
