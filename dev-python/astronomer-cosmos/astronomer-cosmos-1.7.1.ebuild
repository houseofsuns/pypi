...
IUSE="all amazon aws-eks azure-container-instance dbt-all dbt-athena dbt-bigquery dbt-clickhouse dbt-databricks dbt-exasol dbt-postgres dbt-redshift dbt-snowflake dbt-spark dbt-teradata dbt-vertica docker docs gcp-cloud-run-job google kubernetes microsoft openlineage tests"
DEPENDENCIES="dev-python/aenum[${PYTHON_USEDEP}]
	...
	tests? ( >=dev-python/packaging-22.0[${PYTHON_USEDEP}] )
