...
IUSE="airflow all docker-image docs examples flax kfp test tf-ranking tfdf tfjs tflite-support"
DEPENDENCIES="dev-python/ml-pipelines-sdk[${PYTHON_USEDEP}]
	...
	docker-image? ( dev-python/kfp[${PYTHON_USEDEP}] )
	docker-image? ( dev-python/kfp-pipeline-spec[${PYTHON_USEDEP}] )
	docker-image? ( dev-python/mmh[${PYTHON_USEDEP}] )
	docker-image? ( >=dev-python/python-snappy-0.7[${PYTHON_USEDEP}] )
	...
	examples? ( <dev-python/scikit-learn-2.0[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/pytest-subtests-0.13.1[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/markdown-grid-tables[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/pytest-subtests-0.13.1[${PYTHON_USEDEP}] )
