...
LICENSE="Copyright 2023 Christian Gonzlez"
...
DEPENDENCIES=">=dev-python/django-5.1[${PYTHON_USEDEP}]
	...
	dev-python/tetra[${PYTHON_USEDEP}]
	dev? ( dev-python/conjunto[${PYTHON_USEDEP}] )
	...
	doc? ( dev-python/mkdocs-api-autonav[${PYTHON_USEDEP}] )"
