...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	fabric-dev? ( ~dev-python/coverage-7.8.0[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( ~dev-python/pytest-timeout-2.3.1[${PYTHON_USEDEP}] )
	...
	fabric-test? ( ~dev-python/coverage-7.8.0[${PYTHON_USEDEP}] )
	...
	fabric-test? ( ~dev-python/pytest-timeout-2.3.1[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/coverage-7.8.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/pytest-timeout-2.3.1[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/coverage-7.8.0[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/pytest-timeout-2.3.1[${PYTHON_USEDEP}] )
