...
DESCRIPTION="Google Cloud Certificate Manager API client library [wheel]"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-certificate-manager"
LICENSE="Apache-2.0"
