...
IUSE="anthropic cerebras cohere docs dspy google-ai-studio groq instructor langchain litellm llamaindex mistral0 mistral1 modal notdiamond openai pandas-test scorers scorers-tests test vertexai"
