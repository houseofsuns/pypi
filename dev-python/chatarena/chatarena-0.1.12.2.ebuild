...
IUSE="all all_backends all_envs anthropic bard cohere gradio huggingface langchain langchain_requirements pettingzoo umshini umshini_requirements"
DEPENDENCIES="dev-python/openai[${PYTHON_USEDEP}]
	...
	langchain_requirements? ( dev-python/langchain[${PYTHON_USEDEP}] )
	...
	umshini_requirements? ( dev-python/pettingzoo[${PYTHON_USEDEP}] )
	umshini_requirements? ( dev-python/pygame-ce[${PYTHON_USEDEP}] )
	umshini_requirements? ( dev-python/langchain[${PYTHON_USEDEP}] )"
