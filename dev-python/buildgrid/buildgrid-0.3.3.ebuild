...
DEPENDENCIES="dev-python/boto3[${PYTHON_USEDEP}]
	...
	database? ( >=dev-python/psycopg-3.2.10[${PYTHON_USEDEP}] )
	...
	tests? ( >=dev-python/psycopg-3.2.10[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/bump4version[${PYTHON_USEDEP}] )
	mypy? ( dev-python/mypy[${PYTHON_USEDEP}] )
	mypy? ( dev-python/sqlalchemy[${PYTHON_USEDEP}] )
	...
	mypy? ( >=dev-python/psycopg-3.2.10[${PYTHON_USEDEP}] )
