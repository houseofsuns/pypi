...
DEPENDENCIES="dev-python/nb-log[${PYTHON_USEDEP}]
	...
	all? ( dev-python/mysql-replication[${PYTHON_USEDEP}] )
	all? ( ~dev-python/grpcio-1.60.0[${PYTHON_USEDEP}] )
	all? ( dev-python/grpcio-tools[${PYTHON_USEDEP}] )
	all? ( ~dev-python/protobuf-4.25.1[${PYTHON_USEDEP}] )
	...
	extra-brokers? ( dev-python/pulsar-client[${PYTHON_USEDEP}] )
	...
	extra-brokers? ( dev-python/mysql-replication[${PYTHON_USEDEP}] )
	extra-brokers? ( ~dev-python/grpcio-1.60.0[${PYTHON_USEDEP}] )
	extra-brokers? ( dev-python/grpcio-tools[${PYTHON_USEDEP}] )
	extra-brokers? ( ~dev-python/protobuf-4.25.1[${PYTHON_USEDEP}] )
