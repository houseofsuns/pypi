...
REALNAME="metaphor-connectors"
REALVERSION="0.11.129"
DIGEST_SOURCES="yes"
...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/0b/a0/ac7d1903b28585ddd6d5d6db131f642fdad09ed10128fdf2451fd20a9d4e/metaphor_connectors-${REALVERSION}.tar.gz"
...
DEPENDENCIES="all? ( dev-python/asyncpg[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/metaphor-sqllineage[${PYTHON_USEDEP}] )
	redshift? ( dev-python/metaphor-sqllineage[${PYTHON_USEDEP}] )
	tableau? ( dev-python/metaphor-sqllineage[${PYTHON_USEDEP}] )
