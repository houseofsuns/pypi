...
DEPENDENCIES="dev-python/ansys-api-additive[${PYTHON_USEDEP}]
	...
	tests? ( ~dev-python/google-api-python-client-2.159.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/googleapis-common-protos-1.66.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/pydantic-2.10.5[${PYTHON_USEDEP}] )
