...
DEPENDENCIES="serving? ( >=dev-python/django-4.2.11[${PYTHON_USEDEP}] )
	all? ( >=dev-python/django-4.2.11[${PYTHON_USEDEP}] )
	...
	serving? ( >=dev-python/djangorestframework-3.13.1[${PYTHON_USEDEP}] )
	all? ( >=dev-python/djangorestframework-3.13.1[${PYTHON_USEDEP}] )
