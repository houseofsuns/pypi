...
IUSE="all dask-gateway datacube jupyter notebooks"
DEPENDENCIES=">=dev-python/aiohttp-3.5.0[${PYTHON_USEDEP}]
	...
	all? ( dev-python/dask-labextension[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/jupyter-resource-usage[${PYTHON_USEDEP}] )
	...
	jupyter? ( dev-python/dask-labextension[${PYTHON_USEDEP}] )
	...
	notebooks? ( dev-python/dask-labextension[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/gcsfs[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/ipyleaflet[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/jupyter-resource-usage[${PYTHON_USEDEP}] )
