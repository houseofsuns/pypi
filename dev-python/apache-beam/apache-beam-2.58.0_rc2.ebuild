...
IUSE="aws azure dask dataframe docs gcp interactive interactive-test ml-test ml_test test yaml"
DEPENDENCIES="<dev-python/crcmod-2.0[${PYTHON_USEDEP}]
	...
	dataframe? ( <dev-python/pandas-2.2[${PYTHON_USEDEP}] )
	...
	interactive? ( <dev-python/pandas-2.2[${PYTHON_USEDEP}] )
	...
	ml-test? ( dev-python/xgboost[${PYTHON_USEDEP}] )
	ml_test? ( dev-python/tensorflow-transform[${PYTHON_USEDEP}] )
