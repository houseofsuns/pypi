...
DEPENDENCIES="all? ( dev-python/celery[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/fakeredis-2.20.0[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/mkdocs-git-revision-date-localized-plugin-1.2.1[${PYTHON_USEDEP}] )
