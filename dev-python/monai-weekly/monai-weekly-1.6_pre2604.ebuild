...
IUSE="all gdown ignite imagecodecs itk lmdb nibabel ninja openslide pandas pillow psutil scipy skimage tensorboard tifffile torchio torchvision tqdm"
DEPENDENCIES="all? ( dev-python/tensorboardX[${PYTHON_USEDEP}] )
