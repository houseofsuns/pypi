...
IUSE="aimet-onnx auto-opt azureml bnb capture-onnx-graph cpu diffusers directml docker finetune flash-attn gpu inc lora nvmo openvino optimum qnn shared-cache tf torch-tensorrt tune-session-params"
DEPENDENCIES="dev-python/hf-xet[${PYTHON_USEDEP}]
	...
	aimet-onnx? ( dev-python/aimet-onnx[${PYTHON_USEDEP}] )
