...
DEPENDENCIES="<dev-python/djangorestframework-3.16.0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/django-auth-ldap-4.8.0[${PYTHON_USEDEP}] )
	ldap? ( <dev-python/django-auth-ldap-4.8.0[${PYTHON_USEDEP}] )
	...
	<dev-python/netaddr-0.11.0[${PYTHON_USEDEP}]
