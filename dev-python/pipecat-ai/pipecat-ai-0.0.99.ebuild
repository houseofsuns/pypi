...
DEPENDENCIES="<dev-python/aiofiles-25.0[${PYTHON_USEDEP}]
	...
	rnnoise? ( dev-python/pyrnnoise[${PYTHON_USEDEP}] )
	...
	speechmatics? ( dev-python/speechmatics-voice[${PYTHON_USEDEP}] )
