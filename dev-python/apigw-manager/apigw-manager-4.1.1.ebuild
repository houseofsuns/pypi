...
DEPENDENCIES="drf? ( >=dev-python/django-3.0.14[${PYTHON_USEDEP}] )
	django? ( >=dev-python/django-3.0.14[${PYTHON_USEDEP}] )
	demo? ( >=dev-python/django-3.0.14[${PYTHON_USEDEP}] )
	...
	django? ( >=dev-python/pyjwt-2.0.0[${PYTHON_USEDEP}] )
	demo? ( >=dev-python/pyjwt-2.0.0[${PYTHON_USEDEP}] )
