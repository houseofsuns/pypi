...
IUSE="allure coverage flake8 ipdb pdfminer pillow proxy psutil selenium-stealth selenium-wire"
DEPENDENCIES=">=dev-python/pip-24.0[${PYTHON_USEDEP}]
	...
	~dev-python/execnet-2.1.0[${PYTHON_USEDEP}]
	...
	pdfminer? ( ~dev-python/cryptography-42.0.5[${PYTHON_USEDEP}] )
