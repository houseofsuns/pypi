...
IUSE="dev doc min min-plotting plotly plotting style test"
DEPENDENCIES=">=dev-python/jinja2-3.1.2[${PYTHON_USEDEP}]
	...
	doc? ( dev-python/marimo[${PYTHON_USEDEP}] )
	...
	min? ( ~dev-python/jinja2-3.1.2[${PYTHON_USEDEP}] )
	min? ( ~dev-python/joblib-1.2.0[${PYTHON_USEDEP}] )
	min? ( dev-python/nibabel[${PYTHON_USEDEP}] )
	min? ( ~dev-python/numpy-1.22.4[${PYTHON_USEDEP}] )
	min? ( ~dev-python/pandas-2.2.0[${PYTHON_USEDEP}] )
	min? ( ~dev-python/requests-2.30.0[${PYTHON_USEDEP}] )
	min? ( ~dev-python/scikit-learn-1.4.0[${PYTHON_USEDEP}] )
	min? ( ~dev-python/scipy-1.9.0[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/jinja2-3.1.2[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/joblib-1.2.0[${PYTHON_USEDEP}] )
	min-plotting? ( dev-python/kaleido[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/matplotlib-3.8.0[${PYTHON_USEDEP}] )
	min-plotting? ( dev-python/nibabel[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/numpy-1.22.4[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/pandas-2.2.0[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/plotly-5.0.0[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/requests-2.30.0[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/scikit-learn-1.4.0[${PYTHON_USEDEP}] )
	min-plotting? ( ~dev-python/scipy-1.9.0[${PYTHON_USEDEP}] )
	plotly? ( dev-python/kaleido[${PYTHON_USEDEP}] )
	plotly? ( >=dev-python/matplotlib-3.8.0[${PYTHON_USEDEP}] )
	plotly? ( >=dev-python/plotly-5.0.0[${PYTHON_USEDEP}] )
	plotting? ( dev-python/kaleido[${PYTHON_USEDEP}] )
	plotting? ( >=dev-python/matplotlib-3.8.0[${PYTHON_USEDEP}] )
