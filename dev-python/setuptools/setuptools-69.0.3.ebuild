...
DEPENDENCIES="docs? ( >=dev-python/sphinx-3.5[${PYTHON_USEDEP}] )
	...
	testing? ( >=dev-python/ini2toml-0.9[${PYTHON_USEDEP}] )
	...
	testing-integration? ( >=dev-python/virtualenv-13.0.0[${PYTHON_USEDEP}] )
	testing-integration? ( dev-python/tomli[${PYTHON_USEDEP}] )
	testing-integration? ( dev-python/wheel[${PYTHON_USEDEP}] )
	testing-integration? ( >=dev-python/jaraco-path-3.2.0[${PYTHON_USEDEP}] )
	testing-integration? ( >=dev-python/jaraco-envs-2.2[${PYTHON_USEDEP}] )
	testing-integration? ( >=dev-python/build-1.0.3[${PYTHON_USEDEP}] )
	testing-integration? ( >=dev-python/filelock-3.4.0[${PYTHON_USEDEP}] )
	testing-integration? ( >=dev-python/packaging-23.1[${PYTHON_USEDEP}] )
