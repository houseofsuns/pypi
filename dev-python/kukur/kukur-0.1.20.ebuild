...
IUSE="adodb cratedb datafusion delta influxdb inspect kusto odbc piwebapi postgresql redshift"
DEPENDENCIES="dev-python/pyarrow[${PYTHON_USEDEP}]
	...
	inspect? ( dev-python/azure-storage-file-datalake[${PYTHON_USEDEP}] )
	inspect? ( dev-python/adlfs[${PYTHON_USEDEP}] )
