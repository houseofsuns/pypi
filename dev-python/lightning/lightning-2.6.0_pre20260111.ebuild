...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	fabric-dev? ( ~dev-python/coverage-7.13.1[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( <dev-python/numpy-3.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/coverage-7.13.1[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( <dev-python/numpy-3.0[${PYTHON_USEDEP}] )
