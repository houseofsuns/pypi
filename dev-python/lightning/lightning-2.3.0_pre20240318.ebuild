...
DEPENDENCIES="<dev-python/pyyaml-6.1.0[${PYTHON_USEDEP}]
	<dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/jinja-3.2.0[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/backoff-2.3.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/beautifulsoup4-4.13.0[${PYTHON_USEDEP}] )
	all? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	all? ( <dev-python/click-8.2[${PYTHON_USEDEP}] )
	all? ( <dev-python/croniter-1.5.0[${PYTHON_USEDEP}] )
	all? ( dev-python/dateutils[${PYTHON_USEDEP}] )
	all? ( <dev-python/deepdiff-6.6.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/docker-6.1.4[${PYTHON_USEDEP}] )
	all? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	all? ( <dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/traitlets-5.12.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/typing-extensions-4.10.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/urllib3-2.1.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/uvicorn-0.24.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/websocket-client-1.7.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/websockets-11.1.0[${PYTHON_USEDEP}] )
	all? ( dev-python/deepspeed[${PYTHON_USEDEP}] )
	app? ( <dev-python/jinja-3.2.0[${PYTHON_USEDEP}] )
	app? ( <=dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	app? ( <dev-python/arrow-1.3.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/backoff-2.3.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/beautifulsoup4-4.13.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/click-8.2[${PYTHON_USEDEP}] )
	app? ( <dev-python/croniter-1.5.0[${PYTHON_USEDEP}] )
	app? ( dev-python/dateutils[${PYTHON_USEDEP}] )
	app? ( <dev-python/deepdiff-6.6.0[${PYTHON_USEDEP}] )
	app? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	app? ( <dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}] )
	...
	app? ( <dev-python/psutil-5.9.6[${PYTHON_USEDEP}] )
	app? ( >=dev-python/pydantic-1.7.4[${PYTHON_USEDEP}] )
	app? ( <=dev-python/python-multipart-0.0.6[${PYTHON_USEDEP}] )
	app? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	app? ( dev-python/starlette[${PYTHON_USEDEP}] )
	app? ( <dev-python/traitlets-5.12.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/typing-extensions-4.10.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/urllib3-2.1.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/uvicorn-0.24.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/websocket-client-1.7.0[${PYTHON_USEDEP}] )
	app? ( <dev-python/websockets-11.1.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/jinja-3.2.0[${PYTHON_USEDEP}] )
	app-all? ( <=dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/arrow-1.3.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/backoff-2.3.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/beautifulsoup4-4.13.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/click-8.2[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/croniter-1.5.0[${PYTHON_USEDEP}] )
	app-all? ( dev-python/dateutils[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/deepdiff-6.6.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/docker-6.1.4[${PYTHON_USEDEP}] )
	app-all? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}] )
	...
	app-all? ( <dev-python/psutil-5.9.6[${PYTHON_USEDEP}] )
	app-all? ( >=dev-python/pydantic-1.7.4[${PYTHON_USEDEP}] )
	app-all? ( <=dev-python/python-multipart-0.0.6[${PYTHON_USEDEP}] )
	app-all? ( dev-python/pytorch-lightning[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/redis-5.1.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	app-all? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	app-all? ( dev-python/starlette[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/traitlets-5.12.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/typing-extensions-4.10.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/urllib3-2.1.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/uvicorn-0.24.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/websocket-client-1.7.0[${PYTHON_USEDEP}] )
	app-all? ( <dev-python/websockets-11.1.0[${PYTHON_USEDEP}] )
	app-cloud? ( <dev-python/docker-6.1.4[${PYTHON_USEDEP}] )
	app-cloud? ( <dev-python/redis-5.1.0[${PYTHON_USEDEP}] )
	app-cloud? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	app-components? ( <dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}] )
	...
	app-dev? ( <dev-python/jinja-3.2.0[${PYTHON_USEDEP}] )
	app-dev? ( <=dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/arrow-1.3.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/backoff-2.3.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/beautifulsoup4-4.13.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/click-8.2[${PYTHON_USEDEP}] )
	...
	app-dev? ( <dev-python/deepdiff-6.6.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/docker-6.1.4[${PYTHON_USEDEP}] )
	app-dev? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}] )
	...
	app-dev? ( <dev-python/psutil-5.10.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/psutil-5.9.6[${PYTHON_USEDEP}] )
	...
	app-dev? ( <=dev-python/python-multipart-0.0.6[${PYTHON_USEDEP}] )
	app-dev? ( dev-python/pytorch-lightning[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/redis-5.1.0[${PYTHON_USEDEP}] )
	app-dev? ( ~dev-python/requests-mock-1.11.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	app-dev? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/setuptools-68.3.0[${PYTHON_USEDEP}] )
	app-dev? ( dev-python/starlette[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/traitlets-5.12.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/trio-0.22.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/typing-extensions-4.10.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/urllib3-2.1.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/uvicorn-0.24.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/websocket-client-1.7.0[${PYTHON_USEDEP}] )
	app-dev? ( <dev-python/websockets-11.1.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/jinja-3.2.0[${PYTHON_USEDEP}] )
	app-extra? ( <=dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/arrow-1.3.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/backoff-2.3.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/beautifulsoup4-4.13.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/click-8.2[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/croniter-1.5.0[${PYTHON_USEDEP}] )
	app-extra? ( dev-python/dateutils[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/deepdiff-6.6.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/docker-6.1.4[${PYTHON_USEDEP}] )
	app-extra? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}] )
	...
	app-extra? ( <dev-python/psutil-5.9.6[${PYTHON_USEDEP}] )
	app-extra? ( >=dev-python/pydantic-1.7.4[${PYTHON_USEDEP}] )
	app-extra? ( <=dev-python/python-multipart-0.0.6[${PYTHON_USEDEP}] )
	app-extra? ( dev-python/pytorch-lightning[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/redis-5.1.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	app-extra? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	app-extra? ( dev-python/starlette[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/traitlets-5.12.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/typing-extensions-4.10.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/urllib3-2.1.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/uvicorn-0.24.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/websocket-client-1.7.0[${PYTHON_USEDEP}] )
	app-extra? ( <dev-python/websockets-11.1.0[${PYTHON_USEDEP}] )
	...
	app-test? ( <dev-python/psutil-5.10.0[${PYTHON_USEDEP}] )
	...
	app-test? ( <dev-python/setuptools-68.3.0[${PYTHON_USEDEP}] )
	app-test? ( <dev-python/trio-0.22.0[${PYTHON_USEDEP}] )
	cloud? ( <dev-python/docker-6.1.4[${PYTHON_USEDEP}] )
	cloud? ( <dev-python/redis-5.1.0[${PYTHON_USEDEP}] )
	cloud? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	components? ( <dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/jinja-3.2.0[${PYTHON_USEDEP}] )
	dev? ( <=dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	dev? ( <dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/arrow-1.3.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/backoff-2.3.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/beautifulsoup4-4.13.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	dev? ( <dev-python/click-8.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/click-8.1.7[${PYTHON_USEDEP}] )
	dev? ( <dev-python/cloudpickle-2.3.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/deepdiff-6.6.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/docker-6.1.4[${PYTHON_USEDEP}] )
	dev? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	dev? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	dev? ( <dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/psutil-5.10.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/redis-5.1.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/setuptools-68.3.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/traitlets-5.12.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/websockets-11.1.0[${PYTHON_USEDEP}] )
	...
	extra? ( <dev-python/jinja-3.2.0[${PYTHON_USEDEP}] )
	extra? ( <=dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	extra? ( <dev-python/aiohttp-3.9.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/arrow-1.3.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/backoff-2.3.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/beautifulsoup4-4.13.0[${PYTHON_USEDEP}] )
	extra? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	extra? ( <dev-python/click-8.2[${PYTHON_USEDEP}] )
	extra? ( <dev-python/croniter-1.5.0[${PYTHON_USEDEP}] )
	extra? ( dev-python/dateutils[${PYTHON_USEDEP}] )
	extra? ( <dev-python/deepdiff-6.6.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/docker-6.1.4[${PYTHON_USEDEP}] )
	extra? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	extra? ( <dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}] )
	...
	extra? ( <dev-python/matplotlib-3.9.0[${PYTHON_USEDEP}] )
	extra? ( dev-python/omegaconf[${PYTHON_USEDEP}] )
	extra? ( dev-python/packaging[${PYTHON_USEDEP}] )
	extra? ( <dev-python/psutil-5.9.6[${PYTHON_USEDEP}] )
	extra? ( >=dev-python/pydantic-1.7.4[${PYTHON_USEDEP}] )
	extra? ( <=dev-python/python-multipart-0.0.6[${PYTHON_USEDEP}] )
	extra? ( dev-python/pytorch-lightning[${PYTHON_USEDEP}] )
	extra? ( <dev-python/redis-5.1.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	extra? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	extra? ( dev-python/starlette[${PYTHON_USEDEP}] )
	extra? ( dev-python/tensorboardX[${PYTHON_USEDEP}] )
	extra? ( <dev-python/traitlets-5.12.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/typing-extensions-4.10.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/urllib3-2.1.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/uvicorn-0.24.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/websocket-client-1.7.0[${PYTHON_USEDEP}] )
	extra? ( <dev-python/websockets-11.1.0[${PYTHON_USEDEP}] )
	...
	pytorch-all? ( <dev-python/ipython-8.15.0[${PYTHON_USEDEP}] )
	pytorch-all? ( dev-python/jsonargparse[${PYTHON_USEDEP}] )
	pytorch-all? ( dev-python/lightning-utilities[${PYTHON_USEDEP}] )
	pytorch-all? ( <dev-python/matplotlib-3.9.0[${PYTHON_USEDEP}] )
	pytorch-all? ( dev-python/omegaconf[${PYTHON_USEDEP}] )
	pytorch-all? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	pytorch-all? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( <dev-python/cloudpickle-2.3.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( <dev-python/pandas-2.2.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( <dev-python/psutil-5.9.6[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( <dev-python/scikit-learn-1.4.0[${PYTHON_USEDEP}] )
	...
	pytorch-examples? ( <dev-python/ipython-8.15.0[${PYTHON_USEDEP}] )
	pytorch-examples? ( dev-python/lightning-utilities[${PYTHON_USEDEP}] )
	pytorch-examples? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	...
	pytorch-extra? ( <dev-python/matplotlib-3.9.0[${PYTHON_USEDEP}] )
	pytorch-extra? ( dev-python/omegaconf[${PYTHON_USEDEP}] )
	pytorch-extra? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	pytorch-extra? ( dev-python/tensorboardX[${PYTHON_USEDEP}] )
	pytorch-strategies? ( dev-python/deepspeed[${PYTHON_USEDEP}] )
	pytorch-test? ( <dev-python/cloudpickle-2.3.0[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( <dev-python/pandas-2.2.0[${PYTHON_USEDEP}] )
	pytorch-test? ( <dev-python/psutil-5.9.6[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( <dev-python/scikit-learn-1.4.0[${PYTHON_USEDEP}] )
	pytorch-test? ( dev-python/tensorboard[${PYTHON_USEDEP}] )
	pytorch-test? ( dev-python/uvicorn[${PYTHON_USEDEP}] )
	store? ( <dev-python/jinja-3.2.0[${PYTHON_USEDEP}] )
	store? ( <=dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
	store? ( <dev-python/arrow-1.3.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/backoff-2.3.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/beautifulsoup4-4.13.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/click-8.2[${PYTHON_USEDEP}] )
	store? ( <dev-python/croniter-1.5.0[${PYTHON_USEDEP}] )
	store? ( dev-python/dateutils[${PYTHON_USEDEP}] )
	store? ( <dev-python/deepdiff-6.6.0[${PYTHON_USEDEP}] )
	store? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	store? ( <dev-python/fsspec-2023.11.0[${PYTHON_USEDEP}] )
	...
	store? ( <dev-python/psutil-5.9.6[${PYTHON_USEDEP}] )
	store? ( >=dev-python/pydantic-1.7.4[${PYTHON_USEDEP}] )
	store? ( <=dev-python/python-multipart-0.0.6[${PYTHON_USEDEP}] )
	store? ( <dev-python/requests-2.32.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/rich-13.6.0[${PYTHON_USEDEP}] )
	store? ( dev-python/starlette[${PYTHON_USEDEP}] )
	store? ( <dev-python/traitlets-5.12.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/typing-extensions-4.10.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/urllib3-2.1.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/uvicorn-0.24.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/websocket-client-1.7.0[${PYTHON_USEDEP}] )
	store? ( <dev-python/websockets-11.1.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/cloudpickle-2.3.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/psutil-5.10.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/scikit-learn-1.4.0[${PYTHON_USEDEP}] )
	test? ( <dev-python/setuptools-68.3.0[${PYTHON_USEDEP}] )
