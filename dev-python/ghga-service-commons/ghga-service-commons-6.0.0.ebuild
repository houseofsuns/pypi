...
IUSE="all api auth crypt dev http objectstorage transports"
DEPENDENCIES="<dev-python/pydantic-3.0[${PYTHON_USEDEP}]
	api? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	api? ( <dev-python/uvicorn-0.39[${PYTHON_USEDEP}] )
	...
	transports? ( <dev-python/hishel-0.2[${PYTHON_USEDEP}] )
	transports? ( <dev-python/tenacity-10.0[${PYTHON_USEDEP}] )
	transports? ( dev-python/ghga-service-commons[${PYTHON_USEDEP}] )
