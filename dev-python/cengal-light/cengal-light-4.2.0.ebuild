...
DEPENDENCIES="hardware-info-cpu-versions-v-1? ( dev-python/py-cpuinfo[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/PyBindGen[${PYTHON_USEDEP}] )
	...
	full? ( dev-python/PyBindGen[${PYTHON_USEDEP}] )
