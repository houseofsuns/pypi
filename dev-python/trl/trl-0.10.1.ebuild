...
IUSE="benchmark deepspeed dev diffusers liger llm-judge peft quantization test"
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/liger-kernel-nightly[${PYTHON_USEDEP}] )
	...
	liger? ( dev-python/liger-kernel-nightly[${PYTHON_USEDEP}] )
	llm-judge? ( dev-python/openai[${PYTHON_USEDEP}] )
	llm-judge? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/llm-blender[${PYTHON_USEDEP}] )"
