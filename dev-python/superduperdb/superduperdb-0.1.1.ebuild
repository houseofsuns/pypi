...
DEPENDENCIES=">=dev-python/boto3-1.16[${PYTHON_USEDEP}]
	...
	dev-python/ibis-framework[${PYTHON_USEDEP}]
	dev-python/ibis-framework[${PYTHON_USEDEP}]
	<=dev-python/sqlglot-20.10[${PYTHON_USEDEP}]
	>=dev-python/pyyaml-6.0.0[${PYTHON_USEDEP}]
	dev-python/prettytable[${PYTHON_USEDEP}]
	dev-python/python-dotenv[${PYTHON_USEDEP}]
	dev-python/ray[${PYTHON_USEDEP}]
	apis? ( dev-python/openai[${PYTHON_USEDEP}] )
	apis? ( dev-python/cohere[${PYTHON_USEDEP}] )
	apis? ( dev-python/anthropic[${PYTHON_USEDEP}] )
	demo? ( dev-python/ipython[${PYTHON_USEDEP}] )
	demo? ( dev-python/openai-clip[${PYTHON_USEDEP}] )
	demo? ( dev-python/datasets[${PYTHON_USEDEP}] )
	demo? ( dev-python/soundfile[${PYTHON_USEDEP}] )
	demo? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
	demo? ( dev-python/opencv-python[${PYTHON_USEDEP}] )
	demo? ( dev-python/matplotlib[${PYTHON_USEDEP}] )
	demo? ( dev-python/librosa[${PYTHON_USEDEP}] )
	dev? ( dev-python/superduperdb[${PYTHON_USEDEP}] )
	docs? ( dev-python/furo[${PYTHON_USEDEP}] )
	docs? ( dev-python/sphinx[${PYTHON_USEDEP}] )
	docs? ( dev-python/sphinx-autodoc-typehints[${PYTHON_USEDEP}] )
	docs? ( dev-python/myst-parser[${PYTHON_USEDEP}] )
	enterprise? ( dev-python/ray[${PYTHON_USEDEP}] )
	enterprise? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
