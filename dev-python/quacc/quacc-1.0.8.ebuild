...
IUSE="covalent dask defects dev docs fairchem jobflow mace matgl mp newtonnet orb parsl phonons prefect redun sella sevenn tblite torchsim"
DEPENDENCIES="dev-python/ase[${PYTHON_USEDEP}]
	...
	torchsim? ( dev-python/torch-sim-atomistic[${PYTHON_USEDEP}] )
