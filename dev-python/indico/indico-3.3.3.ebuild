...
DEPENDENCIES="~dev-python/alembic-1.13.1[${PYTHON_USEDEP}]
	...
	~dev-python/icalendar-5.0.12[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/anyio-4.3.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/atpublic-4.1.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/attrs-23.2.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/Babel-2.14.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pytest-localserver-0.8.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/requests-2.32.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/sphinx-7.3.5[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/sqlparse-0.5.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/starlette-0.37.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/tokenize-rt-5.2.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/unbeheader[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/urllib3-1.26.19[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/uv-0.2.15[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/uvicorn-0.29.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/watchfiles-0.21.0[${PYTHON_USEDEP}] )
