...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	fabric-dev? ( ~dev-python/pytest-8.3.5[${PYTHON_USEDEP}] )
	...
	fabric-test? ( ~dev-python/pytest-8.3.5[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/pytest-8.3.5[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/pytest-8.3.5[${PYTHON_USEDEP}] )
