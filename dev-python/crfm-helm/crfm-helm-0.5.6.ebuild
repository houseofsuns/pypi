...
IUSE="accelerate aleph-alpha all allenai amazon anthropic audiolm cleva cohere decodingtrust dev google heim human-evaluation ibm ibm-enterprise-scenarios image2struct images medhelm metrics mistral models mongo openai plots proxy-server ranking reka scenarios seahelm slurm summarization together unitxt vlm writer yandex"
DEPENDENCIES="~dev-python/cattrs-22.2[${PYTHON_USEDEP}]
	...
	metrics? ( ~dev-python/immutabledict-4.2.0[${PYTHON_USEDEP}] )
	...
	amazon? ( ~dev-python/boto3-1.34.131[${PYTHON_USEDEP}] )
	amazon? ( dev-python/awscli[${PYTHON_USEDEP}] )
	amazon? ( ~dev-python/botocore-1.34.131[${PYTHON_USEDEP}] )
	...
	image2struct? ( ~dev-python/selenium-4.17.2[${PYTHON_USEDEP}] )
	image2struct? ( ~dev-python/html2text-2024.2.26[${PYTHON_USEDEP}] )
	image2struct? ( dev-python/opencv-python[${PYTHON_USEDEP}] )
	...
	medhelm? ( dev-python/langchain[${PYTHON_USEDEP}] )
	medhelm? ( dev-python/langchain-community[${PYTHON_USEDEP}] )
	medhelm? ( ~dev-python/lxml-5.3.0[${PYTHON_USEDEP}] )
	medhelm? ( ~dev-python/openpyxl-3.1[${PYTHON_USEDEP}] )
	medhelm? ( dev-python/python-docx[${PYTHON_USEDEP}] )
	medhelm? ( dev-python/torch[${PYTHON_USEDEP}] )
	medhelm? ( dev-python/torchvision[${PYTHON_USEDEP}] )
