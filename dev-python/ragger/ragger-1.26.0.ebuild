...
IUSE="all-backends checkers doc ledgercomm ledgerwallet speculos tests"
DEPENDENCIES="dev-python/bip-utils[${PYTHON_USEDEP}]
	...
	checkers? ( dev-python/Flake8-pyproject[${PYTHON_USEDEP}] )
	checkers? ( dev-python/mypy[${PYTHON_USEDEP}] )
	checkers? ( dev-python/types-toml[${PYTHON_USEDEP}] )
