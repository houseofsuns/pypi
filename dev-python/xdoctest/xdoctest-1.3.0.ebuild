...
DEPENDENCIES="all? ( >=dev-python/pytest-6.2.5[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/pygments-2.15.1[${PYTHON_USEDEP}] )
	...
	optional-strict? ( ~dev-python/pygments-2.15.1[${PYTHON_USEDEP}] )
	...
	colors-strict? ( ~dev-python/pygments-2.15.1[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/pygments-2.15.1[${PYTHON_USEDEP}] )
