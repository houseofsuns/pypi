...
IUSE="base client dev docs quality"
DEPENDENCIES="dev-python/albumentations[${PYTHON_USEDEP}]
	...
	base? ( dev-python/albumentations[${PYTHON_USEDEP}] )
	...
	base? ( ~dev-python/joblib-1.4.2[${PYTHON_USEDEP}] )
	base? ( ~dev-python/loguru-0.7.2[${PYTHON_USEDEP}] )
	base? ( ~dev-python/pandas-2.2.3[${PYTHON_USEDEP}] )
	base? ( dev-python/nltk[${PYTHON_USEDEP}] )
	base? ( dev-python/optuna[${PYTHON_USEDEP}] )
	base? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	base? ( dev-python/sacremoses[${PYTHON_USEDEP}] )
	base? ( ~dev-python/scikit-learn-1.5.2[${PYTHON_USEDEP}] )
	base? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	base? ( ~dev-python/tqdm-4.67.0[${PYTHON_USEDEP}] )
	base? ( ~dev-python/werkzeug-3.1.2[${PYTHON_USEDEP}] )
	base? ( dev-python/xgboost[${PYTHON_USEDEP}] )
	base? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
	base? ( ~dev-python/requests-2.32.3[${PYTHON_USEDEP}] )
	base? ( dev-python/einops[${PYTHON_USEDEP}] )
	base? ( dev-python/invisible-watermark[${PYTHON_USEDEP}] )
	base? ( ~dev-python/packaging-24.1[${PYTHON_USEDEP}] )
	base? ( ~dev-python/cryptography-43.0.3[${PYTHON_USEDEP}] )
	base? ( dev-python/nvitop[${PYTHON_USEDEP}] )
	base? ( dev-python/tensorboard[${PYTHON_USEDEP}] )
	base? ( dev-python/peft[${PYTHON_USEDEP}] )
	base? ( dev-python/trl[${PYTHON_USEDEP}] )
	base? ( dev-python/tiktoken[${PYTHON_USEDEP}] )
	base? ( dev-python/transformers[${PYTHON_USEDEP}] )
	base? ( dev-python/accelerate[${PYTHON_USEDEP}] )
	base? ( dev-python/diffusers[${PYTHON_USEDEP}] )
	base? ( dev-python/rouge-score[${PYTHON_USEDEP}] )
	base? ( dev-python/py7zr[${PYTHON_USEDEP}] )
	base? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	base? ( ~dev-python/uvicorn-0.32.0[${PYTHON_USEDEP}] )
	base? ( ~dev-python/python-multipart-0.0.17[${PYTHON_USEDEP}] )
	base? ( ~dev-python/pydantic-2.9.2[${PYTHON_USEDEP}] )
	base? ( dev-python/hf-transfer[${PYTHON_USEDEP}] )
	base? ( dev-python/pyngrok[${PYTHON_USEDEP}] )
	base? ( dev-python/Authlib[${PYTHON_USEDEP}] )
	base? ( ~dev-python/itsdangerous-2.2.0[${PYTHON_USEDEP}] )
	base? ( dev-python/seqeval[${PYTHON_USEDEP}] )
	base? ( ~dev-python/httpx-0.27.2[${PYTHON_USEDEP}] )
	base? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	base? ( dev-python/timm[${PYTHON_USEDEP}] )
	...
	base? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	client? ( dev-python/requests[${PYTHON_USEDEP}] )
	client? ( dev-python/loguru[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/joblib-1.4.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/loguru-0.7.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/tqdm-4.67.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/werkzeug-3.1.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/python-multipart-0.0.17[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/joblib-1.4.2[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/loguru-0.7.2[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/pandas-2.2.3[${PYTHON_USEDEP}] )
	docs? ( dev-python/nltk[${PYTHON_USEDEP}] )
	docs? ( dev-python/optuna[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/tqdm-4.67.0[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/werkzeug-3.1.2[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/cryptography-43.0.3[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/uvicorn-0.32.0[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/python-multipart-0.0.17[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/pydantic-2.9.2[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/torchmetrics[${PYTHON_USEDEP}] )
	docs? ( dev-python/pycocotools[${PYTHON_USEDEP}] )
	docs? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/joblib-1.4.2[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/loguru-0.7.2[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pandas-2.2.3[${PYTHON_USEDEP}] )
	quality? ( dev-python/nltk[${PYTHON_USEDEP}] )
	quality? ( dev-python/optuna[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	quality? ( dev-python/sacremoses[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/scikit-learn-1.5.2[${PYTHON_USEDEP}] )
	quality? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/tqdm-4.67.0[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/werkzeug-3.1.2[${PYTHON_USEDEP}] )
	quality? ( dev-python/xgboost[${PYTHON_USEDEP}] )
	quality? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/requests-2.32.3[${PYTHON_USEDEP}] )
	quality? ( dev-python/einops[${PYTHON_USEDEP}] )
	quality? ( dev-python/invisible-watermark[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/packaging-24.1[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/cryptography-43.0.3[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/uvicorn-0.32.0[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/python-multipart-0.0.17[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pydantic-2.9.2[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/itsdangerous-2.2.0[${PYTHON_USEDEP}] )
	quality? ( dev-python/seqeval[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/httpx-0.27.2[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	quality? ( dev-python/timm[${PYTHON_USEDEP}] )
	quality? ( dev-python/torchmetrics[${PYTHON_USEDEP}] )
	quality? ( dev-python/pycocotools[${PYTHON_USEDEP}] )
	quality? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
