...
DEPENDENCIES="dev-python/teehr[${PYTHON_USEDEP}]
	...
	sm? ( dev-python/torch[${PYTHON_USEDEP}] )
	sm? ( dev-python/pytorch-lightning[${PYTHON_USEDEP}] )
	sm? ( dev-python/torchmetrics[${PYTHON_USEDEP}] )
	sm? ( dev-python/msfootprint[${PYTHON_USEDEP}] )"
