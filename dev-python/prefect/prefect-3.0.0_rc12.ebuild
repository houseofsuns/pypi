...
IUSE="aws azure bitbucket dask databricks dbt dev docker email gcp github gitlab kubernetes ray redis shell slack snowflake sqlalchemy"
DEPENDENCIES=">=dev-python/aiosqlite-0.17.0[${PYTHON_USEDEP}]
	...
	<dev-python/griffe-0.48.0[${PYTHON_USEDEP}]
