...
IUSE="all chainlit chromadb db doc-chat docx hf-embeddings hf-transformers lancedb langroid-pydantic-v1 litellm meilisearch metaphor momento mysql neo4j pdf-parsers postgres scrapy sql transformers unstructured vecdbs"
DEPENDENCIES="vecdbs? ( dev-python/chromadb[${PYTHON_USEDEP}] )
	...
	langroid-pydantic-v1? ( dev-python/langroid-pydantic-v1[${PYTHON_USEDEP}] )
	lancedb? ( dev-python/langroid-pydantic-v1[${PYTHON_USEDEP}] )
