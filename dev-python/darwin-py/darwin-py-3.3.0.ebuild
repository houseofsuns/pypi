...
IUSE="dev medical ml ocv storage-all storage-aws storage-azure storage-gcp test"
DEPENDENCIES="ml? ( dev-python/albumentations[${PYTHON_USEDEP}] )
	<dev-python/argcomplete-4.0.0[${PYTHON_USEDEP}]
	storage-azure? ( dev-python/azure-identity[${PYTHON_USEDEP}] )
	storage-all? ( dev-python/azure-identity[${PYTHON_USEDEP}] )
	storage-azure? ( dev-python/azure-storage-blob[${PYTHON_USEDEP}] )
	storage-all? ( dev-python/azure-storage-blob[${PYTHON_USEDEP}] )
	dev? ( <dev-python/black-25.0.0[${PYTHON_USEDEP}] )
	storage-aws? ( <dev-python/boto3-2.0.0[${PYTHON_USEDEP}] )
	storage-all? ( <dev-python/boto3-2.0.0[${PYTHON_USEDEP}] )
	...
	storage-gcp? ( dev-python/google-cloud-storage[${PYTHON_USEDEP}] )
	storage-all? ( dev-python/google-cloud-storage[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/python-dotenv-2.0.0[${PYTHON_USEDEP}] )
