...
DEPENDENCIES="dev-python/frequenz-api-common[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/frequenz-api-weather[${PYTHON_USEDEP}] )
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.4.4[${PYTHON_USEDEP}] )
	dev-mkdocs? ( ~dev-python/mkdocstrings-0.27.0[${PYTHON_USEDEP}] )
	dev-mkdocs? ( ~dev-python/mkdocstrings-python-1.10.8[${PYTHON_USEDEP}] )
	...
	dev-mypy? ( dev-python/frequenz-api-weather[${PYTHON_USEDEP}] )
	...
	dev-pylint? ( dev-python/frequenz-api-weather[${PYTHON_USEDEP}] )
