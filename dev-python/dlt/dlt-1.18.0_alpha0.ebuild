...
IUSE="athena az bigquery cli clickhouse databricks dbml deltalake dremio duckdb ducklake filesystem gcp gs lancedb motherduck mssql parquet postgis postgres pyiceberg qdrant redshift s3 sftp snowflake sql-database sqlalchemy synapse weaviate workspace"
