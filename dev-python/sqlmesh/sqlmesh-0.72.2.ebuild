...
IUSE="bigquery databricks dbt dev gcppostgres github llm motherduck mssql mwaa mysql postgres redshift slack snowflake trino web"
DEPENDENCIES="dev-python/astor[${PYTHON_USEDEP}]
	...
	~dev-python/sqlglot-21.1.1[${PYTHON_USEDEP}]
