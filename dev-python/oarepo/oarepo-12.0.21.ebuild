...
DEPENDENCIES="~dev-python/alembic-1.10.4[${PYTHON_USEDEP}]
	...
	~dev-python/Faker-25.9.1[${PYTHON_USEDEP}]
	...
	s3? ( ~dev-python/boto3-1.34.131[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/botocore-1.34.131[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/fsspec-2024.6.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/coverage-7.5.4[${PYTHON_USEDEP}] )
