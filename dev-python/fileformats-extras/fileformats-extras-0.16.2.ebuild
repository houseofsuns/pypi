...
IUSE="application dev image test vendor-openxmlformats-officedocument"
DEPENDENCIES="dev-python/fileformats[${PYTHON_USEDEP}]
	dev-python/pydra[${PYTHON_USEDEP}]
	application? ( dev-python/medimages4tests[${PYTHON_USEDEP}] )
	application? ( dev-python/pydicom[${PYTHON_USEDEP}] )
	application? ( >=dev-python/pyyaml-6.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/black[${PYTHON_USEDEP}] )
	dev? ( dev-python/codespell[${PYTHON_USEDEP}] )
	dev? ( dev-python/flake8[${PYTHON_USEDEP}] )
	dev? ( dev-python/Flake8-pyproject[${PYTHON_USEDEP}] )
	dev? ( dev-python/pre-commit[${PYTHON_USEDEP}] )
	image? ( >=dev-python/imageio-2.24.0[${PYTHON_USEDEP}] )
	...
	vendor-openxmlformats-officedocument? ( dev-python/python-docx[${PYTHON_USEDEP}] )"
