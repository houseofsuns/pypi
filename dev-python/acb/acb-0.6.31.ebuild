...
DEPENDENCIES=">=dev-python/itsdangerous-2.2.0[${PYTHON_USEDEP}]
	...
	requests? ( >=dev-python/hishel-0.0.31[${PYTHON_USEDEP}] )
	requests? ( >=dev-python/sentry-sdk-2.14.0[${PYTHON_USEDEP}] )
