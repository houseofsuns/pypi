...
DEPENDENCIES="dev-python/grpcio-status[${PYTHON_USEDEP}]
	...
	base_frozen? ( ~dev-python/cachetools-5.0.0[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/certifi-2021.10.8[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/charset-normalizer-2.0.12[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/click-8.0.4[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/deprecated-1.2.13[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/google-api-core-2.7.1[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/google-auth-2.6.2[${PYTHON_USEDEP}] )
	...
	base_frozen? ( ~dev-python/googleapis-common-protos-1.56.0[${PYTHON_USEDEP}] )
	...
	base_frozen? ( ~dev-python/pyasn1-0.4.8[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/pyasn1-modules-0.2.8[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/requests-2.27.1[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/rsa-4.8[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/six-1.16.0[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/tblib-1.7.0[${PYTHON_USEDEP}] )
	base_frozen? ( dev-python/toml[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/tomli-2.0.1[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/typing-extensions-3.10.0.2[${PYTHON_USEDEP}] )
	base_frozen? ( dev-python/unittest-xml-reporting[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/urllib3-1.26.9[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/wheel-0.37.1[${PYTHON_USEDEP}] )
	base_frozen? ( ~dev-python/wrapt-1.14.0[${PYTHON_USEDEP}] )
