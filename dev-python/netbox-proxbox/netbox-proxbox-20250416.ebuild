...
DESCRIPTION="Netbox Plugin - Integrate Proxmox and Netbox [badver 0.0.6b2.post1]"
...
IUSE="dev"
DEPENDENCIES=">=dev-python/websockets-13.1[${PYTHON_USEDEP}]
