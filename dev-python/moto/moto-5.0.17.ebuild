...
IUSE="all apigateway apigatewayv2 appsync awslambda batch cloudformation cognitoidp dynamodb dynamodbstreams events glue iotdata proxy quicksight resourcegroupstaggingapi s3 s3crc32c server ssm stepfunctions xray"
