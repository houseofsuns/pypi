...
DESCRIPTION="Call gemini api for extraction if the Proccessing method is Encrypted and display the extracted data on front-end in first time upload. [wheel]"
