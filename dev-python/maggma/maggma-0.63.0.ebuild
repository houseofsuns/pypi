...
IUSE="azure docs memray montydb notebook_runner open_data testing vault"
DEPENDENCIES="dev-python/setuptools[${PYTHON_USEDEP}]
	...
	notebook_runner? ( >=dev-python/ipython-8.11[${PYTHON_USEDEP}] )
	notebook_runner? ( >=dev-python/nbformat-5.0[${PYTHON_USEDEP}] )
	notebook_runner? ( >=dev-python/regex-2020.6[${PYTHON_USEDEP}] )
	open_data? ( >=dev-python/pandas-2.1.4[${PYTHON_USEDEP}] )
	open_data? ( dev-python/jsonlines[${PYTHON_USEDEP}] )
