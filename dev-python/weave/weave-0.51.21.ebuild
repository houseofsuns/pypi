...
IUSE="anthropic cerebras cohere docs dspy google-ai-studio groq instructor langchain litellm llamaindex mistral0 mistral1 modal notdiamond openai pandas-test scorers scorers-tests test"
DEPENDENCIES=">=dev-python/emoji-2.12.1[${PYTHON_USEDEP}]
	...
	scorers-tests? ( >=dev-python/Levenshtein-0.26.0[${PYTHON_USEDEP}] )
