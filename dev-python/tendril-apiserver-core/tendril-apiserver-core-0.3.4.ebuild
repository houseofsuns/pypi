...
DESCRIPTION="Tendril API Server Core Infrastructure"

HOMEPAGE="https://github.com/tendril-framework/tendril-apiserver-core"
LICENSE=""
...
DEPENDENCIES="dev-python/uvicorn[${PYTHON_USEDEP}]
	...
	docs? ( dev-python/sphinxcontrib-documentedlist[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/sphinxcontrib-documentedlist[${PYTHON_USEDEP}] )
	...
	build? ( dev-python/sphinxcontrib-documentedlist[${PYTHON_USEDEP}] )
	...
	publish? ( dev-python/sphinxcontrib-documentedlist[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/sphinxcontrib-documentedlist[${PYTHON_USEDEP}] )
