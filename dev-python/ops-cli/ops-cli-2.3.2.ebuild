...
DEPENDENCIES="dev-python/adal[${PYTHON_USEDEP}]
	...
	~dev-python/boto3-1.40.30[${PYTHON_USEDEP}]
	~dev-python/botocore-1.40.30[${PYTHON_USEDEP}]
	~dev-python/cachetools-6.2.1[${PYTHON_USEDEP}]
	...
	~dev-python/google-auth-2.43.0[${PYTHON_USEDEP}]
