...
IUSE="ai-interface cache desktop-ui full rate-limiter scheduler"
DEPENDENCIES=">=dev-python/aiofiles-24.1.0[${PYTHON_USEDEP}]
	...
	desktop-ui? ( >=dev-python/pillow-11.1.0[${PYTHON_USEDEP}] )
	desktop-ui? ( dev-python/pystray[${PYTHON_USEDEP}] )
	desktop-ui? ( dev-python/pywebview[${PYTHON_USEDEP}] )
	...
	full? ( >=dev-python/pillow-11.1.0[${PYTHON_USEDEP}] )
	full? ( dev-python/pystray[${PYTHON_USEDEP}] )
	...
	rate-limiter? ( <dev-python/redis-5.0[${PYTHON_USEDEP}] )
