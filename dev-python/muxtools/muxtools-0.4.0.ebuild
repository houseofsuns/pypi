...
DEPENDENCIES="dev-python/ass[${PYTHON_USEDEP}]
	...
	dev-python/mkvinfo[${PYTHON_USEDEP}]
	>=dev-python/psutil-5.6.4[${PYTHON_USEDEP}]
	...
	dev-python/typed-ffmpeg-compatible[${PYTHON_USEDEP}]
	>=dev-python/typing-extensions-4.12.0[${PYTHON_USEDEP}]
	dev-python/videotimestamps[${PYTHON_USEDEP}]
