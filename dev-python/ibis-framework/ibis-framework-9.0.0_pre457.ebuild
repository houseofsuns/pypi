...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/5d/1b/cfb4de1d6b62abee91e2e21d33e7ff0effd92f8ffd413f3114aac4be8d14/${REALNAME//-/_}-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/atpublic-5.0[${PYTHON_USEDEP}]
	...
	<dev-python/sqlglot-22.6[${PYTHON_USEDEP}]
	...
	snowflake? ( <dev-python/packaging-25.0[${PYTHON_USEDEP}] )
