...
IUSE="anthropic cerebras cohere docs dspy google-ai-studio groq instructor langchain langchain-nvidia-ai-endpoints litellm llamaindex mistral0 mistral1 modal notdiamond openai pandas-test scorers scorers-tests test vertexai"
DEPENDENCIES=">=dev-python/emoji-2.12.1[${PYTHON_USEDEP}]
