...
DESCRIPTION="Basic and essential code building blocks of all pythons [wheel]"
...
IUSE="categorical config pyqtgraph"
DEPENDENCIES="config? ( dev-python/hydra-core[${PYTHON_USEDEP}] )
	...
	categorical? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
