...
IUSE="bigquery databricks dbt dev gcppostgres github llm mssql mwaa mysql postgres redshift slack snowflake trino web"
DEPENDENCIES="dev-python/astor[${PYTHON_USEDEP}]
	...
	~dev-python/sqlglot-20.8.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/agate-1.6.3[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/mkdocs-material-9.0.5[${PYTHON_USEDEP}] )
