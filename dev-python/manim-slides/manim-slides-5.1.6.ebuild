...
IUSE="docs full full-gl magic manim manimgl pyqt6 pyqt6-full pyside6 pyside6-full sphinx-directive"
DEPENDENCIES="dev-python/av[${PYTHON_USEDEP}]
	...
	full-gl? ( >=dev-python/docutils-0.20.1[${PYTHON_USEDEP}] )
	full-gl? ( >=dev-python/ipython-8.12.2[${PYTHON_USEDEP}] )
	full-gl? ( dev-python/manim[${PYTHON_USEDEP}] )
	full-gl? ( dev-python/manimgl[${PYTHON_USEDEP}] )
	...
	pyqt6-full? ( >=dev-python/PyQt6-6.6.1[${PYTHON_USEDEP}] )
	...
	pyside6-full? ( <dev-python/pyside6-6.5.3[${PYTHON_USEDEP}] )
