...
IUSE="argon2 barcode bcrypt completion coroutine email-validation graphviz html2text image levenshtein postgresql pwdlib qrcode test weasyprint"
DEPENDENCIES="dev-python/defusedxml[${PYTHON_USEDEP}]
	...
	pwdlib? ( dev-python/bcrypt[${PYTHON_USEDEP}] )
