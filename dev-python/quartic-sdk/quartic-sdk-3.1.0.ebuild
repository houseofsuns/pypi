...
DEPENDENCIES="dev-python/aiogqlc[${PYTHON_USEDEP}]
	...
	complete? ( ~dev-python/joblib-1.4.0[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/matplotlib-inline-0.1.7[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/parso-0.8.4[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/regex-2024.4.16[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/traitlets-5.14.3[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/zipp-3.18.1[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/threadpoolctl-3.4.0[${PYTHON_USEDEP}] )
	complete? ( dev-python/torch[${PYTHON_USEDEP}] )
	complete? ( dev-python/umap-learn[${PYTHON_USEDEP}] )
	complete? ( ~dev-python/werkzeug-3.0.2[${PYTHON_USEDEP}] )
