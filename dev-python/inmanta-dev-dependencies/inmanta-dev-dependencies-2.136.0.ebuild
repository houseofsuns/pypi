...
DEPENDENCIES="~dev-python/black-24.8.0[${PYTHON_USEDEP}]
	...
	core? ( ~dev-python/psycopg-3.2.2[${PYTHON_USEDEP}] )
	...
	extension? ( ~dev-python/psycopg-3.2.2[${PYTHON_USEDEP}] )
	extension? ( <dev-python/tornado-7.0[${PYTHON_USEDEP}] )
	async? ( ~dev-python/pytest-asyncio-0.24.0[${PYTHON_USEDEP}] )
