...
DEPENDENCIES="dev-python/mosaicml[${PYTHON_USEDEP}]
	...
	databricks-serverless? ( <dev-python/packaging-23.0[${PYTHON_USEDEP}] )
	databricks-serverless? ( <dev-python/pytest-cov-6.0[${PYTHON_USEDEP}] )
	databricks-serverless? ( dev-python/pre-commit[${PYTHON_USEDEP}] )
	databricks-serverless? ( ~dev-python/coverage-7.4.4[${PYTHON_USEDEP}] )
	databricks-serverless? ( <dev-python/pytest-8.0[${PYTHON_USEDEP}] )
	databricks-serverless? ( <dev-python/pytest-codeblocks-0.17[${PYTHON_USEDEP}] )
	databricks-serverless? ( dev-python/mosaicml[${PYTHON_USEDEP}] )
