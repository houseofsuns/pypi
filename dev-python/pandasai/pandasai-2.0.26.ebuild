...
IUSE="bedrock chromadb connectors excel flask ggplot google-ai google-sheets langchain modin numpy plotly polars qdrant scikit-learn seaborn statsmodels streamlit text-generation yfinance"
