...
IUSE="audio chromadb dev generator prefect slackbot tests video"
DEPENDENCIES=">=dev-python/cachetools-5.0[${PYTHON_USEDEP}]
	...
	dev-python/partialjson[${PYTHON_USEDEP}]
	audio? ( dev-python/SpeechRecognition[${PYTHON_USEDEP}] )
	audio? ( >=dev-python/pyaudio-0.2.11[${PYTHON_USEDEP}] )
	audio? ( dev-python/playsound[${PYTHON_USEDEP}] )
	audio? ( >=dev-python/wheel-0.43.0[${PYTHON_USEDEP}] )
	audio? ( dev-python/pyobjc[${PYTHON_USEDEP}] )
	audio? ( dev-python/pydub[${PYTHON_USEDEP}] )
	audio? ( dev-python/simpleaudio[${PYTHON_USEDEP}] )
