...
IUSE="docs python-dateutil test"
DEPENDENCIES="docs? ( dev-python/mkdocs-awesome-pages-plugin[${PYTHON_USEDEP}] )
	docs? ( dev-python/mkdocs-material[${PYTHON_USEDEP}] )
	python-dateutil? ( <dev-python/python-dateutil-3.0.0[${PYTHON_USEDEP}] )
	python-dateutil? ( dev-python/types-python-dateutil[${PYTHON_USEDEP}] )
