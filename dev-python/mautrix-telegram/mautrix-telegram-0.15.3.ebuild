...
IUSE="all e2be formattednumbers metrics proxy qr-login speedups sqlite"
DEPENDENCIES="<dev-python/ruamel-yaml-0.19[${PYTHON_USEDEP}]
	...
	qr-login? ( <dev-python/pillow-12.0[${PYTHON_USEDEP}] )
	qr-login? ( <dev-python/qrcode-9.0[${PYTHON_USEDEP}] )
	formattednumbers? ( <dev-python/phonenumbers-10.0[${PYTHON_USEDEP}] )
	metrics? ( <dev-python/prometheus-client-0.23[${PYTHON_USEDEP}] )
	...
	sqlite? ( <dev-python/aiosqlite-0.22[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/prometheus-client-0.23[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/qrcode-9.0[${PYTHON_USEDEP}] )
