...
IUSE="aws azure bytewax cassandra ci dev docs gcp ge hbase mysql postgres redis snowflake spark trino"
DEPENDENCIES="dev-python/click[${PYTHON_USEDEP}]
	...
	ci? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	...
	ci? ( dev-python/pyOpenSSL[${PYTHON_USEDEP}] )
