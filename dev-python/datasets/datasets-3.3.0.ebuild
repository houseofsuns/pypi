...
IUSE="audio benchmarks dev docs jax quality s3 tensorflow tensorflow-gpu tests tests-numpy2 torch vision"
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	tests? ( dev-python/decord[${PYTHON_USEDEP}] )
	...
	tests-numpy2? ( dev-python/decord[${PYTHON_USEDEP}] )
