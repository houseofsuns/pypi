...
IUSE="all audio bedrock blaxel dev docker e2b gradio litellm mcp mlx-lm modal openai quality telemetry test toolkit torch transformers vision vllm"
DEPENDENCIES="dev-python/huggingface-hub[${PYTHON_USEDEP}]
	...
	blaxel? ( dev-python/blaxel[${PYTHON_USEDEP}] )
	blaxel? ( dev-python/websocket-client[${PYTHON_USEDEP}] )
	...
	modal? ( dev-python/websocket-client[${PYTHON_USEDEP}] )
