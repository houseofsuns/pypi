...
IUSE="elasticc extcats hop lasair ligo lsst slack sncosmo snpy ztf"
DEPENDENCIES="dev-python/adjustText[${PYTHON_USEDEP}]
	...
	dev-python/ampel-plot[${PYTHON_USEDEP}]
	...
	elasticc? ( dev-python/extinction[${PYTHON_USEDEP}] )
	...
	elasticc? ( dev-python/torch[${PYTHON_USEDEP}] )
