...
IUSE="all bigquery datafactory datahub hive kafka looker metabase monte-carlo mssql mysql notion postgresql power-bi redshift s3 snowflake static-web synapse tableau throughtspot trino unity-catalog"
DEPENDENCIES="all? ( dev-python/asyncpg[${PYTHON_USEDEP}] )
	...
	static-web? ( dev-python/llama-hub[${PYTHON_USEDEP}] )
