...
IUSE="all avro aws azure azure-file bigquery elasticsearch iceberg iceberg-aws influxdb3 kinesis mongodb neo4j pandas postgresql protobuf pubsub redis s3 schema-registry"
DEPENDENCIES="dev-python/confluent-kafka[${PYTHON_USEDEP}]
	...
	schema-registry? ( dev-python/confluent-kafka[${PYTHON_USEDEP}] )
