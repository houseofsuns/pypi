...
IUSE="anthropic argilla cohere dev docs groq hf-inference-endpoints hf-transformers litellm llama-cpp mistralai ollama openai outlines tests vertexai vllm"
