...
DEPENDENCIES="all? ( >=dev-python/tox-3.5.2[${PYTHON_USEDEP}] )
	...
	>=dev-python/tifffile-2021.8.30[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/tifffile-2021.8.30[${PYTHON_USEDEP}] )
	all? ( dev-python/bioio-imageio[${PYTHON_USEDEP}] )
