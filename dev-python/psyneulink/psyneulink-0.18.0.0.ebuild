...
DEPENDENCIES="<dev-python/beartype-0.22.0[${PYTHON_USEDEP}]
	...
	<dev-python/protobuf-6.32.2[${PYTHON_USEDEP}]
	...
	dev? ( <dev-python/pytest-8.4.3[${PYTHON_USEDEP}] )
	dev? ( dev-python/pytest-benchmark[${PYTHON_USEDEP}] )
	dev? ( <dev-python/pytest-cov-7.0.1[${PYTHON_USEDEP}] )
	...
	doc? ( <dev-python/sphinx-autodoc-typehints-3.3.0[${PYTHON_USEDEP}] )
	doc? ( dev-python/standard-imghdr[${PYTHON_USEDEP}] )
	tutorial? ( <dev-python/graphviz-0.22.0[${PYTHON_USEDEP}] )
	tutorial? ( <dev-python/jupyter-1.1.2[${PYTHON_USEDEP}] )
	tutorial? ( <dev-python/matplotlib-3.10.7[${PYTHON_USEDEP}] )"
