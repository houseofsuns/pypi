...
DESCRIPTION="The Scientific Python Development Environment [newver 6.0.0a3]"
...
IUSE="test"
DEPENDENCIES=">=dev-python/atomicwrites-1.2.0[${PYTHON_USEDEP}]
	...
	<dev-python/PyQtWebEngine-5.16[${PYTHON_USEDEP}]
	<dev-python/python-lsp-server-1.8.0[${PYTHON_USEDEP}]
