...
IUSE="all all-codecs all-viewers blosc boss compresso crackle dask em-codecs fp-codecs fpzip jpeg jpegxl mesh-viewer png seg-codecs skeleton-viewer test zarr zfpc"
DEPENDENCIES=">=dev-python/boto3-1.4.7[${PYTHON_USEDEP}]
	...
	jpegxl? ( dev-python/imagecodecs[${PYTHON_USEDEP}] )
