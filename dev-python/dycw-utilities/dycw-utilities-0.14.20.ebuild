...
IUSE="airium atomicwrites attrs beartype bottleneck click cryptography cvxpy dev fastapi fastparquet fpdf2 hatch holoviews hypothesis loguru luigi memory-profiler more-itertools numbagg numpy numpy-all pandas pqdm psutil pyinstrument pypi pytest pytest-check scipy scripts selenium semver sqlalchemy sqlalchemy-dbs test tqdm typed-settings xarray xarray-all zarr"
