...
DEPENDENCIES="~dev-python/attrs-23.1[${PYTHON_USEDEP}]
	...
	action? ( <dev-python/yapf-0.40.0[${PYTHON_USEDEP}] )
	...
	classification? ( <dev-python/yapf-0.40.0[${PYTHON_USEDEP}] )
	...
	detection? ( <dev-python/yapf-0.40.0[${PYTHON_USEDEP}] )
	...
	full? ( <dev-python/yapf-0.40.0[${PYTHON_USEDEP}] )
	...
	segmentation? ( <dev-python/yapf-0.40.0[${PYTHON_USEDEP}] )
	segmentation? ( dev-python/tensorboard[${PYTHON_USEDEP}] )
	visual_prompting? ( ~dev-python/natsort-8.1[${PYTHON_USEDEP}] )
	visual_prompting? ( ~dev-python/prettytable-3.9[${PYTHON_USEDEP}] )
	...
	visual_prompting? ( ~dev-python/psutil-5.9[${PYTHON_USEDEP}] )
	visual_prompting? ( ~dev-python/scipy-1.10[${PYTHON_USEDEP}] )
	visual_prompting? ( dev-python/bayesian-optimization[${PYTHON_USEDEP}] )
	visual_prompting? ( ~dev-python/multiprocess-0.70[${PYTHON_USEDEP}] )
	visual_prompting? ( dev-python/pynvml[${PYTHON_USEDEP}] )
