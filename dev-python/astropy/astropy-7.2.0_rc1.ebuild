...
DEPENDENCIES=">=dev-python/numpy-1.24[${PYTHON_USEDEP}]
	...
	recommended? ( >=dev-python/matplotlib-3.8.0[${PYTHON_USEDEP}] )
	recommended? ( >=dev-python/narwhals-1.42.0[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/sortedcontainers-2.1.0[${PYTHON_USEDEP}] )
	...
	test-all? ( dev-python/astropy[${PYTHON_USEDEP}] )
	test-all? ( >=dev-python/objgraph-3.1.2[${PYTHON_USEDEP}] )
	...
	typing? ( >=dev-python/narwhals-1.42.0[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/astropy[${PYTHON_USEDEP}] )
	dev? ( dev-python/astropy[${PYTHON_USEDEP}] )
	dev-all? ( >=dev-python/tox-4.22.0[${PYTHON_USEDEP}] )
