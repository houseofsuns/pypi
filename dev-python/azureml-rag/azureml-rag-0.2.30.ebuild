...
IUSE="azure azure-cosmos-mongo-vcore azureml-core cognitive-search data-generation document-parsing faiss hugging-face langchain local-tests milvus pinecone remote-tests validate-deployments"
