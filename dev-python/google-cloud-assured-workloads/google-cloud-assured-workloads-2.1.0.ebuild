...
DESCRIPTION="Google Cloud Assured Workloads API client library [top-max 2.2.0]"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-assured-workloads"
LICENSE="Apache-2.0"
