...
IUSE="dev flash"
DEPENDENCIES=">=dev-python/array-api-compat-1.9.0[${PYTHON_USEDEP}]
	...
	>=dev-python/ipykernel-6.17.0[${PYTHON_USEDEP}]
	...
	dev-python/simpler-flash[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/celltypist[${PYTHON_USEDEP}] )
