...
DEPENDENCIES="dev-python/eradiate-mitsuba[${PYTHON_USEDEP}]
	...
	recommended? ( >=dev-python/cachetools-5.3[${PYTHON_USEDEP}] )
	recommended? ( >=dev-python/cerberus-1.3[${PYTHON_USEDEP}] )
	recommended? ( dev-python/click[${PYTHON_USEDEP}] )
	recommended? ( dev-python/dessinemoi[${PYTHON_USEDEP}] )
	recommended? ( dev-python/dynaconf[${PYTHON_USEDEP}] )
	...
	recommended? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	...
	recommended? ( dev-python/sf-hamilton[${PYTHON_USEDEP}] )
