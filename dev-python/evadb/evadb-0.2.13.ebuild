...
IUSE="all dev document notebook udf vision"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	all? ( dev-python/facenet-pytorch[${PYTHON_USEDEP}] )
	all? ( dev-python/thefuzz[${PYTHON_USEDEP}] )
	all? ( dev-python/pytube[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/norfair[${PYTHON_USEDEP}] )
	...
	udf? ( dev-python/facenet-pytorch[${PYTHON_USEDEP}] )
	udf? ( dev-python/thefuzz[${PYTHON_USEDEP}] )
	udf? ( dev-python/pytube[${PYTHON_USEDEP}] )
	udf? ( dev-python/youtube-transcript-api[${PYTHON_USEDEP}] )
	udf? ( dev-python/qdrant-client[${PYTHON_USEDEP}] )
	udf? ( dev-python/boto3[${PYTHON_USEDEP}] )
	udf? ( dev-python/norfair[${PYTHON_USEDEP}] )
	udf? ( dev-python/kornia[${PYTHON_USEDEP}] )
