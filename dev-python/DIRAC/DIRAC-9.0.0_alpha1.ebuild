...
DESCRIPTION="DIRAC is an interware, meaning a software framework for distributed computing. [newver 9.0.0a21]"
...
IUSE="server testing"
DEPENDENCIES="dev-python/gfal2-python[${PYTHON_USEDEP}]
