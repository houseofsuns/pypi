...
DEPENDENCIES="gcs? ( dev-python/gcsfs[${PYTHON_USEDEP}] )
	test? ( dev-python/pins[${PYTHON_USEDEP}] )
	<dev-python/appdirs-2.0[${PYTHON_USEDEP}]
	<dev-python/fsspec-2025.9[${PYTHON_USEDEP}]
	...
	check? ( dev-python/pins[${PYTHON_USEDEP}] )
