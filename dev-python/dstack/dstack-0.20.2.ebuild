...
DEPENDENCIES="<dev-python/apscheduler-4.0[${PYTHON_USEDEP}]
	...
	aws? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	azure? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	datacrunch? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	gateway? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	gcp? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	kubernetes? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	lambda? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	nebius? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	oci? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
	...
	verda? ( >=dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
