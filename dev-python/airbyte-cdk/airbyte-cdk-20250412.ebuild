...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="6.45.1.post46.dev14423672753"
DIGEST_SOURCES="yes"
...
DESCRIPTION="A framework for writing Airbyte Connectors. [badver 6.45.1.post46.dev14423672753]"
...
IUSE="file-based sql vector-db-based"
