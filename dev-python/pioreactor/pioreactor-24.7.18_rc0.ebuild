...
DEPENDENCIES="~dev-python/click-8.1.7[${PYTHON_USEDEP}]
	...
	leader? ( ~dev-python/blinker-1.8.2[${PYTHON_USEDEP}] )
	leader? ( ~dev-python/flask-3.0.2[${PYTHON_USEDEP}] )
	leader? ( dev-python/flup6[${PYTHON_USEDEP}] )
	leader? ( dev-python/huey[${PYTHON_USEDEP}] )
	leader? ( ~dev-python/ifaddr-0.2.0[${PYTHON_USEDEP}] )
	leader? ( ~dev-python/itsdangerous-2.2.0[${PYTHON_USEDEP}] )
	leader? ( ~dev-python/jinja-3.1.4[${PYTHON_USEDEP}] )
	leader? ( ~dev-python/markupsafe-2.1.5[${PYTHON_USEDEP}] )
	leader? ( ~dev-python/python-dotenv-1.0.1[${PYTHON_USEDEP}] )
	leader? ( ~dev-python/werkzeug-3.0.3[${PYTHON_USEDEP}] )
	...
	leader? ( ~dev-python/typing-extensions-4.12.2[${PYTHON_USEDEP}] )
	leader-worker? ( ~dev-python/blinker-1.8.2[${PYTHON_USEDEP}] )
	leader-worker? ( ~dev-python/flask-3.0.2[${PYTHON_USEDEP}] )
	leader-worker? ( dev-python/flup6[${PYTHON_USEDEP}] )
	leader-worker? ( dev-python/huey[${PYTHON_USEDEP}] )
	leader-worker? ( ~dev-python/ifaddr-0.2.0[${PYTHON_USEDEP}] )
	leader-worker? ( ~dev-python/itsdangerous-2.2.0[${PYTHON_USEDEP}] )
	leader-worker? ( ~dev-python/jinja-3.1.4[${PYTHON_USEDEP}] )
	leader-worker? ( ~dev-python/markupsafe-2.1.5[${PYTHON_USEDEP}] )
	leader-worker? ( ~dev-python/python-dotenv-1.0.1[${PYTHON_USEDEP}] )
	leader-worker? ( ~dev-python/werkzeug-3.0.3[${PYTHON_USEDEP}] )
	...
	leader-worker? ( ~dev-python/typing-extensions-4.12.2[${PYTHON_USEDEP}] )
	...
	worker? ( ~dev-python/typing-extensions-4.12.2[${PYTHON_USEDEP}] )
