...
DEPENDENCIES="dev-python/ag-ui-protocol[${PYTHON_USEDEP}]
	dev-python/agent-lifecycle-toolkit[${PYTHON_USEDEP}]
	...
	dev-python/vlmrun[${PYTHON_USEDEP}]
	...
	docling? ( dev-python/langchain-docling[${PYTHON_USEDEP}] )
