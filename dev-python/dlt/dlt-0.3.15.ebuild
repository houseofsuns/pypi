...
IUSE="athena bigquery cli dbt duckdb filesystem gcp gs motherduck parquet postgres pydantic redshift s3 snowflake weaviate"
DEPENDENCIES="dev-python/requests[${PYTHON_USEDEP}]
	...
	athena? ( dev-python/boto3[${PYTHON_USEDEP}] )
