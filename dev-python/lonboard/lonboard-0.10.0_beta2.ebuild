...
DEPENDENCIES="dev-python/anywidget[${PYTHON_USEDEP}]
	...
	geopandas? ( <dev-python/pandas-3.0[${PYTHON_USEDEP}] )
	cli? ( dev-python/pyogrio[${PYTHON_USEDEP}] )
	>=dev-python/pyproj-3.3[${PYTHON_USEDEP}]
	cli? ( <dev-python/shapely-3.0[${PYTHON_USEDEP}] )
	geopandas? ( <dev-python/shapely-3.0[${PYTHON_USEDEP}] )
	>=dev-python/traitlets-5.10[${PYTHON_USEDEP}]
