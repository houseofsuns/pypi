...
IUSE="aws-bedrock dataloaders discord dropbox elasticsearch github gmail google googledrive huggingface-hub lancedb llama2 milvus mistralai modal mysql opensearch opensource poe postgres qdrant rss-feed slack together vertexai weaviate whatsapp youtube"
DEPENDENCIES="github? ( <dev-python/PyGithub-2.0.0[${PYTHON_USEDEP}] )
	...
	dev-python/memzero[${PYTHON_USEDEP}]
