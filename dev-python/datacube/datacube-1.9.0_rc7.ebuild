...
IUSE="all cf dev distributed doc netcdf performance s3 test types"
DEPENDENCIES="dev-python/distributed[${PYTHON_USEDEP}]
	...
	all? ( dev-python/botocore-stubs[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/types-affine[${PYTHON_USEDEP}] )
	all? ( dev-python/types-cachetools[${PYTHON_USEDEP}] )
	all? ( dev-python/types-jsonschema[${PYTHON_USEDEP}] )
	all? ( dev-python/types-psutil[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/types-affine[${PYTHON_USEDEP}] )
	...
	types? ( dev-python/types-affine[${PYTHON_USEDEP}] )
	...
	types? ( dev-python/boto3-stubs[${PYTHON_USEDEP}] )
