...
IUSE="a2a channels full gh-release-notes jieba metal nlu pii spacy transformers"
DEPENDENCIES="<dev-python/cachecontrol-0.15.0[${PYTHON_USEDEP}]
	...
	nlu? ( dev-python/keras[${PYTHON_USEDEP}] )
	...
	full? ( dev-python/tensorflow-cpu-aws[${PYTHON_USEDEP}] )
	nlu? ( dev-python/tensorflow-cpu-aws[${PYTHON_USEDEP}] )
	...
	nlu? ( dev-python/tensorflow-macos[${PYTHON_USEDEP}] )
