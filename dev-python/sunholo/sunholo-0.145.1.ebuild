...
DEPENDENCIES="dev-python/google-auth[${PYTHON_USEDEP}]
	...
	all? ( dev-python/a2a-python[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/pytest-asyncio-1.0.0[${PYTHON_USEDEP}] )
	...
	cli? ( dev-python/fastmcp[${PYTHON_USEDEP}] )
	...
	anthropic? ( dev-python/fastmcp[${PYTHON_USEDEP}] )
	...
	http? ( >=dev-python/flask-3.1.0[${PYTHON_USEDEP}] )
