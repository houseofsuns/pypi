...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="1.31.0.post0.dev114"
DIGEST_SOURCES="yes"
...
DESCRIPTION="FlowETL is a collection of special purposes Airflow operators and sensors for use with FlowKit. [badver 1.31.0.post0.dev114, wheel]"
