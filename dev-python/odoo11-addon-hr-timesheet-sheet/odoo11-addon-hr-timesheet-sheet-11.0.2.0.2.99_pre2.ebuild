...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="11.0.2.0.2.99.dev2"
DIGEST_SOURCES="yes"
...
DESCRIPTION="Timesheet Sheets, Activities [wheel]"
...
IUSE=""
DEPENDENCIES="dev-python/odoo11-addon-web-widget-x2many-2d-matrix[${PYTHON_USEDEP}]
