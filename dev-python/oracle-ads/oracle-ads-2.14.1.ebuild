...
IUSE="anomaly aqua bds boosted data feature-store-marketplace forecast geo huggingface llm notebook onnx opctl optuna pii recommender spark tensorflow testsuite text torch viz"
DEPENDENCIES=">=dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}]
	...
	anomaly? ( dev-python/rrcf[${PYTHON_USEDEP}] )
	anomaly? ( <dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	anomaly? ( dev-python/salesforce-merlion[${PYTHON_USEDEP}] )
	aqua? ( dev-python/jupyter-server[${PYTHON_USEDEP}] )
	aqua? ( dev-python/tornado[${PYTHON_USEDEP}] )
	aqua? ( <=dev-python/notebook-6.6[${PYTHON_USEDEP}] )
	aqua? ( dev-python/fire[${PYTHON_USEDEP}] )
	aqua? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	aqua? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
	aqua? ( dev-python/python-dotenv[${PYTHON_USEDEP}] )
	aqua? ( dev-python/rich[${PYTHON_USEDEP}] )
	aqua? ( dev-python/openai[${PYTHON_USEDEP}] )
	...
	boosted? ( <dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	...
	forecast? ( dev-python/cmdstanpy[${PYTHON_USEDEP}] )
	...
	notebook? ( <dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	...
	onnx? ( <dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	...
	opctl? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
	...
	recommender? ( dev-python/oracle-ads[${PYTHON_USEDEP}] )
	recommender? ( dev-python/scikit-surprise[${PYTHON_USEDEP}] )
	recommender? ( dev-python/plotly[${PYTHON_USEDEP}] )
	recommender? ( dev-python/report-creator[${PYTHON_USEDEP}] )
	...
	testsuite? ( dev-python/autogen-agentchat[${PYTHON_USEDEP}] )
