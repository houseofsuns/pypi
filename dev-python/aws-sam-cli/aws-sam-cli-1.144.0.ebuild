...
DEPENDENCIES="dev-python/chevron[${PYTHON_USEDEP}]
	...
	~dev-python/aws-sam-translator-1.100.0[${PYTHON_USEDEP}]
	...
	~dev-python/cfn-lint-1.39.1[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-docutils-0.22.0.20250822[${PYTHON_USEDEP}] )
