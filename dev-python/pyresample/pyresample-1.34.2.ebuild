...
IUSE="all cf dask gradient-search numexpr odc-geo quicklook rasterio tests xarray-bilinear"
DEPENDENCIES=">=dev-python/pyproj-3.0[${PYTHON_USEDEP}]
	...
	gradient-search? ( dev-python/shapely[${PYTHON_USEDEP}] )
	xarray-bilinear? ( dev-python/xarray[${PYTHON_USEDEP}] )
	xarray-bilinear? ( dev-python/dask[${PYTHON_USEDEP}] )
	xarray-bilinear? ( dev-python/zarr[${PYTHON_USEDEP}] )
