...
DEPENDENCIES="dev-python/odoo-addon-account-banking-mandate[${PYTHON_USEDEP}]
	...
	dev-python/odoo-addon-account-invoice-select-for-payment[${PYTHON_USEDEP}]
	...
	dev-python/odoo-addon-account-vendor-bank-account-default[${PYTHON_USEDEP}]
	dev-python/odoo-addon-account-vendor-bank-account-default-purchase[${PYTHON_USEDEP}]
