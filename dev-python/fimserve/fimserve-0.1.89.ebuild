...
DESCRIPTION="Framework which is developed with the purpose of quickly generating Flood Inundation Maps (FIM) for emergency response and risk assessment. It is developed under Surface Dynamics Modeling Lab (SDML). [wheel]"
...
IUSE="dev"
DEPENDENCIES="dev-python/teehr[${PYTHON_USEDEP}]
	...
	dev-python/fimeval[${PYTHON_USEDEP}]
