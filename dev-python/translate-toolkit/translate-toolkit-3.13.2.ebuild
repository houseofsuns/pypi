...
DEPENDENCIES=">=dev-python/lxml-4.6.3[${PYTHON_USEDEP}]
	...
	markdown? ( ~dev-python/mistletoe-1.3.0[${PYTHON_USEDEP}] )
	php? ( ~dev-python/phply-1.2.6[${PYTHON_USEDEP}] )
	rc? ( ~dev-python/pyparsing-3.1.2[${PYTHON_USEDEP}] )
	subtitles? ( dev-python/aeidon[${PYTHON_USEDEP}] )
	trados? ( >=dev-python/beautifulsoup4-4.3[${PYTHON_USEDEP}] )
	yaml? ( ~dev-python/ruamel-yaml-0.18.6[${PYTHON_USEDEP}] )
	all? ( dev-python/aeidon[${PYTHON_USEDEP}] )
	all? ( >=dev-python/beautifulsoup4-4.3[${PYTHON_USEDEP}] )
