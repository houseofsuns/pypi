...
DEPENDENCIES=">=dev-python/pandas-1.3.0[${PYTHON_USEDEP}]
	...
	all? ( dev-python/pyqt6-qscintillaxlrd[${PYTHON_USEDEP}] )
	...
	performance? ( dev-python/pyqt6-qscintillaxlrd[${PYTHON_USEDEP}] )
	performance? ( >=dev-python/openpyxl-3.0.7[${PYTHON_USEDEP}] )
	performance? ( dev-python/python-docx[${PYTHON_USEDEP}] )
	performance? ( dev-python/pywin32[${PYTHON_USEDEP}] )
