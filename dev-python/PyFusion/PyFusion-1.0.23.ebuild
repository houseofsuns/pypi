...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/56/86/27f429063ac7220bbcc3567188504c787327678d214b1a7ef51d23fc635a/pyfusion-${REALVERSION}.tar.gz"
...
DEPENDENCIES=">=dev-python/aiohttp-3.7.1[${PYTHON_USEDEP}]
	...
	doc? ( >=dev-python/mkdocstrings-python-0.18.0[${PYTHON_USEDEP}] )
	doc? ( >=dev-python/mkdocstrings-0.16.0[${PYTHON_USEDEP}] )
	test? ( <dev-python/mypy-0.901.0[${PYTHON_USEDEP}] )
