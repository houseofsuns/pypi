...
IUSE="code_style development graph_generation test"
DEPENDENCIES="dev-python/click[${PYTHON_USEDEP}]
	...
	code_style? ( dev-python/isort[${PYTHON_USEDEP}] )
	...
	graph_generation? ( dev-python/pygraphviz[${PYTHON_USEDEP}] )
	graph_generation? ( dev-python/networkx[${PYTHON_USEDEP}] )
