...
IUSE="adbc all cloudpickle connectorx deltalake fsspec gevent matplotlib numpy openpyxl pandas pyarrow pydantic pyiceberg pyxlsb sqlalchemy xlsx2csv xlsxwriter"
DEPENDENCIES="fsspec? ( dev-python/fsspec[${PYTHON_USEDEP}] )
