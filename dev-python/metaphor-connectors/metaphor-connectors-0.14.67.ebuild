...
IUSE="all bigquery confluence datafactory datahub dbt hive kafka looker monday monte-carlo mssql mysql notion oracle postgresql power-bi redshift s3 sharepoint snowflake static-web synapse tableau thought-spot trino unity-catalog"
