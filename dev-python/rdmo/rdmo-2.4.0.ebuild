...
IUSE="all allauth ci dev gunicorn ldap mysql openapi postgres pytest recommended"
DEPENDENCIES="dev-python/defusedcsv[${PYTHON_USEDEP}]
	...
	all? ( dev-python/rdmo[${PYTHON_USEDEP}] )
	recommended? ( dev-python/rdmo[${PYTHON_USEDEP}] )
	...
	pytest? ( <dev-python/pytest-10.0[${PYTHON_USEDEP}] )
	pytest? ( <dev-python/pytest-cov-8.0[${PYTHON_USEDEP}] )
