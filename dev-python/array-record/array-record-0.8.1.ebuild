...
DESCRIPTION="A file format that achieves a new frontier of IO efficiency [wheel]"
...
DEPENDENCIES="dev-python/absl-py[${PYTHON_USEDEP}]
	...
	beam? ( dev-python/google-cloud-storage[${PYTHON_USEDEP}] )
	beam? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	test? ( dev-python/jax[${PYTHON_USEDEP}] )
	test? ( dev-python/grain[${PYTHON_USEDEP}] )
