...
IUSE="1bit-mpi all autotuning autotuning-ml deepcompile dev inf readthedocs sd sparse sparse-attn triton"
DEPENDENCIES="dev-python/einops[${PYTHON_USEDEP}]
	...
	deepcompile? ( dev-python/scipy[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/pytest-8.4.0[${PYTHON_USEDEP}] )
