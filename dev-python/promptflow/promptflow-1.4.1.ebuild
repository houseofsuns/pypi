...
LICENSE="MIT"
SRC_URI="https://files.pythonhosted.org/packages/e9/ed/eb2a877ba50882287b42a4e9d344b5822b53038efb1b4805ee5e75af29e6/${REALNAME}-${REALVERSION}-py3-none-any.whl"
...
DEPENDENCIES="dev-python/psutil[${PYTHON_USEDEP}]
	...
	azureml-serving? ( dev-python/opentelemetry-api[${PYTHON_USEDEP}] )
	azureml-serving? ( dev-python/opentelemetry-sdk[${PYTHON_USEDEP}] )
	azureml-serving? ( dev-python/azure-monitor-opentelemetry[${PYTHON_USEDEP}] )
