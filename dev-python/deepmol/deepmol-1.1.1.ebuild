...
DEPENDENCIES="dev-python/rdkit[${PYTHON_USEDEP}]
	...
	deep_learning? ( ~dev-python/dill-0.3.6[${PYTHON_USEDEP}] )
	deep_learning? ( dev-python/rdkit[${PYTHON_USEDEP}] )
	deep_learning? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
	deep_learning? ( ~dev-python/seaborn-0.12.0[${PYTHON_USEDEP}] )
	...
	deep_learning? ( ~dev-python/joblib-1.1.1[${PYTHON_USEDEP}] )
	deep_learning? ( ~dev-python/pillow-8.4.0[${PYTHON_USEDEP}] )
	deep_learning? ( ~dev-python/h5py-3.7.0[${PYTHON_USEDEP}] )
	test? ( ~dev-python/dill-0.3.6[${PYTHON_USEDEP}] )
	deep_learning? ( dev-python/smilespe[${PYTHON_USEDEP}] )
	deep_learning? ( ~dev-python/cached-property-1.5.2[${PYTHON_USEDEP}] )
	deep_learning? ( dev-python/scikit-multilearn[${PYTHON_USEDEP}] )
	deep_learning? ( ~dev-python/timeout-decorator-0.5.0[${PYTHON_USEDEP}] )
	...
	deep_learning? ( ~dev-python/numpy-1.23.5[${PYTHON_USEDEP}] )
	...
	machine_learning? ( ~dev-python/h5py-3.7.0[${PYTHON_USEDEP}] )
	machine_learning? ( dev-python/smilespe[${PYTHON_USEDEP}] )
	machine_learning? ( ~dev-python/dill-0.3.6[${PYTHON_USEDEP}] )
	machine_learning? ( ~dev-python/cached-property-1.5.2[${PYTHON_USEDEP}] )
	...
	machine_learning? ( ~dev-python/numpy-1.23.5[${PYTHON_USEDEP}] )
	machine_learning? ( dev-python/shap[${PYTHON_USEDEP}] )
	machine_learning? ( ~dev-python/plotly-5.13.1[${PYTHON_USEDEP}] )
	machine_learning? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
	machine_learning? ( ~dev-python/joblib-1.1.1[${PYTHON_USEDEP}] )
	machine_learning? ( dev-python/scikit-multilearn[${PYTHON_USEDEP}] )
	machine_learning? ( dev-python/umap-learn[${PYTHON_USEDEP}] )
	machine_learning? ( ~dev-python/seaborn-0.12.0[${PYTHON_USEDEP}] )
	machine_learning? ( ~dev-python/pillow-8.4.0[${PYTHON_USEDEP}] )
	machine_learning? ( ~dev-python/timeout-decorator-0.5.0[${PYTHON_USEDEP}] )
