...
DEPENDENCIES="dev-python/pycryptodome[${PYTHON_USEDEP}]
	...
	agents? ( dev-python/anyio[${PYTHON_USEDEP}] )
	agents? ( dev-python/langchain-community[${PYTHON_USEDEP}] )
	agents? ( dev-python/langchain-openai[${PYTHON_USEDEP}] )
	agents? ( dev-python/PyMuPDF[${PYTHON_USEDEP}] )
	agents? ( dev-python/requests[${PYTHON_USEDEP}] )
	agents? ( dev-python/tantivy[${PYTHON_USEDEP}] )
	agents? ( dev-python/typer[${PYTHON_USEDEP}] )
	agents? ( dev-python/typing-extensions[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/pyzotero[${PYTHON_USEDEP}] )
	...
	llms? ( dev-python/faiss-cpu[${PYTHON_USEDEP}] )
	llms? ( dev-python/langchain-community[${PYTHON_USEDEP}] )
	llms? ( dev-python/langchain-openai[${PYTHON_USEDEP}] )
	llms? ( dev-python/PyMuPDF[${PYTHON_USEDEP}] )
	llms? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
	llms? ( dev-python/voyageai[${PYTHON_USEDEP}] )"
