...
DEPENDENCIES="~dev-python/asgiref-3.10.0[${PYTHON_USEDEP}]
	...
	~dev-python/plumbum-1.10.0[${PYTHON_USEDEP}]
	...
	storage-s3? ( ~dev-python/boto3-1.40.65[${PYTHON_USEDEP}] )
	...
	package? ( ~dev-python/twine-6.2.0[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/tblib-3.2.1[${PYTHON_USEDEP}] )
	test? ( >=dev-python/testfixtures-10.0.0[${PYTHON_USEDEP}] )
