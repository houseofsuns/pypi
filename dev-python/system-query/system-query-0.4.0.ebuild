...
DEPENDENCIES="dev-python/boilerplates[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/psutil-6.1[${PYTHON_USEDEP}] )
	...
	cpu? ( ~dev-python/psutil-6.1[${PYTHON_USEDEP}] )
	...
	ram? ( ~dev-python/psutil-6.1[${PYTHON_USEDEP}] )
	swap? ( ~dev-python/psutil-6.1[${PYTHON_USEDEP}] )"
