...
DESCRIPTION="Live Chatbots based on Langchain chatbots and Agents     Integrated into Navigator Framework or used into any aiohttp applications. [prod-max (True, <g_sorcery.g_collections.Version object at 0x7fe2b4ff77d0>)]"
