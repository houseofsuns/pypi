...
DESCRIPTION="Train and deploy pytorch models [topver 0.6.2]"
...
DEPENDENCIES="dev-python/six[${PYTHON_USEDEP}]
	...
	all? ( dev-python/tensorboard-logger[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/parse-1.8.4[${PYTHON_USEDEP}] )
	...
	all-strict? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/psutil-5.4.7[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/Pygments[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/tensorboard-logger[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/tensorboard[${PYTHON_USEDEP}] )
	...
	optional? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	optional? ( dev-python/psutil[${PYTHON_USEDEP}] )
	optional? ( dev-python/Pygments[${PYTHON_USEDEP}] )
	optional? ( dev-python/tensorboard-logger[${PYTHON_USEDEP}] )
	...
	optional-strict? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	optional-strict? ( ~dev-python/psutil-5.4.7[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/Pygments[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/tensorboard-logger[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/tensorboard[${PYTHON_USEDEP}] )
	...
	optional-strict? ( ~dev-python/pandas-1.4.0[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/Pillow[${PYTHON_USEDEP}] )
	optional-strict? ( ~dev-python/matplotlib-3.5.0[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/parse-1.8.4[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( dev-python/kwplot[${PYTHON_USEDEP}] )
