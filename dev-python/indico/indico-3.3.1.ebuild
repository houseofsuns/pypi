...
DEPENDENCIES="~dev-python/alembic-1.13.1[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/aiosmtpd-1.4.5[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/atpublic-4.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/redis-5.0.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/tornado-6.4[${PYTHON_USEDEP}] )
