...
IUSE="all declarative dev doc mysql postgresql sqlite web"
DEPENDENCIES="all? ( dev-python/reahl-browsertools[${PYTHON_USEDEP}] )
	all? ( dev-python/reahl-component[${PYTHON_USEDEP}] )
