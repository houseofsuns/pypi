...
IUSE="all all-strict docs docs-strict gdal gdal-strict gdal-strict-strict graphics graphics-strict headless headless-strict linting linting-strict optional optional-strict postgresql postgresql-strict runtime runtime-strict tests tests-strict"
DEPENDENCIES="dev-python/delayed-image[${PYTHON_USEDEP}]
	...
	docs-strict? ( ~dev-python/pandas-1.3.5[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/jq-1.3.0[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/jq-1.5.0[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/seaborn-0.10.0[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/jq-1.3.0[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/jq-1.5.0[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/seaborn-0.10.0[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/xarray-0.16.0[${PYTHON_USEDEP}] )
