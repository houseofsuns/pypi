...
DESCRIPTION="Provider package apache-airflow-providers-google for Apache Airflow [wheel]"
...
IUSE="amazon apache-beam apache-cassandra cncf-kubernetes fab facebook leveldb microsoft-azure microsoft-mssql mysql openlineage oracle postgres presto salesforce sftp ssh trino"
DEPENDENCIES="dev-python/apache-airflow[${PYTHON_USEDEP}]
	...
	dev-python/google-cloud-managedkafka[${PYTHON_USEDEP}]
