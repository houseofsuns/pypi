...
DESCRIPTION="Large Solar Thermal Monitoring Tool. Implements the Power Check of ISO 24194. [wheel]"
...
DEPENDENCIES="db? ( dev-python/alembic[${PYTHON_USEDEP}] )
	...
	db? ( >=dev-python/psycopg-3.0[${PYTHON_USEDEP}] )
	api? ( >=dev-python/psycopg-3.0[${PYTHON_USEDEP}] )
	all? ( >=dev-python/psycopg-3.0[${PYTHON_USEDEP}] )
