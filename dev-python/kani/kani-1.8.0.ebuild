...
IUSE="all anthropic cpp google huggingface llama mcp multimodal openai vllm"
DEPENDENCIES="<dev-python/pydantic-3.0.0[${PYTHON_USEDEP}]
	...
	all? ( dev-python/kani-ext-vllm[${PYTHON_USEDEP}] )
	all? ( dev-python/kani-multimodal-core[${PYTHON_USEDEP}] )
	...
	cpp? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	...
	multimodal? ( dev-python/kani-multimodal-core[${PYTHON_USEDEP}] )
	...
	vllm? ( dev-python/kani-ext-vllm[${PYTHON_USEDEP}] )"
