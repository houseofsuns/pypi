...
IUSE="all all-codecs all-sql all-viewers blosc boss compresso crackle dask em-codecs fp-codecs fpzip jpeg jxl mesh-viewer mysql png psql seg-codecs skeleton-viewer test zarr zfpc"
DEPENDENCIES=">=dev-python/boto3-1.4.7[${PYTHON_USEDEP}]
	...
	zarr? ( dev-python/zstandard[${PYTHON_USEDEP}] )
	...
	all-sql? ( dev-python/psycopg2[${PYTHON_USEDEP}] )
	all-sql? ( dev-python/mysql-connector-python[${PYTHON_USEDEP}] )
	...
	all-codecs? ( dev-python/zstandard[${PYTHON_USEDEP}] )
