...
IUSE="all anthropic azure cli database excel gcp http iac langchain ollama openai pipeline test tools tts video"
DEPENDENCIES="dev-python/a2a-python[${PYTHON_USEDEP}]
	...
	langchain? ( dev-python/langchain-unstructured[${PYTHON_USEDEP}] )
	...
	gcp? ( dev-python/a2a-python[${PYTHON_USEDEP}] )
	gcp? ( dev-python/aiofiles[${PYTHON_USEDEP}] )
	...
	gcp? ( dev-python/langchain[${PYTHON_USEDEP}] )
	...
	ollama? ( dev-python/pillow[${PYTHON_USEDEP}] )
	...
	http? ( dev-python/langchain[${PYTHON_USEDEP}] )
