...
IUSE="chromadb full lancedb milvus mongo neo4j pinecone postgres qdrant redis whisper"
DEPENDENCIES="dev-python/huggingface-hub[${PYTHON_USEDEP}]
	...
	mongo? ( >=dev-python/pymongo-4.7.0[${PYTHON_USEDEP}] )
	neo4j? ( dev-python/neo4j[${PYTHON_USEDEP}] )
	full? ( >=dev-python/pymongo-4.7.0[${PYTHON_USEDEP}] )
