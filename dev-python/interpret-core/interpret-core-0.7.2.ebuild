...
IUSE="aplr dash debug excel lime notebook plotly sensitivity shap skoperules testing treeinterpreter"
DEPENDENCIES=">=dev-python/numpy-1.25[${PYTHON_USEDEP}]
	...
	excel? ( >=dev-python/xlsxwriter-3.0.1[${PYTHON_USEDEP}] )
	excel? ( dev-python/dotsi[${PYTHON_USEDEP}] )
	excel? ( >=dev-python/seaborn-0.13.2[${PYTHON_USEDEP}] )
	excel? ( >=dev-python/matplotlib-3.9.1[${PYTHON_USEDEP}] )
	...
	testing? ( >=dev-python/scipy-0.18.1[${PYTHON_USEDEP}] )
