...
DEPENDENCIES=">=dev-python/tomli-2.0[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/cattrs-22.2[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/attrs-23.1[${PYTHON_USEDEP}] )
	dev? ( dev-python/black[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/cattrs-22.2[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/furo-2023.9[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/attrs-23.1[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/cattrs-22.2[${PYTHON_USEDEP}] )
	docs? ( dev-python/click-option-group[${PYTHON_USEDEP}] )
	...
	lint? ( >=dev-python/attrs-23.1[${PYTHON_USEDEP}] )
	lint? ( dev-python/black[${PYTHON_USEDEP}] )
	lint? ( >=dev-python/cattrs-22.2[${PYTHON_USEDEP}] )
	lint? ( dev-python/click-option-group[${PYTHON_USEDEP}] )
	lint? ( >=dev-python/click-7.0[${PYTHON_USEDEP}] )
	lint? ( dev-python/jinja[${PYTHON_USEDEP}] )
	lint? ( dev-python/mypy[${PYTHON_USEDEP}] )
	lint? ( >=dev-python/pydantic-2.0[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/attrs-23.1[${PYTHON_USEDEP}] )
	test? ( >=dev-python/cattrs-22.2[${PYTHON_USEDEP}] )
