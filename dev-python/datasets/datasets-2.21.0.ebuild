...
IUSE="apache-beam audio benchmarks dev docs jax metrics-tests quality s3 tensorflow tensorflow-gpu tests tests-numpy2 tests_numpy2 torch vision"
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	tests-numpy2? ( >=dev-python/typing-extensions-4.6.1[${PYTHON_USEDEP}] )
	...
	tests-numpy2? ( dev-python/librosa[${PYTHON_USEDEP}] )
