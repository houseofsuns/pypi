...
DEPENDENCIES="~dev-python/black-24.4.2[${PYTHON_USEDEP}]
	...
	~dev-python/pyupgrade-3.15.2[${PYTHON_USEDEP}]
	...
	core? ( ~dev-python/psycopg-3.1.19[${PYTHON_USEDEP}] )
	...
	extension? ( ~dev-python/psycopg-3.1.19[${PYTHON_USEDEP}] )
	extension? ( <dev-python/tornado-7.0[${PYTHON_USEDEP}] )
	async? ( ~dev-python/pytest-asyncio-0.23.6[${PYTHON_USEDEP}] )
