...
DESCRIPTION="Python Materials Genomics is a robust materials analysis code that defines core object representations for structures"
...
IUSE="abinit ase ci docs electronic-structure mlp numba numpy-v1 optional symmetry tblite vis zeopp"
DEPENDENCIES=">=dev-python/joblib-1.0[${PYTHON_USEDEP}]
	...
	ci? ( dev-python/pymatgen[${PYTHON_USEDEP}] )
