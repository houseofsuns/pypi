...
HOMEPAGE="https://github.com/mesa/mesa"
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/c4/78/781b1e3575b82571d81ef2a027dbcad2ad1679314abc3f3bfae4f83256c8/mesa-${REALVERSION}.tar.gz"
...
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	>=dev-python/pythran-0.17.0[${PYTHON_USEDEP}]
	dev-python/scipy[${PYTHON_USEDEP}]
	dev-python/tqdm[${PYTHON_USEDEP}]
	all? ( dev-python/altair[${PYTHON_USEDEP}] )
	all? ( dev-python/ipython[${PYTHON_USEDEP}] )
	all? ( >=dev-python/ipython-9.2.0[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/pytest-ipywidgets[${PYTHON_USEDEP}] )
