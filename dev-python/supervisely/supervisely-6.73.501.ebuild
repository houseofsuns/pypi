...
IUSE="agent apps aug docs extras model-benchmark plugins sdk-nn-plugins sdk-no-usages tracking training versioning"
DEPENDENCIES="<=dev-python/cachetools-5.5.0[${PYTHON_USEDEP}]
	...
	<=dev-python/python-json-logger-3.0.1[${PYTHON_USEDEP}]
	...
	<=dev-python/starlette-0.47.3[${PYTHON_USEDEP}]
	...
	extras? ( <=dev-python/pandas-2.3.3[${PYTHON_USEDEP}] )
	...
	apps? ( <=dev-python/pandas-2.3.3[${PYTHON_USEDEP}] )
	...
	aug? ( <dev-python/numpy-2.0.0[${PYTHON_USEDEP}] )
	agent? ( <=dev-python/protobuf-3.20.3[${PYTHON_USEDEP}] )
	versioning? ( <=dev-python/pyarrow-22.0.0[${PYTHON_USEDEP}] )"
