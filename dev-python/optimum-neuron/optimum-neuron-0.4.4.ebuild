...
IUSE="diffusers diffusers-tests neuronx quality sentence-transformers tests training vllm vllm-tests"
DEPENDENCIES="dev-python/transformers[${PYTHON_USEDEP}]
	...
	neuronx? ( >=dev-python/protobuf-3.20.3[${PYTHON_USEDEP}] )
	neuronx? ( <=dev-python/numpy-1.26.4[${PYTHON_USEDEP}] )
