...
IUSE="amrvac arepo cf-radial chimera cholla chombo eagle enzo enzo-e exodus-ii fits flash fortran full gadget gadget-fof gamer gdf gizmo halo-catalog hdf5 http-stream idefix mapserver moab nc4-cm1 netcdf4 open-pmd owls owls-subfind parthenon ramses sdf swift test ytdata"
DEPENDENCIES="dev-python/cmyt[${PYTHON_USEDEP}]
	...
	hdf5? ( >dev-python/h5py-3.15.0[${PYTHON_USEDEP}] )
