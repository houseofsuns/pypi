...
DEPENDENCIES="dev-python/dagit[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/dagster-snowflake[${PYTHON_USEDEP}] )
	dev? ( dev-python/types-python-dateutil[${PYTHON_USEDEP}] )
	dev? ( dev-python/types-PyYAML[${PYTHON_USEDEP}] )
	dev? ( dev-python/tox[${PYTHON_USEDEP}] )
	dev? ( dev-python/dagster-snowflake-pandas[${PYTHON_USEDEP}] )
	dev? ( dev-python/packaging[${PYTHON_USEDEP}] )
	dev? ( dev-python/twine[${PYTHON_USEDEP}] )
	dev? ( >dev-python/deepdiff-8.0.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/dagit[${PYTHON_USEDEP}] )
	dev? ( dev-python/dagster[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/dagster-aws[${PYTHON_USEDEP}] )
	...
	integration-tests? ( dev-python/dagster-snowflake-pandas[${PYTHON_USEDEP}] )
	...
	integration-tests? ( dev-python/dagster[${PYTHON_USEDEP}] )
