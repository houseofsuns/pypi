...
DESCRIPTION="Analysis of digital elevation models and elevation point clouds"
...
DEPENDENCIES="dev-python/geoutils[${PYTHON_USEDEP}]
	...
	opt? ( dev-python/laspy[${PYTHON_USEDEP}] )
	opt? ( dev-python/cerberus[${PYTHON_USEDEP}] )
	opt? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	opt? ( dev-python/weasyprint[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/laspy[${PYTHON_USEDEP}] )
