...
DEPENDENCIES="dev-python/pysb[${PYTHON_USEDEP}]
	...
	eidos_offline? ( dev-python/cython[${PYTHON_USEDEP}] )
	eidos_offline? ( dev-python/pyjnius[${PYTHON_USEDEP}] )
	...
	reach_offline? ( dev-python/cython[${PYTHON_USEDEP}] )
	reach_offline? ( dev-python/pyjnius[${PYTHON_USEDEP}] )
	sbml? ( dev-python/python-libsbml[${PYTHON_USEDEP}] )
	sklearn_belief? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
	trips_offline? ( dev-python/pykqml[${PYTHON_USEDEP}] )"
