...
IUSE="ag2 ag2-testing agent-engines autologging cloud-profiler datasets endpoint evaluation full langchain langchain-testing lit llama-index llama-index-testing metadata pipelines prediction private-endpoints ray ray-testing ray_testing reasoningengine tensorboard testing tokenization vizier xai"
DEPENDENCIES="<dev-python/google-api-core-3.0.0[${PYTHON_USEDEP}]
	...
	cloud-profiler? ( <dev-python/werkzeug-2.1.0[${PYTHON_USEDEP}] )
	...
	full? ( <dev-python/werkzeug-2.1.0[${PYTHON_USEDEP}] )
	...
	tensorboard? ( <dev-python/werkzeug-2.1.0[${PYTHON_USEDEP}] )
