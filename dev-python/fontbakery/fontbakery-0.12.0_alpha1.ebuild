...
IUSE="all docs fontval fontwerk googlefonts notofonts shaping typenetwork ufo-sources"
DEPENDENCIES=">=dev-python/fonttools-4.39.0[${PYTHON_USEDEP}]
	...
	all? ( dev-python/gfsubsets[${PYTHON_USEDEP}] )
	...
	fontwerk? ( dev-python/gfsubsets[${PYTHON_USEDEP}] )
	...
	googlefonts? ( dev-python/gfsubsets[${PYTHON_USEDEP}] )
	...
	notofonts? ( dev-python/gfsubsets[${PYTHON_USEDEP}] )
