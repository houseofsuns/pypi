...
DEPENDENCIES="~dev-python/black-25.12.0[${PYTHON_USEDEP}]
	...
	~dev-python/pyupgrade-3.21.2[${PYTHON_USEDEP}]
	...
	core? ( ~dev-python/pytest-env-1.2.0[${PYTHON_USEDEP}] )
	core? ( dev-python/pytest-postgresql[${PYTHON_USEDEP}] )
	core? ( ~dev-python/psycopg-3.3.2[${PYTHON_USEDEP}] )
	...
	extension? ( ~dev-python/pytest-env-1.2.0[${PYTHON_USEDEP}] )
	extension? ( dev-python/pytest-postgresql[${PYTHON_USEDEP}] )
	extension? ( ~dev-python/psycopg-3.3.2[${PYTHON_USEDEP}] )
	extension? ( <dev-python/tornado-7.0[${PYTHON_USEDEP}] )
	async? ( ~dev-python/pytest-asyncio-1.3.0[${PYTHON_USEDEP}] )
	async? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	pytest? ( ~dev-python/pytest-env-1.2.0[${PYTHON_USEDEP}] )
