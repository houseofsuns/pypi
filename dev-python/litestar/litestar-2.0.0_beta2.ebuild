...
IUSE="annotated-types attrs brotli cli cryptography full jinja jwt opentelemetry picologging prometheus redis sqlalchemy standard structlog tortoise-orm"
DEPENDENCIES="sqlalchemy? ( dev-python/alembic[${PYTHON_USEDEP}] )
	...
	attrs? ( dev-python/cattrs[${PYTHON_USEDEP}] )
	...
	attrs? ( dev-python/python-dateutil[${PYTHON_USEDEP}] )
	...
	attrs? ( dev-python/pytimeparse[${PYTHON_USEDEP}] )
	full? ( dev-python/pytimeparse[${PYTHON_USEDEP}] )
