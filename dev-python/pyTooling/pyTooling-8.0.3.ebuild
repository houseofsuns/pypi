...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/44/88/22922827ef42e2defcf7e20a57ecf01f16b6f53dadc54a0c6ff70b70aacd/pytooling-${REALVERSION}.tar.gz"
...
DEPENDENCIES="doc? ( dev-python/sphinxcontrib-mermaid[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/setuptools-75.5[${PYTHON_USEDEP}] )
	...
	packaging? ( ~dev-python/setuptools-75.5[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/setuptools-75.5[${PYTHON_USEDEP}] )
