...
DESCRIPTION="Simple, elegant, Pythonic functional programming. [badver 3.1.2.post0.dev7]"
...
DEPENDENCIES=">=dev-python/setuptools-44.0[${PYTHON_USEDEP}]
	kernel? ( >=dev-python/ipython-9.0[${PYTHON_USEDEP}] )
	...
	mypy? ( >=dev-python/mypy-1.15[${PYTHON_USEDEP}] )
	...
	numpy? ( >=dev-python/xarray-2025.0[${PYTHON_USEDEP}] )
	jupyter? ( >=dev-python/ipython-9.0[${PYTHON_USEDEP}] )
	...
	jupyterlab? ( >=dev-python/ipython-9.0[${PYTHON_USEDEP}] )
	...
	jupytext? ( >=dev-python/ipython-9.0[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/xarray-2025.0[${PYTHON_USEDEP}] )
	...
	tests? ( >=dev-python/ipython-9.0[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/xarray-2025.0[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/pygments-2.19[${PYTHON_USEDEP}] )
