...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/a9/3b/46a97bb7608aa33af3953fa58118b20b507a4c082e2a1b04d7b3df663037/farm_haystack-${REALVERSION}.tar.gz"
...
IUSE="all all-gpu audio beir colab crawler dev docstores docstores-gpu elasticsearch faiss faiss-gpu file-conversion formatting metrics ocr only-faiss only-faiss-gpu only-pinecone onnx onnx-gpu opensearch pdf pinecone preprocessing ray sql weaviate"
DEPENDENCIES="dev-python/azure-ai-formrecognizer[${PYTHON_USEDEP}]
	...
	dev-python/generalimport[${PYTHON_USEDEP}]
