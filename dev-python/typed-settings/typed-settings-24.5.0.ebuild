...
DEPENDENCIES=">=dev-python/tomli-2.0[${PYTHON_USEDEP}]
	...
	dev? ( >=dev-python/cattrs-24.1[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/cattrs-24.1[${PYTHON_USEDEP}] )
	...
	lint? ( >=dev-python/cattrs-24.1[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/cattrs-24.1[${PYTHON_USEDEP}] )
