...
IUSE="adk ag2 ag2-testing agent-engines autologging cloud-profiler datasets endpoint evaluation full langchain langchain-testing lit llama-index llama-index-testing metadata pipelines prediction private-endpoints ray ray-testing reasoningengine tensorboard testing tokenization vizier xai"
DEPENDENCIES="<dev-python/google-api-core-3.0.0[${PYTHON_USEDEP}]
	...
	testing? ( dev-python/litellm[${PYTHON_USEDEP}] )
	...
	testing? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	testing? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	testing? ( <=dev-python/protobuf-5.29.4[${PYTHON_USEDEP}] )
	...
	prediction? ( <=dev-python/httpx-0.28.1[${PYTHON_USEDEP}] )
	...
	adk? ( dev-python/opentelemetry-instrumentation-google-genai[${PYTHON_USEDEP}] )
	...
	reasoningengine? ( dev-python/opentelemetry-exporter-gcp-logging[${PYTHON_USEDEP}] )
	reasoningengine? ( dev-python/opentelemetry-exporter-gcp-trace[${PYTHON_USEDEP}] )
	reasoningengine? ( dev-python/opentelemetry-exporter-otlp-proto-http[${PYTHON_USEDEP}] )
	...
	agent-engines? ( dev-python/opentelemetry-exporter-gcp-logging[${PYTHON_USEDEP}] )
	agent-engines? ( dev-python/opentelemetry-exporter-gcp-trace[${PYTHON_USEDEP}] )
	agent-engines? ( dev-python/opentelemetry-exporter-otlp-proto-http[${PYTHON_USEDEP}] )
	...
	evaluation? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	evaluation? ( dev-python/litellm[${PYTHON_USEDEP}] )
	...
	langchain-testing? ( dev-python/opentelemetry-exporter-otlp-proto-http[${PYTHON_USEDEP}] )
	...
	langchain-testing? ( dev-python/opentelemetry-exporter-gcp-logging[${PYTHON_USEDEP}] )
	...
	ag2-testing? ( dev-python/opentelemetry-exporter-otlp-proto-http[${PYTHON_USEDEP}] )
	...
	ag2-testing? ( dev-python/opentelemetry-exporter-gcp-logging[${PYTHON_USEDEP}] )
	...
	llama-index-testing? ( dev-python/opentelemetry-exporter-otlp-proto-http[${PYTHON_USEDEP}] )
	...
	llama-index-testing? ( dev-python/opentelemetry-exporter-gcp-logging[${PYTHON_USEDEP}] )
