...
DEPENDENCIES="docs? ( ~dev-python/markdown-3.3.7[${PYTHON_USEDEP}] )
	...
	flake8? ( ~dev-python/flake8-3.9.2[${PYTHON_USEDEP}] )
	...
	isort? ( ~dev-python/isort-5.11.4[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/mkdocs-macros-plugin-0.7.0[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/mkdocs-material-9.4.10[${PYTHON_USEDEP}] )
	...
	pylint? ( ~dev-python/pylint-2.13.9[${PYTHON_USEDEP}] )
