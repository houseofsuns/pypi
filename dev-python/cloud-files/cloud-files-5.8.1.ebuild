...
IUSE="apache monitoring numpy test"
DEPENDENCIES=">=dev-python/boto3-1.4.7[${PYTHON_USEDEP}]
	...
	monitoring? ( dev-python/psutil[${PYTHON_USEDEP}] )
	monitoring? ( dev-python/intervaltree[${PYTHON_USEDEP}] )
	monitoring? ( dev-python/matplotlib[${PYTHON_USEDEP}] )
	apache? ( dev-python/lxml[${PYTHON_USEDEP}] )"
