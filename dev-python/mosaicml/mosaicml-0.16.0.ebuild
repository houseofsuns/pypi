...
IUSE="all coco comet_ml deepspeed dev gcs health_checker libcloud mlflow mlperf nlp oci onnx sentencepiece slack streaming tensorboard timm unet vit wandb"
