...
IUSE="annotated-types attrs brotli cli cryptography full htmx jinja jwt mako minijinja opentelemetry piccolo picologging prometheus pydantic redis sqlalchemy standard structlog"
DEPENDENCIES=">=dev-python/anyio-3.0[${PYTHON_USEDEP}]
	...
	htmx? ( dev-python/litestar-htmx[${PYTHON_USEDEP}] )
