...
DEPENDENCIES="dev-python/frequenz-client-microgrid[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( <dev-python/mkdocs-autorefs-1.1[${PYTHON_USEDEP}] )
	...
	dev-mypy? ( ~dev-python/types-setuptools-71.1.0.20240726[${PYTHON_USEDEP}] )
	...
	dev-pylint? ( ~dev-python/pylint-3.2.5[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/hypothesis-6.104.2[${PYTHON_USEDEP}] )"
