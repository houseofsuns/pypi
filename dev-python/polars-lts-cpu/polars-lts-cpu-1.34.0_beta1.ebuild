...
IUSE="adbc all async calamine cloudpickle connectorx database deltalake excel fsspec gpu graph iceberg idx64 lts-cpu numpy openpyxl pandas plot polars-cloud pyarrow pydantic sqlalchemy style xlsx2csv xlsxwriter"
DEPENDENCIES="idx64? ( dev-python/polars-u64-idx[${PYTHON_USEDEP}] )
	lts-cpu? ( dev-python/polars-lts-cpu[${PYTHON_USEDEP}] )
