...
DESCRIPTION="Channel implementations for Python [newver 0.16.1]"
...
DEPENDENCIES="<dev-python/typing-extensions-5.0[${PYTHON_USEDEP}]
	...
	dev-formatting? ( ~dev-python/black-23.10.1[${PYTHON_USEDEP}] )
	dev-formatting? ( ~dev-python/isort-5.12.0[${PYTHON_USEDEP}] )
	dev-mkdocs? ( ~dev-python/black-23.10.1[${PYTHON_USEDEP}] )
	dev-mkdocs? ( ~dev-python/markdown-3.4.4[${PYTHON_USEDEP}] )
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.3.2[${PYTHON_USEDEP}] )
	...
	dev-mypy? ( ~dev-python/mypy-1.6.1[${PYTHON_USEDEP}] )
	...
	dev-pylint? ( ~dev-python/pylint-2.17.7[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/hypothesis-6.88.1[${PYTHON_USEDEP}] )
