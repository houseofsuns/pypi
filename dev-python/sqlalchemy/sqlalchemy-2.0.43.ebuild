...
DEPENDENCIES=">=dev-python/greenlet-1.0[${PYTHON_USEDEP}]
	...
	postgresql-asyncpg? ( >=dev-python/greenlet-1.0[${PYTHON_USEDEP}] )
	...
	aiomysql? ( >=dev-python/greenlet-1.0[${PYTHON_USEDEP}] )
	aiomysql? ( dev-python/aiomysql[${PYTHON_USEDEP}] )
	aioodbc? ( >=dev-python/greenlet-1.0[${PYTHON_USEDEP}] )
	aioodbc? ( dev-python/aioodbc[${PYTHON_USEDEP}] )
	asyncmy? ( >=dev-python/greenlet-1.0[${PYTHON_USEDEP}] )
	asyncmy? ( dev-python/asyncmy[${PYTHON_USEDEP}] )
	aiosqlite? ( >=dev-python/greenlet-1.0[${PYTHON_USEDEP}] )
