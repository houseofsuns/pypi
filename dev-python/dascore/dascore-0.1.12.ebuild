...
IUSE="all dev docs extras profile profile-base test"
DEPENDENCIES="dev-python/h5py[${PYTHON_USEDEP}]
	...
	extras? ( dev-python/bottleneck[${PYTHON_USEDEP}] )
	...
	profile-base? ( dev-python/pytest-codspeed[${PYTHON_USEDEP}] )
	profile-base? ( dev-python/pytest-profiling[${PYTHON_USEDEP}] )
	all? ( dev-python/dascore[${PYTHON_USEDEP}] )
	profile? ( dev-python/dascore[${PYTHON_USEDEP}] )
	profile? ( dev-python/dascore[${PYTHON_USEDEP}] )
