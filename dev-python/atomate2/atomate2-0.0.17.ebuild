...
IUSE="abinit amset ase ase-ext cclib defects dev docs forcefields lobster mp openmm phonons strict strict-forcefields tests"
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	docs? ( ~dev-python/ipython-8.27.0[${PYTHON_USEDEP}] )
