...
IUSE="all console dbtmetricflowapi docs genericjsonapi genericxmlapi githubapi gsheetsapi holidaysmemory htmltableapi pandasmemory s3selectapi systemapi testing"
DEPENDENCIES=">=dev-python/apsw-3.9.2[${PYTHON_USEDEP}]
