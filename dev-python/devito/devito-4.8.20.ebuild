...
DEPENDENCIES=">=dev-python/pip-9.0.1[${PYTHON_USEDEP}]
	...
	nvidia? ( <dev-python/fsspec-2025.7.1[${PYTHON_USEDEP}] )
	...
	tests? ( <dev-python/scipy-1.15.4[${PYTHON_USEDEP}] )
	tests? ( <dev-python/pooch-1.8.3[${PYTHON_USEDEP}] )
	tests? ( <dev-python/click-9.0[${PYTHON_USEDEP}] )
	extras? ( <dev-python/matplotlib-3.10.7[${PYTHON_USEDEP}] )
	extras? ( <dev-python/pillow-11.3.1[${PYTHON_USEDEP}] )
	extras? ( dev-python/pyrevolve[${PYTHON_USEDEP}] )
	extras? ( <dev-python/scipy-1.15.4[${PYTHON_USEDEP}] )
