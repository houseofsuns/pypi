...
IUSE="all anthropic bigquery chromadb duckdb gemini google hf marqo mistralai mysql ollama openai opensearch postgres qdrant snowflake test vllm zhipuai"
