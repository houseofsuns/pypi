...
IUSE="admin ai-interface cache email full scheduler"
DEPENDENCIES=">=dev-python/aiofiles-24.1.0[${PYTHON_USEDEP}]
	...
	admin? ( dev-python/WTForms-SQLAlchemy[${PYTHON_USEDEP}] )
	...
	email? ( dev-python/aiosmtplib[${PYTHON_USEDEP}] )
	...
	full? ( dev-python/WTForms-SQLAlchemy[${PYTHON_USEDEP}] )
