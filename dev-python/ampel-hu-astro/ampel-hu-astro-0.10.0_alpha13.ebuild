...
IUSE="elasticc extcats hop lasair ligo lsst notebook slack sncosmo snpy ztf"
DEPENDENCIES="dev-python/ampel-plot[${PYTHON_USEDEP}]
	...
	elasticc? ( dev-python/lightgbm[${PYTHON_USEDEP}] )
	hop? ( dev-python/py-avro-schema[${PYTHON_USEDEP}] )
	hop? ( dev-python/hop-client[${PYTHON_USEDEP}] )
	lasair? ( dev-python/lasair[${PYTHON_USEDEP}] )"
