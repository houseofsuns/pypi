...
HOMEPAGE="https://github.com/zuspec/zuspec-sv"
LICENSE="Apache-2.0"
...
IUSE=""
DEPENDENCIES="dev-python/zuspec-parser[${PYTHON_USEDEP}]
	dev-python/zuspec-fe-parser[${PYTHON_USEDEP}]
	dev-python/zuspec-arl-dm[${PYTHON_USEDEP}]
	dev-python/zuspec-arl-eval[${PYTHON_USEDEP}]
	dev-python/zuspec-cli[${PYTHON_USEDEP}]
