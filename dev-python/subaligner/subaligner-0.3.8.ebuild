...
DEPENDENCIES="dev-python/zict[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/types-setuptools-64.0.1[${PYTHON_USEDEP}] )
	...
	harmony? ( dev-python/dtw-python[${PYTHON_USEDEP}] )
	...
	harmony? ( dev-python/torchaudio[${PYTHON_USEDEP}] )
	...
	llm? ( dev-python/torchaudio[${PYTHON_USEDEP}] )
	llm? ( dev-python/torch[${PYTHON_USEDEP}] )
	llm? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	stretch? ( dev-python/dtw-python[${PYTHON_USEDEP}] )
	...
	translation? ( dev-python/torchaudio[${PYTHON_USEDEP}] )
