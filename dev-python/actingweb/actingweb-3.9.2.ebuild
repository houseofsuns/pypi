...
IUSE="all fastapi flask mcp postgresql"
DEPENDENCIES="dev-python/pynamodb[${PYTHON_USEDEP}]
	...
	postgresql? ( <dev-python/alembic-2.0.0[${PYTHON_USEDEP}] )
	...
	fastapi? ( <dev-python/uvicorn-0.41.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/uvicorn-0.41.0[${PYTHON_USEDEP}] )"
