...
DEPENDENCIES="dev-python/liquidpy[${PYTHON_USEDEP}]
	...
	dev-python/attr_property[${PYTHON_USEDEP}]
	dev-python/python-varname[${PYTHON_USEDEP}]
	dev-python/pyppl_export[${PYTHON_USEDEP}]
	dev-python/pyppl_echo[${PYTHON_USEDEP}]
	dev-python/pyppl_rich[${PYTHON_USEDEP}]
	dev-python/pyppl_strict[${PYTHON_USEDEP}]
	dev-python/pyppl_lock[${PYTHON_USEDEP}]
	dev-python/pyppl_runners[${PYTHON_USEDEP}]
