...
DEPENDENCIES=">=dev-python/requests-2.26.0[${PYTHON_USEDEP}]
	...
	postgis? ( dev-python/psycopg2cffi[${PYTHON_USEDEP}] )
	...
	parquet? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	motherduck? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	athena? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	synapse? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	clickhouse? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	dremio? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	lancedb? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	deltalake? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
	pyiceberg? ( <dev-python/pyarrow-18.0[${PYTHON_USEDEP}] )
