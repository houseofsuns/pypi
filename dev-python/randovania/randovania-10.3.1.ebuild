...
DEPENDENCIES="dev-python/construct[${PYTHON_USEDEP}]
	...
	>=dev-python/dulwich-0.24.6[${PYTHON_USEDEP}]
	...
	server? ( dev-python/itsdangerous[${PYTHON_USEDEP}] )
	server? ( dev-python/python-multipart[${PYTHON_USEDEP}] )
	server? ( dev-python/fastapi-socketio-handler[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/pytest-test-groups[${PYTHON_USEDEP}] )
