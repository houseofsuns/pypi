...
DESCRIPTION="APRSd is a APRS-IS server that can be used to connect to APRS-IS and send and receive APRS packets. [top-max 4.2.3]"
...
DEPENDENCIES="dev-python/aprslib[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/pyproject-api-1.9.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/snowballstemmer-3.0.1[${PYTHON_USEDEP}] )
