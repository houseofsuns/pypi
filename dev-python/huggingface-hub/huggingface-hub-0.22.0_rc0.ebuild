...
IUSE="all cli dev fastai hf-transfer inference quality tensorflow tensorflow-testing testing torch typing"
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	all? ( dev-python/minijinja[${PYTHON_USEDEP}] )
	...
	inference? ( dev-python/minijinja[${PYTHON_USEDEP}] )
	...
	testing? ( dev-python/minijinja[${PYTHON_USEDEP}] )
