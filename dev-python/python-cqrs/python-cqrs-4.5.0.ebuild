...
IUSE="aiobreaker dev examples kafka protobuf rabbit"
DEPENDENCIES="~dev-python/pydantic-2.0[${PYTHON_USEDEP}]
	...
	aiobreaker? ( dev-python/aiobreaker[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/redis-5.0.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/aiobreaker[${PYTHON_USEDEP}] )
