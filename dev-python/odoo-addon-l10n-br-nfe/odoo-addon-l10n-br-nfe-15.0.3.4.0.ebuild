...
DEPENDENCIES="dev-python/BrazilFiscalReport[${PYTHON_USEDEP}]
	...
	dev-python/odoo-addon-l10n-br-fiscal-certificate[${PYTHON_USEDEP}]
	dev-python/odoo-addon-l10n-br-fiscal-dfe[${PYTHON_USEDEP}]
	dev-python/odoo-addon-l10n-br-fiscal-edi[${PYTHON_USEDEP}]
	dev-python/odoo-addon-l10n-br-nfe-spec[${PYTHON_USEDEP}]
	dev-python/odoo-addon-spec-driven-model[${PYTHON_USEDEP}]
