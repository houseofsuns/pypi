...
DEPENDENCIES=">=dev-python/ubelt-1.3.3[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/levenshtein-0.26.1[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/line-profiler-4.2.0[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/lazy-loader-0.3[${PYTHON_USEDEP}] )
	...
	optional? ( >=dev-python/levenshtein-0.26.1[${PYTHON_USEDEP}] )
	...
	optional? ( >=dev-python/line-profiler-4.2.0[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/levenshtein-0.26.1[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/line-profiler-4.2.0[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/lazy-loader-0.3[${PYTHON_USEDEP}] )
	...
	optional-strict? ( ~dev-python/levenshtein-0.26.1[${PYTHON_USEDEP}] )
	...
	optional-strict? ( ~dev-python/line-profiler-4.2.0[${PYTHON_USEDEP}] )
