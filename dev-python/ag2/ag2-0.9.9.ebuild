...
DEPENDENCIES="<dev-python/anyio-5.0.0[${PYTHON_USEDEP}]
	...
	docs? ( ~dev-python/termcolor-3.1.0[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/typer-0.16.0[${PYTHON_USEDEP}] )
	...
	flaml? ( >=dev-python/numpy-2.1[${PYTHON_USEDEP}] )
	...
	interop? ( dev-python/litellm[${PYTHON_USEDEP}] )
	...
	interop-crewai? ( dev-python/litellm[${PYTHON_USEDEP}] )
	...
	mcp-proxy-gen? ( dev-python/fastapi-code-generator[${PYTHON_USEDEP}] )
	mcp-proxy-gen? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	mcp-proxy-gen? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	mcp-proxy-gen? ( dev-python/requests[${PYTHON_USEDEP}] )
	mcp-proxy-gen? ( dev-python/typer[${PYTHON_USEDEP}] )
	...
	retrievechat? ( ~dev-python/protobuf-6.31.1[${PYTHON_USEDEP}] )
	...
	retrievechat-couchbase? ( ~dev-python/protobuf-6.31.1[${PYTHON_USEDEP}] )
	...
	retrievechat-mongodb? ( ~dev-python/protobuf-6.31.1[${PYTHON_USEDEP}] )
	...
	retrievechat-pgvector? ( ~dev-python/protobuf-6.31.1[${PYTHON_USEDEP}] )
	...
	retrievechat-qdrant? ( ~dev-python/protobuf-6.31.1[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/ipykernel-6.30.1[${PYTHON_USEDEP}] )
	test? ( dev-python/mcp[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/pandas-2.3.1[${PYTHON_USEDEP}] )
	...
	types? ( ~dev-python/ipykernel-6.30.1[${PYTHON_USEDEP}] )
	types? ( dev-python/mcp[${PYTHON_USEDEP}] )
	...
	types? ( ~dev-python/pandas-2.3.1[${PYTHON_USEDEP}] )
	types? ( ~dev-python/pytest-asyncio-1.1.0[${PYTHON_USEDEP}] )
	types? ( ~dev-python/pytest-cov-6.2.1[${PYTHON_USEDEP}] )
	types? ( ~dev-python/pytest-8.4.1[${PYTHON_USEDEP}] )
