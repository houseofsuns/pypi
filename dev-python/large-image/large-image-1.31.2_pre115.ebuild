...
DESCRIPTION="Python modules to work with large, multiresolution images. [top-max 1.32.0_alpha3]"
...
IUSE="all bioformats colormaps common converter deepzoom dicom dummy gdal jupyter mapnik memcached multi nd2 ometiff openjpeg openslide performance pil rasterio redis sources test tiff tifffile tiledoutput vips zarr"
DEPENDENCIES="dev-python/cachetools[${PYTHON_USEDEP}]
	...
	all? ( dev-python/ipyvue[${PYTHON_USEDEP}] )
