...
DEPENDENCIES="<dev-python/grpcio-2.0[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.5.6[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/pytest-asyncio-0.23.4[${PYTHON_USEDEP}] )
	dev-pytest? ( dev-python/async-solipsism[${PYTHON_USEDEP}] )
	dev-pytest? ( ~dev-python/hypothesis-6.98.8[${PYTHON_USEDEP}] )"
