...
DESCRIPTION="A minimal path extraction framework based on Fast Marching arrival functions. [wheel]"

HOMEPAGE="https://github.com/InsightSoftwareConsortium/ITKMinimalPathExtraction"
