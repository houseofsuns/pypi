...
IUSE="crypto desktop lxml mobile ruamel-yaml tui ujson upath webui"
DEPENDENCIES="dev-python/bidict[${PYTHON_USEDEP}]
	...
	<dev-python/pymediainfo-7.0.2[${PYTHON_USEDEP}]
	...
	lxml? ( >=dev-python/lxml-5.3.1[${PYTHON_USEDEP}] )
	...
	ruamel-yaml? ( >=dev-python/ruamel-yaml-0.18.10[${PYTHON_USEDEP}] )
