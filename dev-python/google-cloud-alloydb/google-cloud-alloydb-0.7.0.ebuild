...
DESCRIPTION="Google Cloud Alloydb API client library [wheel]"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-alloydb"
LICENSE="Apache-2.0"
