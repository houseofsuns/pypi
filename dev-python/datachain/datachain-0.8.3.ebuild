...
IUSE="dev docs examples hf remote tests torch vector"
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	examples? ( dev-python/unstructured-ingest[${PYTHON_USEDEP}] )
	examples? ( dev-python/unstructured[${PYTHON_USEDEP}] )
	examples? ( dev-python/pdfplumber[${PYTHON_USEDEP}] )
	examples? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
	examples? ( dev-python/onnx[${PYTHON_USEDEP}] )
