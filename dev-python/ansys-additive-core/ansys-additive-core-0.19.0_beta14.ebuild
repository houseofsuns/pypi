...
DEPENDENCIES="dev-python/ansys-api-additive[${PYTHON_USEDEP}]
	...
	tests? ( ~dev-python/google-api-python-client-2.142.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/googleapis-common-protos-1.64.0[${PYTHON_USEDEP}] )
	tests? ( dev-python/grpcio[${PYTHON_USEDEP}] )
	tests? ( dev-python/grpcio-health-checking[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/numpy-2.1.0[${PYTHON_USEDEP}] )
