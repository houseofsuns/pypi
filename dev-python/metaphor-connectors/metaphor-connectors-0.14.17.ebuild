...
DESCRIPTION="A collection of Python-based 'connectors' that extract metadata from various sources to ingest into the Metaphor app. [wheel]"
...
IUSE="all bigquery confluence datafactory datahub hive kafka looker monday monte-carlo mssql mysql notion postgresql power-bi redshift s3 sharepoint snowflake static-web synapse tableau thought-spot trino unity-catalog"
