...
IUSE="dev docs qt test test_qt"
DEPENDENCIES="test_qt? ( dev-python/fonticon-fontawesome6[${PYTHON_USEDEP}] )
	test_qt? ( dev-python/pytest-qt[${PYTHON_USEDEP}] )
	...
	dev-python/in-n-out[${PYTHON_USEDEP}]
