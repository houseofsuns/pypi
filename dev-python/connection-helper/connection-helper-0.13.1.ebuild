...
DESCRIPTION="A collection of helper for sql connections"
...
DEPENDENCIES=">=dev-python/pandas-2.0.0[${PYTHON_USEDEP}]
	dev-python/pandas-plots[${PYTHON_USEDEP}]
	...
	sec? ( dev-python/infisical-python[${PYTHON_USEDEP}] )
	sec? ( dev-python/bitwarden-sdk[${PYTHON_USEDEP}] )"
