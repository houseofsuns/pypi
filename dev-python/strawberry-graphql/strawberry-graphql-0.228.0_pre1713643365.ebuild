...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.228.0.dev1713643365"
DIGEST_SOURCES="yes"
...
DEPENDENCIES="dev-python/graphql-core[${PYTHON_USEDEP}]
	...
	debug? ( >=dev-python/libcst-0.4.7[${PYTHON_USEDEP}] )
	debug-server? ( >=dev-python/libcst-0.4.7[${PYTHON_USEDEP}] )
	cli? ( >=dev-python/libcst-0.4.7[${PYTHON_USEDEP}] )
