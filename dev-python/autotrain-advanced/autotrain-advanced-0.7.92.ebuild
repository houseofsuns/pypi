...
DEPENDENCIES="dev-python/albumentations[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/joblib-1.4.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/scikit-learn-1.4.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pydantic-2.7.1[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/joblib-1.4.0[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/scikit-learn-1.4.2[${PYTHON_USEDEP}] )
	docs? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/tqdm-4.66.2[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/werkzeug-3.0.2[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/uvicorn-0.29.0[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/python-multipart-0.0.9[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/pydantic-2.7.1[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/httpx-0.27.0[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/joblib-1.4.0[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/loguru-0.7.2[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pandas-2.2.2[${PYTHON_USEDEP}] )
	quality? ( dev-python/nltk[${PYTHON_USEDEP}] )
	quality? ( dev-python/optuna[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pillow-10.3.0[${PYTHON_USEDEP}] )
	quality? ( dev-python/protobuf[${PYTHON_USEDEP}] )
	quality? ( dev-python/sacremoses[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/scikit-learn-1.4.2[${PYTHON_USEDEP}] )
	quality? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/tqdm-4.66.2[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/werkzeug-3.0.2[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/packaging-24.0[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/uvicorn-0.29.0[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/python-multipart-0.0.9[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pydantic-2.7.1[${PYTHON_USEDEP}] )
	...
	quality? ( ~dev-python/httpx-0.27.0[${PYTHON_USEDEP}] )
	quality? ( ~dev-python/pyyaml-6.0.1[${PYTHON_USEDEP}] )
