...
DEPENDENCIES="dev-python/aioboto3[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/inspect-scout[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/types-grpcio[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/xai-sdk[${PYTHON_USEDEP}] )
	...
	doc? ( >=dev-python/click-8.2.0[${PYTHON_USEDEP}] )
