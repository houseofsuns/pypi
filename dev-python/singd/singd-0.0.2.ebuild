...
IUSE="doc fine_tuning lint test"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	fine_tuning? ( dev-python/wandb[${PYTHON_USEDEP}] )
	fine_tuning? ( dev-python/transformers[${PYTHON_USEDEP}] )
	fine_tuning? ( dev-python/datasets[${PYTHON_USEDEP}] )
	fine_tuning? ( dev-python/evaluate[${PYTHON_USEDEP}] )
	fine_tuning? ( dev-python/py7zr[${PYTHON_USEDEP}] )
	fine_tuning? ( dev-python/tqdm[${PYTHON_USEDEP}] )
	fine_tuning? ( dev-python/torchmetrics[${PYTHON_USEDEP}] )
	fine_tuning? ( dev-python/backpack-for-pytorch[${PYTHON_USEDEP}] )
