...
DESCRIPTION="Interactive plotting for the Jupyter notebook, using d3.js and ipywidgets. [prod-max (True, <g_sorcery.g_collections.Version object at 0x7f3f32ef4350>)]"
