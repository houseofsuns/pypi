...
IUSE="all clearml cucim einops fire gdown h5py huggingface-hub ignite imagecodecs itk jsonschema lmdb lpips matplotlib mlflow nibabel ninja nni onnx openslide optuna pandas pillow psutil pyamg pydicom pynrrd pynvml pyyaml scipy skimage tensorboard tensorboardx tifffile torchvision tqdm transformers zarr"
