...
DEPENDENCIES="dev-python/texttable[${PYTHON_USEDEP}]
	...
	check? ( >=dev-python/mypy-1.17.0[${PYTHON_USEDEP}] )
	check? ( >=dev-python/mypy-extensions-1.1.0[${PYTHON_USEDEP}] )
	...
	check? ( >=dev-python/isort-7.0.0[${PYTHON_USEDEP}] )
	...
	check? ( >=dev-python/black-25.1.0[${PYTHON_USEDEP}] )
