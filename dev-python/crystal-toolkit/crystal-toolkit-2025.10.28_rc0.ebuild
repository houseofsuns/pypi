...
IUSE="dev fermi figures jupyterlab-deprecated localenv phonon robocrys server temdiff test vtk"
DEPENDENCIES="dev-python/dash-mp-components[${PYTHON_USEDEP}]
	...
	jupyterlab-deprecated? ( dev-python/crystaltoolkit-extension[${PYTHON_USEDEP}] )"
