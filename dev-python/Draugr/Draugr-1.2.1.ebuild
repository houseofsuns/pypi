...
IUSE="all dev dlib docs drawers extensions ja linu multiprocessing opencv progress-bars pygame setup tests torch tqdm visualisation windows writers"
DEPENDENCIES="dev-python/Apppath[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/bandit-1.7.7[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/Apppath[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/scikit-learn-1.3.1[${PYTHON_USEDEP}] )
	dev? ( dev-python/torch[${PYTHON_USEDEP}] )
	dev? ( dev-python/Warg[${PYTHON_USEDEP}] )
	...
	progress-bars? ( dev-python/notus[${PYTHON_USEDEP}] )
	progress-bars? ( dev-python/pathos[${PYTHON_USEDEP}] )
	...
	visualisation? ( >=dev-python/scikit-learn-1.3.1[${PYTHON_USEDEP}] )
