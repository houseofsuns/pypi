...
DEPENDENCIES=">=dev-python/numpy-1.20.0[${PYTHON_USEDEP}]
	...
	sentence_encoders? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	sentence_encoders? ( dev-python/tensorflow-hub[${PYTHON_USEDEP}] )
	sentence_encoders? ( dev-python/tensorflow-text[${PYTHON_USEDEP}] )
