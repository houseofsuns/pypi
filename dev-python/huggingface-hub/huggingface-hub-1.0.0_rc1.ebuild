...
IUSE="all cli dev fastai hf-transfer hf-xet inference mcp oauth quality testing torch typing"
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/pytest-rerunfailures-16.0[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/ty[${PYTHON_USEDEP}] )
	...
	cli? ( dev-python/shellingham[${PYTHON_USEDEP}] )
	dev? ( dev-python/inquirerpy[${PYTHON_USEDEP}] )
	dev? ( dev-python/shellingham[${PYTHON_USEDEP}] )
	...
	quality? ( dev-python/ty[${PYTHON_USEDEP}] )
	testing? ( dev-python/inquirerpy[${PYTHON_USEDEP}] )
	testing? ( dev-python/shellingham[${PYTHON_USEDEP}] )
