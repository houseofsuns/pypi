...
IUSE="all dev docs experimental"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	experimental? ( dev-python/ragas-experimental[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/ragas-experimental[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/haystack-ai[${PYTHON_USEDEP}] )
	dev? ( dev-python/sacrebleu[${PYTHON_USEDEP}] )
	dev? ( dev-python/r2r[${PYTHON_USEDEP}] )
