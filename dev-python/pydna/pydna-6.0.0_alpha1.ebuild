...
DESCRIPTION="Representing double stranded DNA and functions for simulating cloning and homologous recombination between DNA molecules. [newver 6.0.0a25]"
...
DEPENDENCIES=">=dev-python/appdirs-1.4.4[${PYTHON_USEDEP}]
	...
	gel? ( >=dev-python/scipy-1.8.0[${PYTHON_USEDEP}] )"
