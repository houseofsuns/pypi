...
DEPENDENCIES="dev-python/asyncer[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/uv-0.5.29[${PYTHON_USEDEP}] )
	...
	gemini? ( dev-python/jsonref[${PYTHON_USEDEP}] )
	...
	types? ( ~dev-python/mock-5.1.0[${PYTHON_USEDEP}] )
	...
	types? ( ~dev-python/pytest-asyncio-0.25.3[${PYTHON_USEDEP}] )
