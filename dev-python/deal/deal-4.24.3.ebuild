...
DEPENDENCIES="all? ( dev-python/astroid[${PYTHON_USEDEP}] )
	...
	integration? ( dev-python/astroid[${PYTHON_USEDEP}] )
	...
	integration? ( dev-python/typeguard[${PYTHON_USEDEP}] )
	integration? ( dev-python/vaa[${PYTHON_USEDEP}] )
	integration? ( dev-python/sphinx[${PYTHON_USEDEP}] )
	...
	lint? ( dev-python/mypy_test[${PYTHON_USEDEP}] )
	...
	lint? ( dev-python/typeguard[${PYTHON_USEDEP}] )
