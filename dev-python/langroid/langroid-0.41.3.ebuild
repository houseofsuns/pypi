...
IUSE="all arango chainlit chromadb db doc-chat docling docx exa fastembed google-generativeai hf-embeddings hf-transformers lancedb litellm meilisearch metaphor momento mysql neo4j pdf-parsers pinecone postgres pymupdf4llm scrapy sql tavily transformers unstructured vecdbs weaviate"
DEPENDENCIES="all? ( dev-python/python-arango[${PYTHON_USEDEP}] )
