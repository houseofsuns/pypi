...
DEPENDENCIES="dev-python/opentelemetry-instrumentation-aiohttp-client[${PYTHON_USEDEP}]
	...
	uvicorn-standard-? ( <=dev-python/uvicorn-0.23.1[${PYTHON_USEDEP}] )
