...
IUSE="all all-vectorizers dev encryption parsing sentence-transformers tfidf webui"
DEPENDENCIES="dev-python/ascii-colors[${PYTHON_USEDEP}]
	...
	all? ( dev-python/lollms-client[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/pypdf-3.10[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/uvicorn-0.23.0[${PYTHON_USEDEP}] )
	...
	webui? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	webui? ( dev-python/lollms-client[${PYTHON_USEDEP}] )
	webui? ( >=dev-python/pydantic-2.0[${PYTHON_USEDEP}] )
	webui? ( >=dev-python/python-multipart-0.0.6[${PYTHON_USEDEP}] )
	webui? ( dev-python/python-socketio[${PYTHON_USEDEP}] )
	webui? ( dev-python/toml[${PYTHON_USEDEP}] )
	webui? ( >=dev-python/uvicorn-0.23.0[${PYTHON_USEDEP}] )"
