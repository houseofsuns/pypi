...
DEPENDENCIES="<dev-python/colorama-0.5.0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/nuitka-3.0[${PYTHON_USEDEP}] )
	nuitka? ( <dev-python/nuitka-3.0[${PYTHON_USEDEP}] )
	<dev-python/psutil-8.0[${PYTHON_USEDEP}]
	all? ( <dev-python/pygit2-2.0[${PYTHON_USEDEP}] )
	pygit2? ( <dev-python/pygit2-2.0[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/twisted-26.0[${PYTHON_USEDEP}] )
	twisted? ( <dev-python/twisted-26.0[${PYTHON_USEDEP}] )"
