...
LICENSE="MIT"
SRC_URI="https://files.pythonhosted.org/packages/a9/52/e4a9a27efbb3d0d3aae0d3005c336703eaa02bb2efdf48e5c6bb717b876d/pyhanko-${REALVERSION}.tar.gz"
...
DEPENDENCIES=">=dev-python/asn1crypto-1.5.1[${PYTHON_USEDEP}]
	...
	testing-basic? ( ~dev-python/pytest-asyncio-0.24.0[${PYTHON_USEDEP}] )
