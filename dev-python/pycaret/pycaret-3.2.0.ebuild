...
DEPENDENCIES="dev-python/category-encoders[${PYTHON_USEDEP}]
	...
	>=dev-python/jinja-1.2[${PYTHON_USEDEP}]
	...
	analysis? ( ~dev-python/flask-2.2.3[${PYTHON_USEDEP}] )
	...
	full? ( ~dev-python/flask-2.2.3[${PYTHON_USEDEP}] )
	...
	full? ( >=dev-python/flask-2.0.3[${PYTHON_USEDEP}] )
	...
	full? ( >=dev-python/moto-3.0.7[${PYTHON_USEDEP}] )
	full? ( dev-python/optuna[${PYTHON_USEDEP}] )
	full? ( >=dev-python/pytest-7.0.1[${PYTHON_USEDEP}] )
	...
	full? ( dev-python/triad[${PYTHON_USEDEP}] )
	...
	parallel? ( >=dev-python/flask-2.0.3[${PYTHON_USEDEP}] )
	parallel? ( dev-python/fugue[${PYTHON_USEDEP}] )
	parallel? ( dev-python/triad[${PYTHON_USEDEP}] )
