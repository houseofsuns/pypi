...
IUSE="dev devtools doc matlab responses style test"
DEPENDENCIES=">=dev-python/numpy-1.20.0[${PYTHON_USEDEP}]
	...
	responses? ( dev-python/phys2denoise[${PYTHON_USEDEP}] )
	matlab? ( dev-python/pymatreader[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/phys2denoise[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/phys2denoise[${PYTHON_USEDEP}] )
