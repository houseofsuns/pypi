...
DESCRIPTION="Open source machine learning framework to automate text- and voice-based conversations: NLU, dialogue management, connect to Slack, Facebook, and more - Create chatbots and voice assistants [badver 3.8.0a7.dev2]"

HOMEPAGE="https://rasa.com"
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/35/65/07c9c46e747ecfa866ccb74a9dbc399eb63e6b87b5f8a679d727c354dd2c/${REALNAME}-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/cachecontrol-0.13.0[${PYTHON_USEDEP}]
	...
	<dev-python/APScheduler-3.10.2[${PYTHON_USEDEP}]
