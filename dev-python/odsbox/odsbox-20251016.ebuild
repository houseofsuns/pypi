...
DESCRIPTION="Toolbox for accessing ASAM ODS servers using the HTTP API [badver 1.0.13rc396.post1]"
...
IUSE="exd-data test"
DEPENDENCIES="test? ( ~dev-python/pytest-cov-7.0.0[${PYTHON_USEDEP}] )
