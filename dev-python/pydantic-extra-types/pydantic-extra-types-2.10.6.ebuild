...
IUSE="all cron pendulum phonenumbers pycountry python-ulid semver"
DEPENDENCIES=">=dev-python/pydantic-2.5.2[${PYTHON_USEDEP}]
	dev-python/typing-extensions[${PYTHON_USEDEP}]
	all? ( dev-python/cron-converter[${PYTHON_USEDEP}] )
	...
	cron? ( dev-python/cron-converter[${PYTHON_USEDEP}] )
