...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/cp310/${REALNAME::1}/${REALNAME}/${REALNAME//-/_}-${REALVERSION}-cp310-cp310-macosx_12_7_x86_64.whl"
SOURCEFILE="${REALNAME//-/_}-${REALVERSION}-cp310-cp310-macosx_12_7_x86_64.whl"
RESTRICT="test"
