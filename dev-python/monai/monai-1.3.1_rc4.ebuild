...
DESCRIPTION="AI Toolkit for Healthcare Imaging [top-max 1.3.1_rc6]"
...
IUSE="all clearml cucim einops fire gdown h5py huggingface-hub ignite imagecodecs itk jsonschema lmdb lpips matplotlib mlflow nibabel ninja nni onnx openslide optuna pandas pillow psutil pydicom pynrrd pynvml pyyaml scipy skimage tensorboard tensorboardx tifffile torchvision tqdm transformers zarr"
