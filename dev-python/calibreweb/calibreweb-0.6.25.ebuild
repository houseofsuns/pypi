...
DEPENDENCIES="<dev-python/apscheduler-3.12.0[${PYTHON_USEDEP}]
	...
	dev-python/netifaces-plus[${PYTHON_USEDEP}]
	<dev-python/urllib3-3.0[${PYTHON_USEDEP}]
	dev-python/Flask-Limiter[${PYTHON_USEDEP}]
	<dev-python/regex-2025.3.20[${PYTHON_USEDEP}]
	...
	gdrive? ( <dev-python/greenlet-3.2.0[${PYTHON_USEDEP}] )
	...
	gdrive? ( <dev-python/pyasn1-modules-0.7.0[${PYTHON_USEDEP}] )
	...
	metadata? ( <dev-python/markdown2-2.6.0[${PYTHON_USEDEP}] )
	metadata? ( <dev-python/html2text-2025.2.26[${PYTHON_USEDEP}] )
	metadata? ( <dev-python/python-dateutil-2.10.0[${PYTHON_USEDEP}] )
	metadata? ( <dev-python/beautifulsoup4-4.14.0[${PYTHON_USEDEP}] )
	metadata? ( <dev-python/faust-cchardet-2.1.20[${PYTHON_USEDEP}] )
	metadata? ( dev-python/py7zr[${PYTHON_USEDEP}] )
	metadata? ( dev-python/mutagen[${PYTHON_USEDEP}] )
	metadata? ( <dev-python/pycountry-25.0.0[${PYTHON_USEDEP}] )
