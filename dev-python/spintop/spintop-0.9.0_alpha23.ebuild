...
DEPENDENCIES="dev-python/anytree[${PYTHON_USEDEP}]
	...
	deploy? ( dev-python/prefect[${PYTHON_USEDEP}] )
	deploy? ( dev-python/google-cloud-secret-manager[${PYTHON_USEDEP}] )
	deploy? ( dev-python/google-cloud-storage[${PYTHON_USEDEP}] )
	deploy? ( dev-python/google-cloud-pubsub[${PYTHON_USEDEP}] )
	deploy? ( dev-python/google-cloud-tasks[${PYTHON_USEDEP}] )
