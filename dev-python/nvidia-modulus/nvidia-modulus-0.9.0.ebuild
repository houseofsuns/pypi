...
IUSE="all dev fignet launch makani"
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	dev-python/nvidia-dali-cuda120[${PYTHON_USEDEP}]
	...
	fignet? ( dev-python/jaxtyping[${PYTHON_USEDEP}] )
	fignet? ( dev-python/torch-scatter[${PYTHON_USEDEP}] )
	fignet? ( dev-python/torchinfo[${PYTHON_USEDEP}] )
	fignet? ( dev-python/warp-lang[${PYTHON_USEDEP}] )
	fignet? ( dev-python/webdataset[${PYTHON_USEDEP}] )
	...
	makani? ( dev-python/torch-harmonics[${PYTHON_USEDEP}] )
	makani? ( dev-python/tensorly[${PYTHON_USEDEP}] )
	makani? ( dev-python/tensorly-torch[${PYTHON_USEDEP}] )
