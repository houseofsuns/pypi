...
IUSE="athena azuresql bigquery clickhouse databricks dbt dev dlt gcppostgres github llm lsp mssql mwaa mysql postgres redshift risingwave slack snowflake trino web"
DEPENDENCIES="dev? ( dev-python/dbt-duckdb[${PYTHON_USEDEP}] )
	...
	~dev-python/sqlglot-26.17.1[${PYTHON_USEDEP}]
	...
	bigquery? ( dev-python/bigframes[${PYTHON_USEDEP}] )
