...
IUSE="athena azuresql azuresql-odbc bigframes bigquery clickhouse databricks dbt dev dlt gcppostgres github llm lsp mssql mssql-odbc mwaa mysql postgres redshift risingwave slack snowflake trino web"
DEPENDENCIES="dev-python/astor[${PYTHON_USEDEP}]
	...
	~dev-python/sqlglot-26.31.0[${PYTHON_USEDEP}]
