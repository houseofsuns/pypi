...
DEPENDENCIES="schemaregistry? ( >=dev-python/attrs-21.2.0[${PYTHON_USEDEP}] )
	...
	rules? ( dev-python/google-re2[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/cel-python[${PYTHON_USEDEP}] )
	dev? ( dev-python/google-re2[${PYTHON_USEDEP}] )
	dev? ( dev-python/google-auth[${PYTHON_USEDEP}] )
	dev? ( dev-python/google-api-core[${PYTHON_USEDEP}] )
	dev? ( dev-python/google-cloud-kms[${PYTHON_USEDEP}] )
	dev? ( dev-python/hkdf[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/google-re2[${PYTHON_USEDEP}] )
	...
	tests? ( >=dev-python/isort-5.13.0[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/google-re2[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/isort-5.13.0[${PYTHON_USEDEP}] )
