...
DEPENDENCIES="<dev-python/anyio-5.0.0[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/a2a-sdk[${PYTHON_USEDEP}] )
	dev? ( <dev-python/aiofiles-26.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/mkdocs-material-9.6.19[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/typer-0.17.4[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/uv-0.8.15[${PYTHON_USEDEP}] )
	docs? ( dev-python/a2a-sdk[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/typer-0.17.4[${PYTHON_USEDEP}] )
	...
	interop? ( dev-python/fasta2a[${PYTHON_USEDEP}] )
	...
	interop-pydantic-ai? ( dev-python/fasta2a[${PYTHON_USEDEP}] )
	...
	rag? ( dev-python/llama-index-llms-openai[${PYTHON_USEDEP}] )
	...
	retrievechat? ( ~dev-python/protobuf-6.32.0[${PYTHON_USEDEP}] )
	...
	retrievechat-couchbase? ( ~dev-python/protobuf-6.32.0[${PYTHON_USEDEP}] )
	...
	retrievechat-mongodb? ( ~dev-python/protobuf-6.32.0[${PYTHON_USEDEP}] )
	...
	retrievechat-pgvector? ( ~dev-python/protobuf-6.32.0[${PYTHON_USEDEP}] )
	...
	retrievechat-qdrant? ( ~dev-python/protobuf-6.32.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/aiofiles-26.0.0[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/pandas-2.3.2[${PYTHON_USEDEP}] )
	...
	types? ( dev-python/a2a-sdk[${PYTHON_USEDEP}] )
	types? ( <dev-python/aiofiles-26.0.0[${PYTHON_USEDEP}] )
	types? ( ~dev-python/dirty-equals-0.9.0[${PYTHON_USEDEP}] )
	types? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	types? ( ~dev-python/freezegun-1.5.5[${PYTHON_USEDEP}] )
	...
	types? ( ~dev-python/pandas-2.3.2[${PYTHON_USEDEP}] )
	types? ( ~dev-python/pytest-asyncio-1.1.0[${PYTHON_USEDEP}] )
	types? ( ~dev-python/pytest-cov-6.3.0[${PYTHON_USEDEP}] )
	types? ( ~dev-python/pytest-8.4.2[${PYTHON_USEDEP}] )
	...
	yepcode? ( dev-python/python-dotenv[${PYTHON_USEDEP}] )
	yepcode? ( dev-python/yepcode-run[${PYTHON_USEDEP}] )"
