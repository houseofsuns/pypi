...
DESCRIPTION="The free and open-source Download Manager written in pure Python [badver 0.5.0b3.dev85]"
...
DEPENDENCIES="~dev-python/cheroot-8.4[${PYTHON_USEDEP}]
	dev-python/flask[${PYTHON_USEDEP}]
	~dev-python/flask-babel-1.0[${PYTHON_USEDEP}]
