...
DEPENDENCIES="<dev-python/django-3.3[${PYTHON_USEDEP}]
	...
	~dev-python/selenium-4.24[${PYTHON_USEDEP}]
	...
	~dev-python/sentry-sdk-2.13[${PYTHON_USEDEP}]
	...
	testing? ( ~dev-python/flake8-7.1[${PYTHON_USEDEP}] )
	...
	testing? ( ~dev-python/twine-5.1[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/watchdog-5.0[${PYTHON_USEDEP}] )"
