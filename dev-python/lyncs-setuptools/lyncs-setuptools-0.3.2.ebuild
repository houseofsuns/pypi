...
DEPENDENCIES="dev-python/setuptools[${PYTHON_USEDEP}]
	...
	pylint? ( dev-python/pyenchant[${PYTHON_USEDEP}] )
	pylint? ( dev-python/lyncs-utils[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/lyncs-utils[${PYTHON_USEDEP}] )
