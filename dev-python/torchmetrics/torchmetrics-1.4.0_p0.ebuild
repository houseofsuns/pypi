...
DESCRIPTION="PyTorch native Metrics [top-max 1.4.1]"
...
IUSE="all audio debug detection dev image multimodal text typing visual"
DEPENDENCIES=">dev-python/numpy-1.20.0[${PYTHON_USEDEP}]
	...
	debug? ( dev-python/pretty-errors[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/pretty-errors[${PYTHON_USEDEP}] )
