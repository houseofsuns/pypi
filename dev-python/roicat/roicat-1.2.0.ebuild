...
DEPENDENCIES="tracking? ( dev-python/onnx[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/matplotlib-3.9.1_p1[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/matplotlib-3.9.1_p1[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/matplotlib-3.9.1_p1[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/matplotlib-3.9.1_p1[${PYTHON_USEDEP}] )
