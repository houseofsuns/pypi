...
DEPENDENCIES="bestshell? ( >=dev-python/prompt-toolkit-3.0.29[${PYTHON_USEDEP}] )
	...
	ptk? ( <dev-python/prompt-toolkit-3.0.41[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/prompt-toolkit-3.0.41[${PYTHON_USEDEP}] )
