...
DEPENDENCIES="dev-python/datasets[${PYTHON_USEDEP}]
	...
	core? ( dev-python/langid[${PYTHON_USEDEP}] )
	...
	core? ( dev-python/chonkie[${PYTHON_USEDEP}] )
	core? ( dev-python/gradio[${PYTHON_USEDEP}] )
	core? ( dev-python/rouge-chinese[${PYTHON_USEDEP}] )
	core? ( dev-python/jieba[${PYTHON_USEDEP}] )
