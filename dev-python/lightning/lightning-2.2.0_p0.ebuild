...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	cloud? ( <dev-python/fsspec-2024.0[${PYTHON_USEDEP}] )
	...
	data? ( dev-python/filelock[${PYTHON_USEDEP}] )
	...
	data-all? ( >=dev-python/pillow-9.5.0[${PYTHON_USEDEP}] )
	data-all? ( dev-python/filelock[${PYTHON_USEDEP}] )
	data-all? ( <dev-python/fsspec-2024.0[${PYTHON_USEDEP}] )
	...
	data-cloud? ( <dev-python/fsspec-2024.0[${PYTHON_USEDEP}] )
	data-cloud? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	data-dev? ( >=dev-python/pillow-9.5.0[${PYTHON_USEDEP}] )
	data-dev? ( ~dev-python/coverage-7.3.1[${PYTHON_USEDEP}] )
	data-dev? ( dev-python/filelock[${PYTHON_USEDEP}] )
	data-dev? ( <dev-python/fsspec-2024.0[${PYTHON_USEDEP}] )
	data-dev? ( dev-python/lightning-cloud[${PYTHON_USEDEP}] )
	data-dev? ( dev-python/lightning-utilities[${PYTHON_USEDEP}] )
	data-dev? ( dev-python/polars[${PYTHON_USEDEP}] )
	data-dev? ( dev-python/pyarrow[${PYTHON_USEDEP}] )
	data-dev? ( ~dev-python/pytest-cov-4.1.0[${PYTHON_USEDEP}] )
	data-dev? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	data-dev? ( ~dev-python/pytest-rerunfailures-12.0[${PYTHON_USEDEP}] )
	data-dev? ( ~dev-python/pytest-timeout-2.1.0[${PYTHON_USEDEP}] )
	data-dev? ( ~dev-python/pytest-7.4.0[${PYTHON_USEDEP}] )
	...
	data-dev? ( dev-python/viztracer[${PYTHON_USEDEP}] )
	data-examples? ( >=dev-python/pillow-9.5.0[${PYTHON_USEDEP}] )
	data-examples? ( dev-python/torchvision[${PYTHON_USEDEP}] )
	data-test? ( ~dev-python/coverage-7.3.1[${PYTHON_USEDEP}] )
	data-test? ( dev-python/polars[${PYTHON_USEDEP}] )
	data-test? ( dev-python/pyarrow[${PYTHON_USEDEP}] )
	data-test? ( ~dev-python/pytest-cov-4.1.0[${PYTHON_USEDEP}] )
	data-test? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	data-test? ( ~dev-python/pytest-rerunfailures-12.0[${PYTHON_USEDEP}] )
	data-test? ( ~dev-python/pytest-timeout-2.1.0[${PYTHON_USEDEP}] )
	data-test? ( ~dev-python/pytest-7.4.0[${PYTHON_USEDEP}] )
	data-test? ( dev-python/viztracer[${PYTHON_USEDEP}] )
	...
	examples? ( >=dev-python/pillow-9.5.0[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/viztracer[${PYTHON_USEDEP}] )"
