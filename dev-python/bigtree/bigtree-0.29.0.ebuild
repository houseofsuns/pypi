...
IUSE="all image matplotlib pandas polars query vis"
DEPENDENCIES="all? ( dev-python/lark[${PYTHON_USEDEP}] )
	...
	query? ( dev-python/lark[${PYTHON_USEDEP}] )
	vis? ( dev-python/pyvis[${PYTHON_USEDEP}] )"
