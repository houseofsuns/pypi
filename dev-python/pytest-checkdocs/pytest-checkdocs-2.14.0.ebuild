...
DEPENDENCIES=">=dev-python/docutils-0.15[${PYTHON_USEDEP}]
	...
	type? ( <dev-python/mypy-1.19[${PYTHON_USEDEP}] )
	type? ( dev-python/types-docutils[${PYTHON_USEDEP}] )
	type? ( dev-python/importlib-metadata[${PYTHON_USEDEP}] )
	type? ( >=dev-python/pytest-8.3.3[${PYTHON_USEDEP}] )"
