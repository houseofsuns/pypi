...
IUSE="base ci-benchmark ci-publish ci-tox dev docs"
DEPENDENCIES="dev-python/datumaro[${PYTHON_USEDEP}]
	...
	ci-tox? ( ~dev-python/tox-4.24.1[${PYTHON_USEDEP}] )
	...
	ci-benchmark? ( ~dev-python/nbconvert-7.16.6[${PYTHON_USEDEP}] )
	ci-benchmark? ( ~dev-python/ipython-9.0.1[${PYTHON_USEDEP}] )
