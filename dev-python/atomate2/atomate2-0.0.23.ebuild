...
IUSE="abinit aims amset approxneb ase ase-ext cclib defects dev docs fireworks forcefields lobster mp openmm phonons strict strict-forcefields strict-openff tests"
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	aims? ( dev-python/pymatgen-io-aims[${PYTHON_USEDEP}] )
	aims? ( dev-python/pymatgen[${PYTHON_USEDEP}] )
	...
	forcefields? ( dev-python/deepmd-kit[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/jupyterlab-4.5.0[${PYTHON_USEDEP}] )
	...
	strict-forcefields? ( dev-python/deepmd-kit[${PYTHON_USEDEP}] )
	strict-forcefields? ( dev-python/tensorflow-cpu[${PYTHON_USEDEP}] )
