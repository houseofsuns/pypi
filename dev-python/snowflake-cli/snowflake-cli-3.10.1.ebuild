...
DEPENDENCIES="~dev-python/annotated-types-0.7.0[${PYTHON_USEDEP}]
	...
	~dev-python/boto3-1.40.9[${PYTHON_USEDEP}]
	~dev-python/botocore-1.40.9[${PYTHON_USEDEP}]
	...
	~dev-python/identify-2.6.13[${PYTHON_USEDEP}]
	...
	~dev-python/virtualenv-20.34.0[${PYTHON_USEDEP}]
