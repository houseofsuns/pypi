...
DEPENDENCIES="<dev-python/inflection-0.6.0[${PYTHON_USEDEP}]
	...
	log? ( <dev-python/python-json-logger-4.0.0[${PYTHON_USEDEP}] )
	...
	db? ( <dev-python/python-dateutil-3.0.0[${PYTHON_USEDEP}] )
	db? ( dev-python/asyncpg[${PYTHON_USEDEP}] )
	db? ( dev-python/psycopg2-binary[${PYTHON_USEDEP}] )
	http? ( <dev-python/httpx-0.29.0[${PYTHON_USEDEP}] )
	...
	http? ( <dev-python/python-slugify-9.0.0[${PYTHON_USEDEP}] )"
