...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	pytorch-test? ( ~dev-python/coverage-7.11.0[${PYTHON_USEDEP}] )
	...
	fabric-test? ( ~dev-python/coverage-7.11.0[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( ~dev-python/coverage-7.11.0[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( ~dev-python/pytest-cov-7.0.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/coverage-7.11.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/pytest-cov-7.0.0[${PYTHON_USEDEP}] )
