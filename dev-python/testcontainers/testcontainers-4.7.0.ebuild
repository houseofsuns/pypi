...
IUSE="arangodb azurite chroma clickhouse cosmosdb generic google influxdb k3s keycloak localstack minio mongodb mssql mysql nats neo4j opensearch oracle oracle-free qdrant rabbitmq redis registry selenium testmoduleimport weaviate"
DEPENDENCIES="cosmosdb? ( dev-python/azure-cosmos[${PYTHON_USEDEP}] )
	...
	testmoduleimport? ( dev-python/httpx[${PYTHON_USEDEP}] )
