...
DEPENDENCIES="~dev-python/numpy-1.26.4[${PYTHON_USEDEP}]
	...
	~dev-python/boto3-1.37.30[${PYTHON_USEDEP}]
	...
	database? ( ~dev-python/redis-5.2.0[${PYTHON_USEDEP}] )
	cos? ( dev-python/ibm-cos-sdk[${PYTHON_USEDEP}] )
	cos? ( dev-python/ibm-cos-sdk-core[${PYTHON_USEDEP}] )
