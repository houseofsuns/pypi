...
IUSE="all aws azure cloudflare cudo do docker gcp ibm kubernetes nebius oci remote runpod scp vast vsphere"
DEPENDENCIES="<dev-python/wheel-0.46.0[${PYTHON_USEDEP}]
	...
	nebius? ( <dev-python/urllib3-2.0[${PYTHON_USEDEP}] )
