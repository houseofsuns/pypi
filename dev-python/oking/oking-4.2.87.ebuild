...
DESCRIPTION="Pacote de integração de produtos, preço, estoque e pedidos com o sistema OkVendas da Openk [top-max 4.2.88]"
...
DEPENDENCIES="dev-python/mysql-connector-python[${PYTHON_USEDEP}]
	...
	dev-python/firebirdsql[${PYTHON_USEDEP}]
	dev-python/fdb[${PYTHON_USEDEP}]
