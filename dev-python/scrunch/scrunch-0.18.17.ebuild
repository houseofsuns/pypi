...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/0c/36/91d08be2f1502acc05b5052d6c025adafc4efc1cf9d5a0fa7157fbf89a90/${REALNAME}-${REALVERSION}.tar.gz"
...
DEPENDENCIES="dev-python/pycrunch[${PYTHON_USEDEP}]
	...
	testing? ( dev-python/pyspssio[${PYTHON_USEDEP}] )"
