...
DEPENDENCIES="~dev-python/alembic-1.10.4[${PYTHON_USEDEP}]
	...
	~dev-python/Faker-24.11.0[${PYTHON_USEDEP}]
	...
	~dev-python/pyzmq-26.0.2[${PYTHON_USEDEP}]
	...
	s3? ( ~dev-python/boto3-1.34.88[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/botocore-1.34.88[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/fsspec-2024.3.1[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/black-24.4.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/docutils-0.21.1[${PYTHON_USEDEP}] )
