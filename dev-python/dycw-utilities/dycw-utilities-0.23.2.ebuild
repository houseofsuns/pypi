...
IUSE="airium ast-comments attrs beautifulsoup4 bottleneck cryptography cvxpy dev fastapi fpdf2 hatch holoviews hypothesis luigi mdutils memory-profiler numbagg numpy pandas polars pqdm psutil pydantic pyinstrument pypiserver pytest pytest-check scipy scripts-csv-to-markdown scripts-generate-snippets scripts-luigi scripts-pypi selenium sqlalchemy sqlalchemy-dbs streamlit test xarray xlrd zarr"
DEPENDENCIES="dev-python/atomicwrites[${PYTHON_USEDEP}]
	...
	test? ( dev-python/pytest-is-running[${PYTHON_USEDEP}] )
