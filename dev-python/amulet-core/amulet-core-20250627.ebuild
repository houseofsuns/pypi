...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="2.0.3a2.post250627150829"
DIGEST_SOURCES="yes"
...
DESCRIPTION="A Python library for reading/writing Minecraft's various save formats. [badver 2.0.3a2.post250627150829, wheel]"
