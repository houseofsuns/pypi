...
DEPENDENCIES="~dev-python/attrs-22.2.0[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/build-1.0.0[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/sphinx-7.3.7[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/sphinx-simplepdf[${PYTHON_USEDEP}] )
	all? ( ~dev-python/furo-2024.5.6[${PYTHON_USEDEP}] )
