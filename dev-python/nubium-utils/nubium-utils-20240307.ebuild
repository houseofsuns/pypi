...
DESCRIPTION="Some Kafka utility functions and patterns for the nubium project [badver 3.4.5.post4.dev2]"
...
IUSE="dev"
DEPENDENCIES="dev-python/aiosfstream[${PYTHON_USEDEP}]
	dev-python/fluvii[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/virtualenv-api[${PYTHON_USEDEP}] )
