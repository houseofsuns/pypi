...
IUSE="all data-clean langchain openai"
DEPENDENCIES=">=dev-python/requests-2.24[${PYTHON_USEDEP}]
	...
	data-clean? ( dev-python/torch[${PYTHON_USEDEP}] )
	all? ( dev-python/torch[${PYTHON_USEDEP}] )
	data-clean? ( dev-python/ltp[${PYTHON_USEDEP}] )
	all? ( dev-python/ltp[${PYTHON_USEDEP}] )
	data-clean? ( dev-python/emoji[${PYTHON_USEDEP}] )
	all? ( dev-python/emoji[${PYTHON_USEDEP}] )
	data-clean? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	all? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	dev-python/multiprocess[${PYTHON_USEDEP}]
	dev-python/clevercsv[${PYTHON_USEDEP}]
	dev-python/ijson[${PYTHON_USEDEP}]
	openai? ( dev-python/flask[${PYTHON_USEDEP}] )
	all? ( dev-python/flask[${PYTHON_USEDEP}] )
	openai? ( dev-python/gevent[${PYTHON_USEDEP}] )
