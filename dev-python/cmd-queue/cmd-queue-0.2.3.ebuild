...
IUSE="airflow airflow-strict all all-strict docs docs-strict linting linting-strict optional optional-strict runtime runtime-strict tests tests-strict"
DEPENDENCIES=">=dev-python/numpy-2.3.4[${PYTHON_USEDEP}]
	...
	all? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	all? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	runtime? ( >=dev-python/numpy-2.3.4[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/rich-13.7.1[${PYTHON_USEDEP}] )
	runtime? ( >=dev-python/pandas-2.3.3[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/psutil-6.1.0[${PYTHON_USEDEP}] )
	...
	optional? ( dev-python/Pint[${PYTHON_USEDEP}] )
	optional? ( dev-python/Pint[${PYTHON_USEDEP}] )
	optional? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	optional? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	optional? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/numpy-2.3.4[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/rich-13.7.1[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/pandas-2.3.3[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/psutil-6.1.0[${PYTHON_USEDEP}] )
	...
	all-strict? ( ~dev-python/pytest-cov-4.1.0[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/coverage-7.0.0[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/textual[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/Pint[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/Pint[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/Pint[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	all-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	runtime-strict? ( ~dev-python/numpy-2.3.4[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/rich-13.7.1[${PYTHON_USEDEP}] )
	runtime-strict? ( ~dev-python/pandas-2.3.3[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/psutil-6.1.0[${PYTHON_USEDEP}] )
	...
	tests-strict? ( ~dev-python/pytest-cov-4.1.0[${PYTHON_USEDEP}] )
	tests-strict? ( ~dev-python/coverage-7.0.0[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/textual[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/Pint[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/Pint[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/Pint[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	optional-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	airflow-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	airflow-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
	airflow-strict? ( dev-python/apache-airflow[${PYTHON_USEDEP}] )
