...
DEPENDENCIES="~dev-python/black-25.9.0[${PYTHON_USEDEP}]
	...
	~dev-python/pyupgrade-3.21.0[${PYTHON_USEDEP}]
	...
	core? ( ~dev-python/psycopg-3.2.12[${PYTHON_USEDEP}] )
	...
	extension? ( ~dev-python/psycopg-3.2.12[${PYTHON_USEDEP}] )
	extension? ( <dev-python/tornado-7.0[${PYTHON_USEDEP}] )
	async? ( ~dev-python/pytest-asyncio-1.2.0[${PYTHON_USEDEP}] )
