...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/c7/a9/b38461a5d63a968ae63cd708c08dff9e8855d4f04923c91e67f7d1e3f058/${REALNAME}-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/anyio-5.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/mkdocs-git-revision-date-localized-plugin-1.2.5[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/mkdocs-material-9.5.21[${PYTHON_USEDEP}] )
	...
	devdocs? ( ~dev-python/mkdocs-git-revision-date-localized-plugin-1.2.5[${PYTHON_USEDEP}] )
	...
	test-core? ( ~dev-python/pytest-8.2.0[${PYTHON_USEDEP}] )
	...
	testing? ( ~dev-python/pytest-8.2.0[${PYTHON_USEDEP}] )
