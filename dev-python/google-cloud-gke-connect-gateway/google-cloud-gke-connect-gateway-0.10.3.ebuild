...
DESCRIPTION="Google Cloud Gke Connect Gateway API client library"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-gke-connect-gateway"
LICENSE="Apache-2.0"
