...
DEPENDENCIES="dev-python/requests[${PYTHON_USEDEP}]
	...
	test? ( dev-python/trytond-customs[${PYTHON_USEDEP}] )
	test? ( dev-python/trytond-incoterm[${PYTHON_USEDEP}] )
	test? ( dev-python/trytond-sale[${PYTHON_USEDEP}] )
	test? ( dev-python/trytond-sale-shipment-cost[${PYTHON_USEDEP}] )
	test? ( dev-python/trytond-stock-shipment-customs[${PYTHON_USEDEP}] )"
