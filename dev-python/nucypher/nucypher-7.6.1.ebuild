...
DEPENDENCIES="dev-python/abnf[${PYTHON_USEDEP}]
	...
	~dev-python/txaio-25.6.1[${PYTHON_USEDEP}]
	...
	~dev-python/zope-interface-8.0[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/cffi-2.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/coverage-7.10.7[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/cryptography-46.0.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/executing-2.2.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/identify-2.6.14[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/ipython-8.37.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/jsonschema-specifications-2025.9.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/markdown-it-py-4.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/parso-0.8.5[${PYTHON_USEDEP}] )
	dev? ( dev-python/pendulum[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pexpect-4.9.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/platformdirs-4.4.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/protobuf-6.32.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pydantic-2.11.9[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pygments-2.19.2[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pyjwt-2.10.1[${PYTHON_USEDEP}] )
	dev? ( dev-python/pymultihash[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pynacl-1.6.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pyopenssl-25.3.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/txaio-25.6.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/zope-interface-8.0[${PYTHON_USEDEP}] )"
