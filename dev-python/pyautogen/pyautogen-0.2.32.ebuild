...
IUSE="anthropic autobuild blendsearch cohere cosmosdb gemini graph groq jupyter-executor lmm long-context mathchat mistral redis retrievechat retrievechat-pgvector retrievechat-qdrant teachable test together types websockets websurfer"
