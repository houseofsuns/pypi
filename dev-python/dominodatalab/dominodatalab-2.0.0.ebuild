...
IUSE="agents airflow data dev docs"
DEPENDENCIES="~dev-python/packaging-23.2[${PYTHON_USEDEP}]
	...
	agents? ( >=dev-python/semver-3.0.4[${PYTHON_USEDEP}] )
	agents? ( >=dev-python/pandas-2.3.1[${PYTHON_USEDEP}] )
	agents? ( >=dev-python/numpy-2.0.2[${PYTHON_USEDEP}] )
	agents? ( dev-python/mlflow-skinny[${PYTHON_USEDEP}] )
	agents? ( dev-python/mlflow-tracing[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/ai-mock[${PYTHON_USEDEP}] )
