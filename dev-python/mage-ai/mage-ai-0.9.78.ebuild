...
DEPENDENCIES="dev-python/cachetools[${PYTHON_USEDEP}]
	...
	~dev-python/jupyter-server-2.14.1[${PYTHON_USEDEP}]
	...
	dbt? ( dev-python/dbt-adapters[${PYTHON_USEDEP}] )
	...
	dbt? ( dev-python/dbt-synapse[${PYTHON_USEDEP}] )
	...
	streaming? ( ~dev-python/elasticsearch-8.15.1[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/dbt-adapters[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/dbt-synapse[${PYTHON_USEDEP}] )
	all? ( dev-python/dbt-trino[${PYTHON_USEDEP}] )
	all? ( dev-python/duckdb[${PYTHON_USEDEP}] )
	all? ( ~dev-python/elasticsearch-8.15.1[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/protobuf-4.25.0[${PYTHON_USEDEP}] )
