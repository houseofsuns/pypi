...
IUSE="arrow athena aws-secrets azure azure-secrets bigquery clickhouse cloud databricks dremio excel gcp hive mssql mysql pagerduty postgresql redshift s3 snowflake spark teradata test trino vertica"
DEPENDENCIES="dev-python/altair[${PYTHON_USEDEP}]
	...
	clickhouse? ( <dev-python/pandas-2.2.0[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/nbformat-5.0[${PYTHON_USEDEP}] )
