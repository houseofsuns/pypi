...
IUSE="aws detectron2 dev e2e fastai kedro lightgbm mlflow optuna prophet pytorch pytorch-lightning sacred sklearn tensorboard tensorflow-keras transformers xgboost"
DEPENDENCIES="dev? ( dev-python/Faker[${PYTHON_USEDEP}] )
	...
	e2e? ( dev-python/mlflow[${PYTHON_USEDEP}] )
