...
DEPENDENCIES="dev-python/docstring-to-markdown[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/pylint-4.1.0[${PYTHON_USEDEP}] )
	...
	pylint? ( <dev-python/pylint-4.1.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/pylint-4.1.0[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/websockets-10.3[${PYTHON_USEDEP}] )"
