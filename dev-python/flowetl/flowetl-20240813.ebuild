...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="1.28.1.post0.dev115"
DIGEST_SOURCES="yes"
...
DESCRIPTION="FlowETL is a collection of special purposes Airflow operators and sensors for use with FlowKit. [badver 1.28.1.post0.dev115, wheel]"
