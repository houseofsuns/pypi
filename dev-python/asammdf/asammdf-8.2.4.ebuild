...
IUSE="decode encryption export export-matlab-v5 filesystem gui symbolic-math testing"
DEPENDENCIES="dev-python/canmatrix[${PYTHON_USEDEP}]
	...
	export? ( dev-python/pyarrow[${PYTHON_USEDEP}] )
	...
	testing? ( dev-python/python-can[${PYTHON_USEDEP}] )
