...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="1.7.0.dev20251103064240"
DIGEST_SOURCES="yes"
...
IUSE="dev-env"
DEPENDENCIES="dev-env? ( >=dev-python/setuptools-70.0[${PYTHON_USEDEP}] )
	dev-python/cirq-aqt[${PYTHON_USEDEP}]
	...
	dev-env? ( ~dev-python/mypy-1.18.2[${PYTHON_USEDEP}] )
	...
	dev-env? ( ~dev-python/black-25.9.0[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/isort-6.0.1[${PYTHON_USEDEP}] )
	...
	dev-env? ( >=dev-python/ipython-8.17[${PYTHON_USEDEP}] )
