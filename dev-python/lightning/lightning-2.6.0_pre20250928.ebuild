...
IUSE="all data dev examples extra fabric-all fabric-dev fabric-examples fabric-extra fabric-strategies fabric-test pytorch-all pytorch-dev pytorch-examples pytorch-extra pytorch-strategies pytorch-test strategies test"
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	<dev-python/fsspec-2027.0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/ipython-11.0[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/rich-15.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/psutil-8.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pytest-cov-6.3.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pytest-rerunfailures-16.0.1[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/rich-15.0[${PYTHON_USEDEP}] )
	...
	examples? ( <dev-python/ipython-11.0[${PYTHON_USEDEP}] )
	...
	extra? ( <dev-python/rich-15.0[${PYTHON_USEDEP}] )
	extra? ( dev-python/tensorboardX[${PYTHON_USEDEP}] )
	extra? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	fabric-all? ( dev-python/hydra-core[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( ~dev-python/coverage-7.10.6[${PYTHON_USEDEP}] )
	fabric-dev? ( dev-python/hydra-core[${PYTHON_USEDEP}] )
	fabric-dev? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-cov-6.3.0[${PYTHON_USEDEP}] )
	fabric-dev? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-rerunfailures-16.0.1[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-8.4.2[${PYTHON_USEDEP}] )
	...
	fabric-dev? ( ~dev-python/click-8.2.1[${PYTHON_USEDEP}] )
	...
	fabric-test? ( ~dev-python/coverage-7.10.6[${PYTHON_USEDEP}] )
	fabric-test? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-cov-6.3.0[${PYTHON_USEDEP}] )
	fabric-test? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-rerunfailures-16.0.1[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-8.4.2[${PYTHON_USEDEP}] )
	fabric-test? ( dev-python/tensorboardX[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/click-8.2.1[${PYTHON_USEDEP}] )
	pytorch-all? ( dev-python/hydra-core[${PYTHON_USEDEP}] )
	pytorch-all? ( <dev-python/ipython-11.0[${PYTHON_USEDEP}] )
	...
	pytorch-all? ( <dev-python/rich-15.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( <dev-python/cloudpickle-4.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( ~dev-python/coverage-7.10.6[${PYTHON_USEDEP}] )
	pytorch-dev? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	pytorch-dev? ( dev-python/hydra-core[${PYTHON_USEDEP}] )
	pytorch-dev? ( <dev-python/ipython-11.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( dev-python/onnxscript[${PYTHON_USEDEP}] )
	pytorch-dev? ( <dev-python/pandas-3.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( <dev-python/psutil-8.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( ~dev-python/pytest-cov-6.3.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	pytorch-dev? ( ~dev-python/pytest-rerunfailures-16.0.1[${PYTHON_USEDEP}] )
	pytorch-dev? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( ~dev-python/pytest-8.4.2[${PYTHON_USEDEP}] )
	pytorch-dev? ( <dev-python/requests-3.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( <dev-python/rich-15.0[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( dev-python/torch-tensorrt[${PYTHON_USEDEP}] )
	pytorch-examples? ( <dev-python/ipython-11.0[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/coverage-7.10.6[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/pytest-cov-6.3.0[${PYTHON_USEDEP}] )
	pytorch-test? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	pytorch-test? ( ~dev-python/pytest-rerunfailures-16.0.1[${PYTHON_USEDEP}] )
	pytorch-test? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	pytorch-test? ( ~dev-python/pytest-8.4.2[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( dev-python/torch-tensorrt[${PYTHON_USEDEP}] )
	strategies? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	strategies? ( dev-python/deepspeed[${PYTHON_USEDEP}] )
	test? ( <dev-python/cloudpickle-4.0[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/psutil-8.0[${PYTHON_USEDEP}] )
	test? ( ~dev-python/pytest-cov-6.3.0[${PYTHON_USEDEP}] )
	test? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	test? ( ~dev-python/pytest-rerunfailures-16.0.1[${PYTHON_USEDEP}] )
