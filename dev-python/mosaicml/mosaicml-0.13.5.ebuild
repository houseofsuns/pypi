...
IUSE="all coco comet_ml deepspeed dev health_checker libcloud mlflow mlperf nlp oci onnx sentencepiece streaming tensorboard timm unet vit wandb"
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	health_checker? ( dev-python/slack-sdk[${PYTHON_USEDEP}] )
