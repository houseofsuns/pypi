...
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	dev-tensorflow? ( <dev-python/pytest-rerunfailures-16.0[${PYTHON_USEDEP}] )
	...
	dev-tensorflow? ( dev-python/openai[${PYTHON_USEDEP}] )
	dev-tensorflow? ( >=dev-python/pydantic-2.0[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/uvicorn[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/fastapi[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/starlette[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/torch[${PYTHON_USEDEP}] )
	dev-tensorflow? ( dev-python/accelerate[${PYTHON_USEDEP}] )
