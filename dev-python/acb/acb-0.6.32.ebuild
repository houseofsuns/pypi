...
DEPENDENCIES=">=dev-python/itsdangerous-2.2.0[${PYTHON_USEDEP}]
	...
	dns? ( >=dev-python/validators-0.34.0[${PYTHON_USEDEP}] )
	requests? ( >=dev-python/httpx-0.27.2[${PYTHON_USEDEP}] )
	requests? ( >=dev-python/hishel-0.0.33[${PYTHON_USEDEP}] )
	requests? ( >=dev-python/sentry-sdk-2.16.0[${PYTHON_USEDEP}] )
	requests? ( dev-python/logfire[${PYTHON_USEDEP}] )
	smtp? ( dev-python/mailgun[${PYTHON_USEDEP}] )
	sql? ( >=dev-python/sqlalchemy-2.0.35[${PYTHON_USEDEP}] )
	...
	sql? ( >=dev-python/sentry-sdk-2.16.0[${PYTHON_USEDEP}] )
	nosql? ( dev-python/google-cloud-firestore[${PYTHON_USEDEP}] )
	nosql? ( dev-python/motor[${PYTHON_USEDEP}] )
	demo? ( >=dev-python/Faker-30.3.0[${PYTHON_USEDEP}] )
	ftp? ( dev-python/aioftp[${PYTHON_USEDEP}] )
	ftp? ( >=dev-python/asyncssh-2.17.0[${PYTHON_USEDEP}] )
	secret? ( dev-python/google-cloud-secret-manager[${PYTHON_USEDEP}] )
	monitoring? ( >=dev-python/sentry-sdk-2.16.0[${PYTHON_USEDEP}] )
