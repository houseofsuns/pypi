...
LICENSE="MIT Licence"
SRC_URI="https://files.pythonhosted.org/packages/py3/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-748-py3-none-any.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-748-py3-none-any.whl"
RESTRICT="test"
