...
IUSE="all audio benchmark dev doc embedding ggml image intel mlx rerank sglang transformers video vllm"
DEPENDENCIES="dev-python/xoscar[${PYTHON_USEDEP}]
	...
	all? ( dev-python/matcha-tts[${PYTHON_USEDEP}] )
	...
	audio? ( dev-python/matcha-tts[${PYTHON_USEDEP}] )
	...
	doc? ( dev-python/opencv-contrib-python[${PYTHON_USEDEP}] )
