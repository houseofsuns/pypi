...
IUSE="anthropic ddg dev framework generator lancedb openai serpapi slackbot tests"
DEPENDENCIES="dev-python/beautifulsoup4[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/mkdocs-autolinks-plugin[${PYTHON_USEDEP}] )
	...
	framework? ( dev-python/aiosqlite[${PYTHON_USEDEP}] )
	framework? ( dev-python/alembic[${PYTHON_USEDEP}] )
	framework? ( dev-python/bcrypt[${PYTHON_USEDEP}] )
	framework? ( dev-python/gunicorn[${PYTHON_USEDEP}] )
	framework? ( dev-python/prefect[${PYTHON_USEDEP}] )
	...
	slackbot? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	slackbot? ( dev-python/numpy[${PYTHON_USEDEP}] )
	tests? ( dev-python/marvin[${PYTHON_USEDEP}] )
