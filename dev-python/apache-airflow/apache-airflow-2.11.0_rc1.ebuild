...
DEPENDENCIES="<dev-python/alembic-2.0[${PYTHON_USEDEP}]
	...
	devel-ci? ( >=dev-python/click-8.1.8[${PYTHON_USEDEP}] )
	...
	devel-ci? ( >=dev-python/docutils-0.21[${PYTHON_USEDEP}] )
	...
	devel-ci? ( >=dev-python/sphinx-autoapi-3.0[${PYTHON_USEDEP}] )
	...
	devel-ci? ( >=dev-python/sphinx-7.0[${PYTHON_USEDEP}] )
