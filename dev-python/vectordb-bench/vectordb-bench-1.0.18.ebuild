...
IUSE="alisql aliyun-opensearch all chromadb clickhouse cockroachdb doris elastic lancedb mariadb memorydb mongodb oceanbase opensearch pgvecto-rs pgvector pinecone qdrant redis restful test tidb turbopuffer vespa weaviate"
DEPENDENCIES="dev-python/click[${PYTHON_USEDEP}]
	...
	restful? ( dev-python/flask[${PYTHON_USEDEP}] )
	...
	cockroachdb? ( dev-python/pgvector[${PYTHON_USEDEP}] )
	...
	alisql? ( dev-python/mysql-connector-python[${PYTHON_USEDEP}] )
	doris? ( dev-python/doris-vector-search[${PYTHON_USEDEP}] )
