...
DESCRIPTION="Easy-to-import library with a basic, efficient, pure-Python implementation of the extended Euclidean algorithm."
...
DEPENDENCIES="test? ( ~dev-python/pytest-cov-3.0[${PYTHON_USEDEP}] )
