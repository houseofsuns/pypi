...
IUSE="bedrock connectors excel flask ggplot google-ai google-sheets ibm-watsonx-ai langchain modin numpy plotly scikit-learn seaborn sentencec-transformers statsmodels streamlit text-generation yfinance"
