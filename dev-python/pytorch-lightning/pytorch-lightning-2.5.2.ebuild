...
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	test? ( <dev-python/psutil-7.0.1[${PYTHON_USEDEP}] )
	...
	examples? ( <dev-python/ipython-8.19.0[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/ipython-8.19.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/psutil-7.0.1[${PYTHON_USEDEP}] )
