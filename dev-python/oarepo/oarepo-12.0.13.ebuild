...
DEPENDENCIES="~dev-python/alembic-1.10.4[${PYTHON_USEDEP}]
	...
	~dev-python/dnspython-2.5.0[${PYTHON_USEDEP}]
	...
	~dev-python/Faker-22.5.0[${PYTHON_USEDEP}]
	...
	~dev-python/mako-1.3.1[${PYTHON_USEDEP}]
	...
	~dev-python/nbconvert-7.14.2[${PYTHON_USEDEP}]
	...
	s3? ( ~dev-python/boto3-1.34.25[${PYTHON_USEDEP}] )
	s3? ( ~dev-python/botocore-1.34.25[${PYTHON_USEDEP}] )
