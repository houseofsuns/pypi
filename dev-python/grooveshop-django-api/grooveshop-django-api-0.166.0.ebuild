...
IUSE=""
DEPENDENCIES="~dev-python/Faker-30.1.0[${PYTHON_USEDEP}]
	~dev-python/asgiref-3.8.1[${PYTHON_USEDEP}]
	~dev-python/boto3-1.35.32[${PYTHON_USEDEP}]
	...
	~dev-python/phonenumbers-8.13.46[${PYTHON_USEDEP}]
	...
	~dev-python/rich-13.9.1[${PYTHON_USEDEP}]
