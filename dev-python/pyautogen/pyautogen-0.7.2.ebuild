...
DEPENDENCIES="dev-python/asyncer[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/pdoc3-0.11.5[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/uv-0.5.21[${PYTHON_USEDEP}] )
	...
	docs? ( ~dev-python/pdoc3-0.11.5[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	docs? ( ~dev-python/termcolor-2.5.0[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/nbconvert-7.16.5[${PYTHON_USEDEP}] )
	...
	types? ( ~dev-python/mypy-1.14.1[${PYTHON_USEDEP}] )
	types? ( ~dev-python/nbconvert-7.16.5[${PYTHON_USEDEP}] )
	...
	types? ( ~dev-python/pytest-asyncio-0.25.2[${PYTHON_USEDEP}] )
	types? ( ~dev-python/pytest-cov-6.0.0[${PYTHON_USEDEP}] )
	types? ( ~dev-python/pytest-8.3.4[${PYTHON_USEDEP}] )
