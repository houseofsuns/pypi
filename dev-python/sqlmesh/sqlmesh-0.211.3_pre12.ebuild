...
IUSE="athena azuresql azuresql-odbc bigframes bigquery clickhouse databricks dbt dev dlt fabric gcppostgres github llm lsp motherduck mssql mssql-odbc mwaa mysql postgres redshift risingwave slack snowflake trino web"
DEPENDENCIES="lsp? ( dev-python/lsprotocol[${PYTHON_USEDEP}] )
	...
	~dev-python/sqlglot-27.9.0[${PYTHON_USEDEP}]
	...
	lsp? ( ~dev-python/uvicorn-0.22.0[${PYTHON_USEDEP}] )
