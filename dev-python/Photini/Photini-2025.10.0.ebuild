...
LICENSE="GPL-3+"
SRC_URI="https://files.pythonhosted.org/packages/e0/30/a331eea9dd72be7e87e4ad90b7ea6d321dfba552f94a388c373eb389b49f/photini-${REALVERSION}.tar.gz"
...
DEPENDENCIES=">=dev-python/cachetools-3.0[${PYTHON_USEDEP}]
	...
	pyqt6-windows? ( dev-python/qt6-unavailable[${PYTHON_USEDEP}] )
	...
	pyside6-windows? ( dev-python/qt6-unavailable[${PYTHON_USEDEP}] )
