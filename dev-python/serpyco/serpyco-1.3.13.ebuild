...
DEPENDENCIES="dev-python/python-dateutil[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/dataslots[${PYTHON_USEDEP}] )
	...
	build-doc? ( dev-python/sphinx-autodoc-typehints[${PYTHON_USEDEP}] )
	build-doc? ( dev-python/sphinx-rtd-theme[${PYTHON_USEDEP}] )
	build-doc? ( dev-python/sphinxcontrib-websupport[${PYTHON_USEDEP}] )"
