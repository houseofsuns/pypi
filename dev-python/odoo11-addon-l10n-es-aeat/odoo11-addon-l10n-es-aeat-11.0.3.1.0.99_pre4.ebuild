...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="11.0.3.1.0.99.dev4"
DIGEST_SOURCES="yes"
...
DESCRIPTION="Modulo base para declaraciones de la AEAT [wheel]"
...
IUSE=""
DEPENDENCIES="dev-python/odoo11-addon-account-tax-balance[${PYTHON_USEDEP}]
