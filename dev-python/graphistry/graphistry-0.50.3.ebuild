...
IUSE="ai all bolt build dev dgl-cpu dgl-gpu docs gremlin igraph jupyter kusto networkx nodexl pygraphviz rapids spanner test testai umap-learn"
DEPENDENCIES="ai? ( dev-python/scikit-learn[${PYTHON_USEDEP}] )
	...
	dgl-cpu? ( dev-python/torch[${PYTHON_USEDEP}] )
	dgl-cpu? ( dev-python/torchdata[${PYTHON_USEDEP}] )
	dgl-cpu? ( dev-python/dgl[${PYTHON_USEDEP}] )
	dgl-gpu? ( dev-python/torch[${PYTHON_USEDEP}] )
	dgl-gpu? ( dev-python/dgl-cu12[${PYTHON_USEDEP}] )
