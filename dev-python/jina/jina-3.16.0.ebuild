...
DEPENDENCIES="dev-python/opentelemetry-exporter-prometheus[${PYTHON_USEDEP}]
	...
	aiostream? ( dev-python/aiostream[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/aiostream[${PYTHON_USEDEP}] )
	...
	core? ( dev-python/urllib3[${PYTHON_USEDEP}] )
	...
	core? ( dev-python/aiostream[${PYTHON_USEDEP}] )
	...
	devel? ( dev-python/watchfiles[${PYTHON_USEDEP}] )
	...
	devel? ( dev-python/pydantic[${PYTHON_USEDEP}] )
	...
	devel? ( dev-python/prometheus-client[${PYTHON_USEDEP}] )
	...
	devel? ( dev-python/uvicorn[${PYTHON_USEDEP}] )
	...
	perf? ( dev-python/prometheus-client[${PYTHON_USEDEP}] )
	...
	pytest-asyncio? ( dev-python/pytest-asyncio[${PYTHON_USEDEP}] )
	...
	standard? ( dev-python/pydantic[${PYTHON_USEDEP}] )
	...
	watchfiles? ( dev-python/watchfiles[${PYTHON_USEDEP}] )
