...
DEPENDENCIES="dev-python/chardet[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/sphinx_bootstrap_theme[${PYTHON_USEDEP}] )
	dev? ( dev-python/sphinx_panels[${PYTHON_USEDEP}] )
	...
	doc? ( dev-python/sphinx[${PYTHON_USEDEP}] )
	doc? ( dev-python/sphinx_bootstrap_theme[${PYTHON_USEDEP}] )
	doc? ( dev-python/sphinx_panels[${PYTHON_USEDEP}] )
