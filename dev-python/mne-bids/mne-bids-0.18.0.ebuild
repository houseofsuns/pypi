...
DEPENDENCIES="dev-python/mne[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/curryreader[${PYTHON_USEDEP}] )
	dev? ( dev-python/curryreader[${PYTHON_USEDEP}] )
	...
	dev? ( >dev-python/h5py-3.15.0[${PYTHON_USEDEP}] )
	...
	full? ( >dev-python/h5py-3.15.0[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/curryreader[${PYTHON_USEDEP}] )
	test? ( dev-python/curryreader[${PYTHON_USEDEP}] )
	...
	test? ( >dev-python/h5py-3.15.0[${PYTHON_USEDEP}] )
