...
IUSE="amici autograd copasi doc examples julia migrate ot petab plotly pyarrow r test test-petab webserver-dash webserver-flask yaml2sbml"
DEPENDENCIES=">=dev-python/numpy-1.23.5[${PYTHON_USEDEP}]
	...
	webserver-flask? ( dev-python/Flask-Bootstrap[${PYTHON_USEDEP}] )
	webserver-flask? ( >=dev-python/flask-1.1.2[${PYTHON_USEDEP}] )
	webserver-flask? ( dev-python/bokeh[${PYTHON_USEDEP}] )
	webserver-dash? ( dev-python/dash[${PYTHON_USEDEP}] )
	webserver-dash? ( dev-python/dash-bootstrap-components[${PYTHON_USEDEP}] )
	...
	test-petab? ( dev-python/petabtests[${PYTHON_USEDEP}] )"
