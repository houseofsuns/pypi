...
DEPENDENCIES=">=dev-python/numpy-1.20[${PYTHON_USEDEP}]
	...
	test-more? ( dev-python/meshio[${PYTHON_USEDEP}] )
	test-more? ( dev-python/xatlas[${PYTHON_USEDEP}] )
	...
	test-more? ( dev-python/marimo[${PYTHON_USEDEP}] )
	deprecated? ( dev-python/openctm[${PYTHON_USEDEP}] )
