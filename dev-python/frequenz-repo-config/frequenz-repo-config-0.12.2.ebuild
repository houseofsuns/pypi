...
DEPENDENCIES=">=dev-python/nox-2022.11.21[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.6.2[${PYTHON_USEDEP}] )
	dev-mkdocs? ( ~dev-python/mkdocstrings-0.28.0[${PYTHON_USEDEP}] )
	dev-mkdocs? ( ~dev-python/mkdocstrings-python-1.14.6[${PYTHON_USEDEP}] )
	dev-mypy? ( ~dev-python/mypy-1.14.1[${PYTHON_USEDEP}] )
	dev-mypy? ( <dev-python/types-setuptools-76.0[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/pylint-3.3.4[${PYTHON_USEDEP}] )
