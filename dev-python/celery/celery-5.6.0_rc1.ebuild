...
DEPENDENCIES="dev-python/billiard[${PYTHON_USEDEP}]
	...
	auth? ( ~dev-python/cryptography-46.0.3[${PYTHON_USEDEP}] )
	...
	elasticsearch? ( <=dev-python/elasticsearch-9.1.2[${PYTHON_USEDEP}] )
	elasticsearch? ( <=dev-python/elastic-transport-9.1.0[${PYTHON_USEDEP}] )
	...
	gcs? ( ~dev-python/grpcio-1.75.1[${PYTHON_USEDEP}] )
	...
	pydantic? ( >=dev-python/pydantic-2.12.0_alpha1[${PYTHON_USEDEP}] )
	...
	tblib? ( ~dev-python/tblib-3.2.1[${PYTHON_USEDEP}] )
