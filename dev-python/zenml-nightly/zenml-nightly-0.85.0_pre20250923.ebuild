...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.85.0.dev20250923"
DIGEST_SOURCES="yes"
...
IUSE="adlfs azureml connectors-aws connectors-azure connectors-gcp connectors-kubernetes dev gcsfs jupyter local s3fs sagemaker secrets-aws secrets-azure secrets-gcp secrets-hashicorp server templates vertex"
DEPENDENCIES="<=dev-python/click-8.2.1[${PYTHON_USEDEP}]
	...
	server? ( <=dev-python/alembic-1.15.2[${PYTHON_USEDEP}] )
	local? ( <dev-python/sqlalchemy-3.0.0[${PYTHON_USEDEP}] )
	server? ( <dev-python/sqlalchemy-3.0.0[${PYTHON_USEDEP}] )
	...
	server? ( <dev-python/pymysql-1.2.0[${PYTHON_USEDEP}] )
	local? ( <dev-python/passlib-1.8.0[${PYTHON_USEDEP}] )
	server? ( <dev-python/passlib-1.8.0[${PYTHON_USEDEP}] )
	local? ( ~dev-python/bcrypt-4.0.1[${PYTHON_USEDEP}] )
	server? ( ~dev-python/bcrypt-4.0.1[${PYTHON_USEDEP}] )
