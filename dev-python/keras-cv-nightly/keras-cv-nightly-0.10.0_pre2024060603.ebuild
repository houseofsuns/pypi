...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.10.0.dev2024060603"
DIGEST_SOURCES="yes"
...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/48/91/93fc3a4c6293fc8450b0aa82884745dd55a6dc3026e20c8b238819a46b17/${REALNAME//-/_}-${REALVERSION}.tar.gz"
...
IUSE="examples tests"
DEPENDENCIES="dev-python/kagglehub[${PYTHON_USEDEP}]
