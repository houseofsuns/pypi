...
IUSE="bco deepspeed dev diffusers judges liger mergekit peft quantization scikit test vllm vlm"
DEPENDENCIES="dev-python/accelerate[${PYTHON_USEDEP}]
	...
	mergekit? ( dev-python/mergekit[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/mergekit[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/vllm[${PYTHON_USEDEP}] )
