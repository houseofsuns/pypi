...
DEPENDENCIES="oscore? ( dev-python/cbor2[${PYTHON_USEDEP}] )
	...
	ws? ( <dev-python/websockets-16.0[${PYTHON_USEDEP}] )
	...
	prettyprint? ( dev-python/colorlog[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/DTLSSocket[${PYTHON_USEDEP}] )
