...
DEPENDENCIES=">=dev-python/itsdangerous-2.2.0[${PYTHON_USEDEP}]
	...
	dns? ( >=dev-python/validators-0.28.1[${PYTHON_USEDEP}] )
	requests? ( >=dev-python/httpx-0.27.0[${PYTHON_USEDEP}] )
	requests? ( >=dev-python/hishel-0.0.26[${PYTHON_USEDEP}] )
	email? ( dev-python/mailgun[${PYTHON_USEDEP}] )
	sql? ( >=dev-python/sqlalchemy-2.0.30[${PYTHON_USEDEP}] )
	sql? ( dev-python/SQLAlchemy-Utils[${PYTHON_USEDEP}] )
	sql? ( >=dev-python/mysqlclient-2.2.4[${PYTHON_USEDEP}] )
	...
	demo? ( >=dev-python/Faker-25.2.0[${PYTHON_USEDEP}] )
	ftp? ( dev-python/aioftp[${PYTHON_USEDEP}] )
	ftp? ( >=dev-python/asyncssh-2.14.2[${PYTHON_USEDEP}] )
