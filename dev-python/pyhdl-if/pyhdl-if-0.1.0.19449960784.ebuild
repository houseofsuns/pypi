...
DESCRIPTION="Python interface for HDL programming interfaces [wheel]"
...
IUSE=""
DEPENDENCIES="dev-python/pytypeworks[${PYTHON_USEDEP}]
	dev-python/pyvsc-dataclasses[${PYTHON_USEDEP}]
