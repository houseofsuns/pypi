...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/10/87/f32bc8a859f05d64923377f9cd76ed1c30224786bffbbaa4f05318bed391/ayugespidertools-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/pymysql-2.0.0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/psycopg-3.2.0[${PYTHON_USEDEP}] )
	database? ( <dev-python/psycopg-3.2.0[${PYTHON_USEDEP}] )
