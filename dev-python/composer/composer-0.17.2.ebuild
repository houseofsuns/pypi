...
DEPENDENCIES="<dev-python/pyyaml-7.0[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/ipykernel-6.26.0[${PYTHON_USEDEP}] )
	all? ( ~dev-python/traitlets-5.13.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/ipykernel-6.26.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/traitlets-5.13.0[${PYTHON_USEDEP}] )
