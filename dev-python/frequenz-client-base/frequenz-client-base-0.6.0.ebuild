...
DEPENDENCIES="dev-python/grpcio[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.5.31[${PYTHON_USEDEP}] )
	...
	dev-mypy? ( ~dev-python/mypy-1.11.1[${PYTHON_USEDEP}] )
	...
	dev-pylint? ( ~dev-python/pylint-3.2.6[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/pytest-asyncio-0.23.8[${PYTHON_USEDEP}] )
	dev-pytest? ( dev-python/async-solipsism[${PYTHON_USEDEP}] )
	dev-pytest? ( ~dev-python/hypothesis-6.111.0[${PYTHON_USEDEP}] )
