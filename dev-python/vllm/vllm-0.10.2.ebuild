...
IUSE="audio bench fastsafetensors flashinfer petit-kernel runai tensorizer"
DEPENDENCIES="dev-python/regex[${PYTHON_USEDEP}]
	...
	bench? ( dev-python/datasets[${PYTHON_USEDEP}] )
	...
	runai? ( dev-python/runai-model-streamer-gcs[${PYTHON_USEDEP}] )
	runai? ( dev-python/google-cloud-storage[${PYTHON_USEDEP}] )
	...
	flashinfer? ( dev-python/flashinfer-python[${PYTHON_USEDEP}] )
	petit-kernel? ( dev-python/petit-kernel[${PYTHON_USEDEP}] )"
