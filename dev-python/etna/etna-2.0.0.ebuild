...
IUSE="all all-dev auto classification docs jupyter prophet release style tests torch wandb"
DEPENDENCIES="dev-python/scikit-learn[${PYTHON_USEDEP}]
	...
	all-dev? ( dev-python/numpydoc[${PYTHON_USEDEP}] )
	docs? ( dev-python/sphinx-rtd-theme[${PYTHON_USEDEP}] )
	all-dev? ( dev-python/sphinx-rtd-theme[${PYTHON_USEDEP}] )
	...
	all-dev? ( dev-python/coverage[${PYTHON_USEDEP}] )
