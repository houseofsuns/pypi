...
DEPENDENCIES="dev-python/aprslib[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/libcst-1.5.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pyupgrade-3.18.0[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/tomli-2.0.2[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/virtualenv-20.27.0[${PYTHON_USEDEP}] )
