...
IUSE="athena az bigquery cli clickhouse databricks deltalake dremio duckdb filesystem gcp gs lancedb motherduck mssql parquet postgis postgres pyiceberg qdrant redshift s3 sftp snowflake sql-database sqlalchemy synapse weaviate workspace"
DEPENDENCIES=">=dev-python/click-7.1[${PYTHON_USEDEP}]
	...
	workspace? ( >=dev-python/pandas-2.1.4[${PYTHON_USEDEP}] )
