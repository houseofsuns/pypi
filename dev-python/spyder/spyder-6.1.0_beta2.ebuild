...
DEPENDENCIES="<dev-python/pyqt5-5.16[${PYTHON_USEDEP}]
	...
	<dev-python/ipython-10.0.0[${PYTHON_USEDEP}]
	>=dev-python/ipython-pygments-lexers-1.0[${PYTHON_USEDEP}]
	...
	dev-python/python-lsp-ruff[${PYTHON_USEDEP}]
	<dev-python/python-lsp-server-1.14.0[${PYTHON_USEDEP}]
	...
	<dev-python/spyder-kernels-3.1.0_beta2[${PYTHON_USEDEP}]
