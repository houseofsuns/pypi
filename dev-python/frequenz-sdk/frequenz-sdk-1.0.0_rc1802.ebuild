...
DEPENDENCIES="dev-python/frequenz-client-microgrid[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.6.11[${PYTHON_USEDEP}] )
	...
	dev-mypy? ( ~dev-python/types-setuptools-78.1.0.20250329[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/hypothesis-6.130.12[${PYTHON_USEDEP}] )
