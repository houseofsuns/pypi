...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="5.0.0a1.post250609155219"
DIGEST_SOURCES="yes"
...
DESCRIPTION="Read and write Minecraft NBT and SNBT data. [badver 5.0.0a1.post250609155219, wheel]"

HOMEPAGE="https://www.amuletmc.com"
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/cp313/${REALNAME::1}/${REALNAME}/${REALNAME//-/_}-${REALVERSION}-cp313-cp313-macosx_10_15_universal2.whl"
SOURCEFILE="${REALNAME//-/_}-${REALVERSION}-cp313-cp313-macosx_10_15_universal2.whl"
RESTRICT="test"
...
DEPENDENCIES="~dev-python/numpy-2.0[${PYTHON_USEDEP}]
	dev-python/amulet-compiler-target[${PYTHON_USEDEP}]
