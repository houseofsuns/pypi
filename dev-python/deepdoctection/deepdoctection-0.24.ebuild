...
DEPENDENCIES="dev-python/apted[${PYTHON_USEDEP}]
	...
	hf? ( dev-python/opencv-python[${PYTHON_USEDEP}] )
	hf? ( dev-python/packaging[${PYTHON_USEDEP}] )
	hf? ( dev-python/pycocotools[${PYTHON_USEDEP}] )
	hf? ( dev-python/pypdf2[${PYTHON_USEDEP}] )
	hf? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	hf? ( dev-python/pyzmq[${PYTHON_USEDEP}] )
	hf? ( dev-python/rapidfuzz[${PYTHON_USEDEP}] )
	hf? ( dev-python/termcolor[${PYTHON_USEDEP}] )
	hf? ( dev-python/tabulate[${PYTHON_USEDEP}] )
	hf? ( dev-python/tqdm[${PYTHON_USEDEP}] )
	hf? ( dev-python/types-PyYAML[${PYTHON_USEDEP}] )
	hf? ( dev-python/types-termcolor[${PYTHON_USEDEP}] )
	hf? ( dev-python/types-tabulate[${PYTHON_USEDEP}] )
	hf? ( dev-python/types-tqdm[${PYTHON_USEDEP}] )
	hf? ( dev-python/lxml-stubs[${PYTHON_USEDEP}] )
	...
	pt? ( dev-python/opencv-python[${PYTHON_USEDEP}] )
	pt? ( dev-python/packaging[${PYTHON_USEDEP}] )
	pt? ( dev-python/pycocotools[${PYTHON_USEDEP}] )
	pt? ( dev-python/pypdf2[${PYTHON_USEDEP}] )
	pt? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	pt? ( dev-python/pyzmq[${PYTHON_USEDEP}] )
	pt? ( dev-python/rapidfuzz[${PYTHON_USEDEP}] )
	pt? ( dev-python/termcolor[${PYTHON_USEDEP}] )
	pt? ( dev-python/tabulate[${PYTHON_USEDEP}] )
	pt? ( dev-python/tqdm[${PYTHON_USEDEP}] )
	pt? ( dev-python/types-PyYAML[${PYTHON_USEDEP}] )
	pt? ( dev-python/types-termcolor[${PYTHON_USEDEP}] )
	pt? ( dev-python/types-tabulate[${PYTHON_USEDEP}] )
	pt? ( dev-python/types-tqdm[${PYTHON_USEDEP}] )
	pt? ( dev-python/lxml-stubs[${PYTHON_USEDEP}] )
	...
	tf? ( dev-python/rapidfuzz[${PYTHON_USEDEP}] )
	tf? ( dev-python/termcolor[${PYTHON_USEDEP}] )
	tf? ( dev-python/tabulate[${PYTHON_USEDEP}] )
	tf? ( dev-python/tqdm[${PYTHON_USEDEP}] )
	tf? ( dev-python/types-PyYAML[${PYTHON_USEDEP}] )
	tf? ( dev-python/types-termcolor[${PYTHON_USEDEP}] )
	tf? ( dev-python/types-tabulate[${PYTHON_USEDEP}] )
	tf? ( dev-python/types-tqdm[${PYTHON_USEDEP}] )
	tf? ( dev-python/lxml-stubs[${PYTHON_USEDEP}] )
