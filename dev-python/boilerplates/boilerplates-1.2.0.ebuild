...
DEPENDENCIES="setup? ( ~dev-python/docutils-0.20[${PYTHON_USEDEP}] )
	setup? ( ~dev-python/pygments-2.14[${PYTHON_USEDEP}] )
	setup? ( >=dev-python/setuptools-77.0.3[${PYTHON_USEDEP}] )
	packaging-tests? ( ~dev-python/docutils-0.20[${PYTHON_USEDEP}] )
	packaging-tests? ( ~dev-python/pygments-2.14[${PYTHON_USEDEP}] )
	packaging-tests? ( >=dev-python/setuptools-77.0.3[${PYTHON_USEDEP}] )
