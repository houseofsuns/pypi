...
IUSE="all all-gpu audio aws beir colab crawler dev docstores docstores-gpu elasticsearch elasticsearch7 elasticsearch8 faiss faiss-gpu file-conversion formatting inference metrics ocr only-faiss only-faiss-gpu only-pinecone onnx onnx-gpu opensearch pdf pinecone preprocessing preview ray sql weaviate"
