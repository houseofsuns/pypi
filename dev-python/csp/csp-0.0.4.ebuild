...
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	develop? ( dev-python/slack-sdk[${PYTHON_USEDEP}] )
	...
	symphony? ( dev-python/requests[${PYTHON_USEDEP}] )
