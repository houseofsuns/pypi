...
IUSE="test twilio whatsapp whatsapp-sync"
DEPENDENCIES="dev-python/pymongo[${PYTHON_USEDEP}]
	...
	twilio? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	...
	whatsapp? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	whatsapp-sync? ( ~dev-python/redis-3.4.1[${PYTHON_USEDEP}] )
	whatsapp-sync? ( dev-python/heyoo[${PYTHON_USEDEP}] )
	whatsapp-sync? ( dev-python/pillow[${PYTHON_USEDEP}] )"
