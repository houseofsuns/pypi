...
DEPENDENCIES="dev-python/accelerate[${PYTHON_USEDEP}]
	...
	~dev-python/black-25.11.0[${PYTHON_USEDEP}]
	...
	~dev-python/pymdown-extensions-10.17.2[${PYTHON_USEDEP}]
	~dev-python/pymysql-1.1.1[${PYTHON_USEDEP}]
	dev-python/pypandoc[${PYTHON_USEDEP}]
	~dev-python/pypdf-6.4.0[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/elasticsearch-9.1.0[${PYTHON_USEDEP}] )
