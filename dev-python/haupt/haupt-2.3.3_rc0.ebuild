...
DEPENDENCIES="~dev-python/croniter-2.0.5[${PYTHON_USEDEP}]
	...
	fs? ( ~dev-python/fsspec-2024.6.1[${PYTHON_USEDEP}] )
	...
	sandbox? ( ~dev-python/fsspec-2024.6.1[${PYTHON_USEDEP}] )
	sandbox? ( ~dev-python/uvicorn-0.30.1[${PYTHON_USEDEP}] )
	...
	sandbox? ( <=dev-python/pandas-2.2.2[${PYTHON_USEDEP}] )
	sandbox? ( <dev-python/pyarrow-16.1[${PYTHON_USEDEP}] )
	streams? ( ~dev-python/fsspec-2024.6.1[${PYTHON_USEDEP}] )
	streams? ( ~dev-python/uvicorn-0.30.1[${PYTHON_USEDEP}] )
	...
	streams? ( <=dev-python/pandas-2.2.2[${PYTHON_USEDEP}] )
	streams? ( <dev-python/pyarrow-16.1[${PYTHON_USEDEP}] )"
