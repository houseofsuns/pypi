...
DEPENDENCIES="dev-python/av[${PYTHON_USEDEP}]
	...
	manimgl? ( dev-python/pyrr[${PYTHON_USEDEP}] )
	...
	pyside6? ( >=dev-python/pyside6-6.6.1[${PYTHON_USEDEP}] )
	...
	pyside6-full? ( >=dev-python/pyside6-6.6.1[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/pyrr[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/pyside6-6.6.1[${PYTHON_USEDEP}] )
