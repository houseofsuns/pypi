...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/16/d3/97d257d5cf13ae4291e5792deab268be41c6bc9c207d53069aa35676d82d/nemo_toolkit-${REALVERSION}.tar.gz"
...
DEPENDENCIES="dev-python/huggingface-hub[${PYTHON_USEDEP}]
	...
	asr? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	...
	common? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
	...
	nlp? ( dev-python/gradio[${PYTHON_USEDEP}] )
	...
	slu? ( dev-python/pyyaml[${PYTHON_USEDEP}] )
