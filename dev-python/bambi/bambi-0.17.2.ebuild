...
IUSE="jax nutpie"
DEPENDENCIES="dev-python/arviz-plots[${PYTHON_USEDEP}]
	...
	jax? ( dev-python/blackjax[${PYTHON_USEDEP}] )
	jax? ( dev-python/jax[${PYTHON_USEDEP}] )
	jax? ( dev-python/numpyro[${PYTHON_USEDEP}] )
	nutpie? ( dev-python/numba[${PYTHON_USEDEP}] )
	nutpie? ( dev-python/nutpie[${PYTHON_USEDEP}] )"
