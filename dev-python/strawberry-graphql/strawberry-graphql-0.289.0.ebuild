...
DEPENDENCIES="dev-python/graphql-core[${PYTHON_USEDEP}]
	...
	debug-server? ( >=dev-python/typer-0.12.4[${PYTHON_USEDEP}] )
	...
	cli? ( >=dev-python/typer-0.12.4[${PYTHON_USEDEP}] )
	cli? ( >=dev-python/pygments-2.3[${PYTHON_USEDEP}] )
	cli? ( >=dev-python/rich-12.0.0[${PYTHON_USEDEP}] )
	cli? ( dev-python/libcst[${PYTHON_USEDEP}] )
	cli? ( >=dev-python/starlette-0.18.0[${PYTHON_USEDEP}] )
	cli? ( >=dev-python/uvicorn-0.11.6[${PYTHON_USEDEP}] )
	cli? ( <dev-python/websockets-16.0[${PYTHON_USEDEP}] )
	cli? ( >=dev-python/python-multipart-0.0.7[${PYTHON_USEDEP}] )
