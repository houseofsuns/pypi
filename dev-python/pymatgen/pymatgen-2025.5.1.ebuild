...
DESCRIPTION="Python Materials Genomics is a robust materials analysis code that defines core object representations for structures [wheel]"
...
IUSE="abinit ase ci electronic-structure matcalc mlp numba numpy-v1 optional prototypes symmetry tblite vis zeopp"
DEPENDENCIES=">=dev-python/joblib-1.0[${PYTHON_USEDEP}]
	...
	matcalc? ( dev-python/matcalc[${PYTHON_USEDEP}] )
	matcalc? ( dev-python/matgl[${PYTHON_USEDEP}] )
