...
DEPENDENCIES="dev-python/pyyaml[${PYTHON_USEDEP}]
	...
	dev-python/python-constraint2[${PYTHON_USEDEP}]
	all? ( dev-python/qrules[${PYTHON_USEDEP}] )
	dev? ( dev-python/qrules[${PYTHON_USEDEP}] )
	dev? ( dev-python/qrules[${PYTHON_USEDEP}] )
	dev? ( dev-python/qrules[${PYTHON_USEDEP}] )
	dev? ( dev-python/qrules[${PYTHON_USEDEP}] )
	dev? ( dev-python/qrules[${PYTHON_USEDEP}] )
	...
	doc? ( dev-python/qrules[${PYTHON_USEDEP}] )
	...
	sty? ( dev-python/qrules[${PYTHON_USEDEP}] )
