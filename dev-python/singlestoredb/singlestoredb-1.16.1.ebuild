...
IUSE="build dataframe dbt dev docker docs ed22519 gssapi ibis kerberos pytest rsa sqlalchemy test vectorstore"
DEPENDENCIES="dev-python/pyjwt[${PYTHON_USEDEP}]
	...
	test? ( dev-python/singlestore-vectorstore[${PYTHON_USEDEP}] )
