...
DESCRIPTION="A stub generator for published APIs, variables and properties in a package [wheel]"
...
IUSE=""
DEPENDENCIES=">=dev-python/astroid-2.11[${PYTHON_USEDEP}]
	dev-python/charset-normalizer[${PYTHON_USEDEP}]
	dev-python/pylint[${PYTHON_USEDEP}]
	dev-python/pylint-guidelines-checker[${PYTHON_USEDEP}]
