...
IUSE="anthropic aws chromadb dev docs epsilla faiss-cpu fastembed google-vertex-ai groq marqo milvus mongodb myscale pinecone qdrant snowflake weaviate"
