...
LICENSE="Apache-2.0"
SRC_URI="https://files.pythonhosted.org/packages/98/30/cb7a153ed4a7dc9d282fc488ff6915b6f2a517e132dba0a51c474cecf3b6/lightautoml-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/poetry-core-2.0.0[${PYTHON_USEDEP}]
	...
	dev-python/tabm[${PYTHON_USEDEP}]
	dev-python/tabicl[${PYTHON_USEDEP}]
	nlp? ( dev-python/fasttext-numpy2[${PYTHON_USEDEP}] )
	all? ( dev-python/fasttext-numpy2[${PYTHON_USEDEP}] )
