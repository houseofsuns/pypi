...
IUSE="aiofiles aiohttp all black bs4 cicd core coverage devel docarray docker fastapi filelock flaky grpcio grpcio-health-checking grpcio-reflection jcloud jina-hubble-sdk jsonschema kubernetes mock numpy opentelemetry-api opentelemetry-exporter-otlp opentelemetry-exporter-otlp-proto-grpc opentelemetry-exporter-prometheus opentelemetry-instrumentation-aiohttp-client opentelemetry-instrumentation-fastapi opentelemetry-instrumentation-grpc opentelemetry-sdk opentelemetry-test-utils packaging pathspec perf pillow portforward prometheus-api-client prometheus-client protobuf psutil pydantic pytest pytest-asyncio pytest-cov pytest-custom-exit-code pytest-kind pytest-lazy-fixture pytest-mock pytest-repeat pytest-reraise pytest-timeout python-multipart pyyaml requests requests-mock scipy sgqlc standard standrad strawberry-graphql tensorflow test torch urllib3 uvicorn uvloop watchfiles websockets"
DEPENDENCIES="dev-python/grpcio-reflection[${PYTHON_USEDEP}]
	...
	core? ( <=dev-python/grpcio-1.68.0[${PYTHON_USEDEP}] )
	...
	grpcio? ( <=dev-python/grpcio-1.68.0[${PYTHON_USEDEP}] )
	...
	devel? ( >=dev-python/opentelemetry-sdk-1.14.0[${PYTHON_USEDEP}] )
	...
	perf? ( >=dev-python/opentelemetry-sdk-1.14.0[${PYTHON_USEDEP}] )
	...
	standard? ( >=dev-python/opentelemetry-sdk-1.14.0[${PYTHON_USEDEP}] )
	...
	opentelemetry-sdk? ( >=dev-python/opentelemetry-sdk-1.14.0[${PYTHON_USEDEP}] )
	...
	uvicorn? ( <=dev-python/uvicorn-0.23.1[${PYTHON_USEDEP}] )
	...
	pytest-custom-exit-code? ( dev-python/pytest-custom-exit-code[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/opentelemetry-sdk-1.14.0[${PYTHON_USEDEP}] )
	...
	all? ( <=dev-python/grpcio-1.68.0[${PYTHON_USEDEP}] )
