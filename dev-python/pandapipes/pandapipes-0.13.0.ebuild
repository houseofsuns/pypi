...
LICENSE="Copyright c 2020-2026 by Fraunhofer Institute for Energy Economics"
...
IUSE="all docs fileio plotting test"
DEPENDENCIES="dev-python/pandapower[${PYTHON_USEDEP}]
	...
	fileio? ( dev-python/pandapower[${PYTHON_USEDEP}] )
	all? ( dev-python/pandapipes[${PYTHON_USEDEP}] )"
