...
DEPENDENCIES="adlfs? ( dev-python/adlfs[${PYTHON_USEDEP}] )
	...
	pyarrow? ( <dev-python/pyarrow-16.0.0[${PYTHON_USEDEP}] )
	pandas? ( <dev-python/pyarrow-16.0.0[${PYTHON_USEDEP}] )
	duckdb? ( <dev-python/pyarrow-16.0.0[${PYTHON_USEDEP}] )
	ray? ( <dev-python/pyarrow-16.0.0[${PYTHON_USEDEP}] )
