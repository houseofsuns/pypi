...
DEPENDENCIES="dev-python/ansys-dpf-core[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/scikit-learn-1.5.1[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/ipython-8.26.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/jupyterlab-4.2.4[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/scikit-learn-1.5.1[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/pytest-xdist-3.6.1[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/ipython-8.26.0[${PYTHON_USEDEP}] )
