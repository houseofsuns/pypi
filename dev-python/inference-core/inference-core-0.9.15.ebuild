...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/e0/36/9a317c73b6fd2f455351b7f718814ae7acc32bddcbd4c041caecbdc26bfb/${REALNAME//-/_}-${REALVERSION}-1-py3-none-any.whl"
...
DEPENDENCIES="<=dev-python/APScheduler-3.10.1[${PYTHON_USEDEP}]
	...
	dev-python/inference-sdk[${PYTHON_USEDEP}]
	...
	http? ( >=dev-python/structlog-24.1.0[${PYTHON_USEDEP}] )
