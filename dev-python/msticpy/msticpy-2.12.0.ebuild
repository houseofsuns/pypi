...
IUSE="all azsentinel azure azuresentinel dev kql ml panel riskiq sentinel splunk sql2kql sumologic test vt3 x-azure-core"
DEPENDENCIES=">=dev-python/attrs-18.2.0[${PYTHON_USEDEP}]
	...
	x-azure-core? ( dev-python/azure-mgmt-compute[${PYTHON_USEDEP}] )
	x-azure-core? ( dev-python/azure-mgmt-core[${PYTHON_USEDEP}] )
	x-azure-core? ( dev-python/azure-mgmt-monitor[${PYTHON_USEDEP}] )
	x-azure-core? ( dev-python/azure-mgmt-network[${PYTHON_USEDEP}] )
	x-azure-core? ( dev-python/azure-mgmt-resource[${PYTHON_USEDEP}] )
	x-azure-core? ( dev-python/azure-storage-blob[${PYTHON_USEDEP}] )
	x-azure-core? ( dev-python/azure-mgmt-resourcegraph[${PYTHON_USEDEP}] )
