...
HOMEPAGE="https://github.com/jhornung/compliantDynamodb.git"
LICENSE="Apache-2.0"
...
IUSE=""
DEPENDENCIES="dev-python/aws-cdk-aws-backup[${PYTHON_USEDEP}]
	...
	dev-python/aws-cdk-aws-kinesis[${PYTHON_USEDEP}]
