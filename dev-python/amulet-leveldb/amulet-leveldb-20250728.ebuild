...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="3.0.1a1.post250728110656"
DIGEST_SOURCES="yes"
...
DESCRIPTION="A pybind11 wrapper for Mojang's custom LevelDB. [badver 3.0.1a1.post250728110656, wheel]"

HOMEPAGE="https://www.amuletmc.com"
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/cp312/${REALNAME::1}/${REALNAME}/${REALNAME//-/_}-${REALVERSION}-cp312-cp312-macosx_10_15_universal2.whl"
SOURCEFILE="${REALNAME//-/_}-${REALVERSION}-cp312-cp312-macosx_10_15_universal2.whl"
RESTRICT="test"
