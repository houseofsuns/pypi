...
DESCRIPTION="Lightweight static analysis for many languages. Find bug variants with patterns that look like source code. [wheel]"

HOMEPAGE="https://github.com/returntocorp/semgrep"
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/cp39.cp310.cp311.py39.py310.py311/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-cp39.cp310.cp311.py39.py310.py311-none-macosx_10_14_x86_64.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-cp39.cp310.cp311.py39.py310.py311-none-macosx_10_14_x86_64.whl"
RESTRICT="test"
