...
DEPENDENCIES=">=dev-python/numpy-1.17[${PYTHON_USEDEP}]
	...
	test_dev? ( dev-python/torchpippy[${PYTHON_USEDEP}] )
	...
	test_dev? ( dev-python/bitsandbytes[${PYTHON_USEDEP}] )
	test_dev? ( dev-python/timm[${PYTHON_USEDEP}] )
	...
	test_trackers? ( dev-python/dvclive[${PYTHON_USEDEP}] )
