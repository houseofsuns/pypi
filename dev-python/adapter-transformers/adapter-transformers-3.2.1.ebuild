...
DESCRIPTION="A friendly fork of HuggingFace's Transformers, adding Adapters to PyTorch language models [newver 3.2.1.post0]"
...
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	dev-tensorflow? ( >=dev-python/flake8-3.8.3[${PYTHON_USEDEP}] )
	...
	dev-torch? ( >=dev-python/flake8-3.8.3[${PYTHON_USEDEP}] )
