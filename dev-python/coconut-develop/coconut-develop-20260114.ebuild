...
DESCRIPTION="Simple, elegant, Pythonic functional programming. [badver 3.2.0.post0.dev3]"
...
DEPENDENCIES=">=dev-python/setuptools-44.0[${PYTHON_USEDEP}]
	...
	tests? ( >=dev-python/pandas-1.1[${PYTHON_USEDEP}] )
	tests? ( dev-python/papermill[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/xarray-2025.0[${PYTHON_USEDEP}] )
	...
	tests? ( >=dev-python/ipykernel-7.0[${PYTHON_USEDEP}] )
