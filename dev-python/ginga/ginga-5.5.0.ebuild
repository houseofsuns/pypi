...
DEPENDENCIES=">=dev-python/numpy-1.26[${PYTHON_USEDEP}]
	...
	gtk3? ( dev-python/gobject-introspection[${PYTHON_USEDEP}] )
	gtk3? ( >=dev-python/pycairo-1.27.0[${PYTHON_USEDEP}] )
	gtk3? ( >=dev-python/pygobject-3.50.0[${PYTHON_USEDEP}] )
	gtk4? ( dev-python/gobject-introspection[${PYTHON_USEDEP}] )
	gtk4? ( >=dev-python/pycairo-1.29.0[${PYTHON_USEDEP}] )
	gtk4? ( >=dev-python/pygobject-3.54.5[${PYTHON_USEDEP}] )
