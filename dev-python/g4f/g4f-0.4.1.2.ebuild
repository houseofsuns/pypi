...
DEPENDENCIES="dev-python/requests[${PYTHON_USEDEP}]
	...
	slim? ( dev-python/PyPDF2[${PYTHON_USEDEP}] )
	slim? ( dev-python/docx[${PYTHON_USEDEP}] )
	...
	files? ( dev-python/spacy[${PYTHON_USEDEP}] )
	files? ( dev-python/beautifulsoup4[${PYTHON_USEDEP}] )
	files? ( dev-python/PyPDF2[${PYTHON_USEDEP}] )
	files? ( dev-python/docx[${PYTHON_USEDEP}] )
	files? ( dev-python/odfpy[${PYTHON_USEDEP}] )
	files? ( dev-python/EbookLib[${PYTHON_USEDEP}] )
	files? ( dev-python/openpyxl[${PYTHON_USEDEP}] )"
