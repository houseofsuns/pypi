...
IUSE="container dev evals experimental llama-index"
DEPENDENCIES="dev-python/hdbscan[${PYTHON_USEDEP}]
	...
	evals? ( dev-python/arize-phoenix-evals[${PYTHON_USEDEP}] )
	experimental? ( dev-python/tenacity[${PYTHON_USEDEP}] )
	llama-index? ( dev-python/llama-index-callbacks-arize-phoenix[${PYTHON_USEDEP}] )
