...
IUSE="amqp api_client auth celery debugger dramatiq fastapi fluentbit profiler s3 sql sql_sync test"
DEPENDENCIES="~dev-python/pydantic-2.6[${PYTHON_USEDEP}]
	...
	api_client? ( ~dev-python/aiohttp-3.9[${PYTHON_USEDEP}] )
	api_client? ( ~dev-python/urllib3-2.0[${PYTHON_USEDEP}] )
	...
	sql_sync? ( ~dev-python/sqlalchemy-2.0[${PYTHON_USEDEP}] )
	sql_sync? ( dev-python/psycopg2[${PYTHON_USEDEP}] )
