...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/3c/d9/16ff7fe4cd65148a7f986e5083ff0b822be920e880c275a04e6bc7182a1c/${REALNAME//-/_}-${REALVERSION}-py3-none-any.whl"
...
IUSE="clip cpu gaze gpu grounding-dino hosted http sam sam2 waf yolo-world"
DEPENDENCIES="<=dev-python/APScheduler-3.10.1[${PYTHON_USEDEP}]
	...
	<=dev-python/boto3-1.34.123[${PYTHON_USEDEP}]
	...
	cpu? ( dev-python/GPUtil[${PYTHON_USEDEP}] )
	...
	sam2? ( dev-python/rasterio[${PYTHON_USEDEP}] )
	sam2? ( dev-python/torch[${PYTHON_USEDEP}] )
	sam2? ( dev-python/torchvision[${PYTHON_USEDEP}] )
	sam2? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
