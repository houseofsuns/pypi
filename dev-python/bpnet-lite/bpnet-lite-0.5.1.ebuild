...
DESCRIPTION="bpnet-lite is a minimal implementation of BPNet, a neural network aimed at interpreting regulatory activity of the genome. [topver 0.7.0, newver 0.7.0]"
