...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="3.16.0.dev20260112"
DIGEST_SOURCES="yes"
...
IUSE="channels full gh-release-notes jieba metal monitoring nlu pii spacy transformers"
DEPENDENCIES="<dev-python/cachecontrol-0.15.0[${PYTHON_USEDEP}]
	...
	<dev-python/absl-py-2.4[${PYTHON_USEDEP}]
	...
	<dev-python/apscheduler-3.12[${PYTHON_USEDEP}]
	...
	<dev-python/certifi-2025.12.0[${PYTHON_USEDEP}]
	...
	<dev-python/cryptography-46.1.0[${PYTHON_USEDEP}]
	...
	full? ( dev-python/langfuse[${PYTHON_USEDEP}] )
	...
	<dev-python/python-dotenv-1.3.0[${PYTHON_USEDEP}]
