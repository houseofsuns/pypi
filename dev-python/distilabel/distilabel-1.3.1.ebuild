...
IUSE="anthropic argilla cohere dev docs faiss-cpu faiss-gpu groq hf-inference-endpoints hf-transformers instructor litellm llama-cpp mistralai ollama openai outlines ray sentence-transformers tests vertexai vllm"
DEPENDENCIES="dev-python/datasets[${PYTHON_USEDEP}]
	...
	faiss-gpu? ( dev-python/faiss-cpu[${PYTHON_USEDEP}] )
