...
IUSE="all build doc examples examples_tests tests tests_nb"
DEPENDENCIES="dev-python/bokeh[${PYTHON_USEDEP}]
	...
	examples_tests? ( dev-python/pyepsg[${PYTHON_USEDEP}] )
	...
	examples_tests? ( dev-python/ipykernel[${PYTHON_USEDEP}] )
