...
DEPENDENCIES="dev-python/django-agnocomplete[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/pymdown-extensions-10.13[${PYTHON_USEDEP}] )
	...
	sync? ( dev-python/channels[${PYTHON_USEDEP}] )
	sync? ( dev-python/daphne[${PYTHON_USEDEP}] )
	sync? ( ~dev-python/pydantic-2.10.3[${PYTHON_USEDEP}] )
	sync? ( ~dev-python/websockets-13.1[${PYTHON_USEDEP}] )
	test? ( dev-python/factory-boy[${PYTHON_USEDEP}] )
	test? ( ~dev-python/moto-5.0.24[${PYTHON_USEDEP}] )
