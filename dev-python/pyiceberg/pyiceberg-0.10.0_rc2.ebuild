...
IUSE="adlfs bigquery bodo daft datafusion duckdb dynamodb gcp-auth gcsfs glue hf hive hive-kerberos pandas polars pyarrow pyiceberg-core ray rest-sigv4 s3fs snappy sql-postgres sql-sqlite zstandard"
DEPENDENCIES="adlfs? ( dev-python/adlfs[${PYTHON_USEDEP}] )
	bodo? ( dev-python/bodo[${PYTHON_USEDEP}] )
	...
	daft? ( dev-python/daft[${PYTHON_USEDEP}] )
	...
	gcp-auth? ( >=dev-python/google-auth-2.4.0[${PYTHON_USEDEP}] )
	...
	pandas? ( >=dev-python/pyarrow-17.0.0[${PYTHON_USEDEP}] )
	duckdb? ( >=dev-python/pyarrow-17.0.0[${PYTHON_USEDEP}] )
	ray? ( >=dev-python/pyarrow-17.0.0[${PYTHON_USEDEP}] )
	<dev-python/pydantic-3.0[${PYTHON_USEDEP}]
	pyarrow? ( dev-python/pyiceberg-core[${PYTHON_USEDEP}] )
