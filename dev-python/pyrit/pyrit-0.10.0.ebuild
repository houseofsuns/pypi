...
IUSE="all dev fairness-bias gcg gradio huggingface opencv playwright speech"
DEPENDENCIES="<dev-python/aiofiles-25.0[${PYTHON_USEDEP}]
	...
	dev-python/base2048[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/feedgen[${PYTHON_USEDEP}] )
	...
	gcg? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
	...
	fairness-bias? ( dev-python/spacy[${PYTHON_USEDEP}] )
