...
REALNAME="amazon-braket-strawberryfields-plugin"
...
DESCRIPTION="An open source framework for using Amazon Braket devices with the Strawberry Fields photonic device programming library"
