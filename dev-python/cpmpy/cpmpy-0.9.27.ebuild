...
IUSE="all choco cplex cpo docs exact gcs gurobi minizinc ortools pindakaas pumpkin pysat pysdd test xcsp3 z3"
DEPENDENCIES="dev-python/ortools[${PYTHON_USEDEP}]
	...
	all? ( dev-python/cplex[${PYTHON_USEDEP}] )
	all? ( dev-python/gurobipy[${PYTHON_USEDEP}] )
	all? ( dev-python/pumpkin-solver[${PYTHON_USEDEP}] )
	...
	cplex? ( dev-python/docplex[${PYTHON_USEDEP}] )
	...
	pumpkin? ( dev-python/pumpkin-solver[${PYTHON_USEDEP}] )
	...
	xcsp3? ( dev-python/gnureadline[${PYTHON_USEDEP}] )
