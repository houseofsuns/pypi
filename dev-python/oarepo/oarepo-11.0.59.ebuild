...
DEPENDENCIES="dev-python/alembic[${PYTHON_USEDEP}]
	...
	tests? ( dev-python/bump[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/first[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/jsonschema-specifications[${PYTHON_USEDEP}] )
