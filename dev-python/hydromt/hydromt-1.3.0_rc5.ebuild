...
IUSE="dev doc examples extra io slim test vrt"
DEPENDENCIES="dev-python/affine[${PYTHON_USEDEP}]
	...
	doc? ( dev-python/sbom4python[${PYTHON_USEDEP}] )
	...
	slim? ( dev-python/hydromt[${PYTHON_USEDEP}] )
	test? ( >=dev-python/pytest-8.0[${PYTHON_USEDEP}] )
	test? ( dev-python/pytest-cov[${PYTHON_USEDEP}] )
	test? ( dev-python/pytest-mock[${PYTHON_USEDEP}] )
	test? ( dev-python/pytest-timeout[${PYTHON_USEDEP}] )
	vrt? ( dev-python/GDAL[${PYTHON_USEDEP}] )"
