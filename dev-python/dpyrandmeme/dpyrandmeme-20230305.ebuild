...
DESCRIPTION="Random memes fetched for use in discord.py bot commands. [badver 1.0.1rc32.post1]"
...
DEPENDENCIES=">=dev-python/aiohttp-3.8.4[${PYTHON_USEDEP}]
	...
	test? ( dev-python/discord-py[${PYTHON_USEDEP}] )
