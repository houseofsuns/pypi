...
DEPENDENCIES="dev-python/dictdiffer[${PYTHON_USEDEP}]
	...
	snowflake_tag_propagation? ( >=dev-python/click-6.0.0[${PYTHON_USEDEP}] )
	...
	snowflake_tag_propagation? ( >=dev-python/expandvars-0.6.5[${PYTHON_USEDEP}] )
	...
	tag_propagation? ( >=dev-python/expandvars-0.6.5[${PYTHON_USEDEP}] )
	...
	term_propagation? ( >=dev-python/expandvars-0.6.5[${PYTHON_USEDEP}] )
