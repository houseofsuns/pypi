...
IUSE="all cli dev docs fastai inference quality tensorflow testing torch typing"
DEPENDENCIES="dev-python/filelock[${PYTHON_USEDEP}]
	...
	docs? ( dev-python/InquirerPy[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/types-simplejson[${PYTHON_USEDEP}] )
	docs? ( dev-python/types-toml[${PYTHON_USEDEP}] )
	docs? ( dev-python/types-tqdm[${PYTHON_USEDEP}] )
	...
	inference? ( dev-python/pydantic[${PYTHON_USEDEP}] )
	...
	typing? ( dev-python/pydantic[${PYTHON_USEDEP}] )"
