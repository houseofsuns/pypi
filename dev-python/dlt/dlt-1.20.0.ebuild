...
IUSE="athena az bigquery cli clickhouse databricks dbml deltalake dremio duckdb ducklake filesystem gcp gs http hub lancedb motherduck mssql parquet postgis postgres pyiceberg qdrant redshift s3 sftp snowflake sql-database sqlalchemy synapse weaviate workspace"
DEPENDENCIES=">=dev-python/click-7.1[${PYTHON_USEDEP}]
	...
	hub? ( dev-python/dlt-runtime[${PYTHON_USEDEP}] )
	hub? ( dev-python/dlthub[${PYTHON_USEDEP}] )
