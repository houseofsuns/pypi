...
DEPENDENCIES="dev-python/acb[${PYTHON_USEDEP}]
	...
	>=dev-python/hypothesis-6.148.1[${PYTHON_USEDEP}]
	...
	dev-python/session-mgmt-mcp[${PYTHON_USEDEP}]
	...
	>=dev-python/types-psutil-7.0.0.20251116[${PYTHON_USEDEP}]
	dev-python/types-PyYAML[${PYTHON_USEDEP}]
	dev-python/uv-bump[${PYTHON_USEDEP}]
	>=dev-python/uv-0.9.9[${PYTHON_USEDEP}]
