...
DEPENDENCIES="~dev-python/alembic-1.13.1[${PYTHON_USEDEP}]
	...
	~dev-python/elastic-transport-8.13.0[${PYTHON_USEDEP}]
	~dev-python/elasticsearch-8.13.2[${PYTHON_USEDEP}]
	...
	~dev-python/sentry-sdk-2.3.1[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/watchdog-4.0.1[${PYTHON_USEDEP}] )
