...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="0.0.18.dev20240111"
DIGEST_SOURCES="yes"
...
DESCRIPTION="SeqIO: Task-based datasets, preprocessing, and evaluation for sequence models. [newver 0.0.18.dev20240126]"
...
DEPENDENCIES="dev-python/clu[${PYTHON_USEDEP}]
