...
IUSE="a2a ag-ui anthropic bedrock cli cohere dbos duckduckgo evals fastmcp google groq huggingface logfire mcp mistral openai openrouter outlines-llamacpp outlines-mlxlm outlines-sglang outlines-transformers outlines-vllm-offline prefect retries sentence-transformers tavily temporal ui vertexai web"
DEPENDENCIES="dev-python/genai-prices[${PYTHON_USEDEP}]
	...
	bedrock? ( >=dev-python/boto3-1.42.14[${PYTHON_USEDEP}] )
	...
	outlines-sglang? ( >=dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	outlines-transformers? ( dev-python/outlines[${PYTHON_USEDEP}] )
	outlines-transformers? ( >=dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
