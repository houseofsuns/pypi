...
IUSE="all checking doc fasttext files openai optional optuna plot somajo somajo_transformers testing transformers"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	optional? ( dev-python/tiktoken[${PYTHON_USEDEP}] )
