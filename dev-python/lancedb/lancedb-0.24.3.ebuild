...
IUSE="azure clip dev docs embeddings pylance siglip tests"
DEPENDENCIES="dev-python/deprecation[${PYTHON_USEDEP}]
	...
	siglip? ( dev-python/torch[${PYTHON_USEDEP}] )
	siglip? ( dev-python/pillow[${PYTHON_USEDEP}] )
	siglip? ( dev-python/transformers[${PYTHON_USEDEP}] )
	siglip? ( dev-python/sentencepiece[${PYTHON_USEDEP}] )
