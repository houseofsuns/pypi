...
IUSE="all cliargs concurrencypebble logging numba numpy pandas sparql sqlalchemy stackframesampler timeinterval zstd"
DEPENDENCIES=">=dev-python/decorator-5.1.0[${PYTHON_USEDEP}]
	...
	stackframesampler? ( dev-python/austin[${PYTHON_USEDEP}] )
