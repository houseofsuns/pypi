...
IUSE="android color dev keyring langdetect llama lsp notification openai po repl rich stardict wakatime yaml"
DEPENDENCIES="dev-python/aiohttp[${PYTHON_USEDEP}]
	dev-python/clipman[${PYTHON_USEDEP}]
	android? ( dev-python/termux-api[${PYTHON_USEDEP}] )
	...
	notification? ( dev-python/notify_py[${PYTHON_USEDEP}] )
