...
IUSE="all athena atlas bigquery cassandra db2 delta dev dremio druid feast glue jsonpath kafka neptune oracle rds salesforce schema-registry snowflake teradata"
DEPENDENCIES="<dev-python/elasticsearch-8.0[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/types-setuptools-69.0.0.0[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/typing-extensions-4.1.0[${PYTHON_USEDEP}] )
	...
	neptune? ( ~dev-python/typing-extensions-4.1.0[${PYTHON_USEDEP}] )
	...
	schema-registry? ( dev-python/python-schema-registry-client[${PYTHON_USEDEP}] )
