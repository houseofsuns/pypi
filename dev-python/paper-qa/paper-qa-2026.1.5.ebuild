...
IUSE="dev docling image ldp local memory nemotron office openreview pymupdf pypdf pypdf-enhanced pypdf-media qdrant typing zotero"
DEPENDENCIES="dev-python/anyio[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/httpx-aiohttp[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/vcrpy-8.0[${PYTHON_USEDEP}] )
	docling? ( dev-python/paper-qa-docling[${PYTHON_USEDEP}] )
	image? ( dev-python/fhlmi[${PYTHON_USEDEP}] )
	ldp? ( dev-python/ldp[${PYTHON_USEDEP}] )
	local? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
	memory? ( dev-python/paper-qa[${PYTHON_USEDEP}] )
	memory? ( dev-python/usearch[${PYTHON_USEDEP}] )
	nemotron? ( dev-python/paper-qa-nemotron[${PYTHON_USEDEP}] )
	office? ( dev-python/unstructured[${PYTHON_USEDEP}] )
	...
	pypdf-enhanced? ( dev-python/paper-qa-pypdf[${PYTHON_USEDEP}] )
	pypdf-media? ( dev-python/paper-qa-pypdf[${PYTHON_USEDEP}] )
