...
HOMEPAGE=""
LICENSE="proprietary"
SRC_URI="https://files.pythonhosted.org/packages/cp311/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-cp311-cp311-macosx_10_15_x86_64.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-cp311-cp311-macosx_10_15_x86_64.whl"
RESTRICT="test"
...
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	benchmark? ( dev-python/langchain-community[${PYTHON_USEDEP}] )
	...
	benchmark? ( dev-python/lxml-html-clean[${PYTHON_USEDEP}] )
	...
	docs? ( dev-python/langchain-community[${PYTHON_USEDEP}] )
	...
	neural-db? ( dev-python/langchain-community[${PYTHON_USEDEP}] )
	...
	neural-db? ( dev-python/pydantic[${PYTHON_USEDEP}] )
	...
	neural-db? ( dev-python/lxml-html-clean[${PYTHON_USEDEP}] )
	...
	neural-db-v2? ( dev-python/SQLAlchemy-Utils[${PYTHON_USEDEP}] )
	neural-db-v2? ( dev-python/transformers[${PYTHON_USEDEP}] )
	neural-db-v2? ( dev-python/unstructured[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/lxml-html-clean[${PYTHON_USEDEP}] )
