...
DEPENDENCIES="<dev-python/typing-extensions-5.0[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.5.49[${PYTHON_USEDEP}] )
	...
	dev-pylint? ( ~dev-python/pylint-3.3.3[${PYTHON_USEDEP}] )
	dev-pytest? ( dev-python/async-solipsism[${PYTHON_USEDEP}] )
	dev-pytest? ( dev-python/frequenz-repo-config[${PYTHON_USEDEP}] )
	dev-pytest? ( ~dev-python/hypothesis-6.123.2[${PYTHON_USEDEP}] )
	dev-pytest? ( ~dev-python/pytest-8.3.4[${PYTHON_USEDEP}] )
	dev-pytest? ( ~dev-python/pytest-asyncio-0.25.0[${PYTHON_USEDEP}] )
