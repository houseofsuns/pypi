...
IUSE="all chainlit chromadb db doc-chat docx hf-embeddings hf-transformers lancedb litellm meilisearch metaphor momento mysql neo4j pdf-parsers postgres scrapy sql transformers unstructured vecdbs"
