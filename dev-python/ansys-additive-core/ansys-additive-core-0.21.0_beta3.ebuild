...
DEPENDENCIES="dev-python/ansys-api-additive[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/joblib-1.5.2[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/google-api-python-client-2.181.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/googleapis-common-protos-1.70.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/grpcio-1.73.1[${PYTHON_USEDEP}] )
	tests? ( dev-python/grpcio-health-checking[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/numpy-2.2.6[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/pandas-2.3.2[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/platformdirs-4.4.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/protobuf-6.32.1[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/six-1.17.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/tqdm-4.67.1[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/pydantic-2.11.9[${PYTHON_USEDEP}] )
