...
DEPENDENCIES=">=dev-python/boto3-1.18[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/kombu-5.0[${PYTHON_USEDEP}] )
	...
	all? ( <dev-python/objgraph-4.0[${PYTHON_USEDEP}] )
	all? ( dev-python/advocate[${PYTHON_USEDEP}] )
	all? ( >=dev-python/boto3-1.18[${PYTHON_USEDEP}] )
	all? ( <dev-python/sentry-sdk-1.0[${PYTHON_USEDEP}] )
	all? ( <dev-python/sqlalchemy-2.0[${PYTHON_USEDEP}] )
	all? ( dev-python/kazoo[${PYTHON_USEDEP}] )
	amqp? ( <dev-python/kombu-5.0[${PYTHON_USEDEP}] )
	...
	refcycle? ( <dev-python/objgraph-4.0[${PYTHON_USEDEP}] )
	requests? ( dev-python/advocate[${PYTHON_USEDEP}] )
	s3fetcher? ( >=dev-python/boto3-1.18[${PYTHON_USEDEP}] )
	sentry? ( <dev-python/sentry-sdk-1.0[${PYTHON_USEDEP}] )
