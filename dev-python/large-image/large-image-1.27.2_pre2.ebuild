...
DESCRIPTION="Python modules to work with large, multiresolution images. [newver 1.27.2.dev4]"
...
DEPENDENCIES="all? ( dev-python/large-image-source-rasterio[${PYTHON_USEDEP}] )
