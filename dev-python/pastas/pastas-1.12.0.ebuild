...
IUSE="caching ci codespelling datasets dev formatting full interactive latexify linting pytesting rtd ruffing solvers"
DEPENDENCIES=">=dev-python/numpy-2.0.0[${PYTHON_USEDEP}]
	...
	caching? ( dev-python/cachetools[${PYTHON_USEDEP}] )
	...
	rtd? ( dev-python/sphinx-autoapi[${PYTHON_USEDEP}] )
