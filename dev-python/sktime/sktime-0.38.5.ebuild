...
DEPENDENCIES="<dev-python/joblib-1.6[${PYTHON_USEDEP}]
	...
	datasets? ( dev-python/huggingface-hub[${PYTHON_USEDEP}] )
	...
	notebooks? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/pmdarima[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/seaborn[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/tbats[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/dtw-python[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/prophet[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/pytorch-forecasting[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/skpro[${PYTHON_USEDEP}] )
	notebooks? ( dev-python/statsforecast[${PYTHON_USEDEP}] )
