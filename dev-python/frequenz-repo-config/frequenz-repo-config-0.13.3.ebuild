...
DEPENDENCIES=">=dev-python/nox-2022.11.21[${PYTHON_USEDEP}]
	...
	api? ( <dev-python/setuptools-80.0[${PYTHON_USEDEP}] )
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.6.10[${PYTHON_USEDEP}] )
	...
	dev-mypy? ( <dev-python/types-setuptools-80.0[${PYTHON_USEDEP}] )
	...
	dev-pylint? ( <dev-python/setuptools-80.0[${PYTHON_USEDEP}] )
