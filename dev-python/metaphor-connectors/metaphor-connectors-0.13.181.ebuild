...
IUSE="all bigquery confluence datafactory datahub hive kafka looker monday monte-carlo mssql mysql notion postgresql power-bi redshift s3 snowflake static-web synapse tableau thought-spot trino unity-catalog"
