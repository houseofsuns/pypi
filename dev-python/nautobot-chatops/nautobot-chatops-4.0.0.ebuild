...
IUSE="aci all ansible aristacv grafana ipfabric meraki panorama slurpit"
DEPENDENCIES=">dev-python/markdown-3.3.5[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/termcolor-4.0.0[${PYTHON_USEDEP}] )
	grafana? ( <dev-python/termcolor-4.0.0[${PYTHON_USEDEP}] )
