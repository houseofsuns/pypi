...
DESCRIPTION="A toolkit for processing single cell Hi-C data [wheel]"

HOMEPAGE=""
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/cp39/${REALNAME::1}/${REALNAME}/${REALNAME}-${REALVERSION}-cp39-cp39-manylinux1_x86_64.whl"
SOURCEFILE="${REALNAME}-${REALVERSION}-cp39-cp39-manylinux1_x86_64.whl"
RESTRICT="test"
...
DEPENDENCIES="~dev-python/numpy-1.24.1[${PYTHON_USEDEP}]
	...
	dev-python/fastp[${PYTHON_USEDEP}]
