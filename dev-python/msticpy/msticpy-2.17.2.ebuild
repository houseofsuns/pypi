...
IUSE="aiagents all azsentinel azure azuresentinel dev kql ml riskiq sentinel splunk sql2kql sumologic test vt3"
DEPENDENCIES=">=dev-python/attrs-18.2.0[${PYTHON_USEDEP}]
	...
	ml? ( dev-python/rrcf[${PYTHON_USEDEP}] )
	ml? ( >=dev-python/joblib-1.3.0[${PYTHON_USEDEP}] )
	...
	aiagents? ( dev-python/autogen-agentchat[${PYTHON_USEDEP}] )
	all? ( dev-python/KqlmagicCustom[${PYTHON_USEDEP}] )
	all? ( dev-python/autogen-agentchat[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/joblib-1.3.0[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/rrcf[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/autogen-agentchat[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/rrcf[${PYTHON_USEDEP}] )
