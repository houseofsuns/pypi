...
IUSE="cloud dev gsm8k hotpotqa image lfrqa litqa llm notebook server typing xml"
DEPENDENCIES="dev-python/docstring_parser[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/aviary-notebook[${PYTHON_USEDEP}] )
	...
	notebook? ( dev-python/aviary-notebook[${PYTHON_USEDEP}] )
