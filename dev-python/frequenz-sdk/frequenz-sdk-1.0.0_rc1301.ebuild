...
DEPENDENCIES="dev-python/frequenz-client-microgrid[${PYTHON_USEDEP}]
	...
	dev-mkdocs? ( ~dev-python/mkdocs-material-9.5.45[${PYTHON_USEDEP}] )
	...
	dev-mypy? ( ~dev-python/types-setuptools-75.5.0.20241122[${PYTHON_USEDEP}] )
	...
	dev-pytest? ( ~dev-python/hypothesis-6.119.3[${PYTHON_USEDEP}] )
