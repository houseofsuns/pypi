...
IUSE="aws azure directquery-bigquery directquery-clickhouse directquery-databricks directquery-jdbc directquery-mssql directquery-redshift directquery-snowflake directquery-synapse gcp jdbc jupyterlab kafka observability spring-boot-admin sql-bridge"
DEPENDENCIES="dev-python/atoti-client[${PYTHON_USEDEP}]
	...
	spring-boot-admin? ( dev-python/atoti-server-spring-boot-admin[${PYTHON_USEDEP}] )
