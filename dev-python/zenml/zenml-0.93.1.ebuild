...
IUSE="adlfs azureml connectors-aws connectors-azure connectors-gcp connectors-kubernetes dev gcsfs jupyter local s3fs sagemaker secrets-aws secrets-azure secrets-gcp secrets-hashicorp server templates terraform vertex"
DEPENDENCIES="~dev-python/asgiref-3.10.0[${PYTHON_USEDEP}]
	...
	connectors-azure? ( <dev-python/marshmallow-4.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/coverage-6.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/hypothesis-6.43.1[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/pytest-rerunfailures-14.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/types-hvac[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/types-setuptools-57.4.2[${PYTHON_USEDEP}] )
	dev? ( dev-python/types-six[${PYTHON_USEDEP}] )
	dev? ( dev-python/types-termcolor[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/types-psutil-5.8.13[${PYTHON_USEDEP}] )
	...
	local? ( <=dev-python/alembic-1.15.2[${PYTHON_USEDEP}] )
	local? ( ~dev-python/bcrypt-4.0.1[${PYTHON_USEDEP}] )
	local? ( ~dev-python/passlib-1.7.4[${PYTHON_USEDEP}] )
	local? ( ~dev-python/pymysql-1.1.0[${PYTHON_USEDEP}] )
	local? ( <dev-python/sqlalchemy-3.0.0[${PYTHON_USEDEP}] )
	local? ( dev-python/SQLAlchemy-Utils[${PYTHON_USEDEP}] )
	...
	vertex? ( <dev-python/urllib3-2.6.0[${PYTHON_USEDEP}] )
