...
IUSE="aliyun-oss auth databricks extras gateway genai jfrog langchain mcp mlserver sqlserver"
DEPENDENCIES="<dev-python/cachetools-7.0[${PYTHON_USEDEP}]
	...
	genai? ( dev-python/litellm[${PYTHON_USEDEP}] )
	...
	mcp? ( >dev-python/click-8.3.0[${PYTHON_USEDEP}] )
