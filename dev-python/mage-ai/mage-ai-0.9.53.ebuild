...
DEPENDENCIES="dev-python/Faker[${PYTHON_USEDEP}]
	...
	ai? ( dev-python/astor[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/stomp-py[${PYTHON_USEDEP}] )
	...
	dbt? ( dev-python/dbt-dremio[${PYTHON_USEDEP}] )
	...
	streaming? ( dev-python/stomp-py[${PYTHON_USEDEP}] )
	streaming? ( dev-python/elasticsearch[${PYTHON_USEDEP}] )"
