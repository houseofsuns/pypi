...
IUSE="ai all bolt build dev docs gremlin igraph jupyter networkx nodexl test umap-learn"
DEPENDENCIES="dev-python/numpy[${PYTHON_USEDEP}]
	...
	ai? ( dev-python/annoy[${PYTHON_USEDEP}] )
	...
	nodexl? ( dev-python/openpyxl[${PYTHON_USEDEP}] )
