...
IUSE="all browser datascience dspy eval pyinstaller server telemetry tts youtube"
DEPENDENCIES="<dev-python/click-9.0[${PYTHON_USEDEP}]
	...
	eval? ( dev-python/dspy[${PYTHON_USEDEP}] )
	...
	telemetry? ( dev-python/opentelemetry-instrumentation-openai[${PYTHON_USEDEP}] )
	all? ( dev-python/opentelemetry-instrumentation-openai[${PYTHON_USEDEP}] )
	dspy? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
	eval? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
