...
DESCRIPTION="Redefine is the first AI based CI optimization platform that seamlessly integrates with your existing CI environment [wheel]"

HOMEPAGE="https://redefine.dev/"
LICENSE="Apache-2.0"
