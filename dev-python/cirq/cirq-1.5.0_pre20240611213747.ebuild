...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="1.5.0.dev20240611213747"
DIGEST_SOURCES="yes"
...
DEPENDENCIES="dev-python/cirq-aqt[${PYTHON_USEDEP}]
	...
	dev-env? ( ~dev-python/jupyterlab-4.0.13[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/jupyterlab-server-2.24.0[${PYTHON_USEDEP}] )
	dev-env? ( ~dev-python/nbformat-5.10.4[${PYTHON_USEDEP}] )
