...
IUSE="all bigquery confluence datafactory datahub dbt great-expectations hive kafka looker monday mongodb monte-carlo mssql mysql notion oracle postgresql power-bi redshift s3 sharepoint snowflake static-web synapse tableau thought-spot trino unity-catalog"
DEPENDENCIES="all? ( dev-python/asyncpg[${PYTHON_USEDEP}] )
	...
	dbt? ( <dev-python/httpx-0.28.0[${PYTHON_USEDEP}] )
