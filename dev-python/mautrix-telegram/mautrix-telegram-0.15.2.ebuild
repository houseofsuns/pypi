...
DEPENDENCIES="<dev-python/aiohttp-4.0[${PYTHON_USEDEP}]
	...
	all? ( <dev-python/prometheus-client-0.21[${PYTHON_USEDEP}] )
	...
	metrics? ( <dev-python/prometheus-client-0.21[${PYTHON_USEDEP}] )
	proxy? ( dev-python/python-socks[${PYTHON_USEDEP}] )
	qr-login? ( <dev-python/pillow-11.0[${PYTHON_USEDEP}] )
	qr-login? ( <dev-python/qrcode-8.0[${PYTHON_USEDEP}] )
