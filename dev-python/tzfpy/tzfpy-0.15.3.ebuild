...
DESCRIPTION="Probably the fastest Python package to convert longitude/latitude to timezone name [wheel]"
...
IUSE="pytz"
DEPENDENCIES="pytz? ( >=dev-python/pytz-2023.3[${PYTHON_USEDEP}] )
