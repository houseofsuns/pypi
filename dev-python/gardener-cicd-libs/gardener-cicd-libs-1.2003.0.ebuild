...
DESCRIPTION="Gardener CICD Libraries"
...
IUSE=""
DEPENDENCIES="dev-python/gardener-cicd-base[${PYTHON_USEDEP}]
	...
	dev-python/gardener-component-model[${PYTHON_USEDEP}]
	dev-python/gardener-oci[${PYTHON_USEDEP}]
