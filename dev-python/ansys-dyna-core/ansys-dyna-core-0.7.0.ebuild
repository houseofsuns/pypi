...
DEPENDENCIES="dev-python/ansys-dpf-core[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/imageio-2.36.1[${PYTHON_USEDEP}] )
	...
	doc? ( ~dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/ipython-8.29.0[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/jupyterlab-4.3.1[${PYTHON_USEDEP}] )
	doc? ( dev-python/sphinx-jinja[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/sphinx-autoapi-3.4.0[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/scikit-learn-1.6.0[${PYTHON_USEDEP}] )
