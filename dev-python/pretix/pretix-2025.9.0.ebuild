...
DEPENDENCIES="dev-python/arabic-reshaper[${PYTHON_USEDEP}]
	...
	~dev-python/oauthlib-3.3[${PYTHON_USEDEP}]
	...
	~dev-python/pypdf-6.1[${PYTHON_USEDEP}]
	...
	~dev-python/reportlab-4.4[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/aiohttp-3.13[${PYTHON_USEDEP}] )
	dev? ( dev-python/coverage[${PYTHON_USEDEP}] )
	dev? ( dev-python/coveralls[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/fakeredis-2.32[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/flake8-7.3[${PYTHON_USEDEP}] )
	dev? ( dev-python/freezegun[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/isort-6.1[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/pytest-mock-3.15[${PYTHON_USEDEP}] )
