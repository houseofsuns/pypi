...
IUSE="all backports dev docs ipython jupyter kernel mypy numpy tests watch xonsh"
DEPENDENCIES="dev-python/pyparsing[${PYTHON_USEDEP}]
	...
	backports? ( dev-python/async-generator[${PYTHON_USEDEP}] )
	backports? ( dev-python/exceptiongroup[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/async-generator[${PYTHON_USEDEP}] )
