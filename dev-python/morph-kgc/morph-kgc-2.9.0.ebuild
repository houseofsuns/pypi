...
IUSE="all databricks excel kafka kuzu mssql mysql neo4j oracle postgresql snowflake spss sqlite tabular test"
DEPENDENCIES="dev-python/duckdb[${PYTHON_USEDEP}]
	...
	all? ( dev-python/databricks-sqlalchemy[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/pyarrow-20.0.0[${PYTHON_USEDEP}] )
