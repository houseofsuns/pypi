...
IUSE="azure google kafka prometheus s3 sftp"
DEPENDENCIES="<=dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
	...
	<dev-python/cryptography-43.0.2[${PYTHON_USEDEP}]
	...
	<dev-python/jq-1.9.0[${PYTHON_USEDEP}]
