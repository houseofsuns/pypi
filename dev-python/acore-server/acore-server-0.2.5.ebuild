...
DESCRIPTION="AzerothCore World of Warcraft Logic Server Data Model."
...
DEPENDENCIES="dev-python/func-args[${PYTHON_USEDEP}]
	...
	dev-python/acore-paths[${PYTHON_USEDEP}]
	dev-python/acore-constants[${PYTHON_USEDEP}]
	dev-python/acore-server-metadata[${PYTHON_USEDEP}]
	dev-python/acore-server-config[${PYTHON_USEDEP}]
	dev-python/acore-db-ssh-tunnel[${PYTHON_USEDEP}]
