...
IUSE="brotli cli cryptography full jinja jwt opentelemetry picologging redis sqlalchemy standard structlog"
DEPENDENCIES="sqlalchemy? ( dev-python/alembic[${PYTHON_USEDEP}] )
	...
	sqlalchemy? ( >=dev-python/sqlalchemy-2.0.4[${PYTHON_USEDEP}] )
