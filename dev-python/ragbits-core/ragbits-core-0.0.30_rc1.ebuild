...
IUSE="azure chroma fastembed fastembed-gpu gcs google-drive hf local logfire otel pgvector postgres promptfoo qdrant s3 sqlite weaviate"
DEPENDENCIES="<dev-python/aiohttp-4.0.0[${PYTHON_USEDEP}]
	...
	sqlite? ( <dev-python/aiosqlite-1.0.0[${PYTHON_USEDEP}] )
