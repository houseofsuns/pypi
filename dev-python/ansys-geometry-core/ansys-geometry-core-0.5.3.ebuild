...
DEPENDENCIES="dev-python/ansys-api-geometry[${PYTHON_USEDEP}]
	...
	doc? ( ~dev-python/nbconvert-7.16.3[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/nbsphinx-0.9.3[${PYTHON_USEDEP}] )
	doc? ( ~dev-python/notebook-7.1.3[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/grpcio-1.62.2[${PYTHON_USEDEP}] )
