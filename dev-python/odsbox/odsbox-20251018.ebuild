...
DESCRIPTION="Toolbox for accessing ASAM ODS servers using the HTTP API [badver 1.0.13rc410.post1]"
...
DEPENDENCIES="<dev-python/protobuf-7.0.0[${PYTHON_USEDEP}]
	...
	test? ( ~dev-python/pylint-4.0.1[${PYTHON_USEDEP}] )
