...
IUSE="all flickr google gpxpy importer ipernity keyring pixelfed pyqt5 pyqt6 pyside2 pyside6 requests-oauthlib requests-toolbelt spelling"
DEPENDENCIES=">=dev-python/appdirs-1.3[${PYTHON_USEDEP}]
	...
	pyqt6? ( dev-python/PyQt6-Qt6[${PYTHON_USEDEP}] )
	pyqt6? ( dev-python/PyQt6-WebEngine-Qt6[${PYTHON_USEDEP}] )
