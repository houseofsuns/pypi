...
DEPENDENCIES="~dev-python/aiofiles-25.1[${PYTHON_USEDEP}]
	~dev-python/aiohttp-3.12[${PYTHON_USEDEP}]
	dev-python/aiohttp-client-cache[${PYTHON_USEDEP}]
	~dev-python/aiosqlite-0.21[${PYTHON_USEDEP}]
	...
	setuptools? ( ~dev-python/build-1.3[${PYTHON_USEDEP}] )
	setuptools? ( ~dev-python/twine-6.0[${PYTHON_USEDEP}] )
	setuptools? ( ~dev-python/wheel-0.45.1[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/types-docutils-0.21[${PYTHON_USEDEP}] )
	...
	test? ( ~dev-python/yarl-1.22[${PYTHON_USEDEP}] )
	test? ( dev-python/betty[${PYTHON_USEDEP}] )
	development? ( ~dev-python/pytest-repeat-0.9.4[${PYTHON_USEDEP}] )
	development? ( ~dev-python/yappi-1.7[${PYTHON_USEDEP}] )
