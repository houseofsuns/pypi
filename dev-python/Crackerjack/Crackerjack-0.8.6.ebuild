...
LICENSE="BSD"
SRC_URI="https://files.pythonhosted.org/packages/35/e7/2a041741dd45ec6919201e6896a9fb8d82ab2ffd2a01038141cd2ccba3d5/crackerjack-${REALVERSION}.tar.gz"
...
DEPENDENCIES=">=dev-python/click-8.1.7[${PYTHON_USEDEP}]
	...
	>=dev-python/pdm-2.16.1[${PYTHON_USEDEP}]"
