...
DEPENDENCIES="~dev-python/alabaster-0.7.16[${PYTHON_USEDEP}]
	...
	~dev-python/bibtexparser-1.4.1[${PYTHON_USEDEP}]
	dev-python/billiard[${PYTHON_USEDEP}]
	~dev-python/bleach-6.1.0[${PYTHON_USEDEP}]
	~dev-python/blinker-1.8.2[${PYTHON_USEDEP}]
	~dev-python/boto3-1.35.14[${PYTHON_USEDEP}]
	~dev-python/botocore-1.35.14[${PYTHON_USEDEP}]
	...
	~dev-python/Faker-28.4.1[${PYTHON_USEDEP}]
	...
	~dev-python/lxml-html-clean-0.2.2[${PYTHON_USEDEP}]
	...
	~dev-python/platformdirs-4.3.2[${PYTHON_USEDEP}]
	...
	dev? ( ~dev-python/selenium-3.141.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/toml[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/tomli-2.0.1[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/black-24.8.0[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/build-1.2.2[${PYTHON_USEDEP}] )
	devs? ( dev-python/check-manifest[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/coverage-7.6.1[${PYTHON_USEDEP}] )
	...
	devs? ( ~dev-python/pyproject-hooks-1.1.0[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/pytest-7.1.3[${PYTHON_USEDEP}] )
	devs? ( dev-python/pytest-black-ng[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/pytest-cov-5.0.0[${PYTHON_USEDEP}] )
	devs? ( dev-python/pytest-flask[${PYTHON_USEDEP}] )
	...
	devs? ( ~dev-python/selenium-3.141.0[${PYTHON_USEDEP}] )
	devs? ( dev-python/toml[${PYTHON_USEDEP}] )
	devs? ( ~dev-python/tomli-2.0.1[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/build-1.2.2[${PYTHON_USEDEP}] )
