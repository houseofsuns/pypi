...
IUSE="consul etcd etcd3 etcd3gw ipc memcached mysql postgresql redis test zake zookeeper"
DEPENDENCIES="dev-python/fasteners[${PYTHON_USEDEP}]
	...
	etcd3? ( dev-python/etcd3[${PYTHON_USEDEP}] )
	etcd3? ( dev-python/grpcio[${PYTHON_USEDEP}] )
	etcd3? ( dev-python/protobuf[${PYTHON_USEDEP}] )
