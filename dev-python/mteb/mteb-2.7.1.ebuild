...
IUSE="ark blip2 bm25s codecarbon cohere colpali-engine colqwen3 eager-embed faiss-cpu flagembedding flash-attention gritlm image jina jina-v4 leaderboard llama-embed-nemotron llm2vec model2vec nomic open-clip-torch openai peft pylate sauerkrautlm-colpali timm vertexai vllm voyage-v voyageai xet xformers youtu"
DEPENDENCIES="dev-python/datasets[${PYTHON_USEDEP}]
	...
	sauerkrautlm-colpali? ( dev-python/sauerkrautlm-colpali[${PYTHON_USEDEP}] )
