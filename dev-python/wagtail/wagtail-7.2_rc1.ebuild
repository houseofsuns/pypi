...
DEPENDENCIES=">=dev-python/django-4.2[${PYTHON_USEDEP}]
	...
	dev-python/django-tasks[${PYTHON_USEDEP}]
	dev-python/wagtailmodelsearch[${PYTHON_USEDEP}]
	testing? ( >=dev-python/python-dateutil-2.7[${PYTHON_USEDEP}] )
	testing? ( <dev-python/jinja2-3.2[${PYTHON_USEDEP}] )
	...
	testing? ( <dev-python/responses-1.0[${PYTHON_USEDEP}] )
	testing? ( >=dev-python/coverage-3.7.0[${PYTHON_USEDEP}] )
	testing? ( ~dev-python/doc8-1.1.2[${PYTHON_USEDEP}] )
