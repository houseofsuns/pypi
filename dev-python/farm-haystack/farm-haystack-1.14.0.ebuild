...
IUSE="all all-gpu audio beir colab crawler dev docstores docstores-gpu faiss faiss-gpu formatting graphdb inmemorygraph milvus ocr only-faiss only-faiss-gpu only-milvus only-pinecone onnx onnx-gpu opensearch pinecone preprocessing ray sql weaviate"
DEPENDENCIES="dev-python/azure-ai-formrecognizer[${PYTHON_USEDEP}]
	...
	audio? ( dev-python/espnet[${PYTHON_USEDEP}] )
	audio? ( dev-python/espnet-model-zoo[${PYTHON_USEDEP}] )
	audio? ( dev-python/ffmpeg-python[${PYTHON_USEDEP}] )
