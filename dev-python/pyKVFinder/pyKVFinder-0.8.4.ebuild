...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/01/f0/ad00ac7e1af3e9927eba121c75a68c0fbe2f65aefdac77ad40dc8f42b5c3/pykvfinder-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/numpy-2.5.0[${PYTHON_USEDEP}]
	<dev-python/matplotlib-3.11.0[${PYTHON_USEDEP}]
	<dev-python/plotly-6.6.0[${PYTHON_USEDEP}]
