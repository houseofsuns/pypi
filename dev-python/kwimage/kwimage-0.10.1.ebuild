...
DEPENDENCIES=">=dev-python/ubelt-1.3.3[${PYTHON_USEDEP}]
	...
	all-strict? ( ~dev-python/shapely-2.0.2[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/pillow-10.0.0[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/scikit-image-0.22.0[${PYTHON_USEDEP}] )
	all-strict? ( ~dev-python/coverage-7.2.7[${PYTHON_USEDEP}] )
	...
	all? ( >=dev-python/coverage-7.2.7[${PYTHON_USEDEP}] )
	...
	docs-strict? ( ~dev-python/coverage-7.2.7[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/matplotlib-3.7.3[${PYTHON_USEDEP}] )
	docs-strict? ( dev-python/torch[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/scipy-1.11.2[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/numpy-1.26.0[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/shapely-2.0.2[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/pillow-10.0.0[${PYTHON_USEDEP}] )
	docs-strict? ( ~dev-python/scikit-image-0.22.0[${PYTHON_USEDEP}] )
	...
	docs? ( >=dev-python/coverage-7.2.7[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/matplotlib-3.7.3[${PYTHON_USEDEP}] )
	docs? ( dev-python/torch[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/scipy-1.11.2[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/numpy-1.26.0[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/shapely-2.0.2[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/pillow-10.0.0[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/scikit-image-0.22.0[${PYTHON_USEDEP}] )
	...
	runtime-strict? ( ~dev-python/shapely-2.0.2[${PYTHON_USEDEP}] )
	runtime-strict? ( ~dev-python/pillow-10.0.0[${PYTHON_USEDEP}] )
	runtime-strict? ( ~dev-python/scikit-image-0.22.0[${PYTHON_USEDEP}] )
	...
	runtime? ( >=dev-python/shapely-2.0.2[${PYTHON_USEDEP}] )
	runtime? ( >=dev-python/pillow-10.0.0[${PYTHON_USEDEP}] )
	runtime? ( >=dev-python/scikit-image-0.22.0[${PYTHON_USEDEP}] )
	...
	tests-strict? ( ~dev-python/coverage-5.3.1[${PYTHON_USEDEP}] )
	tests-strict? ( ~dev-python/coverage-7.2.7[${PYTHON_USEDEP}] )
