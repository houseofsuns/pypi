...
DEPENDENCIES="all? ( dev-python/hdbscan[${PYTHON_USEDEP}] )
	...
	all? ( ~dev-python/selenium-4.33.0[${PYTHON_USEDEP}] )
	...
	core? ( ~dev-python/pillow-11.2.1[${PYTHON_USEDEP}] )
	core? ( ~dev-python/pytest-8.4.1[${PYTHON_USEDEP}] )
	core? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	core? ( ~dev-python/scikit-learn-1.7.0[${PYTHON_USEDEP}] )
	...
	classification? ( ~dev-python/pillow-11.2.1[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/pytest-8.4.1[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	classification? ( ~dev-python/scikit-learn-1.7.0[${PYTHON_USEDEP}] )
	...
	tracking? ( ~dev-python/pillow-11.2.1[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/pytest-8.4.1[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/pyyaml-6.0.2[${PYTHON_USEDEP}] )
	tracking? ( ~dev-python/scikit-learn-1.7.0[${PYTHON_USEDEP}] )
