...
DESCRIPTION="Python module that is able to merge json record objects. [wheel]"
...
IUSE="all contrib tests"
DEPENDENCIES="dev-python/inspire-dictdiffer[${PYTHON_USEDEP}]
