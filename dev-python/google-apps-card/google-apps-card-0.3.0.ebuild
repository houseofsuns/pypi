...
DESCRIPTION="Google Apps Card API client library [top-max 0.4.0]"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-apps-card"
LICENSE="Apache-2.0"
