...
IUSE="excel-export print-tables"
DEPENDENCIES="dev-python/sanic[${PYTHON_USEDEP}]
	...
	dev-python/ansitohtml[${PYTHON_USEDEP}]
	<dev-python/aiofiles-25.0.0[${PYTHON_USEDEP}]
	<dev-python/python-dotenv-2.0.0[${PYTHON_USEDEP}]
	excel-export? ( <dev-python/openpyxl-4.0.0[${PYTHON_USEDEP}] )
	print-tables? ( <dev-python/tabulate-0.10.0[${PYTHON_USEDEP}] )"
