...
IUSE="all arango chainlit chromadb db doc-chat docling docx fastembed hf-embeddings hf-transformers lancedb litellm meilisearch metaphor momento mysql neo4j pdf-parsers postgres pymupdf4llm scrapy sql transformers unstructured vecdbs weaviate"
DEPENDENCIES="dev-python/adb-cloud-connector[${PYTHON_USEDEP}]
	...
	docling? ( >=dev-python/pypdf-5.1.0[${PYTHON_USEDEP}] )
