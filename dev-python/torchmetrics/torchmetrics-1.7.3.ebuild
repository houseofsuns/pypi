...
IUSE="all audio clustering detection dev image multimodal text typing visual"
DEPENDENCIES=">dev-python/numpy-1.20.0[${PYTHON_USEDEP}]
	...
	typing? ( ~dev-python/mypy-1.16.0[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/PyTDC[${PYTHON_USEDEP}] )
