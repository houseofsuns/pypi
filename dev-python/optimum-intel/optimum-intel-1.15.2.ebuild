...
IUSE="diffusers ipex neural-compressor nncf openvino openvino-tokenizers quality tests"
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	ipex? ( dev-python/onnx[${PYTHON_USEDEP}] )
	neural-compressor? ( dev-python/neural-compressor[${PYTHON_USEDEP}] )
	neural-compressor? ( dev-python/onnx[${PYTHON_USEDEP}] )
	neural-compressor? ( dev-python/onnxruntime[${PYTHON_USEDEP}] )
	...
	openvino-tokenizers? ( dev-python/openvino-tokenizers[${PYTHON_USEDEP}] )
	...
	tests? ( dev-python/auto-gptq[${PYTHON_USEDEP}] )"
