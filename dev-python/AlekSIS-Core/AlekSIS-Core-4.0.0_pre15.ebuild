...
SRC_URI="https://files.pythonhosted.org/packages/89/2b/53c79ca94385b421c12d815da8e570bbc90ffb2f278366689dae0d7559ee/aleksis_core-${REALVERSION}.tar.gz"
...
DEPENDENCIES="<dev-python/django-6.0[${PYTHON_USEDEP}]
	...
	<dev-python/recurring-ical-events-4.0.0[${PYTHON_USEDEP}]
