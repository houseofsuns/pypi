...
DEPENDENCIES="all? ( dev-python/asyncpg[${PYTHON_USEDEP}] )
	...
	metabase? ( dev-python/sql_metadata[${PYTHON_USEDEP}] )
	power-bi? ( dev-python/sql_metadata[${PYTHON_USEDEP}] )
	snowflake? ( dev-python/sql_metadata[${PYTHON_USEDEP}] )
	...
	throughtspot? ( dev-python/thoughtspot-rest-api-v1[${PYTHON_USEDEP}] )
