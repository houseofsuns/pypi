...
IUSE="cloud-deploy cloud-storage"
DEPENDENCIES="<dev-python/requests-3.0.0[${PYTHON_USEDEP}]
	...
	cloud-storage? ( <dev-python/fsspec-2025.0.0[${PYTHON_USEDEP}] )
	cloud-storage? ( dev-python/s3fs[${PYTHON_USEDEP}] )
	cloud-storage? ( dev-python/gcsfs[${PYTHON_USEDEP}] )
	cloud-storage? ( dev-python/adlfs[${PYTHON_USEDEP}] )
