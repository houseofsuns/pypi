...
REALNAME="${PN}"
LITERALNAME="${PN}"
REALVERSION="4.9.4.dev202401210044"
DIGEST_SOURCES="yes"
...
DEPENDENCIES="dev-python/absl-py[${PYTHON_USEDEP}]
	...
	dev? ( dev-python/tf-agents[${PYTHON_USEDEP}] )
	...
	huggingface? ( dev-python/tf-agents[${PYTHON_USEDEP}] )
	...
	tests-all? ( dev-python/tf-agents[${PYTHON_USEDEP}] )
