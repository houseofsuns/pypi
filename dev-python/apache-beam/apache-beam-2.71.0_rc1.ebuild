...
IUSE="aws azure dask dataframe dill docs gcp hadoop interactive interactive-test milvus ml-cpu ml-test onnx p312-ml-test p313-ml-test redis tensorflow tensorflow-hub test tfrecord tft torch transformers vllm xgboost yaml"
DEPENDENCIES="<dev-python/cryptography-48.0.0[${PYTHON_USEDEP}]
	...
	test? ( <dev-python/hypothesis-6.148.4[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-python/pymysql-1.1.0[${PYTHON_USEDEP}] )
	test? ( dev-python/oracledb[${PYTHON_USEDEP}] )
	test? ( dev-python/pymilvus[${PYTHON_USEDEP}] )
	...
	gcp? ( dev-python/python-tds[${PYTHON_USEDEP}] )
	gcp? ( dev-python/pg8000[${PYTHON_USEDEP}] )
	gcp? ( >=dev-python/pymysql-1.1.0[${PYTHON_USEDEP}] )
	gcp? ( dev-python/keyrings-google-artifactregistry-auth[${PYTHON_USEDEP}] )
	gcp? ( <dev-python/orjson-4.0[${PYTHON_USEDEP}] )
	gcp? ( >=dev-python/regex-2020.6.8[${PYTHON_USEDEP}] )
	...
	interactive? ( <dev-python/pydot-2.0[${PYTHON_USEDEP}] )
	...
	ml-test? ( dev-python/dill[${PYTHON_USEDEP}] )
	...
	p313-ml-test? ( dev-python/embeddings[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/onnxruntime[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/langchain[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/sentence-transformers[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/skl2onnx[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/pillow[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/pyod[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/tensorflow-hub[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/tf2onnx[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/torch[${PYTHON_USEDEP}] )
	p313-ml-test? ( dev-python/transformers[${PYTHON_USEDEP}] )
	...
	hadoop? ( dev-python/hdfs[${PYTHON_USEDEP}] )
	...
	yaml? ( <dev-python/jsonschema-5.0.0[${PYTHON_USEDEP}] )
	...
	ml-cpu? ( dev-python/tensorflow[${PYTHON_USEDEP}] )
	ml-cpu? ( dev-python/transformers[${PYTHON_USEDEP}] )
	redis? ( <dev-python/redis-6.0[${PYTHON_USEDEP}] )
	tft? ( dev-python/tensorflow-transform[${PYTHON_USEDEP}] )
	tft? ( dev-python/dill[${PYTHON_USEDEP}] )
	tfrecord? ( <dev-python/crcmod-2.0[${PYTHON_USEDEP}] )
