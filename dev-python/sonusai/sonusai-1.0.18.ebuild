...
DESCRIPTION="Framework for building deep neural network models for sound, speech, and voice AI [wheel]"
...
DEPENDENCIES="dev-python/dataclasses-json[${PYTHON_USEDEP}]
	...
	<dev-python/pyaudio-1.0.0[${PYTHON_USEDEP}]
	...
	<dev-python/soundfile-1.0.0[${PYTHON_USEDEP}]
