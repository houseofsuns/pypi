...
DEPENDENCIES=">=dev-python/requests-toolbelt-0.10.1[${PYTHON_USEDEP}]
	...
	python_version_2-7_? ( dev-python/futures[${PYTHON_USEDEP}] )
	python_version_2-7_? ( dev-python/configparser[${PYTHON_USEDEP}] )
	python_version_2-7_? ( >=dev-python/certifi-2022.12.7[${PYTHON_USEDEP}] )
