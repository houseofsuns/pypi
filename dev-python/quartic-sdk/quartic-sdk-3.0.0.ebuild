...
DEPENDENCIES="dev-python/aiogqlc[${PYTHON_USEDEP}]
	...
	complete? ( ~dev-python/jupyter-core-5.7.1[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/traitlets-5.14.1[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/grpcio-1.62.0[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/markdown-3.5.2[${PYTHON_USEDEP}] )
	...
	complete? ( ~dev-python/wheel-0.42.0[${PYTHON_USEDEP}] )
