...
DEPENDENCIES=">=dev-python/typeguard-4.0[${PYTHON_USEDEP}]
	...
	uvicorn? ( >=dev-python/uvicorn-0.32.0[${PYTHON_USEDEP}] )
	hypercorn? ( >=dev-python/hypercorn-0.17.0[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/sphinx-autodoc-typehints-3.0.0[${PYTHON_USEDEP}] )
