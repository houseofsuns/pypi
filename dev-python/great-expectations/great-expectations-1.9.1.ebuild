...
DEPENDENCIES="dev-python/altair[${PYTHON_USEDEP}]
	...
	snowflake? ( >=dev-python/pyarrow-14.0[${PYTHON_USEDEP}] )
	...
	arrow? ( >=dev-python/pyarrow-14.0[${PYTHON_USEDEP}] )
	arrow? ( dev-python/pyarrow[${PYTHON_USEDEP}] )
	gx-redshift? ( dev-python/gx-sqlalchemy-redshift[${PYTHON_USEDEP}] )
	gx-redshift? ( dev-python/psycopg2-binary[${PYTHON_USEDEP}] )
	gx-redshift? ( >=dev-python/sqlalchemy-1.4.0[${PYTHON_USEDEP}] )
	...
	test? ( dev-python/pdf2image[${PYTHON_USEDEP}] )
	test? ( >=dev-python/pytesseract-0.3.13[${PYTHON_USEDEP}] )
	...
	azure-secrets? ( dev-python/azure-identity[${PYTHON_USEDEP}] )
	azure-secrets? ( dev-python/azure-keyvault-secrets[${PYTHON_USEDEP}] )
	azure-secrets? ( dev-python/azure-storage-blob[${PYTHON_USEDEP}] )
	...
	gcp? ( >=dev-python/sqlalchemy-1.4.0[${PYTHON_USEDEP}] )
