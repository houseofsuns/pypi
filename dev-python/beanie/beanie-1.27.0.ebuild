...
DEPENDENCIES="<dev-python/pydantic-3.0[${PYTHON_USEDEP}]
	...
	aws? ( dev-python/motor[${PYTHON_USEDEP}] )
	...
	encryption? ( dev-python/motor[${PYTHON_USEDEP}] )
	gssapi? ( dev-python/motor[${PYTHON_USEDEP}] )
	ocsp? ( dev-python/motor[${PYTHON_USEDEP}] )
	queue? ( dev-python/beanie-batteries-queue[${PYTHON_USEDEP}] )
	snappy? ( dev-python/motor[${PYTHON_USEDEP}] )
	...
	zstd? ( dev-python/motor[${PYTHON_USEDEP}] )"
