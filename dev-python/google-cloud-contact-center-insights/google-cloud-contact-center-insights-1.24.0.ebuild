...
DESCRIPTION="Google Cloud Contact Center Insights API client library [top-max 1.25.0]"

HOMEPAGE="https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-contact-center-insights"
LICENSE="Apache-2.0"
