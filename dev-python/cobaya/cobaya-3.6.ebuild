...
DEPENDENCIES=">=dev-python/numpy-1.17.0[${PYTHON_USEDEP}]
	...
	devel? ( dev-python/pyupgrade[${PYTHON_USEDEP}] )
	...
	devel? ( dev-python/dill[${PYTHON_USEDEP}] )
	devel? ( dev-python/mpi4py[${PYTHON_USEDEP}] )
	devel? ( dev-python/iminuit[${PYTHON_USEDEP}] )"
