...
DESCRIPTION="A Python Toolbox for Machine Learning on Partially-Observed Time Series [wheel]"
...
DEPENDENCIES="dev-python/h5py[${PYTHON_USEDEP}]
	...
	basic? ( dev-python/benchpots[${PYTHON_USEDEP}] )
	...
	dev? ( dev-python/benchpots[${PYTHON_USEDEP}] )
	...
	full? ( dev-python/benchpots[${PYTHON_USEDEP}] )
