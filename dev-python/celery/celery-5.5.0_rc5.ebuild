...
DEPENDENCIES="dev-python/billiard[${PYTHON_USEDEP}]
	...
	auth? ( ~dev-python/cryptography-44.0.1[${PYTHON_USEDEP}] )
	...
	elasticsearch? ( <=dev-python/elasticsearch-8.17.1[${PYTHON_USEDEP}] )
	elasticsearch? ( <=dev-python/elastic-transport-8.17.0[${PYTHON_USEDEP}] )
