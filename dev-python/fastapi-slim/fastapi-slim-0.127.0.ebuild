...
DEPENDENCIES="<dev-python/starlette-0.51.0[${PYTHON_USEDEP}]
	...
	standard? ( dev-python/pydantic-settings[${PYTHON_USEDEP}] )
	standard? ( dev-python/pydantic-extra-types[${PYTHON_USEDEP}] )
	...
	standard-no-fastapi-cloud-cli? ( dev-python/pydantic-settings[${PYTHON_USEDEP}] )
	standard-no-fastapi-cloud-cli? ( dev-python/pydantic-extra-types[${PYTHON_USEDEP}] )
