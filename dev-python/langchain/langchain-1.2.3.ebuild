...
IUSE="anthropic aws azure-ai community deepseek fireworks google-genai google-vertexai groq huggingface mistralai ollama openai perplexity together xai"
DEPENDENCIES="openai? ( dev-python/langchain-openai[${PYTHON_USEDEP}] )
