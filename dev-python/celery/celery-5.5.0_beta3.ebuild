...
DEPENDENCIES="dev-python/billiard[${PYTHON_USEDEP}]
	...
	auth? ( ~dev-python/cryptography-43.0.1[${PYTHON_USEDEP}] )
	...
	elasticsearch? ( <=dev-python/elasticsearch-8.15.0[${PYTHON_USEDEP}] )
	elasticsearch? ( <=dev-python/elastic-transport-8.15.0[${PYTHON_USEDEP}] )
