...
DEPENDENCIES="aiohttp? ( dev-python/aioworkers-aiohttp[${PYTHON_USEDEP}] )
	...
	dev-interactive? ( ~dev-python/ipykernel-6.29.5[${PYTHON_USEDEP}] )
	dev-interactive? ( ~dev-python/ipython-8.30.0[${PYTHON_USEDEP}] )
	...
	dev-test? ( ~dev-python/coverage-7.6.1[${PYTHON_USEDEP}] )
	dev-test? ( ~dev-python/httptools-0.6.4[${PYTHON_USEDEP}] )
	dev-test? ( ~dev-python/msgpack-1.1.0[${PYTHON_USEDEP}] )
