...
IUSE="file-based sphinx-docs vector-db-based"
DEPENDENCIES="dev-python/airbyte-protocol-models-dataclasses[${PYTHON_USEDEP}]
	...
	file-based? ( ~dev-python/pandas-2.2.0[${PYTHON_USEDEP}] )
