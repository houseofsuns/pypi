...
DEPENDENCIES="~dev-python/alembic-1.13.1[${PYTHON_USEDEP}]
	...
	~dev-python/pastedeploy-3.1.0[${PYTHON_USEDEP}]
	...
	dev-python/pyramid-session-redis[${PYTHON_USEDEP}]
	...
	~dev-python/zope-component-7.0[${PYTHON_USEDEP}]
	~dev-python/zope-deprecation-5.0[${PYTHON_USEDEP}]
	~dev-python/zope-event-6.0[${PYTHON_USEDEP}]
	~dev-python/zope-interface-8.0.1[${PYTHON_USEDEP}]
