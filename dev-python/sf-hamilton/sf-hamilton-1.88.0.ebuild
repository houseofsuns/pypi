...
IUSE="cli dask dask-array dask-core dask-dataframe dask-diagnostics dask-distributed datadog dev diskcache docs experiments lsp openlineage packaging pandera pydantic pyspark ray rich sdk slack test tqdm ui vaex visualization"
DEPENDENCIES="docs? ( dev-python/pillow[${PYTHON_USEDEP}] )
