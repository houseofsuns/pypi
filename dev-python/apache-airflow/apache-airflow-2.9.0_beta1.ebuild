...
DEPENDENCIES="<dev-python/alembic-2.0[${PYTHON_USEDEP}]
	...
	uv? ( >=dev-python/uv-0.1.22[${PYTHON_USEDEP}] )
	...
	devel-ci? ( >=dev-python/docker-6.0[${PYTHON_USEDEP}] )
	...
	devel-ci? ( dev-python/Flask-AppBuilder[${PYTHON_USEDEP}] )
	devel-ci? ( >=dev-python/flask-login-0.6.2[${PYTHON_USEDEP}] )
	devel-ci? ( <dev-python/flask-2.3[${PYTHON_USEDEP}] )
	devel-ci? ( dev-python/google-re2[${PYTHON_USEDEP}] )
	...
	devel-ci? ( >=dev-python/python-slugify-5.0[${PYTHON_USEDEP}] )
	...
	devel-ci? ( dev-python/qdrant-client[${PYTHON_USEDEP}] )
	...
	devel-ci? ( dev-python/teradatasql[${PYTHON_USEDEP}] )
	devel-ci? ( dev-python/teradatasqlalchemy[${PYTHON_USEDEP}] )
	devel-ci? ( <dev-python/pandas-2.2[${PYTHON_USEDEP}] )
	devel-ci? ( dev-python/trino[${PYTHON_USEDEP}] )
	devel-ci? ( >=dev-python/uv-0.1.22[${PYTHON_USEDEP}] )
