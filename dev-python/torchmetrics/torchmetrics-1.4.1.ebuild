...
DESCRIPTION="PyTorch native Metrics [wheel]"
...
DEPENDENCIES=">dev-python/numpy-1.20.0[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/mypy-1.11.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/numpy-2.1.0[${PYTHON_USEDEP}] )
	...
	typing? ( ~dev-python/mypy-1.11.0[${PYTHON_USEDEP}] )
