...
IUSE="cosmos docs ethereum mqtt nuls2 polkadot solana testing tezos"
DEPENDENCIES="dev-python/eciespy[${PYTHON_USEDEP}]
	...
	tezos? ( dev-python/pynacl[${PYTHON_USEDEP}] )
