...
IUSE="all datacore datera ds8k fujitsu hpe3par infinidat kaminario linstor powermax pure rbd-iscsi rsd storpool test unity vnx"
DEPENDENCIES=">=dev-python/paste-3.4.3[${PYTHON_USEDEP}]
