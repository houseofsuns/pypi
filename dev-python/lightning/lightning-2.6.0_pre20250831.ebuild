...
DEPENDENCIES="<dev-python/pyyaml-8.0[${PYTHON_USEDEP}]
	...
	fabric-dev? ( ~dev-python/coverage-7.10.5[${PYTHON_USEDEP}] )
	fabric-dev? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-cov-6.2.1[${PYTHON_USEDEP}] )
	fabric-dev? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-rerunfailures-15.1[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	fabric-dev? ( ~dev-python/pytest-8.4.1[${PYTHON_USEDEP}] )
	...
	fabric-test? ( ~dev-python/coverage-7.10.5[${PYTHON_USEDEP}] )
	fabric-test? ( <dev-python/numpy-2.0[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-cov-6.2.1[${PYTHON_USEDEP}] )
	fabric-test? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-rerunfailures-15.1[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	fabric-test? ( ~dev-python/pytest-8.4.1[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/coverage-7.10.5[${PYTHON_USEDEP}] )
	...
	pytorch-dev? ( ~dev-python/pytest-cov-6.2.1[${PYTHON_USEDEP}] )
	pytorch-dev? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	pytorch-dev? ( ~dev-python/pytest-rerunfailures-15.1[${PYTHON_USEDEP}] )
	pytorch-dev? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	pytorch-dev? ( ~dev-python/pytest-8.4.1[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/coverage-7.10.5[${PYTHON_USEDEP}] )
	...
	pytorch-test? ( ~dev-python/pytest-cov-6.2.1[${PYTHON_USEDEP}] )
	pytorch-test? ( dev-python/pytest-random-order[${PYTHON_USEDEP}] )
	pytorch-test? ( ~dev-python/pytest-rerunfailures-15.1[${PYTHON_USEDEP}] )
	pytorch-test? ( ~dev-python/pytest-timeout-2.4.0[${PYTHON_USEDEP}] )
	pytorch-test? ( ~dev-python/pytest-8.4.1[${PYTHON_USEDEP}] )
