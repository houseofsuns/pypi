...
DESCRIPTION="*(\"yoots\")*: utilities I've missed in the Python standard library, Pytest, Pandas, Plotly, …"
...
DEPENDENCIES="all? ( dev-python/reportlab[${PYTHON_USEDEP}] )
	dev-python/stdlb[${PYTHON_USEDEP}]
