...
IUSE="all coco comet_ml databricks deepspeed dev gcs libcloud mlflow mlperf neptune nlp oci onnx pandas peft sentencepiece slack streaming system_metrics_monitor tensorboard wandb"
DEPENDENCIES="<dev-python/pyyaml-7.0[${PYTHON_USEDEP}]
	...
	all? ( ~dev-python/coverage-7.4.1[${PYTHON_USEDEP}] )
