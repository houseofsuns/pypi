...
DEPENDENCIES="dev-python/graphql-core[${PYTHON_USEDEP}]
	...
	debug? ( <dev-python/libcst-1.8.0[${PYTHON_USEDEP}] )
	debug-server? ( <dev-python/libcst-1.8.0[${PYTHON_USEDEP}] )
	cli? ( <dev-python/libcst-1.8.0[${PYTHON_USEDEP}] )
	...
	debug-server? ( <dev-python/websockets-16.0.0[${PYTHON_USEDEP}] )"
