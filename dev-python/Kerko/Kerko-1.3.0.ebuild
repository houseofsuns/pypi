...
HOMEPAGE=""
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/a3/7d/3d6abb93f9cc39c9b276e740cce351cec92bf392494e6b226df40d30336c/kerko-${REALVERSION}.tar.gz"
...
DEPENDENCIES="dev-python/Babel[${PYTHON_USEDEP}]
	...
	<=dev-python/pyzotero-1.5.20[${PYTHON_USEDEP}]
	...
	tests? ( <dev-python/elementpath-6.0[${PYTHON_USEDEP}] )
	tests? ( <dev-python/lxml-6.0[${PYTHON_USEDEP}] )
