...
DESCRIPTION="A complete web automation framework for end-to-end testing. [wheel]"
...
DEPENDENCIES=">=dev-python/pip-25.1.1[${PYTHON_USEDEP}]
	>=dev-python/packaging-25.0[${PYTHON_USEDEP}]
	>=dev-python/setuptools-80.1.0[${PYTHON_USEDEP}]
	...
	~dev-python/selenium-4.32.0[${PYTHON_USEDEP}]
	...
	coverage? ( >=dev-python/pytest-cov-6.1.1[${PYTHON_USEDEP}] )
	flake8? ( ~dev-python/flake8-7.2.0[${PYTHON_USEDEP}] )
	flake8? ( ~dev-python/mccabe-0.7.0[${PYTHON_USEDEP}] )
	flake8? ( ~dev-python/pyflakes-3.3.2[${PYTHON_USEDEP}] )
	flake8? ( ~dev-python/pycodestyle-2.13.0[${PYTHON_USEDEP}] )
	...
	pdfminer? ( ~dev-python/cryptography-44.0.3[${PYTHON_USEDEP}] )
	pdfminer? ( ~dev-python/cffi-1.17.1[${PYTHON_USEDEP}] )
	pdfminer? ( ~dev-python/pycparser-2.22[${PYTHON_USEDEP}] )
	pillow? ( >=dev-python/pillow-11.2.1[${PYTHON_USEDEP}] )
