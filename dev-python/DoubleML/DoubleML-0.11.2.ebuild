...
SRC_URI="https://files.pythonhosted.org/packages/12/fa/bd4873db92accc57951b6a9efbac435895905107453b1beb89018fd4a809/doubleml-${REALVERSION}.tar.gz"
...
DEPENDENCIES=">=dev-python/joblib-1.2.0[${PYTHON_USEDEP}]
	...
	>=dev-python/mypy-1.18.0[${PYTHON_USEDEP}]
