...
IUSE="all bigquery-v2 bqstorage geopandas ipython ipywidgets matplotlib opentelemetry pandas tqdm"
DEPENDENCIES="<dev-python/google-api-core-3.0.0[${PYTHON_USEDEP}]
	...
	bqstorage? ( <dev-python/grpcio-2.0.0[${PYTHON_USEDEP}] )
	bqstorage? ( >=dev-python/pyarrow-4.0.0[${PYTHON_USEDEP}] )
	pandas? ( >=dev-python/pandas-1.3.0[${PYTHON_USEDEP}] )
	pandas? ( dev-python/pandas-gbq[${PYTHON_USEDEP}] )
	pandas? ( <dev-python/grpcio-2.0.0[${PYTHON_USEDEP}] )
	pandas? ( <dev-python/grpcio-2.0.0[${PYTHON_USEDEP}] )
	...
	ipywidgets? ( >=dev-python/ipykernel-6.2.0[${PYTHON_USEDEP}] )
	geopandas? ( dev-python/geopandas[${PYTHON_USEDEP}] )
	geopandas? ( <dev-python/shapely-3.0.0[${PYTHON_USEDEP}] )
	ipython? ( >=dev-python/ipython-7.23.1[${PYTHON_USEDEP}] )
	ipython? ( dev-python/bigquery-magics[${PYTHON_USEDEP}] )
	matplotlib? ( >=dev-python/matplotlib-3.10.3[${PYTHON_USEDEP}] )
	...
	bigquery-v2? ( <dev-python/proto-plus-2.0.0[${PYTHON_USEDEP}] )
	bigquery-v2? ( <dev-python/protobuf-7.0.0[${PYTHON_USEDEP}] )
