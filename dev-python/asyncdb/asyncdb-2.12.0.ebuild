...
IUSE="all arangodb bigquery boto3 cassandra clickhouse couchdb dataframe default elasticsearch hazelcast influxdb jdbc mariadb memcache mongodb msqlserver mysql odbc oracle postgres postgresql redis redpanda rethinkdb scylla sqlalchemy sqlite uvloop"
