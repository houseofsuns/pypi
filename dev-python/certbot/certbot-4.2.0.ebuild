...
DEPENDENCIES="dev-python/acme[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/poetry-plugin-export-1.9.0[${PYTHON_USEDEP}] )
	all? ( dev-python/towncrier[${PYTHON_USEDEP}] )
	all? ( dev-python/twine[${PYTHON_USEDEP}] )
	all? ( >=dev-python/sphinx-1.2[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/poetry-plugin-export-1.9.0[${PYTHON_USEDEP}] )
	dev? ( dev-python/towncrier[${PYTHON_USEDEP}] )
	dev? ( dev-python/twine[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/sphinx-1.2[${PYTHON_USEDEP}] )
