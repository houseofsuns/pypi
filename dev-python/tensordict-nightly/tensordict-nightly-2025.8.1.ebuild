...
DESCRIPTION="TensorDict is a pytorch dedicated tensor container. [wheel]"
...
IUSE="checkpointing dev h5 tests typecheck"
DEPENDENCIES="dev-python/torch[${PYTHON_USEDEP}]
	...
	typecheck? ( >=dev-python/mypy-1.0.0[${PYTHON_USEDEP}] )
