...
DEPENDENCIES="dev-python/aiobotocore[${PYTHON_USEDEP}]
	...
	~dev-python/aioitertools-0.13.0[${PYTHON_USEDEP}]
	...
	~dev-python/arrow-1.4.0[${PYTHON_USEDEP}]
	...
	~dev-python/faker-40.1.0[${PYTHON_USEDEP}]
	...
	~dev-python/fsspec-2025.12.0[${PYTHON_USEDEP}]
	...
	~dev-python/greenlet-3.3.0[${PYTHON_USEDEP}]
	~dev-python/h11-0.16.0[${PYTHON_USEDEP}]
	~dev-python/humanize-4.15.0[${PYTHON_USEDEP}]
	...
	~dev-python/jupyter-core-5.9.1[${PYTHON_USEDEP}]
	...
	~dev-python/mistune-3.2.0[${PYTHON_USEDEP}]
	...
	~dev-python/nbclient-0.10.4[${PYTHON_USEDEP}]
	...
	~dev-python/orderedmultidict-1.0.2[${PYTHON_USEDEP}]
	...
	~dev-python/pyparsing-3.3.1[${PYTHON_USEDEP}]
	...
	~dev-python/sphinx-9.1.0[${PYTHON_USEDEP}]
	...
	dev-python/types-webencodings[${PYTHON_USEDEP}]
	...
	~dev-python/uritools-6.0.1[${PYTHON_USEDEP}]
