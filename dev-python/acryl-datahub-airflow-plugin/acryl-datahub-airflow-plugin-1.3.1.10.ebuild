...
IUSE="airflow2 airflow3 datahub-file datahub-kafka datahub-rest dev integration-tests"
DEPENDENCIES="dev-python/acryl-datahub[${PYTHON_USEDEP}]
	...
	airflow2? ( dev-python/openlineage-airflow[${PYTHON_USEDEP}] )
	airflow3? ( dev-python/apache-airflow-providers-openlineage[${PYTHON_USEDEP}] )
