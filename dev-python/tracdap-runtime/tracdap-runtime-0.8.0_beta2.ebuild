...
IUSE="aws azure gcp grpc polars pyspark sql"
DEPENDENCIES="gcp? ( dev-python/gcsfs[${PYTHON_USEDEP}] )
	...
	grpc? ( ~dev-python/grpcio-1.66.1[${PYTHON_USEDEP}] )
	grpc? ( ~dev-python/grpcio-status-1.66.1[${PYTHON_USEDEP}] )
