...
LICENSE=""
SRC_URI="https://files.pythonhosted.org/packages/52/55/fc2a34405ac63aaf973a33884c5f77f87564bbb9a4343c1d103cbf8c87f5/${REALNAME}-${REALVERSION}.tar.gz"
...
DEPENDENCIES="dev-python/fast-depends[${PYTHON_USEDEP}]
	...
	cli? ( <=dev-python/typer-0.20.1[${PYTHON_USEDEP}] )
