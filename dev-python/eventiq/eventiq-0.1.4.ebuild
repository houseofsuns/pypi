...
DEPENDENCIES="all? ( dev-python/aio-pika[${PYTHON_USEDEP}] )
	...
	all? ( dev-python/aiorun[${PYTHON_USEDEP}] )
	common? ( dev-python/aiorun[${PYTHON_USEDEP}] )
	cli? ( dev-python/aiorun[${PYTHON_USEDEP}] )
